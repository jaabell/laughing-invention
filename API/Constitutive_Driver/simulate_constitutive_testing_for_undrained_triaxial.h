...
//! \n
//! <div class="contents">
//! <h1>DSL of Constitutive Testing for Undrained Triaxial Test</h1>
...
//! \n
//! This documentation is the API for Domain Specific Language (DSL) of constitutive testing for undrained triaxial test.
//! \n
//! \n
...
int simulate_constitutive_testing_for_undrained_triaxial(double increment_size,
        double strain_cut,
        ...
        int MaterialNumber)
{
    ...
    if (FTEP == NULL)
    {
        cerr << "Error: (simulate_constitutive_testing_for_undrained_triaxial) material allocation problem!" << endl;
        return -1;
    }
