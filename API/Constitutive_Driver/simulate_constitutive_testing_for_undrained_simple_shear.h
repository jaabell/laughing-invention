...
//! \n
//! <div class="contents">
//! <h1>DSL of Constitutive Testing for Undrained Simple Shear Test</h1>
...
//! \n
//! This documentation is the API for Domain Specific Language (DSL) of constitutive testing for undrained simple shear test.
//! \n
//! \n
...
int simulate_constitutive_testing_for_undrained_simple_shear(double increment_size,
        double strain_cut,
        ...
        int MaterialNumber)
{
    ...
    cout << "Test condition is: Undrained Simple Shear \n";
    ...
    if (FTEP == NULL)
    {
        cerr << "Error: (simulate_constitutive_testing_for_undrained_simple_shear) material allocation problem!" << endl;
        return -1;
    }
    ...
    do
    {
        ...
        E12 = tStrain.val(1, 2);         // strain epsilon_xx
        pp  = tStress.p_hydrostatic();   // mean effective stress
        qq  = tStress.q_deviatoric();     // deviatoric stress
        MIT_q = -tStress.val(1, 1) + tStress.val(2, 2); // deviatoric stress
        volstrain = (tStrain.val(1, 1) +
