...
//! \n
//! <div class="contents">
//! <h1>DSL of Constitutive Testing for Undrained Cyclic Triaxial Test</h1>
...
//! \n
//! This documentation is the API for Domain Specific Language (DSL) of constitutive testing for undrained cyclic triaxial test.
//! \n
//! \n
...
int simulate_constitutive_testing_for_undrained_triaxial_stress_control(double increment_size,
        double strain_cut,
        ...
        int MaterialNumber)
{
    ...
    cout << "Test condition is: Undrained Triaxial \n";
    ...
    if (FTEP == NULL)
    {
        cerr << "Error: (simulate_constitutive_testing_for_undrained_triaxial_stress_control) material allocation problem!" << endl;
        return -1;
    }
