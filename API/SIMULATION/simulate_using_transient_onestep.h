...
//! \n
//! <div class="contents">
//! <h1>DSL of Transient (Dynamic) Analysis for One Step</h1>
...
//! \n
//! This documentation is the API for Domain Specific Language (DSL) of transient (dynamic) analysis for one step.
//! \n
//! \n
...
int simulate_using_transient_onestep(double dT)
{
    ...
    {
        cerr << "Error: (analyze_transient_onestep) memory for analysismodel can not be allocated!" << endl;
        return -1;
    }
    ...
    if (theHandler == NULL)
    {
        cerr << "Error: (analyze_transient_onestep) theHandler!" << endl;
        return -1;
    }
    ...
    if (theNumberer == NULL)
    {
        cerr << "Error: (analyze_transient_onestep) theNumberer!" << endl;
        return -1;
    }
    ...
    {
        cerr << "Error: (analyze_transient_onestep) theAlgorithm!" << endl;
        return -1;
    }
    ...
    if (theSOE == NULL)
    {
        cerr << "Error: (analyze_transient_onestep) theSOE!" << endl;
        return -1;
    }
    ...
    {
        cerr << "Error: (analyze_transient_onestep) theTransientIntegrator!" << endl;
        return -1;
    }
    ...
    {
        cerr << "Error: (analyze_transient_onestep) memory for theTransientAnalysis can not be allocated!" << endl;
        return -1;
    }
