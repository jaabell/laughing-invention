...
//! \n
//! <div class="contents">
//! <h1>DSL of Static Analysis for One Step</h1>
...
//! \n
//! This documentation is the API for Domain Specific Language (DSL) of static analysis for one step.
//! \n
//! \n
...
int simulate_using_static_onestep()
{
    ...
    {
        cerr << "Error: (analyze_static_onestep) memory for analysismodel can not be allocated!" << endl;
        return -1;
    }
    ...
    if (theHandler == NULL)
    {
        cerr << "Error: (analyze_static_onestep) theHandler!" << endl;
        return -1;
    }
    ...
    if (theNumberer == NULL)
    {
        cerr << "Error: (analyze_static_onestep) theNumberer!" << endl;
        return -1;
    }
    ...
    {
        cerr << "Error: (analyze_static_onestep) theAlgorithm!" << endl;
        return -1;
    }
    ...
    if (theSOE == NULL)
    {
        cerr << "Error: (analyze_static_onestep) theSOE!" << endl;
        return -1;
    }
    ...
    {
        cerr << "Error: (analyze_static_onestep) theStaticIntegrator!" << endl;
        return -1;
    }
    ...
    {
        cerr << "Error: (analyze_static_onestep) memory for theStaticAnalysis can not be allocated!" << endl;
        return -1;
    }
