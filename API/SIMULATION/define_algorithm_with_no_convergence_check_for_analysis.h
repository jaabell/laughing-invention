...
//! \n
//! <div class="contents">
//! <h1>DSL of Analysis Algorithms (Linear)</h1>
...
//! \n
//! This documentation is the API for Domain Specific Language (DSL) of linear algorithm for analysis.
//! \n
//! \n
...
int define_algorithm_with_no_convergence_check_for_analysis()
{
    ...
    {
        cerr << "Error: (define_algorithm_with_no_convergence_check_for_analysis) memory for defining algorithm can not be allocated!" << endl;
        return -1;
    }
