...
//! \n
//! <div class="contents">
//! <h1>DSL of Convergence Tests (Norm Displacement Increment)</h1>
...
//! \n
//! This documentation is the API for Domain Specific Language (DSL) of gonvergence test (norm displacement increment).
//! \n
//! \n
...
int define_convergence_test_normdisplacementincrement_for_analysis(double theTol, int maxIter, int PrintFlag)
{
    theConvergenceTest = new CTestNormDispIncr(theTol, maxIter, PrintFlag);

    if (theConvergenceTest == NULL)
    {
        cerr << "Error: (define_convergence_test_normdisplacementincrement_for_analysis) memory for convergence test can not be allocated!" << endl;
        return -1;
    }
