...
//! \n
//! <div class="contents">
//! <h1>DSL of Analysis Algorithms (Modified Newton)</h1>
...
//! \n
//! This documentation is the API for Domain Specific Language (DSL) of modified Newton algorithm for analysis.
//! \n
//! \n
...
int define_algorithm_modifiednewton_for_analysis()
{
    ...
    {
        cerr << "Error: (define_algorithm_modifiednewton_for_analysis) the convergence test has not been set to be used by algorithm!" << endl;
        return -1;
    }


    theAlgorithm = new ModifiedNewton(*theConvergenceTest);

    if (theAlgorithm == NULL)
    {
        cerr << "Error: (define_algorithm_modifiednewton_for_analysis) memory for defining algorithm can not be allocated!" << endl;
        return -1;
    }
