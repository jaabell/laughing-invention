...
//! \n
//! <div class="contents">
//! <h1>DSL of Shell MITC4 Element </h1>
...
//! \n
//! This documentation is the API for Domain Specific Language (DSL) of the MITC4 shell element.
//! \n
//! \n
...
int add_element_shell_MITC4(int ElementNumber,
                            int node_numb_1,
                            int node_numb_2,
                            int node_numb_3,
                            int node_numb_4,
                            ...
                            int MaterialNumber)
{
    ...
    //Add the element
    theElement = new ShellMITC4(ElementNumber, node_numb_1, node_numb_2, node_numb_3, node_numb_4, *theSection);

    if (theElement == 0)
    {
        cerr << "WARNING: (add_element_shell_MITC4) ran out of memory creating element\n";
        cerr << "add_element_shell_MITC4 element: " << ElementNumber << endln;
        return -1;
    }

    if (theDomain.addElement(theElement) == false)
    {
        cerr << "WARNING: (add_element_shell_MITC4) could not add element to the domain\n";
        cerr << "add_element_shell_MITC4 element: " << ElementNumber << endln;
        return -1;
        //      delete theElement;
    }
