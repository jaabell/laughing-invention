...
//! \n
//! <div class="contents">
//! <h1>DSL of Reinforcement Bars (Arc)</h1>
...
//! \n
//! This documentation is the API for Domain Specific Language (DSL) of arc type of reinforcement bars.
//! \n
//! \n
...
int add_reinforcing_bars_arc_to_section(int SectionNumber,
                                        int MaterialNumber,
                                        int numReinfBars,
                                        double reinfBarArea,
                                        double yCenter,
                                        ...
                                        double endAng)
{
    ...
    if (sectionRepres == 0)
    {
        cerr <<  "WARNING: (add_reinforcing_bars_arc_to_section) cannot retrieve section\n";
        return -1;
    }
    ...
    if (!reinfLayer)
    {
        cerr <<  "WARNING: (add_reinforcing_bars_arc_to_section) cannot alocate reinfLayer\n";
        return -1;
    }
    ...
    if (error)
    {
        cerr <<  "WARNING: (add_reinforcing_bars_arc_to_section) cannot add reinforcing layer to section\n";
        return -1;
    }
