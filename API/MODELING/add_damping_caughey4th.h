...
//! \n
//! <div class="contents">
//! <h1>DSL of Adding Caughey Damping (4th Order) (based on current stiffness)</h1>
...
//! \n
//! This documentation is the API for Domain Specific Language (DSL) of adding Caughey damping (4th order) based on current stiffness.
//! \n
//! \n
...
int add_damping_caughey4th(int dampingNumber, double a0, double a1, double a2, double a3, string which_stiffness_to_use)
{

    Damping* theDamping = 0;

    theDamping = new Caughey4th(dampingNumber, a0, a1, a2, a3, which_stiffness_to_use);

    if (theDamping == NULL)
    {
        cerr << "Error: (add_damping_caughey4th) memory for theDamping can not be allocated!" << endl;
        return -1;
    }
    ...
    {
        cerr << "Error: (add_damping_caughey4th) Caughey4th " << dampingNumber << " could not be added to the domain " << endl;
        return -1;
    }
