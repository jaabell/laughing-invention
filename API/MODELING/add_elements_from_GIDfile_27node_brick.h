...
int add_elements_from_GIDfile_27node_brick(string, int, int);
int add_elements_from_GIDfile_27node_brick(string inputelementsfile, int MaterialNumber, int AccelerationFieldNumber)
{
