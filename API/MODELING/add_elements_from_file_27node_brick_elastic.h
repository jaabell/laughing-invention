...
int add_elements_from_file_27node_brick_elastic(string inputelementsfile, int MaterialNumber, int AccelerationFieldNumber)
{
    ...
    if(! inputelements)
    {
        cerr << "Error: (add_elements_from_file_27node_brick_elastic) Can not open " << inputelementsfile << "!" << endl;
        return -1;
    }
