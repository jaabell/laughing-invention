...
int add_element_beam_elastic(int ElementNumber,
                             double A,
                             double E,
                             double G,
                             double Jx,
                             ...
                             double jntOffsetJ_X, double jntOffsetJ_Y, double jntOffsetJ_Z)
{
    ...
    theElement = new ElasticBeam(ElementNumber, A, E, G, Jx, Iy, Iz, iNode, jNode, rho, SectionNumber,
    ...
    if (theElement == 0)
    {
        cerr << "WARNING: (add_element_beam_elastic) ran out of memory creating element\n";
    ...
    {
        cerr << "WARNING: (add_element_beam_elastic) could not add element to the domain\n";
