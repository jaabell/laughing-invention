...
//! \n
//! <div class="contents">
//! <h1>DSL of Adding Rayleigh Damping</h1>
...
//! \n
//! This documentation is the API for Domain Specific Language (DSL) of adding rayleigh damping.
//! \n
//! \n
...
//! - a0, a1: Rayleigh order damping coefficients
...
int add_damping_rayleigh(int dampingNumber, double a0, double a1, string which_stiffness_to_use)
{

    Damping* theDamping = 0;

    theDamping = new Rayleigh(dampingNumber, a0, a1, which_stiffness_to_use);

    if (theDamping == NULL)
    {
        cerr << "Error: (add_damping_rayleigh) memory for theDamping can not be allocated!" << endl;
        return -1;
    }

    if( theDomain.addDamping(theDamping) != 0 )
    {
        cerr << "Error: (add_damping_rayleigh) Rayleigh " << dampingNumber << " could not be added to the domain " << endl;
        return -1;
    }
