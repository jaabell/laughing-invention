...
//! \n
//! This documentation is the API for Domain Specific Language (DSL) of removing a node.
//! \n
//! \n
...
//! Inputs:
//! - NodeNumber: integer tag identifying the node to be removed
...
{
    Node* theNode = theDomain.removeNode(NodeNumber);

    if (theNode == NULL)
    {
        cerr.flush() << "Error: (remove_node) memory allocation problem!" << endl;
        return -1;
    }
