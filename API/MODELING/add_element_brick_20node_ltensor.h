...
int add_element_brick_20node_ltensor(int ElementNumber,
                             int node_numb_1,
                             int node_numb_2,
                             int node_numb_3,
                             int node_numb_4,
                             ...
                             int MaterialNumber)
{
    ...
    if (ndmaterial == NULL)
    {
        cerr << "Error: (add_element_brick_20node_ltensor) memory allocation problem for ndmaterial!" << endl;
        return -1;
    }


    Element* theElement = 0;
    theElement = new TwentyNodeBrickLT(ElementNumber, node_numb_1, node_numb_2, node_numb_3, node_numb_4, node_numb_5, node_numb_6, node_numb_7, node_numb_8, node_numb_9, node_numb_10, node_numb_11, node_numb_12, node_numb_13, node_numb_14, node_numb_15, node_numb_16, node_numb_17, node_numb_18, node_numb_19, node_numb_20, ndmaterial);

    if (theElement == NULL)
    {
        cerr << "Error: (add_element_brick_20node_ltensor) memory allocation problem for theElement!" << endl;
        return -1;
    }

    if (theDomain.addElement(theElement) == false)
    {
        cerr << "WARNING: (add_element_brick_20node_ltensor) could not add element to the domain\n";
