...
//! \n
//! <div class="contents">
//! <h1>DSL of ND Material - von-Mises Isotropic Hardening</h1>
...
//! \n
//! This documentation is the API for Domain Specific Language (DSL) of ND material von-Mises isotropic hardening.
//! \n
//! \n
