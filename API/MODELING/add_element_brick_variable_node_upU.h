...
int add_element_brick_variable_node_upU(int ElementNumber,
                                 int node_numb_1,
                                 int node_numb_2,
                                 int node_numb_3,
                                 int node_numb_4,
