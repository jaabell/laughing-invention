...
//! \n
//! <div class="contents">
//! <h1>DSL of Returning the Domain Time</h1>
...
//! \n
//! This documentation is the API for Domain Specific Language (DSL) of returning the domain time.
//! \n
//! \n
