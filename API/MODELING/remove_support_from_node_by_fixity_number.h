...
//! \n
//! <div class="contents">
//! <h1>DSL of Removing a Node Support (Fixity)</h1>
...
//! \n
//! This documentation is the API for Domain Specific Language (DSL) of removing a node support (fixity).
//! \n
//! \n
...
//! Inputs:
//! - FixityNumber: integer tag identifying the fixity to be removed
...
int remove_support_from_node_by_fixity_number(int FixityNumber)
{
    ...
    theSPconstraint = theDomain.removeSP_Constraint(FixityNumber - 1);

    if (theSPconstraint == NULL)
    {
        cerr << "Error: (remove_support_from_node_by_fixity_number) memory allocation problem!" << endl;
        return -1;
    }
