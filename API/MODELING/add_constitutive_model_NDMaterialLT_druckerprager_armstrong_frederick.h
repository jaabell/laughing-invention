...
int add_constitutive_model_NDMaterialLT_druckerprager_armstrong_frederick(int MaterialNumber,
        double rho,
        double E,
        double nu,
        double k,
        ...
        double p0)
{
    ...
    theMaterial = new   DruckerPragerArmstrongFrederick(MaterialNumber,  k,  ha_alpha, cr_alpha,  H_k,  E,  nu, rho, p0);
