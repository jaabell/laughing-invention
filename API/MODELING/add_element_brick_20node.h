...
//! \n
//! <div class="contents">
//! <h1>DSL of Twenty Node Brick Element</h1>
...
//! \n
//! This documentation is the API for Domain Specific Language (DSL) of twenty node brick element.
//! \n
//! \n
                             ...
                             int MaterialNumber)
{
    ...
    if (ndmaterial == NULL)
    {
        cerr << "Error: (add_element_brick_20node) memory allocation problem for ndmaterial!" << endl;
        return -1;
    }
