...
//! Inputs:
//! @param[in]  MaterialNumber: numer/tag of the nD material to be used
...
//! @param[in]  initialconfiningstress: initial confining pressure (positive for compression)
//!
//! \details Material Modeling, Drucker-Prager Perfectly Plastic.
//!
//! \details This DSL command is used to define a Drucker-Prager  Perfectly Plastic material model
//!
