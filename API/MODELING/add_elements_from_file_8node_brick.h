...
int add_elements_from_file_8node_brick(string inputelementsfile, int MaterialNumber, int AccelerationFieldNumber)
{
    ...
    if(! inputelements)
    {
        cerr << "Error: (add_elements_from_file_8node_brick) Can not open " << inputelementsfile << "!" << endl;
        return -1;
    }
