...
int add_element_brick_variable_node(int ElementNumber,
        ...
        int MaterialNumber)
{
    ...
    {
        cerr << "Error: (add_element_brick_variable_node) memory allocation problem for ndmaterialLT!" << endl;
        return -1;
    }


    Element* theElement = 0;
    theElement = new VariableNodeBrickLT(ElementNumber, node_numb_1, node_numb_2, node_numb_3, node_numb_4,
