...
int main(int argc, char* argv[])
{
    ...
    tensor t2times3 = t2 * 3.0;
    t2times3.print("t2times3", "\ntensor t2 times 3");
    ...
    //fprintf(stderr,"LINE  --------------------------  7");
    // tensor additions and scalar multiplications
