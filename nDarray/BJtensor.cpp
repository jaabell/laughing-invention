...
// out BJ 27April2007//##############################################################################
// out BJ 27April2007//// scalar multiplication (BJtensor * scalar)
// out BJ 27April2007//check what happens if you are have tenosr A=B and then you do B*5.13
// out BJ 27April2007// does it change A as well !!!!!!!!!!!!!!!!!!!!!!!!!!
// out BJ 27April2007// TS KR!!!!
// out BJ 27April2007//
// out BJ 27April2007BJtensor BJtensor::operator*( double rval) const //Guanzhou added const
// out BJ 27April2007 {
// out BJ 27April2007// construct BJtensor using the same control numbers as for the
// out BJ 27April2007// original one.
// out BJ 27April2007
// out BJ 27April2007    //Guanzhou changed!!! taking const values from cval instead of val
// out BJ 27April2007
// out BJ 27April2007    BJtensor mult(this->rank(), dim(), 0.0);
// out BJ 27April2007
// out BJ 27April2007    mult.indices1 = this->indices1;
// out BJ 27April2007
// out BJ 27April2007// out BJ 27April2007      for (int counter = 0 ; counter < pc_nDarray_rep->total_numb ; counter ++)
// out BJ 27April2007// out BJ 27April2007        {
// out BJ 27April2007// out BJ 27April2007          *pc_nDarray_rep->pd_nDdata *= rval;
// out BJ 27April2007// out BJ 27April2007        }
// out BJ 27April2007
// out BJ 27April2007
// out BJ 27April2007
// out BJ 27April2007
// out BJ 27April2007    switch(this->rank())
// out BJ 27April2007      {
// out BJ 27April2007        case 0:
// out BJ 27April2007          {
// out BJ 27April2007            mult.val(1) = cval(1) * rval;
// out BJ 27April2007            break;
// out BJ 27April2007          }
// out BJ 27April2007
// out BJ 27April2007        case 1:
// out BJ 27April2007          {
// out BJ 27April2007            for ( int i1=1 ; i1<=this->dim()[0] ; i1++ )
// out BJ 27April2007              mult.val(i1) = cval(i1) * rval;
// out BJ 27April2007            break;
// out BJ 27April2007          }
// out BJ 27April2007
// out BJ 27April2007        case 2:
// out BJ 27April2007          {
// out BJ 27April2007            for ( int i2=1 ; i2<=this->dim()[0] ; i2++ )
// out BJ 27April2007              for ( int j2=1 ; j2<=this->dim()[1] ; j2++ )
// out BJ 27April2007                mult.val(i2, j2) = cval(i2, j2) * rval;
// out BJ 27April2007            break;
// out BJ 27April2007          }
// out BJ 27April2007
// out BJ 27April2007        case 3:
// out BJ 27April2007          {
// out BJ 27April2007            for ( int i3=1 ; i3<=this->dim()[0] ; i3++ )
// out BJ 27April2007              for ( int j3=1 ; j3<=this->dim()[1] ; j3++ )
// out BJ 27April2007                for ( int k3=1 ; k3<=this->dim()[2] ; k3++ )
// out BJ 27April2007                  mult.val(i3, j3, k3) = cval(i3, j3, k3) * rval;
// out BJ 27April2007            break;
// out BJ 27April2007          }
// out BJ 27April2007
// out BJ 27April2007        case 4:
// out BJ 27April2007          {
// out BJ 27April2007            for ( int i4=1 ; i4<=this->dim()[0] ; i4++ )
// out BJ 27April2007              for ( int j4=1 ; j4<=this->dim()[1] ; j4++ )
// out BJ 27April2007                for ( int k4=1 ; k4<=this->dim()[2] ; k4++ )
// out BJ 27April2007                  for ( int l4=1 ; l4<=this->dim()[3] ; l4++ )
// out BJ 27April2007                    mult.val(i4,j4,k4,l4) = cval(i4,j4,k4,l4)*rval;
// out BJ 27April2007            break;
// out BJ 27April2007          }
// out BJ 27April2007      }
// out BJ 27April2007
// out BJ 27April2007    mult.null_indices();
// out BJ 27April2007
// out BJ 27April2007    return mult;
// out BJ 27April2007 }
...
// TS KR!!!!
//
BJtensor BJtensor::operator*( double rval) const //Guanzhou added const
{
    // construct BJtensor using the same control numbers as for the
    // original one.
    ...
    // out BJ 27April2007      for (int counter = 0 ; counter < pc_nDarray_rep->total_numb ; counter ++)
    // out BJ 27April2007        {
    // out BJ 27April2007
    // out BJ 27April2007          *mult.pc_nDarray_rep->pd_nDdata = *pc_nDarray_rep->pd_nDdata * rval;
    // out BJ 27April2007           mult.pc_nDarray_rep->pd_nDdata++;
    // out BJ 27April2007           pc_nDarray_rep->pd_nDdata++;
    // out BJ 27April2007
    // out BJ 27April2007           mult.print("mult","\nmult\n");
    // out BJ 27April2007
    // out BJ 27April2007
    // out BJ 27April2007        }
...
arg.rank() = %d\n",
    ...
    //Amit //##############################################################################
    //Amit  //// ///compare indices start here//////////////
    //Amit  /////////////////////Amit//////////////////////////////////
    //Amit
    //Amit    int * final_integer_array_for_for_both_indices_new = new int[10];
    //Amit
    //Amit
    //Amit   compare_ind( this_indices,
    //Amit                arg_indices,
    //Amit             this_indices_number,
    //Amit                 arg_indices_number,
    //Amit             final_integer_array_for_for_both_indices_new);
    //Amit
    //Amit
    //Amit
    //Amit   matrix_formation(   this_indices,
    //Amit                        arg_indices,
    //Amit            this_indices_number,
    //Amit             arg_indices_number,
    //Amit                        final_integer_array_for_for_both_indices_new);
...
//Amit ///////////////////////////////////////////////////////////////////////////////
//Amit ///////////////////////Implementation By Amit//////////////////////////////////
//Amit ////////////////////////////////////////////////////////////////////////////////
//Amit   void BJtensor::matrix_formation( const char  * this_indices,
//Amit                                    const char  * arg_indices,
//Amit                                    int this_indices_number,
//Amit                                    int arg_indices_number,
//Amit                                    int final_integer_array_for_for_both_indices_new[])
//Amit   {
//Amit      FILE * pFile;
//Amit  pFile = fopen ("tensorproduct_types.txt","w");
//Amit
//Amit
//Amit
//Amit    compare_ind( this_indices,
...
//Amit //       ::fprintf(stderr,"\n");
//Amit //
//Amit //    for (int counter = 0 ; counter < 8 ; counter++)
//Amit //      {
//Amit //        ::fprintf(stderr,"final_integer_array_for_for_both_indices[%d] = %d \n",
//Amit //                          counter,
//Amit //       final_integer_array_for_for_both_indices_new[counter]);
//Amit //      }
//Amit //
//Amit //
//Amit //        ::fprintf(stderr,"\n");
...
//Amit
//Amit /////////////////////////////////////////
//Amit   static int store[100][8] ; ////CHECK if it indeed initializes to zero for all compilers
//Amit   static int how_many_in_that_cathegory[100];
//Amit
//Amit
//Amit
//Amit
//Amit  static int current_rows_filled_up = -1;
//Amit         int row_counter = 0;
//Amit
//Amit
//Amit //happens only once, the first time!
//Amit
//Amit      if  (current_rows_filled_up == -1)
//Amit        {
//Amit          for( int positions = 0 ;  positions <8; positions++ )
//Amit            {
//Amit         store[row_counter][positions] = final_integer_array_for_for_both_indices_new[positions];
//Amit            }
//Amit   current_rows_filled_up++;
//Amit
//Amit        }
//Amit
//Amit        // for all other instances go through this
//Amit       else
//Amit
//Amit     {
//Amit
//Amit  bool match = 0;
//Amit         while (row_counter <= current_rows_filled_up )
//Amit
//Amit
//Amit        {
//Amit
//Amit    ////storing arrays in a matrix//////////////
//Amit
//Amit
//Amit             for( int positions = 0 ;  positions <  8; positions++ )
//Amit
//Amit             {
//Amit                 if (store[row_counter][positions] != final_integer_array_for_for_both_indices_new[positions]) goto loop;
//Amit             }
//Amit
//Amit
//Amit
//Amit            match = 1;
//Amit                ++how_many_in_that_cathegory[row_counter];
//Amit
//Amit         loop:
//Amit         row_counter++;
//Amit
//Amit
//Amit       if (row_counter > current_rows_filled_up && !(match))
//Amit             {
//Amit
//Amit            for( int positions = 0 ;  positions <  8; positions++ )
//Amit
...
//Amit
//Amit
//Amit         for (int i = 0 ; i < 100 ; i++)
//Amit         {
//Amit         fprintf(pFile, " store [%3d] [0-7] = %1d %1d %1d %1d %1d %1d %1d %1d ",
//Amit                            i, store[i][0],
//Amit          store[i][1],
//Amit          store[i][2],
//Amit          store[i][3],
...
//Amit
//Amit
//Amit               fprintf(pFile, "  how_many_in_that_cathegory [%3d]\n",
//Amit
//Amit         how_many_in_that_cathegory[i]);
//Amit         }
//Amit     fclose (pFile);
//Amit
//Amit
...
//Amit
//Amit
//Amit void BJtensor::compare_ind( const char  * this_indices,
//Amit                            const char  * arg_indices,
//Amit       int this_indices_number,
//Amit       int arg_indices_number,
//Amit                            int * final_integer_array_for_for_both_indices_new)
...
//Amit {
//Amit
//Amit   int leftcontractedint;
//Amit   int rightcontractedint;
//Amit
//Amit   int leftno[4]={0,0,0,0};
//Amit   int rightno[4]={0,0,0,0};
//Amit   int final_integer_array_for_for_both_indices[8] = {0,0,0,0,0,0,0,0};
//Amit //  int c[8]={0,0,0,0,0,0,0,0};
//Amit
//Amit
//Amit //int type1[8]={1,2,3,4,1,2,7,8};
//Amit
//Amit //  char * a = this_indices;
//Amit //  char * b = arg_indices;
//Amit
//Amit
//Amit   // cout << a << " " << b << endl;                        // Output: abcd efg xyz ijk
//Amit //   //
//Amit //          ::fprintf(stderr,"\n");
//Amit //     ::fprintf(stderr,"String length for this_indices_number = %d\n",this_indices_number);
//Amit //     ::fprintf(stderr,"String length for arg_indices_number = %d\n",arg_indices_number);
//Amit //
//Amit //#############################################################################################
//Amit
//Amit   int i=0;
//Amit   for (i=0 ; i < this_indices_number; i++)//Generate integers for left indices
//Amit    {
//Amit      leftno[i]=i+1;
//Amit     // cout<<leftno[i]<<i<<endl;
//Amit    }
//Amit
//Amit //#############################################################################################
//Amit
//Amit   for (i=0 ; i < arg_indices_number ; i++)//Generate integers for right indices
//Amit     {
//Amit       rightno[i] = i + this_indices_number + 1;
//Amit       //cout<<rightno[j]<<j<<endl;
//Amit     }
//Amit
//Amit //#################################################################################################################################
//Amit
//Amit    int j;
//Amit    for (i=0 ; i<this_indices_number ; i++)
//Amit      {
//Amit        for (j=0 ; j<arg_indices_number  ; j++)
//Amit          {
//Amit        if (this_indices[i] == arg_indices[j])
//Amit              {
//Amit  //       cout<<"left contracted indices number= "<<i+1<<endl<<"Right contracted indices number= "<<j+1<<endl<<a[i]<<endl<<b[j]<<endl;
//Amit         leftcontractedint = i+1;
//Amit         rightcontractedint = j+this_indices_number+1;
//Amit                rightno[j]=leftcontractedint;     //trying to replace right indices with left contracted members
//Amit              }
//Amit          }
//Amit      }
//Amit
//Amit
//Amit //############################### store changed numbers############################
//Amit //  for (i=0 ; i<this_indices_number ; i++)
//Amit //    {
//Amit //     // cout<<leftno[i];
//Amit //    }
//Amit //
//Amit //  for (i=0;i<arg_indices_number  ;i++ )
//Amit //    {
//Amit //     // cout<<rightno[i];
//Amit //    }
//Amit //  cout<<endl;
//Amit
//Amit //################################## storing 2 arrays in a single array################
//Amit
//Amit   for (i=0;i<this_indices_number; i++)
//Amit     {
//Amit       final_integer_array_for_for_both_indices[i] = leftno[i];
//Amit     }
//Amit
//Amit   for (i=0;i<arg_indices_number; i++)
//Amit     {
//Amit       final_integer_array_for_for_both_indices[i+this_indices_number] = rightno[i];
//Amit      // ::fprintf(stderr,"%10",c[i]);//Amit
//Amit     }
//Amit
//Amit   for (i=0; i<8; i++)
//Amit     {
//Amit     final_integer_array_for_for_both_indices_new[i] = final_integer_array_for_for_both_indices[i];
//Amit     }
//Amit
//Amit }
//Amit
...
BJtensor BJtensor::operator/( BJtensor& rval)
{
    ...
    if ( rval.rank() != 1 )
    {
        ::printf("rval.rank() != 1 for BJtensor BJtensor::operator/( BJtensor & rval)\n");
    }
...
// I_ikjl scheme
{
    ...
    //    converted.print("t","\n\n converted  in BJtensor2BJmatrix_2\n");
