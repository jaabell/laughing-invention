...
arg.rank() = %d\n",
    ...
    //##############################################################################
    //// ///compare indices start here//////////////
    /////////////////////Amit//////////////////////////////////

    int* final_integer_array_for_for_both_indices_new = new int[10];
    ...
    compare_ind( this_indices,
                 ...
                 this_indices_number,
                 arg_indices_number,
                 final_integer_array_for_for_both_indices_new);



    matrix_formation(   this_indices,
                        arg_indices,
                        this_indices_number,
                        arg_indices_number,
                        final_integer_array_for_for_both_indices_new);
...
///////////////////////////////////////////////////////////////////////////////
///////////////////////Implementation By Amit//////////////////////////////////
////////////////////////////////////////////////////////////////////////////////
void BJtensor::matrix_formation( const char*   this_indices,
                                 const char*   arg_indices,
                                 int this_indices_number,
                                 int arg_indices_number,
                                 int final_integer_array_for_for_both_indices_new[])
{
    FILE* pFile;
    pFile = fopen ("tensorproduct_types.txt", "w");
    ...
    for (int counter = 0 ; counter < 8 ; counter++)
    {
        ::fprintf(stderr, "final_integer_array_for_for_both_indices[%d] = %d \n",
                  counter,
                  final_integer_array_for_for_both_indices_new[counter]);
    }
    ...
    /////////////////////////////////////////
    static int store[60][8] ; ////CHECK if it indeed initializes to zero for all compilers
    static int how_many_in_that_cathegory[20];
    ...
    if  (current_rows_filled_up == -1)
    {
        ...
        {
            store[row_counter][positions] = final_integer_array_for_for_both_indices_new[positions];
        }
...

    {
...

        {
            ...
            {
                if (store[row_counter][positions] != final_integer_array_for_for_both_indices_new[positions])
                {
                    goto loop;
                }
            }
            ...
            match = 1;
            ++how_many_in_that_cathegory[row_counter];

loop:
            row_counter++;


            if (row_counter > current_rows_filled_up && !(match))
            {
    ...
    for (int i = 0 ; i < 60 ; i++)
    {
        fprintf(pFile, " store [%3d] [0-7] = %1d %1d %1d %1d %1d %1d %1d %1d ",
                i, store[i][0],
                store[i][1],
                store[i][2],
                store[i][3],
        ...
        fprintf(pFile, "  how_many_in_that_cathegory [%3d]\n",

                how_many_in_that_cathegory[i]);
    }
...

{
    ...
    int final_integer_array_for_for_both_indices[8] = {0, 0, 0, 0, 0, 0, 0, 0};
    ...
    for (i = 0; i < 8; i++)
    {
        final_integer_array_for_for_both_indices_new[i] = final_integer_array_for_for_both_indices[i];
    }
