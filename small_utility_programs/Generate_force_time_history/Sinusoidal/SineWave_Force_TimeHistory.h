...
#ifndef SineWave_Force_TimeHistory_h
#define SineWave_Force_TimeHistory_h
...
class SineWave_Force_TimeHistory : public LoadPattern
{
    public:
        SineWave_Force_TimeHistory();

        SineWave_Force_TimeHistory(int tag,
                                   int NodeNumber,
