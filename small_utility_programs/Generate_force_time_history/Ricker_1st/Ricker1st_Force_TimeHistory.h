...
#ifndef Ricker1st_Force_TimeHistory_h
#define Ricker1st_Force_TimeHistory_h
...
class Ricker1st_Force_TimeHistory : public LoadPattern
{
    public:
        Ricker1st_Force_TimeHistory();

        Ricker1st_Force_TimeHistory(int tag,
                                    int NodeNumber,
