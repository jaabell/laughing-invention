...
#ifndef Ricker2nd_Force_TimeHistory_h
#define Ricker2nd_Force_TimeHistory_h
...
class Ricker2nd_Force_TimeHistory : public LoadPattern
{
    public:
        Ricker2nd_Force_TimeHistory();

        Ricker2nd_Force_TimeHistory(int tag,
                                    int NodeNumber,
