...
#ifndef Ricker2nd_Disp_TimeHistory_Penalty_h
#define Ricker2nd_Disp_TimeHistory_Penalty_h
...
class Ricker2nd_Disp_TimeHistory_Penalty : public LoadPattern
{
    public:
        Ricker2nd_Disp_TimeHistory_Penalty();

        Ricker2nd_Disp_TimeHistory_Penalty(int tag,
