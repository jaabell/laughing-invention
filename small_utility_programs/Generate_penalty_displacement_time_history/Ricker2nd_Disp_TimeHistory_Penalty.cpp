...
#include <Ricker2nd_Disp_TimeHistory_Penalty.h>
#include <math.h>
...
Ricker2nd_Disp_TimeHistory_Penalty::Ricker2nd_Disp_TimeHistory_Penalty()
    : LoadPattern(0, PATTERN_TAG_Ricker2nd_Disp_TimeHistory_Penalty),
      nodeTag(0),
      penalty_stiffness(0),
      dof(0),
      tStart(0),
...
Ricker2nd_Disp_TimeHistory_Penalty::Ricker2nd_Disp_TimeHistory_Penalty(int tag,
        ...
        double TimeMaximum,
        double Amplitude)
    : LoadPattern(tag, PATTERN_TAG_Ricker2nd_Disp_TimeHistory_Penalty),
      nodeTag(NodeNumber),
...
void
Ricker2nd_Disp_TimeHistory_Penalty::setDomain(Domain* theDomain)
{
...
double
Ricker2nd_Disp_TimeHistory_Penalty::getFactor(double pseudoTime)
{
    ...
    if (pseudoTime >= tStart && (pseudoTime - tFinish <= 1.0e-10))
    {
        ...
        double current_load = cFactor * (2 * a1 * (pseudoTime - tStart - Timemax) *
...
void
Ricker2nd_Disp_TimeHistory_Penalty::applyLoad(double time)
{
    ...
    if (theNode == 0)
    {
        std::cerr << "Ricker2nd_Disp_TimeHistory_Penalty - no nodes associtated to the nodeTag " << nodeTag << "\n";
        exit(1);
    }
...
int
Ricker2nd_Disp_TimeHistory_Penalty::sendSelf(int commitTag, Channel& theChannel)
{
...
void
Ricker2nd_Disp_TimeHistory_Penalty::Print(OPS_Stream& s, int flag)
{
    s << "Ricker2nd_Disp_TimeHistory_Penalty " << this->getTag() << endln;
...
LoadPattern*
Ricker2nd_Disp_TimeHistory_Penalty::getCopy(void)
{

    std::cerr << "Ricker2nd_Disp_TimeHistory_Penalty::getCopy() - not yet implemented\n";
    return 0;
}
