...
#ifndef SineWave_Disp_TimeHistory_Penalty_h
#define SineWave_Disp_TimeHistory_Penalty_h
...
class SineWave_Disp_TimeHistory_Penalty : public LoadPattern
{
    public:
        SineWave_Disp_TimeHistory_Penalty();

        SineWave_Disp_TimeHistory_Penalty(int tag,
