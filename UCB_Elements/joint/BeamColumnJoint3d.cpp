    ...
    BCJoint(13, 16), dg_df(4, 13), dDef_du(13, 4), K(24, 24), R(24)
{
    ...
    {
        std::cerr << "ERROR : BeamColumnJoint::BeamColumnJoint - " << tag << "failed to create an ID of size 4" << endln;
    }
    ...
    if (!MaterialPtr[0])
    {
        std::cerr << "ERROR : BeamColumnJoint::Constructor failed to get a copy of material 1" << endln;
    }
    ...
    if (!MaterialPtr[1])
    {
        std::cerr << "ERROR : BeamColumnJoint::Constructor failed to get a copy of material 2" << endln;
    }
    ...
    if (!MaterialPtr[2])
    {
        std::cerr << "ERROR : BeamColumnJoint::Constructor failed to get a copy of material 3" << endln;
    }
    ...
    if (!MaterialPtr[3])
    {
        std::cerr << "ERROR : BeamColumnJoint::Constructor failed to get a copy of material 4" << endln;
    }
    ...
    if (!MaterialPtr[4])
    {
        std::cerr << "ERROR : BeamColumnJoint::Constructor failed to get a copy of material 5" << endln;
    }
    ...
    if (!MaterialPtr[5])
    {
        std::cerr << "ERROR : BeamColumnJoint::Constructor failed to get a copy of material 6" << endln;
    }
    ...
    if (!MaterialPtr[6])
    {
        std::cerr << "ERROR : BeamColumnJoint::Constructor failed to get a copy of material 7" << endln;
    }
    ...
    if (!MaterialPtr[7])
    {
        std::cerr << "ERROR : BeamColumnJoint::Constructor failed to get a copy of material 8" << endln;
    }
    ...
    if (!MaterialPtr[8])
    {
        std::cerr << "ERROR : BeamColumnJoint::Constructor failed to get a copy of material 9" << endln;
    }
    ...
    if (!MaterialPtr[9])
    {
        std::cerr << "ERROR : BeamColumnJoint::Constructor failed to get a copy of material 10" << endln;
    }
    ...
    if (!MaterialPtr[10])
    {
        std::cerr << "ERROR : BeamColumnJoint::Constructor failed to get a copy of material 11" << endln;
    }
    ...
    if (!MaterialPtr[11])
    {
        std::cerr << "ERROR : BeamColumnJoint::Constructor failed to get a copy of material 12" << endln;
    }
    ...
    if (!MaterialPtr[12])
    {
        std::cerr << "ERROR : BeamColumnJoint::Constructor failed to get a copy of material 13" << endln;
    }
...
BeamColumnJoint3d::setDomain(Domain *theDomain)
{
    if (theDomain == 0)
    {
        std::cerr << "ERROR : BeamColumnJoint::setDomain -- Domain is null" << endln;
    }
    ...
    for (int i = 0; i < 4; i++ )
    {
        ...
        if (nodePtr[i] == 0)
        {
            std::cerr << "ERROR : BeamColumnJoint::setDomain -- node pointer is null" << endln;
    ...
    {
        std::cerr << "ERROR : BeamColumnJoint::setDomain -- number of DOF associated with the node incorrect" << endln;
        exit(-1); // donot go any further - otherwise segmentation fault
    }
    ...
    {
        std::cerr << "ERROR : BeamColumnJoint::setDomain -- length or width not correct, division by zero occurs" << endln;
        exit(-1); // donot go any further - otherwise segmentation fault
    }
...
void BeamColumnJoint3d::getGlobalDispls(Vector &dg)
{
    ...
    while ((loadStep < 1.0) && (totalCount < maxTotalCount))
    {
        ...
        if (!converge && loadStep < 1.0)
        {
            ...
            {
                std::cerr << "WARNING : BeamColumnJoint::getGlobalDispls() - convergence problem in state determination" << endln;
...
void BeamColumnJoint3d::formTransfMat()
{
    ...
    double a24 = Node2(0) / Crd24;
    double b24 = Node2(1) / Crd24;
    double c24 = Node2(2) / Crd24;
    double a31 = Node3(0) / Crd31;
    double b31 = Node3(1) / Crd31;
    double c31 = Node3(2) / Crd31;
    ...
    Tran(1, 1) =  b31;
    Tran(1, 2) = c31;
    Tran(2, 3) = b24 * c31 - b31 * c24;
    Tran(2, 4) = -a24 * c31 + c24 * a31;
    Tran(2, 5) = a24 * b31 - b24 * a31;
