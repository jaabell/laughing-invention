...
HingeRadauTwoBeamIntegration3d::sendSelf(int cTag, Channel& theChannel)
{
    ...
    {
        std::cerr << "HingeRadauTwoBeamIntegration3d::sendSelf() - failed to send Vector data\n";
        return -1;
    }
...
int
HingeRadauTwoBeamIntegration3d::receiveSelf(int cTag, Channel& theChannel,
        FEM_ObjectBroker& theBroker)
{
    ...
    {
        std::cerr << "HingeRadauTwoBeamIntegration3d::receiveSelf() - failed to receive Vector data\n";
        return -1;
    }
...
void
HingeRadauTwoBeamIntegration3d::Print(ostream& s, int flag)
{
