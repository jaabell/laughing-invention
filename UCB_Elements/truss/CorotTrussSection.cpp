      ...
      theMatrix(0), theVector(0)
{
    ...
    if (theSection == 0)
    {
        std::cerr << "FATAL CorotTrussSection::CorotTrussSection - " << tag <<
      ...
      theMatrix(0), theVector(0)
{
    ...
    if (connectedExternalNodes.Size() != 2)
    {
        std::cerr << "FATAL CorotTrussSection::CorotTrussSection - failed to create an ID of size 2\n";
        exit(-1);
    }
}
...
CorotTrussSection::setDomain(Domain *theDomain)
{
    ...
    {
        std::cerr << "CorotTrussSection::setDomain() - CorotTrussSection " <<
    ...
    if (dofNd1 != dofNd2)
    {
        std::cerr << "WARNING CorotTrussSection::setDomain(): nodes have differing dof at ends for CorotTrussSection" <<
                  this->getTag() << endln;
    ...
    {
        std::cerr << "CorotTrussSection::setDomain -- nodal DOF not compatible with element " << this->getTag() << endln;
...
CorotTrussSection::commitState()
{
    ...
    {
        std::cerr << "CorotTrussSection::commitState () - failed in base class";
    }
