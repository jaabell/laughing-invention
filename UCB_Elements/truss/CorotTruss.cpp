      ...
      theMatrix(0), theVector(0)
{
    ...
    if (theMaterial == 0)
    {
        std::cerr << "FATAL CorotTruss::CorotTruss - " <<  tag <<
      ...
      theMatrix(0), theVector(0)
{
    ...
    if (connectedExternalNodes.Size() != 2)
    {
        std::cerr << "FATAL CorotTruss::CorotTruss - failed to create an ID of size 2\n";
        exit(-1);
    }
...
CorotTruss::setDomain(Domain *theDomain)
{
    ...
    {
        std::cerr << "CorotTruss::setDomain() - CorotTruss " << this->getTag() << " node " <<
    ...
    if (dofNd1 != dofNd2)
    {
        std::cerr << "WARNING CorotTruss::setDomain(): nodes " << Nd1 <<
    ...
    {
        std::cerr << " CorotTruss::setDomain -- nodal DOF " << dofNd1 << " not compatible with element\n";
...
CorotTruss::commitState()
{
    ...
    {
        std::cerr << "CorotTruss::commitState () - failed in base class\n";
    }
