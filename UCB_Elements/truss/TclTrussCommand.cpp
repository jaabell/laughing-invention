                         ...
                         TclModelBuilder* theTclBuilder, int eleArgStart)
{
    ...
    if ((argc - eleArgStart) < 5)
    {
        ...
        std::cerr << "Want: element truss eleTag? iNode? jNode? A? matTag?\n";
        std::cerr << " -or- element truss eleTag? iNode? jNode? sectTag?" << endln;
        return TCL_ERROR;
    }
    ...
    {
        std::cerr << "WARNING invalid truss eleTag" << endln;
        return TCL_ERROR;
    }
    ...
    if (Tcl_GetInt(interp, argv[2 + eleArgStart], &iNode) != TCL_OK)
    {
        ...
        std::cerr << "truss element: " << trussId << endln;
        return TCL_ERROR;
    }
    ...
    if ((argc - eleArgStart) == 6)
    {
        ...
        {
            std::cerr << "WARNING invalid matTag\n";
            std::cerr << "truss element: " << trussId << endln;
            return TCL_ERROR;
        }
    ...
    else
    {
        ...
        if (theSection == 0)
        {
            std::cerr << "WARNING section not found\n";
            std::cerr << "section tag: " << sectID;
            std::cerr << "\ntruss element: " << trussId << endln;
            return TCL_ERROR;
        }
