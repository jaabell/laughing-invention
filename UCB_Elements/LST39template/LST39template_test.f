...
C     All inputs built-in; execute "as is"
      ...
      double precision   e(9), v(9,9), z(9), fpars(10)
      real               tbeg, tend
...
C
     ...
     &      ('OPT', ' C', x, y, Emat, h, ls, Kt, m, status)
      ...
      call   MATRIXPRINT (e, 1, m)
      call   LST39RSignature('OPT', Em, fpars, status)
...
*23456789012345678901234567890123456789012345678901234567890123456789012
	...
	call   MATRIXPRINT (Q4, 3, 3)
	call   MATRIXPRINT (Q5, 3, 3)
	call   MATRIXPRINT (Q6, 3, 3)
	call   MATRIXPRINT (Te, 3, 3)
	call   MATRIXPRINT (Eh, 3, 3)
	call   MATRIXPRINT (Ehn, 3, 3)
