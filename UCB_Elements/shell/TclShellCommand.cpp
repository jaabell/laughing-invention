                              ...
                              TclModelBuilder* theTclBuilder, int eleArgStart)
{
    ...
    if ((argc - eleArgStart) < 7)
    {
        ...
        std::cerr << "Want: element ShellMITC4 eleTag? iNode? jNode? kNode? lNode? secTag?\n";
        return TCL_ERROR;
    }
    ...
    {
        std::cerr << "WARNING invalid ShellMITC4 eleTag" << endln;
        return TCL_ERROR;
    }
    ...
    if (Tcl_GetInt(interp, argv[2 + eleArgStart], &iNode) != TCL_OK)
    {
        ...
        std::cerr << "ShellMITC4 element: " << ShellMITC4Id << endln;
        return TCL_ERROR;
    }
