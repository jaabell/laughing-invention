...
NDMaterial* ElasticCrossAnisotropic::getCopy (const char* type)
{
    ...
    {
        cerr << "ElasticCrossAnisotropic::getModel failed to get model " << type << "\n";
        return 0;
    }
}
...
ElasticCrossAnisotropic::sendSelf(int commitTag, Channel& theChannel)
{
    ...
    if (res < 0)
    {
        cerr << " ElasticCrossAnisotropic::sendSelf -- could not send Vector\n";
        return res;
    }
...
{
    s << "ElasticCrossAnisotropic" << endl;
    s << "\tEh:  " << Eh <<endl;
    s << "\tEv:  " << Ev <<endl;
    s << "\tnuhv:  " << nuhv << endl;
    s << "\tnuhh:  " << nuhh << endl;
