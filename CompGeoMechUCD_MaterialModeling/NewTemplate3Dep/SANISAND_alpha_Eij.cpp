...
////////////////////////////////////////////////////////////////
SANISAND_alpha_Eij::~SANISAND_alpha_Eij()
{
...
double SANISAND_alpha_Eij::getec(double e_r, double lambda, double xi, double Pat, double p_c) const
{
    ...
    {
        cerr << "Warning: SANISAND_alpha_Eij - 'p_c/Pat' less than zero! " << endln;
    }
...
int SANISAND_alpha_Eij::sendSelf(int commitTag, Channel& theChannel)
{
    ...
    {
        cerr << "SANISAND_alpha_Eij::sendSelf -- failed to send ID\n";
        return -1;
    }
...
//Guanzhou added for parallel
int SANISAND_alpha_Eij::receiveSelf(int commitTag, Channel& theChannel, FEM_ObjectBroker& theBroker)
{
    int dataTag = this->getDbTag();
    ...
    {
        cerr << "SANISAND_alpha_Eij::receiveSelf -- failed to recv ID\n";
        return -1;
    }
