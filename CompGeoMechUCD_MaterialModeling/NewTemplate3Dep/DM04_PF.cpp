        ...
        const MaterialParameter& MaterialParameter_in) const
{
    ...
    double z_n = 0.0;
    //double alpha_n;   //J.Abell : Dec 2012 -> is not used
    double s_n = 0.0;
                             ...
                             const MaterialParameter& MaterialParameter_in) const
{
    ...
    alpha_n = (alpha("ij") * n("ij")).trace(); //J.Abell : Dec 2012 -> is not used
    s_n = (s("ij") * n("ij")).trace();
...
const stresstensor& DM04_PF::getalpha(const MaterialParameter& MaterialParameter_in) const
{
    ...
    {
        cerr << "DM04_PF: Invalid Input. " << endln;
        exit (1);
    }
}
...
double DM04_PF::getParameters(const MaterialParameter& MaterialParameter_in, int parIndex, int which) const
{
    ...
    {
        cerr << "DM04_PF: Invalid Input. " << parIndex << " and " << which << endln;
        exit (1);
    }
}
...
double DM04_PF::getec(double e_r, double lambda_c, double xi, double Pat, double p_c) const
{
    ...
    {
        cerr << "Warning: DM04_PF - 'p_c/Pat' less than zero! " << endln;
    }
...
int DM04_PF::sendSelf(int commitTag, Channel& theChannel)
{
    ...
    idData(1) = e_r_which;
    idData(13) = index_e_r;
    idData(2) = lambda_c_which;
    idData(14) = index_lambda_c;
    idData(3) = xi_which;
    idData(15) = index_xi;
    idData(4) = Pat_which;
    idData(16) = index_Pat;
    idData(5) = m_which;
    idData(17) = index_m;
    idData(6) = M_cal_which;
    idData(18) = index_M_cal;
    idData(7) = cc_which;
    idData(19) = index_cc;
    idData(8) = A0_which;
    idData(20) = index_A0;
    ...
    idData(10) = alpha_which;
    idData(22) = index_alpha;
    idData(11) = z_which;
    idData(23) = index_z;
    ...
    {
        cerr << "DM04_PF::sendSelf -- failed to send ID\n";
        return -1;
    }
...
//Guanzhou added for parallel
int DM04_PF::receiveSelf(int commitTag, Channel& theChannel, FEM_ObjectBroker& theBroker)
{
    int dataTag = this->getDbTag();
    ...
    {
        cerr << "DM04_PF::receiveSelf -- failed to recv ID\n";
        return -1;
    }
    ...
    e_r_which      = idData(1);
    index_e_r     = idData(13);
    lambda_c_which = idData(2);
    index_lambda_c = idData(14);
    xi_which       = idData(3);
    index_xi      = idData(15);
    Pat_which      = idData(4);
    index_Pat     = idData(16);
    m_which        = idData(5);
    index_m       = idData(17);
    M_cal_which    = idData(6);
    index_M_cal   = idData(18);
    cc_which       = idData(7);
    index_cc      = idData(19);
    A0_which       = idData(8);
    index_A0      = idData(20);
    ...
    alpha_which   = idData(10);
    index_alpha   = idData(22);
    z_which       = idData(11);
    index_z       = idData(23);
