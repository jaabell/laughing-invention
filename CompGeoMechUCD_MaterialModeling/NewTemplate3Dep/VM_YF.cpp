...
//-out        else
//-out        {
//-out          cerr << "Warning!! VM_YF: Invalid Input Parameter. " << endln;
//-out          exit (1);
//-out        }
//-out
//-out      }
...
double VM_YF::getk(const MaterialParameter& MaterialParameter_in) const
{
    ...
    {
        cerr << "Warning!! VM_YF: Invalid Input. " << endln;
        exit (1);
    }
}
...
int VM_YF::sendSelf(int commitTag, Channel& theChannel)
{
    ...
    {
        cerr << "VM_YF::sendSelf -- failed to send ID\n";
        return -1;
    }
...
//================================================================================
//Guanzhou added for parallel
int VM_YF::receiveSelf(int commitTag, Channel& theChannel, FEM_ObjectBroker& theBroker)
{
    int dataTag = this->getDbTag();
    ...
    {
        cerr << "VM_YF::receiveSelf -- failed to recv ID\n";
        return -1;
    }
