...
double CC_Ev::getM(const MaterialParameter& material_parameter) const
{
    ...
    {
        cerr << "CC_Ev: Invalid Input of " << lambda_index << endln;
        exit (1);
    }
}
...
double CC_Ev::getkappa(const MaterialParameter& material_parameter) const
{
    ...
    {
        cerr << "CC_Ev: Invalid Input of " << kappa_index << endln;
        exit (1);
    }
}
...
double CC_Ev::gete0(const MaterialParameter& material_parameter) const
{
    ...
    {
        cerr << "CC_Ev: Invalid Input of " << e0_index << endln;
        exit (1);
    }
}
...
double CC_Ev::getp0(const MaterialParameter& material_parameter) const
{
    ...
    {
        cerr << "CC_Ev: Invalid Input of " << p0_index << endln;
        exit (1);
    }
}
...
int CC_Ev::sendSelf(int commitTag, Channel& theChannel)
{
    ...
    {
        cerr << "CC_Ev::sendSelf -- failed to send ID\n";
        return -1;
    }
...
//Guanzhou added for parallel
int CC_Ev::receiveSelf(int commitTag, Channel& theChannel, FEM_ObjectBroker& theBroker)
{
    int dataTag = this->getDbTag();
    ...
    {
        cerr << "CC_Ev::receiveSelf -- failed to recv ID\n";
        return -1;
    }
