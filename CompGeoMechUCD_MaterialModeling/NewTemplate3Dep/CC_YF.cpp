                                 ...
                                 int which) const
{
    ...
    {
        cerr << "Warning!! CC_YF: Invalid Input Parameter. " << endln;
        exit (1);
    }
}
...
double CC_YF::getM(const MaterialParameter& MaterialParameter_in) const
{
    ...
    {
        cerr << "Warning!! CC_YF: Invalid Input (M). " << endln;
        exit (1);
    }
}
...
double CC_YF::getP0(const MaterialParameter& MaterialParameter_in) const
{
    ...
    {
        cerr << "Warning!! CC_YF: Invalid Input (po). " << endln;
        exit (1);
    }
}
...
int CC_YF::sendSelf(int commitTag, Channel& theChannel)
{
    ...
    {
        cerr << "CC_YF::sendSelf -- failed to send ID\n";
        return -1;
    }
...
//Guanzhou added for parallel
int CC_YF::receiveSelf(int commitTag, Channel& theChannel, FEM_ObjectBroker& theBroker)
{
    int dataTag = this->getDbTag();
    ...
    {
        cerr << "CC_YF::receiveSelf -- failed to recv ID\n";
        return -1;
    }
