                                     ...
                                     int Num_Internal_Tensor_in) : MovableObject(MP_TAG)
{
    ...
    if (Num_Material_Constant_in > 0)
    {
        ...
        {
            cerr << "MaterialConstant::Insufficient memory! " << endln;
            exit (1);
        }
    ...
    if (Num_Internal_Scalar_in > 0)
    {
        ...
        if (!Internal_Scalar)
        {
            cerr << "MaterialParameter::Insufficient memory! " << endln;
            exit (1);
        }
...
// Material_Constant(NULL), Num_Material_Constant(0),
...
double MaterialParameter::getMaterial_Constant(int which) const
{
    ...
    {
        cerr << "Error! MaterialParameter::getMaterial_Constant - Invalid index of material constants. " << endln;
        exit(1);
    }
...
double MaterialParameter::getInternal_Scalar(int which) const
{
    ...
    {
        cerr << "Error! MaterialParameter::getInternal_Scalar - Invalid index of internal scalars. " << endln;
        exit(1);
    }
...
const stresstensor& MaterialParameter::getInternal_Tensor(int which) const
{
    ...
    {
        cerr << "Error! MaterialParameter::getInternal_Tensor - Invalid index of internal tensors. " << endln;
        exit (1);
    }
...
int MaterialParameter::setMaterial_Constant(int which, double newMaterial_Constant)
{
    if (which < 0 || which > Num_Material_Constant)
    {
        cerr << "Error! MaterialParameter::setMaterial_Constant - Invalid index of material constants. " << endln;
        return (1);
    }
...
int MaterialParameter::setInternal_Scalar(int which, double newInternal_Scalar)
{
    if (which < 0 || which > Num_Internal_Scalar)
    {
        cerr << "Error! MaterialParameter::setInternal_Scalar - Invalid index of internal scalars. " << endln;
        exit (1);
    }
...
int MaterialParameter::setInternal_Tensor(int which, const stresstensor& newInternal_Tensor)
{
    if (which < 0 || which > Num_Internal_Tensor)
    {
        cerr << "Error! MaterialParameter::setInternal_Tensor - Invalid index of internal tensors. " << endln;
        exit (1);
    }
...
int MaterialParameter::sendSelf(int commitTag, Channel& theChannel)
{
    ...
    //       cerr << "Num_Internal_Scalar:" << Num_Internal_Scalar << "\n";
    //       cerr << "Num_Internal_Tensor:" << Num_Internal_Tensor << "\n";


    if (theChannel.sendID(dataTag, commitTag, idData) < 0)
    {
        cerr << "MaterialParameter::sendSelf -- failed to send ID\n";
        return -1;
    }
    ...
    if ( Num_Material_Constant > 0 )
    {
        ...
        {
            cerr << "MaterialParameter::sendSelf -- failed to send Vector Material_Constant\n";
            return -1;
        }
    }
    ...
    if ( Num_Internal_Scalar > 0 )
    {
        ...
        //       cerr << "Internal_Scalar(" << 0 << "): " <<Internal_Scalar[0] << "\n";

        if (theChannel.sendVector(dataTag, commitTag, data) < 0)
            //         if (theChannel.sendVector(dataTag, commitTag, Internal_Scalar) < 0)
        {
            cerr << "MaterialParameter::sendSelf -- failed to send Vector Internal_Scalar\n";
            return -1;
        }
    }
    ...
    if ( Num_Internal_Tensor > 0 )
    {
        for (int i = 0; i < Num_Internal_Tensor; i++)
        {
            ...
            {
                cerr << "MaterialParameter::sendSelf -- failed to send Internal_Tensors\n";
                return -1;
            }
        }
    }
...
int MaterialParameter::recvSelf(int commitTag, Channel& theChannel, FEM_ObjectBroker& theBroker)
{
    ...
    if ( Num_Internal_Scalar > 0 )
    {
        ...
        {
            cerr << "Internal_Scalar::Insufficient memory! " << endln;
            exit (1);
        }
    ...
    /*      cerr << "Num_Internal_Scalar: " << Num_Internal_Scalar << "\n";
       ...
       for (int i=0; i<Num_Internal_Scalar; i++)
        {
          cerr << "Internal_Scalar(" << i << "): " <<Internal_Scalar[i] << "\n";
        }  */
    ...
    if ( Num_Internal_Tensor > 0 )
    {
        ...
        {
            cerr << "Internal_Tensor::Insufficient memory! " << endln;
            exit (1);
        }
        ...
        //     for (int i=0; i<Num_Internal_Tensor; i++)
        //     {
        // //       cerr << "Internal_Tensor(" << i << "): " << Internal_Tensor[i].print() << "\n";
        //       Internal_Tensor[i].print("Internal_Tensor" , "Internal_Tensor");
        //       cerr << "\n";
        //     }
