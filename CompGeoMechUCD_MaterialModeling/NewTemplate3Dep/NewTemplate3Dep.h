...
class NewTemplate3Dep : public NDMaterial
{
    ...
    public:
        ...
        NewTemplate3Dep( int tag,
                         ...
                         int maximum_number_of_iterations, double tolerance_1, double tolerance_2);
    ...
    private:
        ...
        //! Explicit: function for explicit integration method

        int Explicit(const straintensor& strain_incr, int NumStep_in = 1);


        //! Implicit: function for implicit integration method

        int Implicit(const straintensor& strain_incr, int NumStep_in = 1);


        //! ImplicitLineSearch: function for implicit linesearch integration method

        int ImplicitLineSearch(const straintensor& strain_incr);


        //! ScaledExplicit: function for scaled explicit integration method
