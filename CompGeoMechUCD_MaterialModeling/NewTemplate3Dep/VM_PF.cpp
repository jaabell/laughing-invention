...
// out, Mahdi and Boris 27April2007    cerr << "Warning!! VM_PF: Invalid Input Parameter. " << endln;
...
// out, Mahdi and Boris 27April2007   }
// out, Mahdi and Boris 27April2007
// out, Mahdi and Boris 27April2007   cerr << "Warning!! VM_PF: Invalid Input. " << endln;
// out, Mahdi and Boris 27April2007   exit (1);
// out, Mahdi and Boris 27April2007  }
// out, Mahdi and Boris 27April2007
// out, Mahdi and Boris 27April2007
...
const stresstensor& VM_PF::getalpha(const MaterialParameter& MaterialParameter_in) const
{
    ...
    cerr << "Warning!! VM_PF: Invalid Input. " << endln;
    exit (1);
}
...
int VM_PF::sendSelf(int commitTag, Channel& theChannel)
{
    ...
    {
        cerr << "VM_PF::sendSelf -- failed to send ID\n";
        return -1;
    }
