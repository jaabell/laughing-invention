...
// vonMisesKH is another form of NewTemplate3Dep which has all
// the functions embeded here for efficiency.

#ifndef vonMisesKH_CPP
#define vonMisesKH_CPP

#include "vonMisesKH.h"


const  straintensor vonMisesKH::ZeroStrain;
const  stresstensor vonMisesKH::ZeroStress;

BJtensor vonMisesKH::Ee(4, def_dim_4, 0.0);

// Constructor
//================================================================================
vonMisesKH::vonMisesKH(int tag,
                       double E_in,
                       double v_in,
                       double k_in,
                       double ha_in,
                       ...
                       double tolerance_1,
                       double tolerance_2)
    : NDMaterial(tag, ND_TAG_vonMisesKH),
      E(E_in),
      v(v_in),
      k(k_in),
      ha(ha_in),
...
// Constructor
//================================================================================
vonMisesKH::vonMisesKH()
    : NDMaterial(0, ND_TAG_vonMisesKH)
{
    this->revertToStart();
}
...
//================================================================================
int vonMisesKH::setTrialStrain(const Tensor& v)
{
    return this->setTrialStrainIncr( v - getStrainTensor() );
}

//================================================================================
int vonMisesKH::setTrialStrainIncr(const Tensor& strain_increment)
{
    return this->Explicit(strain_increment);
}

//================================================================================
const BJtensor& vonMisesKH::getTangentTensor(void)
{
    return this->Stiffness;
}

//================================================================================
const stresstensor&  vonMisesKH::getStressTensor(void)
{
...
//================================================================================
const straintensor& vonMisesKH::getStrainTensor(void)
{
    return this->TrialStrain;
}

//================================================================================
const straintensor& vonMisesKH::getPlasticStrainTensor(void)
{
...
//================================================================================
int vonMisesKH::commitState(void)
{
...
//================================================================================
int vonMisesKH::revertToLastCommit(void)
{
...
//================================================================================
int vonMisesKH::revertToStart(void)
{
    int err = 0;
...
//================================================================================
NDMaterial* vonMisesKH::getCopy(void)
{
    NDMaterial* tmp = new vonMisesKH(this->getTag(),
                                     this->getE(),
                                     this->getv(),
                                     this->getk(),
                                     this->getha(),
...
//================================================================================
NDMaterial* vonMisesKH::getCopy(const char* code)
{
    if (strcmp(code, "ThreeDimensional") == 0)
    {
        vonMisesKH* tmp = new vonMisesKH( this->getTag(),
                                          this->getE(),
                                          this->getv(),
                                          this->getk(),
                                          this->getha(),
    ...
    {
        cout << "vonMisesKH::getCopy failed to get model: " <<  code << endln;
        exit(1);
    }
...
//================================================================================
const char* vonMisesKH::getType(void) const
{
    return "ThreeDimensional";
}

//================================================================================
int vonMisesKH::sendSelf(int commitTag, Channel& theChannel)
{
    return 0;
}
...
//================================================================================
void vonMisesKH::Print(ostream& s, int flag)
{
    s << (*this);
}

//================================================================================
double vonMisesKH::getE()
{
    return E;
}

//================================================================================
double vonMisesKH::getv()
{
    return v;
}

//================================================================================
double vonMisesKH::getk()
{
    return k;
}

//================================================================================
double vonMisesKH::getha()
{
    return ha;
}

//================================================================================
double vonMisesKH::getCr()
{
    return Cr;
}

//================================================================================
double vonMisesKH::getRho(void)
{
    return rho;
}

//================================================================================
stresstensor& vonMisesKH::getInternalTensor(void)
{
    return Internal_Tensor;
}

//================================================================================
double vonMisesKH::getInitialConfiningStress(void)
{
    return initialconfiningstress;
}

//================================================================================
double vonMisesKH::YieldFunctionValue( const stresstensor& Stre) const
{
...
//================================================================================
int vonMisesKH::Explicit(const straintensor& strain_incr)
{
    int err = 0;
    double f_start = 0.0;
    double f_pred  = 0.0;
    ...
    else
    {
        ...
        {
            fprintf(stderr, "ERROR stresstensor& vonMisesKH::StressDerivative(  s_norm <= 0 ");
            //       exit(1);
        }
...
//================================================================================
stresstensor vonMisesKH::yield_surface_cross(const stresstensor& start_stress,
...
//================================================================================
double vonMisesKH::zbrentstress(const stresstensor& start_stress,
