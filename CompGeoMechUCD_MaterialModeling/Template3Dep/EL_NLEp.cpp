...
EvolutionLaw_NL_Ep::EvolutionLaw_NL_Ep( double eod, double lambdad, double kappad )
    : EvolutionLaw_S(ELS_TAG_NL_Ep), eo(eod), lambda(lambdad), kappa(kappad)
{}
...
int
EvolutionLaw_NL_Ep::sendSelf(int commitTag, Channel& theChannel)
{
    int res = 0;
    ...
    if (res < 0)
    {
        cerr << "EvolutionLaw_NL_Ep::sendSelf() - failed to send data\n";
    }
...
int EvolutionLaw_NL_Ep::getObjectSize()
{
    int size = 0;
