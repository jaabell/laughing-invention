...
{
    //Guanzhou out Feb3-2005 //if ( msg ) ::printf("%s",msg);
    //Guanzhou out Feb3-2005 if ( msg )  cerr << msg;
    //Guanzhou out Feb3-2005
    //Guanzhou out Feb3-2005 ::printf("\n\n\n---------------------------------------------------- \n");
    //Guanzhou out Feb3-2005 ::printf("Gauss point #r %d #s %d  #t %d \n",
    //Guanzhou out Feb3-2005                              GP_number_r(), GP_number_s(), GP_number_t());
    //Guanzhou out Feb3-2005
    //Guanzhou out Feb3-2005 ::printf("\tr->%.8e   s->%.8e   t->%.8e  \n",
    //Guanzhou out Feb3-2005  r_coordinate(),s_coordinate(),t_coordinate());
    //Guanzhou out Feb3-2005
    //Guanzhou out Feb3-2005 ::printf("\tr_weight->%.8e   s_weight->%.8e   t_weight->%.8e  \n",
    //Guanzhou out Feb3-2005  r_weight(),s_weight(),t_weight());
    //Guanzhou out Feb3-2005
    //Guanzhou out Feb3-2005
    //Guanzhou out Feb3-2005 if ( matmodel )
    //Guanzhou out Feb3-2005   {
    //Guanzhou out Feb3-2005     cerr << (*matmodel);
    //Guanzhou out Feb3-2005
    //Guanzhou out Feb3-2005     stresstensor tmpstress = matmodel->getStressTensor();
    //Guanzhou out Feb3-2005     tmpstress.report("stress at this Gauss-Legendre point\n");
    //Guanzhou out Feb3-2005
    //Guanzhou out Feb3-2005     straintensor tmpstrain = matmodel->getStrainTensor();
    //Guanzhou out Feb3-2005     tmpstrain.report("strain at this Gauss-Legendre point\n");
    //Guanzhou out Feb3-2005   }
    //Guanzhou out Feb3-2005 else
    //Guanzhou out Feb3-2005   cerr << "Empty Material Model\n";
    ...
    //       {
    //         cerr << (*matmodel);
    //      cerr << "stress at this Gauss-Legendre point: \n" << matmodel->getStressTensor() << '\n';
    //      cerr << "strain at this Gauss-Legendre point: \n" << matmodel->getStrainTensor() << '\n';
    //       }
    else
    {
        fprintf(stderr, "Empty Material Model\n");
    }

    //      cerr << "Empty Material Model\n";
