                                ...
                                TCL_Char** argv, TclModelBuilder* theTclBuilder, int eleArgStart)
{
    ...
    {
        cerr << "nDMaterial Templated3Dep - invalid tag " << argv[loc] << endln;
        return 0;
    }

    if (Tcl_GetInt(interp, argv[loc++], &ElMattag) != TCL_OK)
    {
        cerr << "nDMaterial Templated3Dep - invalid elastic material tag " << argv[loc] << endln;
        return 0;
    }

    if (ElMattag == tag)
    {
        cerr << "nDMaterial Templated3Dep - error: the elastic matTag is the same with Templated3Dep matTag" << argv[loc] << endln;
        return 0;
    }
    ...
    if (theElMat == 0)
    {
        cerr << "WARNING nD elastic material does not exist\n";
        cerr << "nD material: " << ElMattag;
    ...
    while (loc < argc)
    {
        if ((strcmp(argv[loc], "-YS") == 0) || (strcmp(argv[loc], "-ys") == 0))
        {
            ...
            if (YS == 0)
            {
                cerr << "nDMaterial Templated3Dep - could not create a YS from" << argv[loc + 1] << endln;
                return 0;
            }
        }
        ...
        else if ((strcmp(argv[loc], "-PS") == 0) || (strcmp(argv[loc], "-ps") == 0))
        {
            ...
            if (PS == 0)
            {
                cerr << "nDMaterial Templated3Dep - could not create a PS from" << argv[loc + 1] << endln;
                return 0;
            }
        }
        ...
        else if ((strcmp(argv[loc], "-EPS") == 0) || (strcmp(argv[loc], "-eps") == 0))
        {
            ...
            if (EPS == 0)
            {
                cerr << "nDMaterial Templated3Dep - could not create an EPS from" << argv[loc + 1] << endln;
                return 0;
            }
        }
        ...
        else if ((strcmp(argv[loc], "-ELS1") == 0) || (strcmp(argv[loc], "-els1") == 0))
        {
            ...
            if (ELS1 == 0)
            {
                cerr << "nDMaterial Templated3Dep - could not create an ELS1 from" << argv[loc + 1] << endln;
                return 0;
            }
        }
        ...
        else if ((strcmp(argv[loc], "-ELS2") == 0) || (strcmp(argv[loc], "-els2") == 0))
        {
            ...
            if (ELS2 == 0)
            {
                cerr << "nDMaterial Templated3Dep - could not create an ELS2 from" << argv[loc + 1] << endln;
                return 0;
            }
        }
        ...
        else if ((strcmp(argv[loc], "-ELS3") == 0) || (strcmp(argv[loc], "-els3") == 0))
        {
            ...
            if (ELS3 == 0)
            {
                cerr << "nDMaterial Templated3Dep - could not create an ELS3 from" << argv[loc + 1] << endln;
                return 0;
            }
        }
        ...
        else if ((strcmp(argv[loc], "-ELS4") == 0) || (strcmp(argv[loc], "-els4") == 0))
        {
            ...
            if (ELS4 == 0)
            {
                cerr << "nDMaterial Templated3Dep - could not create an ELS4 from" << argv[loc + 1] << endln;
                return 0;
            }
        }
        ...
        else if ((strcmp(argv[loc], "-ELT1") == 0) || (strcmp(argv[loc], "-elt1") == 0))
        {
            ...
            if (ELT1 == 0)
            {
                cerr << "nDMaterial Templated3Dep - could not create an ELT1 from" << argv[loc + 1] << endln;
                return 0;
            }
        }
        ...
        else if ((strcmp(argv[loc], "-ELT2") == 0) || (strcmp(argv[loc], "-elt2") == 0))
        {
            ...
            if (ELT2 == 0)
            {
                cerr << "nDMaterial Templated3Dep - could not create an ELT2 from" << argv[loc + 1] << endln;
                return 0;
            }
        }
        ...
        else if ((strcmp(argv[loc], "-ELT3") == 0) || (strcmp(argv[loc], "-elt3") == 0))
        {
            ...
            if (ELT3 == 0)
            {
                cerr << "nDMaterial Templated3Dep - could not create an ELT3 from" << argv[loc + 1] << endln;
                return 0;
            }
        }
        ...
        else if ((strcmp(argv[loc], "-ELT4") == 0) || (strcmp(argv[loc], "-elt4") == 0))
        {
            ...
            if (ELT4 == 0)
            {
                cerr << "nDMaterial Templated3Dep - could not create an ELT4 from" << argv[loc + 1] << endln;
                return 0;
            }
        }
        ...
        {
            cerr << "nDMaterial Templated3Dep - don't understand %s\n";
            return 0;
        }
    ...
    {
        cerr << "invalid number of args used to create a Template3Dep material\n";
    }
...
YieldSurface* EvaluateYieldSurfaceArgs(ClientData clientData, Tcl_Interp* interp, TCL_Char* tclString)
{
    ...
    else if ((strcmp(argv[0], "-CC") == 0) || (strcmp(argv[0], "-cc") == 0))
    {
        ...
        if (argc > 1)
        {
            ...
            {
                cerr << "invalid M: argv[1] for -PS CamClay M\n";
                return 0;
            }
        }
    ...
    {
        cerr << "invalid yield function: " << argv[0] << endln;
        return 0;
    }
...
PotentialSurface* EvaluatePotentialSurfaceArgs(ClientData clientData, Tcl_Interp* interp, TCL_Char* tclString)
{
    ...
    if ((strcmp(argv[0], "-DP") == 0) || (strcmp(argv[0], "-dp") == 0))
    {
        ...
        if (argc == 2)
        {
            ...
            {
                cerr << "nDMaterial Templated3Dep PS.Drucker-Prager - invalid or missing alpha " << argv[1] << endln;
                cleanup(argv);
                return 0;
            }
        }
        ...
        {
            cerr << "nDMaterial Templated3Dep PS.Drucker-Prager - missing alpha " << endln;
            cleanup(argv);
            return 0;
        }
    ...
    else if ((strcmp(argv[0], "-CC") == 0) || (strcmp(argv[0], "-cc") == 0))
    {
        ...
        if (Tcl_GetDouble(interp, argv[1], &mp) != TCL_OK)
        {
            cerr << "nDMaterial Templated3Dep PS.CamClay - invalid or missing M " << argv[1] << endln;
            return 0;
        }
    ...
    {
        cerr << "invalid potential function: " << argv[0] << endln;
        return 0;
    }
...
//ZCMay04   if (values == 0) {
//ZCMay04     cerr << "nDMaterial Template3DEp -ESP stresstenor - out of memory for size: " << argc << endln;
...
//ZCMay04       cerr << "nDMaterial Templated3Dep -ESP stresstensor - invalid value: " << argv[i] << endln;
//ZCMay04       cleanup(argv);
...
//ZCMay04   if (values == 0) {
//ZCMay04     cerr << "nDMaterial Template3DEp -ESP straintensor - out of memory for size: " << argc << endln;
//ZCMay04     cleanup(argv);
//ZCMay04     return -1;
//ZCMay04   }
//ZCMay04
...
//ZCMay04     if (Tcl_GetDouble(interp, argv[i], &values[i]) != TCL_OK) {
//ZCMay04       cerr << "nDMaterial Templated3Dep -ESP straintensor - invalid value: " << argv[i] << endln;
//ZCMay04       cleanup(argv);
//ZCMay04       //delete [] values;
//ZCMay04       return -1;
//ZCMay04     }
...
EPState* EvaluateEPStateArgs(ClientData clientData, Tcl_Interp* interp, TCL_Char* tclString)
{
    ...
    //ZCMay04    cerr << "nDMaterial Templated3Dep -EPS - invalid Eod " << argv[1] << endln;
    //ZCMay04    cleanup(argv);
    //ZCMay04    return 0;
    //ZCMay04  }
    //ZCMay04  if (Tcl_GetDouble(interp, argv[1], &Ed) != TCL_OK) {
    //ZCMay04    cerr << "nDMaterial Templated3Dep -EPS - invalid Ed " << argv[1] << endln;
    //ZCMay04    cleanup(argv);
    //ZCMay04    return 0;
    //ZCMay04  }
    //ZCMay04  if (Tcl_GetDouble(interp, argv[2], &nu) != TCL_OK) {
    //ZCMay04    cerr << "nDMaterial Templated3Dep -EPS - invalid nu " << argv[1] << endln;
    //ZCMay04    cleanup(argv);
    //ZCMay04    return 0;
    //ZCMay04  }
    //ZCMay04  if (Tcl_GetDouble(interp, argv[3], &rho) != TCL_OK) {
    //ZCMay04    cerr << "nDMaterial Templated3Dep -EPS - invalid rho " << argv[1] << endln;
    //ZCMay04  }
    //ZCMay04
    //ZCMay04  int loc = 4;
    int loc = 0;
    ...
    while (loc < argc)
    {
        ...
        if ((strcmp(argv[loc], "-stressP") == 0) || (strcmp(argv[loc], "-stressp") == 0))
        {
            ...
            for (int i = 0; i < 9; i++)
            {
                ...
                {
                    cerr << "nDMaterial Templated3Dep -EPS - invalid stress tensor: need nine components " << argv[loc_i] << endln;
                    return 0;
                }
            ...
            stressp.val(1, 1) = values_stp[0];
            stressp.val(1, 2) = values_stp[1];
            stressp.val(1, 3) = values_stp[2];
            stressp.val(2, 1) = values_stp[3];
            stressp.val(2, 2) = values_stp[4];
            stressp.val(2, 3) = values_stp[5];
            stressp.val(3, 1) = values_stp[6];
            stressp.val(3, 2) = values_stp[7];
            stressp.val(3, 3) = values_stp[8];
            loc++;
        }
        ...
        else if ((strcmp(argv[loc], "-strainP") == 0) || (strcmp(argv[loc], "-strainp") == 0))
        {
            ...
            for (int i = 0; i < 9; i++)
            {
                if (Tcl_GetDouble(interp, argv[loc + 1], &values_stp[i]) != TCL_OK)
                {
                    cerr << "nDMaterial Templated3Dep -EPS - invalid strain tensor: need nine components " << argv[loc_i] << endln;
                    return 0;
                }
            ...
            strainp.val(1, 1) = values_stp[0];
            strainp.val(1, 2) = values_stp[1];
            strainp.val(1, 3) = values_stp[2];
            strainp.val(2, 1) = values_stp[3];
            strainp.val(2, 2) = values_stp[4];
            strainp.val(2, 3) = values_stp[5];
            strainp.val(3, 1) = values_stp[6];
            strainp.val(3, 2) = values_stp[7];
            strainp.val(3, 3) = values_stp[8];
            loc++;
        }
        ...
        else if ((strcmp(argv[loc], "-EstrainP") == 0) || (strcmp(argv[loc], "-Estrainp") == 0))
        {
            ...
            for (int i = 0; i < 9; i++)
            {
                if (Tcl_GetDouble(interp, argv[loc + 1], &values_stp[i]) != TCL_OK)
                {
                    cerr << "nDMaterial Templated3Dep -EPS - invalid Estrain tensor: need nine components " << argv[loc_i] << endln;
                    return 0;
                }
            ...
            Estrainp.val(1, 1) = values_stp[0];
            Estrainp.val(1, 2) = values_stp[1];
            Estrainp.val(1, 3) = values_stp[2];
            Estrainp.val(2, 1) = values_stp[3];
            Estrainp.val(2, 2) = values_stp[4];
            Estrainp.val(2, 3) = values_stp[5];
            Estrainp.val(3, 1) = values_stp[6];
            Estrainp.val(3, 2) = values_stp[7];
            Estrainp.val(3, 3) = values_stp[8];
            loc++;
        }
        ...
        else if ((strcmp(argv[loc], "-PstrainP") == 0) || (strcmp(argv[loc], "-Pstrainp") == 0))
        {
            ...
            for (int i = 0; i < 9; i++)
            {
                if (Tcl_GetDouble(interp, argv[loc + 1], &values_stp[i]) != TCL_OK)
                {
                    cerr << "nDMaterial Templated3Dep -EPS - invalid Pstrain tensor: need nine components " << argv[loc_i] << endln;
                    return 0;
                }
            ...
            Pstrainp.val(1, 1) = values_stp[0];
            Pstrainp.val(1, 2) = values_stp[1];
            Pstrainp.val(1, 3) = values_stp[2];
            Pstrainp.val(2, 1) = values_stp[3];
            Pstrainp.val(2, 2) = values_stp[4];
            Pstrainp.val(2, 3) = values_stp[5];
            Pstrainp.val(3, 1) = values_stp[6];
            Pstrainp.val(3, 2) = values_stp[7];
            Pstrainp.val(3, 3) = values_stp[8];
            loc++;
        }
        ...
        //ZCMay04     cerr << "nDMaterial Templated3Dep -EPS - invalid strainp " << argv[loc+1] << endln;
        //ZCMay04     cleanup(argv);
        //ZCMay04     return 0;
        //ZCMay04       }
        //ZCMay04     }
        ...
        //ZCMay04     cerr << "nDMaterial Templated3Dep -EPS - invalid Estrainp " << argv[loc+1] << endln;
        //ZCMay04     cleanup(argv);
        //ZCMay04     return 0;
        //ZCMay04       loc+=2;
        //ZCMay04     }
        ...
        //ZCMay04     cerr << "nDMaterial Templated3Dep -EPS - invalid Pstrainp " << argv[loc+1] << endln;
        //ZCMay04     cleanup(argv);
        //ZCMay04     return 0;
        //ZCMay04       }
        //ZCMay04       loc+=2;
        ...
        else if ((strcmp(argv[loc], "-NOS") == 0) || (strcmp(argv[loc], "-nos") == 0))
        {
            ...
            {
                cerr << "nDMaterial Templated3Dep -EPS - invalid NOS " << argv[loc + 1] << endln;
                return 0;
            }
            ...
            if (NoS > 0)
            {
                ...
                for (int i = 0; i < NoS; i++)
                {
                    ...
                    {
                        cerr << "nDMaterial Templated3Dep -EPS - invalid scalar: " << argv[loc - 1] << endln;
                        return 0;
                    }
                }
            }
        ...
        else if ((strcmp(argv[loc], "-NOD") == 0) || (strcmp(argv[loc], "-nod") == 0))
        {
            ...
            {
                cerr << "nDMaterial Templated3Dep -EPS - invalid NOD: " << argv[loc + 1] << endln;
                return 0;
            }
        ...
        //ZCMay04       cerr << "nDMaterial Templated3Dep -EPS - invalid e " << argv[loc+1] << endln;
        //ZCMay04       cleanup(argv);
        //ZCMay04       return 0;
        //ZCMay04       }
        //ZCMay04       loc+=2;
        ...
        //ZCMay04       cerr << "nDMaterial Templated3Dep -EPS - invalid Ev " << argv[loc+1] << endln;
        //ZCMay04       cleanup(argv);
        //ZCMay04       return 0;
        //ZCMay04       }
        //ZCMay04       loc+=2;
        ...
        //ZCMay04       cerr << "nDMaterial Templated3Dep -EPS - invalid nuhv " << argv[loc+1] << endln;
        //ZCMay04       cleanup(argv);
        //ZCMay04       return 0;
        //ZCMay04       }
        //ZCMay04       loc+=2;
        ...
        //ZCMay04       cerr << "nDMaterial Templated3Dep -EPS - invalid Ghv " << argv[loc+1] << endln;
        //ZCMay04       cleanup(argv);
        //ZCMay04       return 0;
        //ZCMay04       }
        //ZCMay04       loc+=2;
        ...
        //ZCMay04       cerr << "nDMaterial Templated3Dep -EPS - invalid ec " << argv[loc+1] << endln;
        //ZCMay04       cleanup(argv);
        //ZCMay04       return 0;
        //ZCMay04       }
        //ZCMay04       loc+=2;
        ...
        //ZCMay04       cerr << "nDMaterial Templated3Dep -EPS - invalid lambda " << argv[loc+1] << endln;
        //ZCMay04       cleanup(argv);
        //ZCMay04       return 0;
        //ZCMay04       }
        //ZCMay04       loc+=2;
        ...
        //ZCMay04       cerr << "nDMaterial Templated3Dep -EPS - invalid p_ref " << argv[loc+1] << endln;
        //ZCMay04       cleanup(argv);
        //ZCMay04       return 0;
        //ZCMay04       }
        //ZCMay04       loc+=2;
        ...
        //ZCMay04       cerr << "nDMaterial Templated3Dep -EPS - invalid a " << argv[loc+1] << endln;
        //ZCMay04       cleanup(argv);
        //ZCMay04       return 0;
        //ZCMay04       }
        //ZCMay04       loc+=2;
        ...
        else if  (strcmp(argv[loc], "-e") == 0)
        {
            ...
            {
                cerr << "nDMaterial Templated3Dep -EPS - invalid e " << argv[loc + 1] << endln;
                cleanup(argv);
                return 0;
            }
        ...
        else if  (strcmp(argv[loc], "-psi") == 0)
        {
            ...
            {
                cerr << "nDMaterial Templated3Dep -EPS - invalid psip " << argv[loc + 1] << endln;
                cleanup(argv);
                return 0;
            }
        ...
        {
            if ( strcmp(argv[loc + 1], "BackwardEuler") == 0 )
            {
                integratorFlag = 1;
            }
            else if ( strcmp(argv[loc + 1], "ForwardEuler") == 0 )
            {
                integratorFlag = 0;
            }
            else
            {
                cerr << "nDMaterial Templated3Dep -EPS - invalid integrator " << argv[loc + 1] << endln;
                cleanup(argv);
                return 0;
            }
    ...
    if (EPS == 0)
    {
        cerr << "nDMaterial Templated3Dep -EPS - out of memory\n";
    }
...
EvolutionLaw_S* EvaluateEvolutionLawSArgs(ClientData clientData, Tcl_Interp* interp, TCL_Char* tclString)
{
    ...
    if ((strcmp(argv[0], "-Leq") == 0) || (strcmp(argv[0], "-leq") == 0))
    {
        ...
        if (argc > 1)
            if (Tcl_GetDouble(interp, argv[1], &alpha) != TCL_OK)
            {
                cerr << "nDMaterial Templated3Dep - invalid alpha " << argv[1] << endln;
                cleanup(argv);
                return 0;
            }
    ...
    if ((strcmp(argv[0], "-NLp") == 0) || (strcmp(argv[0], "-nlp") == 0))
    {
        ...
        if (argc == 3 )
        {
            ...
            {
                cerr << "nDMaterial Templated3Dep - invalid eo " << argv[1] << endln;
            ...
            {
                cerr << "nDMaterial Templated3Dep - invalid lambda " << argv[2] << endln;
            ...
            {
                cerr << "nDMaterial Templated3Dep - invalid kappa " << argv[3] << endln;
...
EvolutionLaw_T* EvaluateEvolutionLawTArgs(ClientData clientData, Tcl_Interp* interp, TCL_Char* tclString)
{
    ...
    else if ((strcmp(argv[0], "-NLEij") == 0) || (strcmp(argv[0], "-AF") == 0))
    {
        ...
        {
            cerr << "nDMaterial Templated3Dep - invalid ha " << argv[1] << endln;
            cleanup(argv);
            return 0;
        }
        ...
        {
            cerr << "nDMaterial Templated3Dep - invalid Cr " << argv[2] << endln;
            cleanup(argv);
            return 0;
        }
    ...
    else if ((strcmp(argv[0], "-NLEijMD") == 0) || (strcmp(argv[0], "-MD") == 0 ))
    {
        ...
        while (loc < argc)
        {
            ...
            if  (strcmp(argv[loc], "-eo") == 0)
            {
                ...
                {
                    cerr << "nDMaterial Templated3Dep -EPS - invalid eo " << argv[loc + 1] << endln;
                    cleanup(argv);
                    return 0;
                }
            ...
            else if  (strcmp(argv[loc], "-a") == 0)
            {
                ...
                {
                    cerr << "nDMaterial Templated3Dep -EPS - invalid a " << argv[loc + 1] << endln;
                    cleanup(argv);
                    return 0;
                }
            ...
            else if  (strcmp(argv[loc], "-Mc") == 0)
            {
                ...
                {
                    cerr << "nDMaterial Templated3Dep -EPS - invalid Mc " << argv[loc + 1] << endln;
                    cleanup(argv);
                    return 0;
                }
            ...
            else if  (strcmp(argv[loc], "-Me") == 0)
            {
                ...
                {
                    cerr << "nDMaterial Templated3Dep -EPS - invalid ec " << argv[loc + 1] << endln;
                    cleanup(argv);
                    return 0;
                }
            ...
            else if  (strcmp(argv[loc], "-Lambda") == 0)
            {
                ...
                {
                    cerr << "nDMaterial Templated3Dep -EPS - invalid lambdad " << argv[loc + 1] << endln;
                    cleanup(argv);
                    return 0;
                }
            ...
            else if  (strcmp(argv[loc], "-ec_ref") == 0)
            {
                ...
                {
                    cerr << "nDMaterial Templated3Dep -EPS - invalid ec_ref " << argv[loc + 1] << endln;
                    cleanup(argv);
                    return 0;
                }
            ...
            else if  (strcmp(argv[loc], "-p_ref") == 0)
            {
                ...
                {
                    cerr << "nDMaterial Templated3Dep -EPS - invalid p_ref " << argv[loc + 1] << endln;
                    cleanup(argv);
                    return 0;
                }
            ...
            else if  (strcmp(argv[loc], "-kc_b") == 0)
            {
                ...
                {
                    cerr << "nDMaterial Templated3Dep -EPS - invalid kc_b " << argv[loc + 1] << endln;
                    cleanup(argv);
                    return 0;
                }
            ...
            else if  (strcmp(argv[loc], "-kc_d") == 0)
            {
                ...
                {
                    cerr << "nDMaterial Templated3Dep -EPS - invalid kc_d " << argv[loc + 1] << endln;
                    cleanup(argv);
                    return 0;
                }
            ...
            else if  (strcmp(argv[loc], "-ke_b") == 0)
            {
                ...
                {
                    cerr << "nDMaterial Templated3Dep -EPS - invalid ke_b " << argv[loc + 1] << endln;
                    cleanup(argv);
                    return 0;
                }
            ...
            else if  (strcmp(argv[loc], "-ke_d") == 0)
            {
                ...
                {
                    cerr << "nDMaterial Templated3Dep -EPS - invalid ke_d " << argv[loc + 1] << endln;
                    cleanup(argv);
                    return 0;
                }
