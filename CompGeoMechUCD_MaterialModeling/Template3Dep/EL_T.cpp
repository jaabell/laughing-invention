...
int EvolutionLaw_T::sendSelf(int commitTag, Channel& theChannel)
{
    //sub-Class responsibility
    return 0;
}

int EvolutionLaw_T::receiveSelf(int commitTag, Channel& theChannel, FEM_ObjectBroker& theBroker)
{
    //sub-Class responsibility
    return 0;
}
