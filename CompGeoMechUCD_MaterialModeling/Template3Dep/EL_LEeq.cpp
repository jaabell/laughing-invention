...
EvolutionLaw_L_Eeq::EvolutionLaw_L_Eeq( double ad )
    : EvolutionLaw_S(ELS_TAG_L_Eeq), a(ad)
{}
...
int
EvolutionLaw_L_Eeq::sendSelf(int commitTag, Channel& theChannel)
{
    int res = 0;
    ...
    if (res < 0)
    {
        cerr << "EvolutionLaw_L_Eeq::sendSelf() - failed to send data\n";
    }
...
//Guanzhou added for PDD
int
EvolutionLaw_L_Eeq::receiveSelf(int commitTag, Channel& theChannel, FEM_ObjectBroker& theBroker)
{
    int res = 0;
    static Vector data(1);
    ...
    if (res < 0)
    {
        cerr << "EvolutionLaw_L_Eeq::receiveSelf() - failed to recv data\n";
    }
    else
    {
        a = data(0);
...
//Guanzhou added
int
EvolutionLaw_L_Eeq::getObjectSize()
{
    int size = 0;
    size += sizeof(double);
    return size;
