...
class EvolutionLaw_S : public MovableObject //Guanzhou
{
    public:

        EvolutionLaw_S(int clsTag) : MovableObject(clsTag) {}; //Guanzhou            //Normal Constructor
        ...
        int getObjectSize();//subclasses override!!!!
