...
public:
    ...
    sanisand2004_alpha_EV(double G0_, double h0_, double ch_, double patm_, const double& e_, const DTensor2& alpha_in);
    sanisand2004_alpha_EV(double G0_, double h0_, double ch_, double patm_, const double& e_, const DTensor2& alpha_in,  DTensor2& alpha0);
