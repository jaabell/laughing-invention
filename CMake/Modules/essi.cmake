...
MACRO(IMPORT_NATIVE_LIB lib_dir lib_name alt_dir)
    ...
    if(${lib_name}_FOUND)
        message(STATUS ${${lib_name}_LIBRARY_DIRS})
        add_library(${${lib_name}}_LIBRARY_DIRS SHARED IMPORTED)
        set_property(TARGET ${lib_name} PROPERTY IMPORTED_LOCATION ${${lib_name}}_LIBRARY_DIRS)
    else()
