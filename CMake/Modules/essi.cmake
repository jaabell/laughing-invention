...
MACRO(IMPORT_NATIVE_LIB lib_dir lib_name alt_dir)
    ...
    message(STATUS ${HDF5_INCLUDE_DIRS}) # - Location of the hdf5 includes
    message(STATUS ${HDF5_INCLUDE_DIR}) # - Location of the hdf5 includes (deprecated)
    message(STATUS ${HDF5_DEFINITIONS}) # - Required compiler definitions for HDF5
    message(STATUS ${HDF5_C_LIBRARIES}) # - Required libraries for the HDF5 C bindings.
    message(STATUS ${HDF5_CXX_LIBRARIES}) # - Required libraries for the HDF5 C++ bindings
    message(STATUS ${HDF5_Fortran_LIBRARIES}) # - Required libraries for the HDF5 Fortran bindings
    message(STATUS ${HDF5_HL_LIBRARIES}) # - Required libraries for the HDF5 high level API
    message(STATUS ${HDF5_Fortran_HL_LIBRARIES}) # - Required libraries for the high level Fortran                            bindings.
    message(STATUS ${HDF5_LIBRARIES}) # - Required libraries for all requested bindings
    message(STATUS ${HDF5_FOUND}) # - true if HDF5 was found on the system
    if(${lib_name}_FOUND)
        message(STATUS ${${lib_name}_LIBRARIES})
        add_library(${${lib_name}}_LIBRARIES SHARED IMPORTED)
        set_property(TARGET ${lib_name} PROPERTY IMPORTED_LOCATION ${${lib_name}}_LIBRARIES)
    else()
