                               ...
                               TCL_Char** argv, TclModelBuilder* theTclBuilder)
{
    ...
    if (strcmp(argv[1], "Elastic") == 0)
    {
        if (argc < 5)
        {
            ...
            //cerr << "Want: section Elastic tag? EA? EIz? <EIy? GJ?>" << endln;
            cerr << "Want: section Elastic tag? E? A? Iz? <Iy? G? J?>" << endln;
            return TCL_ERROR;
        }
        ...
        {
            cerr << "WARNING invalid section Elastic tag" << endln;
            return TCL_ERROR;
        }
        ...
        if (Tcl_GetDouble (interp, argv[3], &E) != TCL_OK)
        {
            ...
            cerr << "Elastic section: " << tag << endln;
            return TCL_ERROR;
        }
        ...
        if (argc > 8)
        {
            ...
            {
                cerr << "WARNING invalid EIy" << endln;
                cerr << "Elastic section: " << tag << endln;
                return TCL_ERROR;
            }
             ...
             strcmp(argv[1], "Uniaxial") == 0)
    {
        if (argc < 5)
        {
            cerr << "WARNING insufficient arguments\n";
            printCommand(argc, argv);
            cerr << "Want: section Uniaxial tag? 1DTag? code?" << endln;
            return TCL_ERROR;
        }
        ...
        if (Tcl_GetInt(interp, argv[2], &tag) != TCL_OK)
        {
            cerr << "WARNING invalid section Uniaxial tag" << endln;
            return TCL_ERROR;
        }

        if (Tcl_GetInt(interp, argv[3], &uniTag) != TCL_OK)
        {
            cerr << "WARNING invalid 1DTag" << endln;
            cerr << "Uniaxial section: " << tag << endln;
            return TCL_ERROR;
        }
        ...
        {
            cerr << "WARNING invalid code" << endln;
            cerr << "Uniaxial section: " << tag << endln;
            return TCL_ERROR;
        }
    ...
    {
        cerr << "section GenericND is no longer available" << endln;
        return TCL_ERROR;
        ...
        if (argc < 5) {
            cerr << "WARNING insufficient arguments\n";
            printCommand(argc,argv);
            cerr << "Want: section GenericNd tag? NDTag? code?" << endln;
            return TCL_ERROR;
        }
        ...
        if (Tcl_GetInt(interp, argv[2], &tag) != TCL_OK) {
            cerr << "WARNING invalid section GenericNd tag" << endln;
            return TCL_ERROR;
        }

        if (Tcl_GetInt(interp, argv[3], &NDTag) != TCL_OK) {
            cerr << "WARNING invalid NDTag" << endln;
            cerr << "GenericNd section: " << tag << endln;
            return TCL_ERROR;
        }
        ...
        for (i = 4, j = 0; i < argc; i++, j++) {
           ...
           cerr << "WARNING invalid GenericND code" << endln;
    ...
    else if (strcmp(argv[1], "AddDeformation") == 0 || strcmp(argv[1], "Aggregator") == 0)
    {
        if (argc < 5)
        {
            cerr << "WARNING insufficient arguments\n";
            printCommand(argc, argv);
            cerr << "Want: section Aggregator tag? uniTag1? code1? ... <-section secTag?>" << endln;
            return TCL_ERROR;
        }
        ...
        if (Tcl_GetInt(interp, argv[2], &tag) != TCL_OK)
        {
            cerr << "WARNING invalid Aggregator tag" << endln;
            return TCL_ERROR;
        }
        ...
        if (nArgs % 2 != 0)
        {
            cerr << "WARNING improper number of arguments for Aggregator" << endln;
            return TCL_ERROR;
        }
        ...
        if (theMats == 0)
        {
            cerr << "TclModelBuilderSection (Aggregator) -- unable to create uniaxial array" << endln;
            return TCL_ERROR;
        }
        ...
        for (i = 3, j = 0; j < nMats; i++, j++)
        {
            ...
            {
                cerr << "WARNING invalid Aggregator matTag" << endln;
                return TCL_ERROR;
            }
    ...
    else if (strcmp(argv[1], "ElasticPlateSection") == 0)
    {
        if (argc < 5)
        {
            cerr << "WARNING insufficient arguments\n";
            printCommand(argc, argv);
            cerr << "Want: section ElasticPlateSection tag? E? nu? h? " << endln;
            return TCL_ERROR;
        }
        ...
        if (Tcl_GetInt(interp, argv[2], &tag) != TCL_OK)
        {
            cerr << "WARNING invalid section ElasticPlateSection tag" << endln;
            return TCL_ERROR;
        }
        ...
        {
            cerr << "WARNING invalid E" << endln;
            cerr << "ElasticPlateSection section: " << tag << endln;
            return TCL_ERROR;
        }

        if (Tcl_GetDouble (interp, argv[4], &nu) != TCL_OK)
        {
            cerr << "WARNING invalid nu" << endln;
            cerr << "ElasticPlateSection section: " << tag << endln;
            return TCL_ERROR;
        }
    ...
    else if (strcmp(argv[1], "ElasticMembranePlateSection") == 0)
    {
        if (argc < 5)
        {
            cerr << "WARNING insufficient arguments\n";
            printCommand(argc, argv);
            cerr << "Want: section ElasticMembranePlateSection tag? E? nu? h? <rho?>" << endln;
            return TCL_ERROR;
        }
        ...
        if (Tcl_GetInt(interp, argv[2], &tag) != TCL_OK)
        {
            cerr << "WARNING invalid section ElasticMembranePlateSection tag" << endln;
            return TCL_ERROR;
        }
        ...
        {
            cerr << "WARNING invalid E" << endln;
            cerr << "ElasticMembranePlateSection section: " << tag << endln;
            return TCL_ERROR;
        }
        ...
        {
            cerr << "WARNING invalid rho" << endln;
            cerr << "ElasticMembranePlateSection section: " << tag << endln;
            return TCL_ERROR;
        }
    ...
    else if (strcmp(argv[1], "PlateFiber") == 0)
    {
        if (argc < 5)
        {
            cerr << "WARNING insufficient arguments\n";
            printCommand(argc, argv);
            cerr << "Want: section PlateFiber tag? matTag? h? " << endln;
            return TCL_ERROR;
        }
        ...
        if (Tcl_GetInt(interp, argv[2], &tag) != TCL_OK)
        {
            cerr << "WARNING invalid section PlateFiber tag" << endln;
            return TCL_ERROR;
        }

        if (Tcl_GetInt (interp, argv[3], &matTag) != TCL_OK)
        {
            cerr << "WARNING invalid matTag" << endln;
            cerr << "PlateFiber section: " << matTag << endln;
            return TCL_ERROR;
        }
        ...
        {
            cerr << "WARNING invalid h" << endln;
            cerr << "PlateFiber section: " << tag << endln;
            return TCL_ERROR;
        }
    ...
    else if (strcmp(argv[1], "Bidirectional") == 0)
    {
        if (argc < 7)
        {
            cerr << "WARNING insufficient arguments\n";
            printCommand(argc, argv);
            cerr << "Want: section Bidirectional tag? E? sigY? Hiso? Hkin?" << endln;
            return TCL_ERROR;
        }
        ...
        if (Tcl_GetInt(interp, argv[2], &tag) != TCL_OK)
        {
            cerr << "WARNING invalid Bidirectional tag" << endln;
            return TCL_ERROR;
        }
        ...
        if (Tcl_GetDouble(interp, argv[3], &E) != TCL_OK)
        {
            ...
            cerr << "section Bidirectional: " << tag << endln;
            return TCL_ERROR;
        }
    ...
    else if (strcmp(argv[1], "Iso2spring") == 0)
    {
        if (argc < 10)
        {
            cerr << "WARNING insufficient arguments\n";
            printCommand(argc, argv);
            cerr << "Want: section Iso2spring tag? tol? k1? Fy? k2? kv? hb? Pe? <Po?>" << endln;
            return TCL_ERROR;
        }
        ...
        if (Tcl_GetInt(interp, argv[2], &tag) != TCL_OK)
        {
            cerr << "WARNING invalid Iso2spring tag" << endln;
            return TCL_ERROR;
        }
        ...
        if (Tcl_GetDouble(interp, argv[3], &tol) != TCL_OK)
        {
            ...
            cerr << "section Iso2spring: " << tag << endln;
            return TCL_ERROR;
        }

        if (Tcl_GetDouble(interp, argv[4], &k1) != TCL_OK)
        {
            cerr << "WARNING invalid k1\n";
            cerr << "section Iso2spring: " << tag << endln;
            return TCL_ERROR;
        }
    ...
    if (theSection == 0)
    {
        cerr << "WARNING could not create section " << argv[1] << endln;
        return TCL_ERROR;
    }
                                 ...
                                 TCL_Char** argv, TclModelBuilder* theTclModelBuilder)
{
    ...
    {
        cerr <<  "WARNING - ran out of memory to create section representation\n";
        return TCL_ERROR;
    }

    if (theTclModelBuilder->addSectionRepres(*fiberSectionRepr) < 0)
    {
        cerr <<  "WARNING - cannot add section representation\n";
        return TCL_ERROR;
    }
                         ...
                         TCL_Char** argv, TclModelBuilder* theTclModelBuilder)
{
    ...
    {
        cerr <<  "WARNING subcommand 'patch' is only valid inside a 'section' command\n";
        return TCL_ERROR;
    }
    ...
    if (argc < 2)
    {
        cerr <<  "WARNING need to specify a patch type \n";
        return TCL_ERROR;
    }
    ...
    if (strcmp(argv[1], "quad") == 0 || strcmp(argv[1], "quadr") == 0)
    {
        ...
        if (argc < 13)
        {
            cerr <<  "WARNING invalid number of parameters: patch quad matTag numSubdivIJ numSubdivJK yVertI zVertI yVertJ zVertJ yVertK zVertK yVertL zVertL\n";
            return TCL_ERROR;
        }
        ...
        {
            cerr <<  "WARNING invalid matTag: patch quad matTag numSubdivIJ numSubdivJK yVertI zVertI yVertJ zVertJ yVertK zVertK yVertL zVertL\n";
            return TCL_ERROR;
        }
        ...
        {
            cerr <<  "WARNING invalid numSubdivIJ: patch quad matTag numSubdivIJ numSubdivJK yVertI zVertI yVertJ zVertJ yVertK zVertK yVertL zVertL\n";
            return TCL_ERROR;
        }
        ...
        {
            cerr <<  "WARNING invalid numSubdivJK: patch quad matTag numSubdivIJ numSubdivJK yVertI zVertI yVertJ zVertJ yVertK zVertK yVertL zVertL\n";
            return TCL_ERROR;
        }
        ...
        for (j = 0; j < 4; j++)
        {
            ...
            {
                cerr <<  "WARNING invalid Coordinate y: ...yVertI zVertI yVertJ zVertJ yVertK zVertK yVertL zVertL\n";
                return TCL_ERROR;
            }
            ...
            {
                cerr <<  "WARNING invalid Coordinate z: ...yVertI zVertI yVertJ zVertJ yVertK zVertK yVertL zVertL\n";
                return TCL_ERROR;
            }
        ...
        if (sectionRepres == 0)
        {
            cerr <<  "WARNING cannot retrieve section\n";
            return TCL_ERROR;
        }

        if (sectionRepres->getType() != SEC_TAG_FiberSection)
        {
            cerr <<  "WARNING section invalid: patch can only be added to fiber sections\n";
            return TCL_ERROR;
        }
        ...
        if (!patch)
        {
            cerr <<  "WARNING cannot alocate patch\n";
            return TCL_ERROR;
        }
        ...
        if (error)
        {
            cerr <<  "WARNING cannot add patch to section\n";
            return TCL_ERROR;
        }
    }
             ...
             strcmp(argv[1], "rectangular") == 0)
    {
        ...
        if (argc < 9)
        {
            cerr <<  "WARNING invalid number of parameters: patch quad matTag numSubdivIJ numSubdivJK yVertI zVertI yVertK zVertK\n";
            return TCL_ERROR;
        }
    ...
    else if (strcmp(argv[1], "circ") == 0)
    {
        ...
        if (argc < 11)
        {
            cerr <<  "WARNING invalid number of parameters: patch circ matTag numSubdivCirc numSubdivRad yCenter zCenter intRad extRad startAng endAng\n";
            return TCL_ERROR;
        }

        if (Tcl_GetInt(interp, argv[argi++], &matTag) != TCL_OK)
        {
            cerr <<  "WARNING invalid matTag: patch circ matTag numSubdivCirc numSubdivRad yCenter zCenter intRad extRad startAng endAng\n";
            return TCL_ERROR;
        }
        ...
        {
            cerr <<  "WARNING invalid numSubdivCirc: patch circ matTag numSubdivCirc numSubdivRad yCenter zCenter intRad extRad startAng endAng\n";
            return TCL_ERROR;
        }
        ...
        {
            cerr <<  "WARNING invalid numSubdivRad: patch circ matTag numSubdivCirc numSubdivRad yCenter zCenter intRad extRad startAng endAng\n";
            return TCL_ERROR;
        }
        ...
        {
            cerr <<  "WARNING invalid yCenter: patch circ matTag numSubdivCirc numSubdivRad yCenter zCenter intRad extRad startAng endAng\n";
            return TCL_ERROR;
        }
        ...
        {
            cerr <<  "WARNING invalid zCenter: patch circ matTag numSubdivCirc numSubdivRad yCenter zCenter intRad extRad startAng endAng\n";
            return TCL_ERROR;
        }
        ...
        {
            cerr <<  "WARNING invalid intRad: patch circ matTag numSubdivCirc numSubdivRad yCenter zCenter intRad extRad startAng endAng\n";
            return TCL_ERROR;
        }
        ...
        {
            cerr <<  "WARNING invalid extRad: patch circ matTag numSubdivCirc numSubdivRad yCenter zCenter intRad extRad startAng endAng\n";
            return TCL_ERROR;
        }
        ...
        {
            cerr <<  "WARNING invalid startAng: patch circ matTag numSubdivCirc numSubdivRad yCenter zCenter intRad extRad startAng endAng\n";
            return TCL_ERROR;
        }
        ...
        {
            cerr <<  "WARNING invalid endAng: patch circ matTag numSubdivCirc numSubdivRad yCenter zCenter intRad extRad startAng endAng\n";
            return TCL_ERROR;
        }
    ...
    {
        cerr <<  "WARNING patch type is not available\n";
        return TCL_ERROR;
    }
                         ...
                         TCL_Char** argv, TclModelBuilder* theTclModelBuilder)
{
    ...
    if (currentSectionTag == 0)
    {
        cerr <<  "WARNING subcommand 'fiber' is only valid inside a 'section' command\n";
        return TCL_ERROR;
    }
    ...
    if (argc < 5)
    {
        cerr <<  "WARNING invalid num args: fiber yLoc zLoc area matTag\n";
        return TCL_ERROR;
    }
    ...
    {
        cerr <<  "WARNING invalid yLoc: fiber yLoc zLoc area matTag\n";
        return TCL_ERROR;
    }

    if (Tcl_GetDouble(interp, argv[2], &zLoc) != TCL_OK)
    {
        cerr <<  "WARNING invalid zLoc: fiber yLoc zLoc area matTag\n";
        return TCL_ERROR;
    }

    if (Tcl_GetDouble(interp, argv[3], &area) != TCL_OK)
    {
        cerr <<  "WARNING invalid area: fiber yLoc zLoc area matTag\n";
        return TCL_ERROR;
    }

    if (Tcl_GetInt(interp, argv[4], &matTag) != TCL_OK)
    {
        cerr <<  "WARNING invalid matTag: fiber yLoc zLoc area matTag\n";
        return TCL_ERROR;
    }
    ...
    if (NDM == 2)
    {
        ...
        if (material == 0)
        {
            cerr <<  "WARNING invalid material ID for patch\n";
            return TCL_ERROR;
        }
        ...
        if (theFiber == 0)
        {
            cerr <<  "WARNING unable to allocate fiber \n";
            return TCL_ERROR;
        }
    }
    ...
    {
        cerr <<  "WARNING fiber command for FiberSection only fo 2 or 3d \n";
        return TCL_ERROR;
    }
                              ...
                              TCL_Char** argv, TclModelBuilder* theTclModelBuilder)
{
    ...
    if (argc < 2)
    {
        cerr <<  "WARNING need to specify a layer type \n";
        return TCL_ERROR;
    }
    ...
    if (strcmp(argv[1], "straight") == 0)
    {
        if (argc < 9)
        {
            cerr <<  "WARNING invalid number of parameters: layer straight matTag numReinfBars reinfBarArea yStartPt zStartPt yEndPt zEndPt\n";
            return TCL_ERROR;
        }
        ...
        if (Tcl_GetInt(interp, argv[argi++], &matTag) != TCL_OK)
        {
            cerr <<  "WARNING invalid matTag: layer straight matTag numReinfBars reinfBarArea  yStartPt zStartPt yEndPt zEndPt\n";
            return TCL_ERROR;
        }
        ...
        {
            cerr <<  "WARNING invalid numReinfBars: layer straight matTag numReinfBars reinfBarArea  yStartPt zStartPt yEndPt zEndPt\n";
            return TCL_ERROR;
        }
        ...
        {
            cerr <<  "WARNING invalid reinfBarArea: layer straight matTag numReinfBars reinfBarArea  yStartPt zStartPt yEndPt zEndPt\n";
            return TCL_ERROR;
        }
        ...
        {
            cerr <<  "WARNING invalid yStartPt: layer straight matTag numReinfBars reinfBarArea  yStartPt zStartPt yEndPt zEndPt\n";
            return TCL_ERROR;
        }
        ...
        {
            cerr <<  "WARNING invalid zStartPt: layer straight matTag numReinfBars reinfBarArea  yStartPt zStartPt yEndPt zEndPt\n";
            return TCL_ERROR;
        }
        ...
        {
            cerr <<  "WARNING invalid yEndPt: layer straight matTag numReinfBars reinfBarArea  yStartPt zStartPt yEndPt zEndPt\n";
            return TCL_ERROR;
        }
        ...
        {
            cerr <<  "WARNING invalid zEndPt: layer straight matTag numReinfBars reinfBarArea  yStartPt zStartPt yEndPt zEndPt\n";
            return TCL_ERROR;
        }
        ...
        if (!reinfLayer)
        {
            cerr <<  "WARNING cannot alocate reinfLayer\n";
            return TCL_ERROR;
        }
        ...
        if (error)
        {
            cerr <<  "WARNING cannot add reinforcing layer to section\n";
            return TCL_ERROR;
        }
    ...
    else if (strcmp(argv[1], "circ") == 0)
    {
        if (argc < 8)
        {
            cerr <<  "WARNING invalid number of parameters: layer circ matTag numReinfBars reinfBarArea yCenter zCenter arcRadius <startAng endAng>\n";
            return TCL_ERROR;
        }
        ...
        if (Tcl_GetInt(interp, argv[argi++], &matTag) != TCL_OK)
        {
            cerr <<  "WARNING invalid matTag: layer circ matTag numReinfBars reinfBarArea yCenter zCenter radius startAng endAng\n";
            return TCL_ERROR;
        }
        ...
        if (Tcl_GetInt(interp, argv[argi++], &numReinfBars) != TCL_OK)
        {
            cerr <<  "WARNING invalid numReinfBars: layer circ matTag numReinfBars reinfBarArea yCenter zCenter radius startAng endAng\n";
            return TCL_ERROR;
        }
        ...
        if (Tcl_GetDouble(interp, argv[argi++], &reinfBarArea) != TCL_OK)
        {
            cerr <<  "WARNING invalid reinfBarArea: layer circ matTag numReinfBars reinfBarArea yCenter zCenter radius startAng endAng\n";
            return TCL_ERROR;
        }
        ...
        if (Tcl_GetDouble(interp, argv[argi++], &yCenter) != TCL_OK)
        {
            cerr <<  "WARNING invalid yCenter: layer circ matTag numReinfBars reinfBarArea yCenter zCenter radius startAng endAng\n";
            return TCL_ERROR;
        }
        ...
        if (Tcl_GetDouble(interp, argv[argi++], &zCenter) != TCL_OK)
        {
            cerr <<  "WARNING invalid zCenter: layer circ matTag numReinfBars reinfBarArea yCenter zCenter radius startAng endAng\n";
            return TCL_ERROR;
        }
        ...
        {
            cerr <<  "WARNING invalid radius: layer circ matTag numReinfBars reinfBarArea yCenter zCenter radius startAng endAng\n";
            return TCL_ERROR;
        }
        ...
        if (argc > 9)
        {
            if (Tcl_GetDouble(interp, argv[argi++], &startAng) != TCL_OK)
            {
                cerr <<  "WARNING invalid startAng: layer circ matTag numReinfBars reinfBarArea yCenter zCenter radius startAng endAng\n";
                return TCL_ERROR;
            }
            ...
            if (Tcl_GetDouble(interp, argv[argi++], &endAng) != TCL_OK)
            {
                cerr <<  "WARNING invalid endAng: layer circ matTag numReinfBars reinfBarArea yCenter zCenter radius startAng endAng\n";
                return TCL_ERROR;
            }
    ...
    {
        cerr <<  "WARNING reinforcing layer type is not available\n";
        return TCL_ERROR;
    }
             ...
             int secTag, bool isTorsion, double GJ)
{
    ...
    if (sectionRepres->getType() == SEC_TAG_FiberSection)
    {
        ...
        for (i = 0; i < numPatches; i++)
        {
            ...
            if (cell == 0)
            {
                cerr <<  "WARNING out of run to create fibers\n";
                return TCL_ERROR;
            }
        ...
        if (fiber == 0)
        {
            cerr <<  "WARNING unable to allocate fibers \n";
            return TCL_ERROR;
        }
        ...
        if (NDM == 2)
        {
            ...
            if (section == 0)
            {
                cerr <<  "WARNING - cannot construct section\n";
                return TCL_ERROR;
            }

            if (theTclModelBuilder->addSection (*section) < 0)
            {
                cerr <<  "WARNING - cannot add section\n";
                return TCL_ERROR;
            }
        ...
        else if (NDM == 3)
        {
            ...
            for (i = numSectionRepresFibers; i < numFibers; i++)
            {
                ...
                if (fibersArea(k) < 0)
                {
                    cerr << "ERROR: " << fiberPosition(0) << " " << fiberPosition(1) << endln;
                }
    ...
    {
        cerr <<  "WARNING section invalid: can only build fiber sections\n";
        return TCL_ERROR;
    }
                                   ...
                                   TCL_Char** argv, TclModelBuilder* theTclModelBuilder)
{
    ...
    if (Tcl_GetInt(interp, argv[2], &secTag) != TCL_OK)
    {
        cerr <<  "could not read section tag\n";
        return TCL_ERROR;
    }
    ...
    else
    {
        ...
        while (theFile >> ycoord >> zcoord >> area >> prestrain >> garbage >> matTag)
        {
            ...
            if (theMaterial == 0)
            {
                cerr << "section UCFiber - no material exists with tag << " << matTag << endln;
                return TCL_ERROR;
            }
