...
SectionForceDeformation *OPS_getSectionForceDeformation(int tag)
{
    ...
    if (theResult == 0)
    {
        std::cerr << "SectionForceDeformation *getSectionForceDeformation(int tag) - none found with tag: " << tag << endln;
        return 0;
    }
...
SectionForceDeformation::getInitialFlexibility ()
{
    ...
    if (fDefault == 0)
    {
        ...
        if (fDefault == 0)
        {
            std::cerr << "SectionForceDeformation::getInitialFlexibility -- failed to allocate flexibility matrix\n";
            exit(-1);
        }
    }
...
//         if (fDefault == 0)
//         {
//             std::cerr << "SectionForceDeformation::getSectionTangentSensitivity -- failed to allocate matrix\n";
//             exit(-1);
//         }
//     }
...
//         if (fDefault == 0)
//         {
//             std::cerr << "SectionForceDeformation::getInitialTangentSensitivity -- failed to allocate matrix\n";
//             exit(-1);
//         }
//     }
...
//         if (fDefault == 0)
//         {
//             std::cerr << "SectionForceDeformation::getSectionFlexibilitySensitivity -- failed to allocate matrix\n";
//             exit(-1);
//         }
//     }
...
//         if (fDefault == 0)
//         {
//             std::cerr << "SectionForceDeformation::getInitialFlexibilitySensitivity -- failed to allocate matrix\n";
//             exit(-1);
//         }
//     }
...
{
    std::cerr << "SectionForceDeformation::setTrialSectionDeformation(strain) - should not be called\n";
    return -1;
}
...
{
    std::cerr << "SectionForceDeformation::setTrialSectionDeformationTemperature (strain, tData) - should not be called\n";
    return -1;
}
...
{
    std::cerr << "SectionForceDeformation::getTemperatureStress(double *dataMixed) - should not be called\n";
