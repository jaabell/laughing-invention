...
SectionForceDeformation::getSectionFlexibility ()
{
    ...
    if (fDefault == 0)
    {
        ...
        if (fDefault == 0)
        {
            cerr << "SectionForceDeformation::getSectionFlexibility -- failed to allocate flexibility matrix\n";
            exit(-1);
        }
    }
...
SectionForceDeformation::getInitialFlexibility ()
{
    ...
    if (fDefault == 0)
    {
        ...
        if (fDefault == 0)
        {
            cerr << "SectionForceDeformation::getInitialFlexibility -- failed to allocate flexibility matrix\n";
            exit(-1);
        }
    }
...
double
SectionForceDeformation::getArea()
{
    return this->getArea();
}