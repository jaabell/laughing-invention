      ...
      E(E_in), A(A_in), I(I_in)
{
    if (E <= 0.0)
    {
        cerr << "YS_Section2D01::YS_Section2D01 -- Input E <= 0.0 ... setting E to 1.0\n";
        E = 1.0;
    }

    if (A <= 0.0)
    {
        cerr << "YS_Section2D01::YS_Section2D01 -- Input A <= 0.0 ... setting A to 1.0\n";
        A = 1.0;
    }

    if (I <= 0.0)
    {
        cerr << "YS_Section2D01::YS_Section2D01 -- Input I <= 0.0 ... setting I to 1.0",
             I = 1.0;
    }
