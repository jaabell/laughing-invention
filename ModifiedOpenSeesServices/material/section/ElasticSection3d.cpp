      ...
      e(4), eCommit(4)
{
    if (E <= 0.0)
    {
        cerr << "ElasticSection3d::ElasticSection3d -- Input E <= 0.0 ... setting E to 1.0\n";
        E = 1.0;
    }

    if (A <= 0.0)
    {
        cerr << "ElasticSection3d::ElasticSection3d -- Input A <= 0.0 ... setting A to 1.0\n";
        A = 1.0;
    }

    if (Iz <= 0.0)
    {
        cerr << "ElasticSection3d::ElasticSection3d -- Input Iz <= 0.0 ... setting Iz to 1.0\n";
        Iz = 1.0;
    }

    if (Iy <= 0.0)
    {
        cerr << "ElasticSection3d::ElasticSection3d -- Input Iy <= 0.0 ... setting Iy to 1.0\n";
        Iy = 1.0;
    }

    if (G <= 0.0)
    {
        cerr << "ElasticSection3d::ElasticSection3d -- Input G <= 0.0 ... setting G to 1.0\n";
        G = 1.0;
    }

    if (J <= 0.0)
    {
        cerr << "ElasticSection3d::ElasticSection3d -- Input J <= 0.0 ... setting J to 1.0\n";
        J = 1.0;
    }
      ...
      e(4), eCommit(4)
{
    if (A <= 0.0)
    {
        cerr << "ElasticSection3d::ElasticSection3d -- Input EA <= 0.0 ... setting EA to 1.0\n";
        A = 1.0;
    }

    if (Iz <= 0.0)
    {
        cerr << "ElasticSection3d::ElasticSection3d -- Input EIz <= 0.0 ... setting EIz to 1.0\n";
        Iz = 1.0;
    }

    if (Iy <= 0.0)
    {
        cerr << "ElasticSection3d::ElasticSection3d -- Input EIy <= 0.0 ... setting EIy to 1.0\n";
        Iy = 1.0;
    }

    if (J <= 0.0)
    {
        cerr << "ElasticSection3d::ElasticSection3d -- Input GJ <= 0.0 ... setting GJ to 1.0\n";
        J = 1.0;
    }
                           ...
                           FEM_ObjectBroker& theBroker)
{
    ...
    if(res < 0)
    {
        cerr << "ElasticSection3d::receiveSelf -- failed to receive data\n";
        return res;
    }
