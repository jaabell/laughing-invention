      ...
      numHV(nhv), numData(ndata), myFormulation(ThreeDimensional)
{
    ...
    if (numHV > 0)
    {
        ...
        if (hstv == 0)
        {
            cerr <<  "FeapMaterial::FeapMaterial -- failed to allocate history array -- type: " << classTag << endln;
            exit(-1);
        }
    ...
    if (numData > 0)
    {
        ...
        if (ud == 0)
        {
            cerr << "FeapMaterial::FeapMaterial -- failed to allocate ud array -- type: " << classTag << endln;
            exit(-1);
        }
    }
...
FeapMaterial::setTrialStrain(const Vector& strain)
{
    switch (myFormulation)
    {
        ...
        default:
            cerr << "FeapMaterial::FeapMaterial -- unknown material formulation\n";
            exit(-1);
            break;
    }
...
FeapMaterial::getStrain(void)
{
    switch (myFormulation)
    {
        ...
        default:
            cerr << "FeapMaterial::getSTrain -- unknown material formulation\n";
            exit(-1);
...
FeapMaterial::getStress(void)
{
    ...
    switch (myFormulation)
    {
        ...
        default:
            cerr << "FeapMaterial::getStress -- unknown material formulation\n";
            exit(-1);
            return sigma6;
    }
}
...
FeapMaterial::getTangent(void)
{
    ...
    switch (myFormulation)
    {
        ...
        default:
            cerr << "FeapMaterial::getTangent -- unknown material formulation\n";
            exit(-1);
            return tangent6;
    }
}
...
FeapMaterial::getCopy(const char* type)
{
    ...
    {
        cerr << "FeapMaterial::getCopy -- Invalid type (" << type << ") for FeapMaterial\n";
        return 0;
    }
...
FeapMaterial::getType(void) const
{
    switch (myFormulation)
    {
        ...
        default:
            cerr << "FeapMaterial::getTYpe -- unknown material formulation\n";
            return "Unknown";
    }
}
...
FeapMaterial::getOrder(void) const
{
    switch (myFormulation)
    {
        ...
        default:
            cerr << "FeapMaterial::getOrder -- unknown material formulation\n";
            return 0;
    }
}
...
FeapMaterial::invokeSubroutine(int isw)
{
    ...
    switch (this->getClassTag())
    {
        ...
        // Add more cases as needed
        default:
            cerr << "FeapMaterial::invokeSubroutine -- unknown material type\n";
            return -1;
    }
