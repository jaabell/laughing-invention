...

{
    ...
    if (theMaterial == 0)
    {
        cerr << "BeamFiberMaterial::BeamFiberMaterial -- failed to get copy of material\n";
        exit(-1);
    }
}
...
BeamFiberMaterial::setTrialStrain(const Vector& strainFromElement)
{
    ...
    do
    {
        ...
        {
            cerr << "BeamFiberMaterial::setTrialStrain - setStrain failed in material with strain ";
...
int
BeamFiberMaterial::receiveSelf(int commitTag, Channel& theChannel, FEM_ObjectBroker& theBroker)
{
    int res = 0;
