      ...
      numMaterials(num), theModels(0)
{
    ...
    if (theModels == 0)
    {
        cerr << "SeriesMaterial::SeriesMaterial -- failed to allocate material array\n";
        exit(-1);
    }
    ...
    for (i = 0; i < numMaterials; i++)
    {
        ...
        if (theModels[i] == 0)
        {
            cerr << "SeriesMaterial::SeriesMaterial -- failed to get copy of material: " << i << endln;
            exit(-1);
        }
    }
    ...
    if (strain == 0)
    {
        cerr << "SeriesMaterial::SeriesMaterial -- failed to allocate strain array\n";
        exit(-1);
    }
    ...
    if (stress == 0)
    {
        cerr << "SeriesMaterial::SeriesMaterial -- failed to allocate stress array\n";
        exit(-1);
    }
    ...
    if (flex == 0)
    {
        cerr << "SeriesMaterial::SeriesMaterial -- failed to allocate flex array\n";
        exit(-1);
    }
...
SeriesMaterial::sendSelf(int cTag, Channel &theChannel)
{
    ...
    if (res < 0)
    {
        cerr << "SeriesMaterial::sendSelf -- failed to send data Vector\n";
        return res;
    }
    ...
    if (res < 0)
    {
        cerr << "SeriesMaterial::sendSelf -- failed to send classTags ID\n";
        return res;
    }
    ...
    for (i = 0; i < numMaterials; i++)
    {
        ...
        if (res < 0)
        {
            cerr << "SeriesMaterial::sendSelf -- failed to send UniaxialMaterial: " << i << endln;
            return res;
        }
    }
