...
ShearCurve::checkElementState(double springForce)
{
    ...
    else if (defType == 2) // interstory drift
    {
        ...
        //cerr << "Drift ndI: " << dispI(dof) << endln;
        //cerr << "Drift ndJ: " << dispJ(dof) << endln;
    ...
    //cerr << "The shear force in the element is: " << force << endln;


    //cerr << "State flag............................:" << stateFlag << endln;
    //cerr << "Shear force in the column.........: " << force << endln;
    //cerr << "forceSurface: " << forceSurface << endln;
    ...
    if (stateFlag == 0) //prior to failure
    {
...

        {
            ...
            //cerr << "*********************" << endln;
            cerr << "ShearCurve - failure detected....." << endln; //SDK

            // cerr << "deformSurface: " << deformSurface << endln; //SDK





            //cerr << "Capacity: " << forceSurface << endln;
            //cerr << "*********************" << endln;
        }
...
void
ShearCurve::Print(ostream& s, int flag)
{
