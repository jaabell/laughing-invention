...
double Steel03::getR (double x_in)
{
    ...
    if (cR1 < 0.1 && cR2 < 0.1)
    {
        ...
        //cerr << "xin = " << x_in << " rout = " << temp_r << endln;
    }
    else
    {
...
int Steel03::sendSelf (int commitTag, Channel& theChannel)
{
    ...
    if (res < 0)
    {
        cerr << "Steel03::sendSelf() - failed to send data\n";
    }

    return res;
}

int Steel03::receiveSelf (int commitTag, Channel& theChannel,
                       FEM_ObjectBroker& theBroker)
{
    ...
    if (res < 0)
    {
        cerr << "Steel03::receiveSelf() - failed to receive data\n";
        this->setTag(0);
    }
    else
    {
...
void Steel03::Print (ostream& s, int flag)
{
