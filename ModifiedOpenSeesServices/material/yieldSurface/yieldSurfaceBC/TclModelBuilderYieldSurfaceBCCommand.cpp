                                       ...
                                       TCL_Char** argv, TclModelBuilder* theBuilder)
{
    ...
    if (argc < 3)
    {
        ...
        cerr << "Want: yieldSurfaceBC type? tag? <specific material args>" << endln;
        return TCL_ERROR;
    }
    ...
    if(strcmp(argv[1], "null") == 0)
    {
        if(argc < 4)
        {
            ...
            cerr << "Want: yieldSurfaceBC null tag? dimensions?" << endln;
            return TCL_ERROR;
        }
        ...
        {
            cerr << "WARNING invalid yieldSurfaceBC null tag" << endln;
            return TCL_ERROR;
        }

        if (Tcl_GetInt(interp, argv[3], &dim) != TCL_OK)
        {
            cerr << "WARNING invalid yieldSurfaceBC null dimensions" << endln;
            return TCL_ERROR;
        }
        ...
        switch (dim)
        {
            ...
            // case 3: 3D YS
            default:
                cerr << "incorrect dimension for null ys\n";
                return TCL_ERROR;
        }
    ...
    else if (strcmp(argv[1], "Orbison2D") == 0)
    {
        if (argc < 6)
        {
            ...
            cerr << "Want: yieldSurfaceBC Orbison2D tag? xCap? yCap? ys_model_tag?" << endln;
            return TCL_ERROR;
        }
        ...
        if (Tcl_GetInt(interp, argv[2], &tag) != TCL_OK)
        {
            cerr << "WARNING invalid yieldSurfaceBC Orbison2D tag" << endln;
            return TCL_ERROR;
        }
        ...
        if (Tcl_GetDouble(interp, argv[3], &xCap) != TCL_OK)
        {
            ...
            cerr << "yieldSurfaceBC Orbison2D tag: " << tag << endln;
            return TCL_ERROR;
        }
        ...
        {
            cerr << "WARNING invalid yieldSurfaceBC Orbison2D matID1" << modelID << endln;
            return TCL_ERROR;
        }
        ...
        if(theModel == 0)
        {
            cerr << "WARNING yieldSurfaceBC Orbison2D no ys_model exixts with tag: " << modelID << endln;
            return TCL_ERROR;
        }
    ...
    else if (strcmp(argv[1], "ElTawil2D") == 0)
    {
        if (argc < 7)
        {
            ...
            printCommand(argc, argv);
            // Orbison2D(int tag, double xmax, double ymax, YS_HardeningModel &model);
            cerr << "Want: yieldSurfaceBC ElTawil2D tag? xCap? yCap? ys_model_tag?" << endln;
            return TCL_ERROR;
        }
        ...
        if (Tcl_GetInt(interp, argv[2], &tag) != TCL_OK)
        {
            cerr << "WARNING invalid yieldSurfaceBC ElTawil2D tag" << endln;
            return TCL_ERROR;
        }
        ...
        if (Tcl_GetDouble(interp, argv[3], &xBal) != TCL_OK)
        {
            ...
            cerr << "yieldSurfaceBC ElTawil2D tag: " << tag << endln;
            return TCL_ERROR;
        }
        ...
        {
            cerr << "WARNING invalid yieldSurfaceBC ElTawil2D matID1" << modelID << endln;
            return TCL_ERROR;
        }
        ...
        if(theModel == 0)
        {
            cerr << "WARNING yieldSurfaceBC ElTawil2D no ys_model exixts with tag: " << modelID << endln;
            return TCL_ERROR;
        }
    ...
    else if (strcmp(argv[1], "ElTawil2DUnSym") == 0)
    {
        ...
        if (Tcl_GetInt(interp, argv[2], &tag) != TCL_OK)
        {
            cerr << "WARNING invalid yieldSurfaceBC ElTawil2DUnSym tag" << endln;
            return TCL_ERROR;
        }
        ...
        if (Tcl_GetDouble(interp, argv[3], &xPosBal) != TCL_OK)
        {
            ...
            cerr << "yieldSurfaceBC ElTawil2DUnSym tag: " << tag << endln;
            return TCL_ERROR;
        }
    ...
    else if (strcmp(argv[1], "Attalla2D") == 0)
    {
        ...
        if (argc < 6 || argc > 14)
        {
            cerr << "WARNING invalid number of arguments\n";
            printCommand(argc, argv);
            cerr << "Want: yieldSurfaceBC Attalla2D tag? xCap? yCap? matXTag? maxYTag? isoRatio? <..>" << endln;
            return TCL_ERROR;
        }
        ...
        if (Tcl_GetInt(interp, argv[2], &tag) != TCL_OK)
        {
            cerr << "WARNING invalid yieldSurfaceBC Attalla2D tag" << endln;
            return TCL_ERROR;
        }
        ...
        {
            cerr << "WARNING invalid xCap\n";
            cerr << "yieldSurfaceBC Attalla2D tag: " << tag << endln;
            return TCL_ERROR;
        }
        ...
        if (Tcl_GetInt(interp, argv[5], &modelID) != TCL_OK)
        {
            cerr << "WARNING invalid yieldSurfaceBC Attalla2D modelID" << modelID << endln;
            return TCL_ERROR;
        }
    ...
    else if (strcmp(argv[1], "Hajjar2D") == 0)
    {
        if (argc < 9)
        {
            cerr << "WARNING invalid number of arguments\n";
            printCommand(argc, argv);
            cerr << "Want: yieldSurfaceBC Hajjar2D tag? ysModelTag? D? b? t? fc? fy?" << endln;
            return TCL_ERROR;
        }
        ...
        if (Tcl_GetInt(interp, argv[2], &tag) != TCL_OK)
        {
            cerr << "WARNING invalid yieldSurfaceBC Hajjar2D  tag" << endln;
            return TCL_ERROR;
        }

        if (Tcl_GetInt(interp, argv[3], &modelID) != TCL_OK)
        {
            cerr << "WARNING invalid yieldSurfaceBC Hajjar2D  matID1" << modelID << endln;
            return TCL_ERROR;
        }
        ...
        if (Tcl_GetDouble(interp, argv[4], &D) != TCL_OK)
        {
            ...
            cerr << "yieldSurfaceBC Hajjar2D  tag: " << tag << endln;
            return TCL_ERROR;
        }
