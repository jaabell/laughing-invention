      ...
      czPos(cz_pos), tyPos(ty_pos), czNeg(cz_neg), tyNeg(ty_neg), qy(0.005)
{
    ...
    {
        cerr << "WARNING - ElTawil2DUnSym() - yBalance < 0" << endln;
    }
...
void ElTawil2DUnSym::getGradient(double& gx, double& gy, double x, double y)
{
    ...
    // cerr << "ElTawil2DUnSym::getGradient drift:" << this->YieldSurface_BC2D::getDrift(x, y) << endln;
    ...
    else
    {
        ...
        else
        {
            ...
            {
                cerr << "Eltawil2DUnsym - condition not possible" << endln;
                cerr << "\a";
            }
...
double ElTawil2DUnSym::getSurfaceDrift(double x, double y)
{
    ...
    else
    {
        ...
        else
        {
            ...
            cerr << "x=" << x << ", y=" << y << ", capx=" << capx << ", capy=" << capy << endln;
            cerr << "xVal = " << xVal << ", yVal = " << yVal << endln;
            cerr << "\a";
        }
