...
double  translateY = translate(1);
    ...
    if(transDebug)
    {
        cerr << "Deformed - fx = " << x << ",\tfy = " << y << "\n";
        cerr << "isotropicFactor =  " <<  isotropicFactor << "\n";
        cerr << "translateX       = " << translateX << ",\ttranslateY = " << translateY << "\n";
    }
}
*/
                                  ...
                                  Vector &G, Vector &F_Surface, int flag)
{
    ...
    // cerr << "isoX = " << isoX << ", isoY = " << isoY << endln;
    ...
    */
    ...
    if (evolDebug)
    {
        cerr << "F_Surface Vector: ";
        //      cerr << "F_Surface Vector: " << f_sur;
        cerr << "Fx_new = " << fx_new << ", Fy_new = " << fy_new << endln;
        //      cerr << "Gradient: " << gl;
        cerr << "KpxIso = " << getIsoPlasticStiffness(0) << ", KpyIso = " <<  getIsoPlasticStiffness(1) << endln;
        cerr << "F_surf(1) = " << f_sur(1) << ", dfy_iso = " << dfy_iso << endln;
        cerr << "x_grow = " <<  x_grow << ", y_grow = " <<  y_grow << endln;
        cerr << "---------------------------------------------------------" << endln;
    }
