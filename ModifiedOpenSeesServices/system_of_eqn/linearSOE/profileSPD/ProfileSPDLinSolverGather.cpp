...
// What: "@(#) ProfileSPDLinDirectSolverGather.C, revA"
...
ProfileSPDLinSolverGather::ProfileSPDLinSolverGather(double tol)
    : LinearSOESolver(SOLVER_TAGS_ProfileSPDLinSolverGather),
...
ProfileSPDLinSolverGather::~ProfileSPDLinSolverGather()
{
    if (RowTop != 0)
    {
        delete [] RowTop;
...
int
ProfileSPDLinSolverGather::setSize(void)
{

    if (theSOE == 0)
    {
        cerr << "ProfileSPDLinSolverGather::setSize()";
    ...
    {
        cerr << "Warning :ProfileSPDLinSolverGather::ProfileSPDLinSolverGather :";
...
int
ProfileSPDLinSolverGather::solve(void)
{

    // check for quick returns
    if (theSOE == 0)
    {
        cerr << "ProfileSPDLinSolverGather::solve(void): ";
    ...
    /*
      ...
      cerr << "COLUMN " << iii << " Biii -> " << X[iii] << endln;
      }
      cerr << endln;
      */
    ...
    if (theSOE->isAfactored == false)
    {
        ...
        if (a00 <= 0.0)
        {
            cerr << "ProfileSPDLinSolverGather::solve() - ";
...
double
ProfileSPDLinSolverGather::getDeterminant(void)
{
    int theSize = theSOE->size;
...
int
ProfileSPDLinSolverGather::setLinearSOE(ProfileSPDLinSOEGather& theNewSOE)
{
    if (theSOE != 0)
    {
        cerr << "ProfileSPDLinSolverGather::setProfileSOE() - ";
...
int
ProfileSPDLinSolverGather::factor(int n)
{

    // check for quick returns
    if (theSOE == 0)
    {
        cerr << "ProfileSPDLinSolverGather::factor: ";
        cerr << " - No ProfileSPDSOE has been assigned\n";
        return -1;
    }
    ...
    {
        cerr << "ProfileSPDLinSolverGather::factor: ";
        cerr << " - n " << n << " greater than size of system" << theSize << endln;
        return -1;
    }
...
int
ProfileSPDLinSolverGather::sendSelf(int cTag,
                                    Channel& theChannel)
{
    return 0;
}
