      ...
      size(0), A(0), B(0), X(0), vectX(0), vectB(0), isAfactored(false)
{
    if (size > 0)
    {
        ...
        if (A == 0 || B == 0 || X == 0)
        {
            cerr << "ERROR DiagonalSOE::DiagonalSOE :";
    ...
    if (solverOK < 0)
    {
        cerr << "WARNING DiagonalSOE::DiagonalSOE :";
...
DiagonalSOE::setSize(Graph& theGraph)
{
    ...
    if (size > oldSize)
    {
        ...
        if (A == 0 || B == 0 || X == 0)
        {
            cerr << "ERROR DiagonalSOE::setSize() - ";
            cerr << " ran out of memory for size: " << size << endln;
    ...
    if (solverOK < 0)
    {
        cerr << "WARNING DiagonalSOE::setSize :";
...
DiagonalSOE::getX(void)
{
    if (vectX == 0)
    {
        cerr << "FATAL DiagonalSOE::getX - vectX == 0";
        exit(-1);
    }
...
DiagonalSOE::getB(void)
{
    if (vectB == 0)
    {
        cerr << "FATAL DiagonalSOE::getB - vectB == 0";
        exit(-1);
    }
...
DiagonalSOE::setDiagonalSolver(DiagonalSolver& newSolver)
{
    ...
    if (size != 0)
    {
        ...
        if (solverOK < 0)
        {
            cerr << "WARNING:DiagonalSOE::setSolver :";
