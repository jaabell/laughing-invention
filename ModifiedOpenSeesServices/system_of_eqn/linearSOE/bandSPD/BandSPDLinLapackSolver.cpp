...
BandSPDLinLapackSolver::solve(void)
{
    ...
    //        int A2size = theSOE->Asize;
    //        int B2size = theSOE->Bsize;
    //
    //       for (int w=0; w<A2size; w++)
    //         {
    //           cout << "A[" << w << "]" << "=" << (Aptr)[w] << endl;
    //         }
    //
    //
    //       for (int w=0; w<B2size; w++)
    //         {
    //           cout << "B[" << w << "]" << "=" << (Bptr)[w] << endl;
    //         }
    ...
    if (info != 0)
    {
        ...
        cerr << " routines returned " << info << endln;
        return -info;
    }
