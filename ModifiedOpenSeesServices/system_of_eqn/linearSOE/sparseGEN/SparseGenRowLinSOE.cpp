 ...
 factored(false)
{
    ...
    if (A == 0) {
    cerr << "WARNING :SparseGenRowLinSOE::SparseGenRowLinSOE :";
...
SparseGenRowLinSOE::setSize(Graph& theGraph)
{
    ...
    if (size != 0)
    {
        ...
        for (int a = 0; a < size; a++)
        {
            ...
            if (theVertex == 0)
            {
                cerr << "WARNING:SparseGenRowLinSOE::setSize :";
...
SparseGenRowLinSOE::getX(void)
{
    if (vectX == 0)
    {
        cerr << "FATAL SparseGenRowLinSOE::getX - vectX == 0";
        exit(-1);
    }
...
SparseGenRowLinSOE::getB(void)
{
    if (vectB == 0)
    {
        cerr << "FATAL SparseGenRowLinSOE::getB - vectB == 0";
        exit(-1);
    }
...
SparseGenRowLinSOE::setSparseGenRowSolver(SparseGenRowLinSolver& newSolver)
{
    ...
    if (size != 0)
    {
        ...
        if (solverOK < 0)
        {
            cerr << "WARNING:SparseGenRowLinSOE::setSolver :";
