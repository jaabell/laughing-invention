...
PetscSparseSeqSolver::setSize()
{
    ...
    PetscErrorCode ierr = PetscOptionsGetInt(PETSC_NULL, "-n", &n, &flg);
    CHKERRQ(ierr);
    ierr = VecCreateSeqWithArray(PETSC_COMM_WORLD, n, Xdata, &x);
    CHKERRQ(ierr);
    ierr = VecCreateSeqWithArray(PETSC_COMM_WORLD, n, Bdata, &b);
    CHKERRQ(ierr);
