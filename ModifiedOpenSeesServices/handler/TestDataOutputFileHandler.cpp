...
int main(int argc, char** argv)
{
    ...
    cerr << " *******************************************************************\n";
    cerr << "                        DataOutputFileHandler unit test\n";
    cerr << " *******************************************************************\n\n";
    ...
    cerr << "TEST: Creation of DataOutputFile object - will create 3 objects 1,2, & 3\n";
    ...
    {
        cerr << "PASS: Creation of DataOutputFileHandler object\n\n";
    }
    else
    {
        cerr << "FAIL: Creation of DataOutputFileHandler object\n\n";
        exit(-1);
    }
    ...
    cerr << "TEST: Destruction of DataOutputFileHandler object\n";
    delete theHandler1;
    delete theHandler2;
    delete theHandler3;
    delete theHandler4;
    ...
    cerr << "PASS: Destruction of DataOutputFileHandler object\n\n";
    exit(0);
}
