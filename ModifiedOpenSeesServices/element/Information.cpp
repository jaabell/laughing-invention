      ...
      theID(0), theVector(0), theMatrix(0), theTensor(0)
{
    ...
    if (theID == 0)
    {
        cerr << "Information::Information -- failed to allocate\n";
    }
}
      ...
      theID(0), theVector(0), theMatrix(0), theTensor(0)
{
    ...
    if (theVector == 0)
    {
        cerr << "Information::Information -- failed to allocate Vector\n";
    }
}
      ...
      theID(0), theVector(0), theMatrix(0), theTensor(0)
{
    ...
    if (theMatrix == 0)
    {
        cerr << "Information::Information -- failed to allocate Matrix\n";
    }
}
      ...
      theID(0), theVector(0), theMatrix(0), theTensor(0)
{
    ...
    if (theTensor == 0)
    {
        cerr << "Information::Iformation -- failed to allocate Tensor\n";
    }
}
