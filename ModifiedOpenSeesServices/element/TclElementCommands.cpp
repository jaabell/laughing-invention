                              ...
                              Domain* theTclDomain, TclModelBuilder* theTclBuilder)
{
    ...
    if (argc < 2)
    {
        ...
        cerr << "Want: element eleType <specific element args> .. see manual for valid eleTypes & arguments\n";
        return TCL_ERROR;
    }
    ...
    {
        int eleArgStart = 1;
        //Guanzhou int result = TclModelBuilder_addFeapTruss(clientData, interp, argc, argv,
        //Guanzhou                        theTclDomain, theTclBuilder, eleArgStart);
        //Guanzhou return result;
    }
