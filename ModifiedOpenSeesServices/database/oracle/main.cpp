...
int main(int argc, char** argv)
{
    ...
    Channel* database = new DB_Datastore("test1", *theDomain, *theBroker);
    ...
    cout << "Node4 " << " Disp: " << disp << endln;

    Element* theElement = theDomain2->getElement(6);
    Matrix stiff = theElement->getTangentStiff();
    cout << "Element " << " Stiff: " << endln << stiff;
