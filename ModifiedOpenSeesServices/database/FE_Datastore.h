...
class FE_Datastore: public Channel
{
    public:
        ...
        //     virtual int saveResults(int commitTag);
        int setDbTag(int cTag);
        //     virtual int restoreResults(int commitTag);
        //     virtual Vector& restoreNodalDisplacement(int commitTag, int NodeNumber, int dof, int stepNumber);

        virtual double restoreNodalDisplacement(int NodeNumber, int dof, int stepNumber);
        virtual int saveResultsDatabase();
        virtual int createDisplacementTables(int StepNumber);
        virtual int create8GPBrickStressTables(int StepNumber);
        virtual int create27GPBrickStressTables(int StepNumber);
        virtual int createLineElementForceTables(int StepNumber);
        //==============================================================================
