                          ...
                          ChannelAddress* theAddress)
{
    ...
    if (matSize >= maxMatSize)
    {
        ...
        cerr << "with Matrixs of this size " << matSize << endln;
        return -1;
    }
    ...
    if (mats[matSize] == 0)
    {
        ...
        if (mats[matSize] == 0)
        {
            cerr << "FileDatastore::sendMatrix() - could not open file\n";
            return -1;
        }
                          ...
                          ChannelAddress* theAddress)
{
    ...
    if (vectSize >= maxVectSize)
    {
        ...
        cerr << "with Vectors of this size " << vectSize << endln;
    }
    ...
    if (vects[vectSize] == 0)
    {
        ...
        if (vects[vectSize] == 0)
        {
            cerr << "FileDatastore::sendVector() - could not open file\n";
            return -1;
        }
                      ...
                      ChannelAddress* theAddress)
{
    ...
    if (ids[idSize] == 0)
    {
        ...
        if (ids[idSize] == 0)
        {
            cerr << "FileDatastore::sendID() - could not open file\n";
            return -1;
        }
...
FileDatastore::createTable(const char* tableName, int numColumns, char* columns[])
{
    ...
    if (fileName == 0)
    {
        cerr << "FileDatastore::insertData - out of memory; failed to open file: " << fileName << endln;
        return -1;
    }
    ...
    {
        cerr << "FileDatastore::insertData - failed to open file: " << fileName << endln;
        res = -1;
    }
...
FileDatastore::openFile(char* fileName)
{
    ...
    if (res == 0)
    {
        cerr << "FileDatastore::openFile - out of memory; failed to open file: " << fileName << endln;
        return 0;
    }
    ...
    if (res->bad() == true || res->is_open() == false)
    {
        cerr << "FATAL - FileDatastore::openFile() - could not open file " << fileName << endln;
        delete res;
        return 0;
    }
