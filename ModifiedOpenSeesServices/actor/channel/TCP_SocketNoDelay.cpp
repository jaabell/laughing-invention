...
TCP_SocketNoDelay::setUpActor(void)
{
    ...
    cerr << "TCP_SocketNoDelay::TCP_SocketNoDelay - " << optlen << " flag " << flag <<  endln;
    */
...
TCP_SocketNoDelay::addToProgram(void)
{
    ...
    //char *newStuff =(char *)malloc(100*sizeof(char));  //Out by Babak to make the memory allocation dynamic on 09/12/2012: and repalse with following

    char* newStuff = new char[100];
