      ...
      first(true), initializationDone(false), numValidNodes(0)
{
    ...
    for (i = 0; i < numDOF; i++)
    {
        ...
        {
            cerr << "EnvelopeNodeRecorder::EnvelopeNodeRecorder - invalid dof  " << dof;
    ...
    if (numNode != 0)
    {
        ...
        if (theNodalTags == 0)
        {
            cerr << "EnvelopeNodeRecorder::EnvelopeNodeRecorder - out of memory\n";
        }
    }
...
EnvelopeNodeRecorder::record(int commitTag, double timeStamp)
{
    ...
    if (theHandler == 0)
    {
        cerr << "EnvelopeNodeRecorder::record() - no DataOutputHandler has been set\n";
        return -1;
    }
    ...
    if (initializationDone != true)
        ...
        {
            cerr << "EnvelopeNodeRecorder::record() - failed in initialize()\n";
            return -1;
        }
...
EnvelopeNodeRecorder::sendSelf(int commitTag, Channel& theChannel)
{
    ...
    {
        cerr << "EnvelopeNodeRecorder::sendSelf() - does not send data to a datastore\n";
        return -1;
    }
    ...
    {
        cerr << "EnvelopeNodeRecorder::sendSelf() - failed to send idData\n";
        return -1;
    }
    ...
    if (theDofs != 0)
        ...
        {
            cerr << "EnvelopeNodeRecorder::sendSelf() - failed to send dof id's\n";
            return -1;
        }
    ...
    if (theNodalTags != 0)
        ...
        {
            cerr << "EnvelopeNodeRecorder::sendSelf() - failed to send nodal tags\n";
            return -1;
        }
    ...
    {
        cerr << "EnvelopeNodeRecorder::sendSelf() - failed to send data\n";
        return -1;
    }
                               ...
                               FEM_ObjectBroker& theBroker)
{
    ...
    if (theHandler == 0)
    {
        cerr << "EnvelopeNodeRecorder::sendSelf() - failed to get a data output handler\n";
        return -1;
    }
...
EnvelopeNodeRecorder::initialize(void)
{
    ...
    {
        cerr << "EnvelopeNodeRecorder::initialize() - either nodes, dofs or domain has not been set\n";
        return -1;
    }
    ...
    if (theNodes == 0)
    {
        cerr << "EnvelopeNodeRecorder::domainChanged - out of memory\n";
        return -1;
    }
