      ...
      flag(startFlag), deltaT(dT), nextTimeStampToRecord(0.0)
{
    ...
    if (fileName == 0)
    {
        cerr << "PatternRecorder::PatternRecorder - out of memory creating string" << endln;
    }
    ...
    if (theFile.bad())
    {
        cerr << "WARNING - PatternRecorder::PatternRecorder()";
...
PatternRecorder::playback(int commitTag)
{
    ...
    if (inputFile.bad())
    {
        cerr << "WARNING - PatternRecorder::playback() - could not open file ";
        cerr << fileName << endln;
        return -1;
    }
...
PatternRecorder::restart(void)
{
    ...
    if (theFile.bad())
    {
        cerr << "WARNING - PatternRecorder::restart() - could not open file ";
        cerr << fileName << endln;
    }
