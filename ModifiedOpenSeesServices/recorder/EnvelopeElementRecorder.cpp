...
EnvelopeElementRecorder::sendSelf(int commitTag, Channel& theChannel)
{
    ...
    {
        cerr << "EnvelopeElementRecorder::sendSelf() - does not send data to a datastore\n";
        return -1;
    }
    ...
    {
        cerr << "EnvelopeElementRecorder::sendSelf() - failed to send idData\n";
        return -1;
    }
    ...
    if (msgLength ==  0)
    {
        cerr << "EnvelopeElementRecorder::sendSelf() - no data to send!!\n";
        return -1;
    }
    ...
    {
        cerr << "EnvelopeElementRecorder::sendSelf() - out of memory\n";
        return -1;
    }
    ...
    {
        cerr << "EnvelopeElementRecorder::sendSelf() - failed to send message\n";
        return -1;
    }
    ...
    {
        cerr << "EnvelopeElementRecorder::sendSelf() - failed to send the DataOutputHandler\n";
        return -1;
    }
