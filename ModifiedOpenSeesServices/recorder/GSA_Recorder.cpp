      ...
      theDomain(&theDom), ndm(3), ndf(6), counter(0), deltaT(dT), nextTimeStampToRecord(0.0)
{
    ...
    {
        cerr << "WARNING - GSA_Recorder::GSA_Recorder()";
    ...
    while ((theNode = theNodes()) != 0)
    {
        ...
        if (crds.Size() != ndm)
        {
            cerr << "WARNING - GSA_Recorder::GSA_Recorder() - node: " <<  nodeTag ;
            cerr << " has invalid number of coordinates, expecting: " << ndm << " got: " << crds.Size() << endln;
            exit(-1);
        }
        ...
        {
            cerr << "WARNING - GSA_Recorder::GSA_Recorder() - node: " <<  nodeTag ;
            cerr << " has invalid number of dof, expecting: " << ndf << " got: " << disp.Size() << endln;
            exit(-1);
        }
