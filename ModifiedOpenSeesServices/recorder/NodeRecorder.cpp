      ...
      initializationDone(false), numValidNodes(0)
{
    ...
    if (numNode != 0)
    {
        ...
        if (theNodalTags == 0)
        {
            cerr << "NodeRecorder::NodeRecorder - out of memory\n";
        }
    }
    ...
    else if (((strcmp(dataToStore, "reactionInertia") == 0))
             || ((strcmp(dataToStore, "reactionIncInertia") == 0))
    ...
    else if ((strcmp(dataToStore, "eigen") == 0))
    {
        dataFlag = 10;
    }
    else
...
NodeRecorder::record(int commitTag, double timeStamp)
{
    ...
    if (theHandler == 0)
    {
        cerr << "NodeRecorder::record() - no DataOutputHandler has been set\n";
        return -1;
    }
    ...
    if (initializationDone != true)
        ...
        {
            cerr << "NodeRecorder::record() - failed in initialize()\n";
            return -1;
        }
...
NodeRecorder::sendSelf(int commitTag, Channel& theChannel)
{
    ...
    {
        cerr << "NodeRecorder::sendSelf() - does not send data to a datastore\n";
        return -1;
    }
    ...
    {
        cerr << "NodeRecorder::sendSelf() - failed to send idData\n";
        return -1;
    }
    ...
    if (theDofs != 0)
        ...
        {
            cerr << "NodeRecorder::sendSelf() - failed to send dof id's\n";
            return -1;
        }
    ...
    if (theNodalTags != 0)
        ...
        {
            cerr << "NodeRecorder::sendSelf() - failed to send nodal tags\n";
            return -1;
        }
    ...
    {
        cerr << "NodeRecorder::sendSelf() - failed to send data\n";
        return -1;
    }
...
NodeRecorder::initialize(void)
{
    ...
    {
        cerr << "NodeRecorder::initialize() - either nodes, dofs or domain has not been set\n";
        return -1;
    }
    ...
    if (theNodes == 0)
    {
        cerr << "NodeRecorder::domainChanged - out of memory\n";
        return -1;
    }
