...
MeshRegion::sendSelf(int commitTag, Channel& theChannel)
{
    ...
    {
        cerr << "MeshRegion::sendSelf - channel failed to send the initial ID\n";
        return -1;
    }
    ...
    if (lastGeoSendTag != currentGeoTag)
    {
        if (numNod != 0)
            ...
            {
                cerr << "MeshRegion::sendSelf - channel failed to send the nodes\n";
                return -1;
            }
        ...
        if (numEle != 0)
            ...
            {
                cerr << "MeshRegion::sendSelf - channel failed to send the elements\n";
                return -1;
            }
