...
TrapezoidalTimeSeriesIntegrator::integrate(TimeSeries* theSeries, double delta)
{
    ...
    if (theSeries == 0)
    {
        cerr << "TrapezoidalTimeSeriesIntegrator::integrate() - - no TimeSeries passed\n";
        return 0;
    }
    ...
    {
        cerr << "TrapezoidalTimeSeriesIntegrator::integrate() Ran out of memory allocating Vector of size " <<
             numSteps << endln;
    ...
    */
    ...
    if (returnSeries == 0)
    {
        cerr << "TrapezoidalTimeSeriesIntegrator::integrate() Ran out of memory creating PathSeries\n";
