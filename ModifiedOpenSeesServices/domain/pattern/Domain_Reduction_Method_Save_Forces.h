...
#ifndef Domain_Reduction_Method_Save_Forces_h
#define Domain_Reduction_Method_Save_Forces_h
...
class Domain_Reduction_Method_Save_Forces : public LoadPattern
{
    public:
        Domain_Reduction_Method_Save_Forces();
        Domain_Reduction_Method_Save_Forces(int tag,
                                            const char* PBEfName,
                                            const char* PBNfName,
