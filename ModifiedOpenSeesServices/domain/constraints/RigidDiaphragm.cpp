                               ...
                               int perpPlaneConstrained, int startMPtag)
{
    ...
    {
        cerr << "RigidDiaphragm::RigidDiaphragm - " <<
        ...
        if (nodeC != 0)
        {
            ...
            if ((nodeR->getNumberDOF() == 6) && (crdR.Size() == 3))
            {
                ...
                if (perpPlaneConstrained == 2)
                {
                    ...
                    {
                        cerr << "RigidDiaphragm::RigidDiaphragm - ignoring constrained Node " << ndC << ", not in xy plane\n";
                    }
                ...
                else if (perpPlaneConstrained == 1)
                {
                    ...
                    {
                        cerr << "RigidDiaphragm::RigidDiaphragm - ignoring constrained Node " << ndC << ", not in xz plane\n";
                    }
                ...
                else
                {
                    ...
                    if (deltaX == 0.0)
                    {
                        ...
                        cerr << "RigidDiaphragm::RigidDiaphragm - ignoring constrained Node " << ndC <<
                             ", not in xz plane\n";
                }
