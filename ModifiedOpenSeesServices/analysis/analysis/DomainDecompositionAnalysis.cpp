...
DomainDecompositionAnalysis::domainChanged(void)
{
    ...
    **********************/
    ...
    //     theSOE->setSize(theModel->getDOFGraph()); //Out by Babak 06/4/13


    int MaxDOFtag = theModel->getMaxDOFtag(); //Added by Babak 6/4/13
...
{
    cerr << "DomainDecompositionAnalysis::setAlgorithm() - not implemented\n";
    return -1;
}
...
{
    cerr << "DomainDecompositionAnalysis::setIntegrator() - not implemented\n";
    return -1;
}
...
{
    cerr << "DomainDecompositionAnalysis::setLinearSOE() - not implemented\n";
    return -1;
}
...
{
    cerr << "DomainDecompositionAnalysis::setConvergenceTest() - not implemented\n";
    return -1;
}
