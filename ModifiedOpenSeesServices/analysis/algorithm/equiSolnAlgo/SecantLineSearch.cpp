                         ...
                         IncrementalIntegrator &theIntegrator)
{
    ...
    if (printFlag == 0)
    {
        cout << "Secant Line Search - initial: "
    ...
    while ( r > tolerance  &&  count < maxIter )
    {
        ...
        *x *= eta - etaJ;
        ...
        {
            cout << "WARNING SecantLineSearch::search() -";
        ...
        if (printFlag == 0)
        {
            cout << "Secant Line Search - iteration: " << count
...
void
SecantLineSearch::Print(std::ostream &s, int flag)
{
    if (flag == 0)
    {
