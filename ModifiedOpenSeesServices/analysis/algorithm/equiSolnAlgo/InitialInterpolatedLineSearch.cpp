                                      ...
                                      IncrementalIntegrator &theIntegrator)
{
    ...
    if (printFlag == 0)
    {
        cout << "InitialInterpolated Line Search - initial       "
             << "    eta : " << eta
             << " , Ratio |s/s0| = " << r0 << endln;
    }
    ...
    while ( r > tolerance  &&  count < maxIter )
    {
        ...
        *x *= eta - etaPrev;
        ...
        {
            cout << "WARNInG InitialInterpolatedLineSearch::search() -";
        ...
        if (printFlag == 0)
        {
            cout << "InitialInterpolated Line Search - iteration: " << count
                 << " , eta(j) : " << eta
                 << " , Ratio |sj/s0| = " << r << endln;
        }
...
void
InitialInterpolatedLineSearch::Print(std::ostream &s, int flag)
{
    if (flag == 0)
    {
