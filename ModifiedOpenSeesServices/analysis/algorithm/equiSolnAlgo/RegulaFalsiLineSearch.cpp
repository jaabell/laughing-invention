                              ...
                              IncrementalIntegrator &theIntegrator)
{
    ...
    if (printFlag == 0)
    {
        cout << "RegulaFalsi Line Search - initial: "
    ...
    while ((sU * sL > 0.0) && (etaU < maxEta))
    {
        ...
        *x *= factor;
        ...
        {
            cout << "WARNING BisectionLineSearch::search() -";
        ...
        if (printFlag == 0)
        {
            cout << "Bisection Line Search - bracketing: " << count
    ...
    while ( r > tolerance  &&  count < maxIter )
    {
        ...
        *x *= eta - etaJ;
        ...
        if (theIntegrator.update(*x) < 0)
        {
            cout << "WARNING RegulaFalsiLineSearch::search() -";
            cout << "the Integrator failed in update()\n";
            return -1;
        }
        ...
        if (printFlag == 0)
        {
            cout << "RegulaFalsi Line Search - iteration: " << count
...
void
RegulaFalsiLineSearch::Print(std::ostream &s, int flag)
{
    if (flag == 0)
    {
