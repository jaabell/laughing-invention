      ...
      theMP(mp), Trans(0), modTangent(0), modUnbalance(0), modID(0), theSPs(0)
{
    ...
    *******************/
            ...
            Trans == 0 || Trans->noRows() == 0)
    {
        ...
        cerr << " ran out of memory for size: " << modNumDOF << endln;
        exit(-1);
    }
...
{
    cerr << "TransformationDOF_Group::getC_Force() - not yet implemented\n";
    return *modUnbalance;
}
...
{
    cerr << "TransformationDOF_Group::getTangForce() - not yet implemented\n";
    return *modUnbalance;
}
