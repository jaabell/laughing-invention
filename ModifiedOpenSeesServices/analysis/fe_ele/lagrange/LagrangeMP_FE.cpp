...
{
    cerr << "WARNING LagrangeSP_FE::getTangForce() - not yet implemented\n";
    return *resid;
}
...
{
    cerr << "WARNING LagrangeSP_FE::getK_Force() - not yet implemented\n";
    return *resid;
}
...
{
    cerr << "WARNING LagrangeSP_FE::getC_Force() - not yet implemented\n";
    return *resid;
}
...
{
    cerr << "WARNING LagrangeSP_FE::getM_Force() - not yet implemented\n";
    return *resid;
}
