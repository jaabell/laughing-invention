      ...
      theResidual(0), theTangent(0), theIntegrator(0)
{
    if (numDOF <= 0)
    {
        ...
        cerr << " element must have 1 dof at least.";
    ...
    if (theDomain == 0)
    {
        cerr << "FATAL FE_Element::FE_Element() - element has no domain ";
    ...
    for (int i = 0; i < numGroups; i++)
    {
        ...
        {
            cerr << "FATAL FE_Element::FE_Element() - Node: ";
            cerr << "Node has no DOF_Group associated with it\n";
...
FE_Element::getK_Force(const Vector &disp, double fact)
{
    if (myEle != 0)
    {
        ...
        {
            cerr << "WARNING FE_Element::getKForce() - ";
            cerr << "- addMatrixVector returned error\n";
        }
    ...
    {
        cerr << "WARNING FE_Element::getKForce() - no Element *given ";
        cerr << "- subclasses must provide implementation\n";
        return errVector;
    }
}
...
FE_Element::getM_Force(const Vector &disp, double fact)
{
    ...
    if (myEle != 0)
    {
        ...
        {
            cerr << "WARNING FE_Element::getMForce() - ";
            cerr << "- addMatrixVector returned error\n";
        }
    ...
    {
        cerr << "WARNING FE_Element::getMForce() - no Element *given ";
        cerr << "- subclasses must provide implementation\n";
        return errVector;
    }
}
...
FE_Element::getC_Force(const Vector &disp, double fact)
{
    if (myEle != 0)
    {
        ...
        {
            cerr << "WARNING FE_Element::getDForce() - ";
            cerr << "- addMatrixVector returned error\n";
        }
    ...
    {
        cerr << "WARNING FE_Element::getDForce() - no Element *given ";
        cerr << "- subclasses must provide implementation\n";
        return errVector;
    }
}
