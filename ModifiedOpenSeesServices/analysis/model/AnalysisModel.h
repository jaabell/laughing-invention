...
class AnalysisModel: public MovableObject
{
    public:
        ...
        virtual int    Output_Domain_Iteration(int global_iteration_no);                     // Added by Sumeet 3rd August, 2016
        virtual int    Output_Domain_Step();                                                 // Added by Sumeet Sepetember, 2016
