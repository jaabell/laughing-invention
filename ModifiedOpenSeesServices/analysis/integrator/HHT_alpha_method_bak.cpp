...
HHT_alpha_method::HHT_alpha_method(double _alpha)
    : TransientIntegrator(INTEGRATOR_TAGS_HHT_alpha_method),
      alpha(_alpha + 1.0), gamma(0.5 - _alpha), beta((1 - _alpha) * (1 - _alpha) * 0.25),
      c1(0.0), c2(0.0), c3(0.0),
      Ut(0), Utdot(0), Utdotdot(0),  U(0), Udot(0), Udotdot(0),
      Ualpha(0), Udotalpha(0)
{
...
HHT_alpha_method::HHT_alpha_method(double _alpha,
                                   ...
                                   double _gamma)
    : TransientIntegrator(INTEGRATOR_TAGS_HHT_alpha_method),
      alpha(_alpha + 1.0), gamma(_gamma), beta(_beta),
      c1(0.0), c2(0.0), c3(0.0),
      Ut(0), Utdot(0), Utdotdot(0),  U(0), Udot(0), Udotdot(0),
      Ualpha(0), Udotalpha(0)
{
...
// HHT_alpha_method::HHT_alpha_method(double _alpha, double alpham, double betak, double betaki, double betakc)
// :TransientIntegrator(INTEGRATOR_TAGS_HHT_alpha_method),
...
int
HHT_alpha_method::recvSelf(int cTag, Channel& theChannel, FEM_ObjectBroker& theBroker)
{
    //     Vector data(8);
    Vector data(4);
    ...
    {
        cerr << "WARNING HHT_alpha_method::recvSelf() - could not receive data\n";
        return -1;
    }
