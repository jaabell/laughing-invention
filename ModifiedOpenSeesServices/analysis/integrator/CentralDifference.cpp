...
CentralDifference::domainChanged()
{
    ...
    cerr << "WARNING: CentralDifference::domainChanged() - assuming Ut-1 = 0\n";
    Utm1->Zero();
...
CentralDifference::update(const Vector& X)
{
    ...
    if (updateCount > 1)
    {
        cerr << "ERROR CentralDifference::update() - called more than once -";
        cerr << " Central Difference integration schemes require a LINEAR solution algorithm\n";
        return -1;
    }
