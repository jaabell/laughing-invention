...
class TransientIntegrator : public IncrementalIntegrator
{
    public:
        ...
        int formK(); //Added by Babak for Eigen Analysis ... 1/15/13
        int formM(); //Added by Babak for Eigen Analysis ... 1/15/13
        int formEleTangK(FE_Element* theEle);   //Added by Babak for Eigen Analysis ... 1/15/13
        int formEleTangM(FE_Element* theEle);   //Added by Babak for Eigen Analysis ... 1/15/13
        int formNodTangM(DOF_Group* theDof);    //Added by Babak for Eigen Analysis ... 1/15/13
    protected:
        int flagK; //Added by Babak for Eigen Analysis ... 1/15/13
