...
#ifndef VariableNodeBrickOrderTwo_up_CPP
#define VariableNodeBrickOrderTwo_up_CPP

#include "VariableNodeBrickOrderTwo_up.h"

#undef  ELE_TAG_BRICK_TYPE
#define ELE_TAG_BRICK_TYPE  ELE_TAG_VariableNodeBrickOrderTwo_up
