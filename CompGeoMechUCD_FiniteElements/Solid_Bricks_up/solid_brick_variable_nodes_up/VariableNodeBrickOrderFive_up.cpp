...
#ifndef VariableNodeBrickOrderFive_up_CPP
#define VariableNodeBrickOrderFive_up_CPP

#include "VariableNodeBrickOrderFive_up.h"

#undef  ELE_TAG_BRICK_TYPE
#define ELE_TAG_BRICK_TYPE  ELE_TAG_VariableNodeBrickOrderFive_up
