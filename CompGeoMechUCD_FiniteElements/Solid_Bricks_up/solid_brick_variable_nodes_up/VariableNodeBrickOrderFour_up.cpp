...
#ifndef VariableNodeBrickOrderFour_up_CPP
#define VariableNodeBrickOrderFour_up_CPP

#include "VariableNodeBrickOrderFour_up.h"

#undef  ELE_TAG_BRICK_TYPE
#define ELE_TAG_BRICK_TYPE  ELE_TAG_VariableNodeBrickOrderFour_up
