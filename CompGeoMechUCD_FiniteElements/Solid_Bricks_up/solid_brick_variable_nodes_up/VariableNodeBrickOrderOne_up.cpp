...
#ifndef VariableNodeBrickOrderOne_up_CPP
#define VariableNodeBrickOrderOne_up_CPP

#include "VariableNodeBrickOrderOne_up.h"

#undef  ELE_TAG_BRICK_TYPE
#define ELE_TAG_BRICK_TYPE  ELE_TAG_VariableNodeBrickOrderOne_up
