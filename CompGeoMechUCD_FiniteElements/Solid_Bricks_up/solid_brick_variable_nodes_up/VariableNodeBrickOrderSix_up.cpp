...
#ifndef VariableNodeBrickOrderSix_up_CPP
#define VariableNodeBrickOrderSix_up_CPP

#include "VariableNodeBrickOrderSix_up.h"

#undef  ELE_TAG_BRICK_TYPE
#define ELE_TAG_BRICK_TYPE  ELE_TAG_VariableNodeBrickOrderSix_up
