...
#ifndef TwentyNodeBrickOrderFive_up_CPP
#define TwentyNodeBrickOrderFive_up_CPP

#include "TwentyNodeBrickOrderFive_up.h"

#undef ELE_TAG_BRICK_TYPE
#define ELE_TAG_BRICK_TYPE  ELE_TAG_TwentyNodeBrickOrderFive_up
