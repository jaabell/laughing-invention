...
#ifndef TwentyNodeBrickOrderTwo_up_CPP
#define TwentyNodeBrickOrderTwo_up_CPP

#include "TwentyNodeBrickOrderTwo_up.h"

#undef ELE_TAG_BRICK_TYPE
#define ELE_TAG_BRICK_TYPE  ELE_TAG_TwentyNodeBrickOrderTwo_up
