...
#ifndef TwentyNodeBrickOrderOne_up_CPP
#define TwentyNodeBrickOrderOne_up_CPP

#include "TwentyNodeBrickOrderOne_up.h"

#undef ELE_TAG_BRICK_TYPE
#define ELE_TAG_BRICK_TYPE  ELE_TAG_TwentyNodeBrickOrderOne_up
