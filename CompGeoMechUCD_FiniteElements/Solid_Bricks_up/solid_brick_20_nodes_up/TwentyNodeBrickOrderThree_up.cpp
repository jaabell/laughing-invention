...
// This is a Header file that is taken from MasterTwentyNodeBrick_up.h
// The macros (#define) that go into this master BrickHeaderFile are 
//
// BRICK_TYPE -> define the element type like "TwentyNodeBrick_up"
// BRICK_ELEMENT_NAME -> Name of the brick in string Eg:- "TwentyNodeBrick_up"
...
#ifndef TwentyNodeBrickOrderThree_up_CPP
#define TwentyNodeBrickOrderThree_up_CPP

#include "TwentyNodeBrickOrderThree_up.h"

#undef ELE_TAG_BRICK_TYPE
#define ELE_TAG_BRICK_TYPE  ELE_TAG_TwentyNodeBrickOrderThree_up

#undef Order
#define Order 3


#include "../MasterTwentyNodeBrick_up.cpp"
