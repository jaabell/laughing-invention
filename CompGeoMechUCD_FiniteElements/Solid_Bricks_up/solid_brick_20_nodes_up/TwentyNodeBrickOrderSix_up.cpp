...
#ifndef TwentyNodeBrickOrderSix_up_CPP
#define TwentyNodeBrickOrderSix_up_CPP

#include "TwentyNodeBrickOrderSix_up.h"

#undef ELE_TAG_BRICK_TYPE
#define ELE_TAG_BRICK_TYPE  ELE_TAG_TwentyNodeBrickOrderSix_up
