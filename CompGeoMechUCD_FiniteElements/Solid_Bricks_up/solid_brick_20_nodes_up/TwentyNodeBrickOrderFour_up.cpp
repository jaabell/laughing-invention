...
#ifndef TwentyNodeBrickOrderFour_up_CPP
#define TwentyNodeBrickOrderFour_up_CPP

#include "TwentyNodeBrickOrderFour_up.h"

#undef ELE_TAG_BRICK_TYPE
#define ELE_TAG_BRICK_TYPE  ELE_TAG_TwentyNodeBrickOrderFour_up
