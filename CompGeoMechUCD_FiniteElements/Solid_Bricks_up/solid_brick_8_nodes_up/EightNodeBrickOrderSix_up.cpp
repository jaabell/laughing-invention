...
#ifndef EightNodeBrickOrderSix_up_CPP
#define EightNodeBrickOrderSix_up_CPP

#include "EightNodeBrickOrderSix_up.h"

#undef ELE_TAG_BRICK_TYPE
#define ELE_TAG_BRICK_TYPE  ELE_TAG_EightNodeBrickOrderSix_up
