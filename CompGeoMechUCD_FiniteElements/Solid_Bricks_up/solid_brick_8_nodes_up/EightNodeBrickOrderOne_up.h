...
#ifndef EightNodeBrickOrderOne_up_H
#define EightNodeBrickOrderOne_up_H

#undef BRICK_TYPE
#define BRICK_TYPE EightNodeBrickOrderOne_up

#undef BRICK_ELEMENT_NAME
#define BRICK_ELEMENT_NAME "EightNodeBrickOrderOne_up"
