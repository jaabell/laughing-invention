...
#ifndef EightNodeBrickOrderOne_up_CPP
#define EightNodeBrickOrderOne_up_CPP

#include "EightNodeBrickOrderOne_up.h"

#undef ELE_TAG_BRICK_TYPE
#define ELE_TAG_BRICK_TYPE  ELE_TAG_EightNodeBrickOrderOne_up
