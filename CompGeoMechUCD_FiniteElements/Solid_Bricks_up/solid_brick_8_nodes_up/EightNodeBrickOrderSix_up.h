...
#ifndef EightNodeBrickOrderSix_up_H
#define EightNodeBrickOrderSix_up_H

#undef BRICK_TYPE
#define BRICK_TYPE EightNodeBrickOrderSix_up

#undef BRICK_ELEMENT_NAME
#define BRICK_ELEMENT_NAME "EightNodeBrickOrderSix_up"
