...
#ifndef EightNodeBrickOrderTwo_up_CPP
#define EightNodeBrickOrderTwo_up_CPP

#include "EightNodeBrickOrderTwo_up.h"

#undef ELE_TAG_BRICK_TYPE
#define ELE_TAG_BRICK_TYPE  ELE_TAG_EightNodeBrickOrderTwo_up
