...
#ifndef EightNodeBrickOrderThree_up_CPP
#define EightNodeBrickOrderThree_up_CPP

#include "EightNodeBrickOrderThree_up.h"

#undef ELE_TAG_BRICK_TYPE
#define ELE_TAG_BRICK_TYPE  ELE_TAG_EightNodeBrickOrderThree_up

#undef Order
#define Order 3


#include "../MasterEightNodeBrick_up.cpp"
