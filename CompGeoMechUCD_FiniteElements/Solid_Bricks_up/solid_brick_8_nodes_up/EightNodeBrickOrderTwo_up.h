...
#ifndef EightNodeBrickOrderTwo_up_H
#define EightNodeBrickOrderTwo_up_H

#undef BRICK_TYPE
#define BRICK_TYPE EightNodeBrickOrderTwo_up

#undef BRICK_ELEMENT_NAME
#define BRICK_ELEMENT_NAME "EightNodeBrickOrderTwo_up"
