...
#ifndef EightNodeBrickOrderFive_up_H
#define EightNodeBrickOrderFive_up_H

#undef BRICK_TYPE
#define BRICK_TYPE EightNodeBrickOrderFive_up

#undef BRICK_ELEMENT_NAME
#define BRICK_ELEMENT_NAME "EightNodeBrickOrderFive_up"
