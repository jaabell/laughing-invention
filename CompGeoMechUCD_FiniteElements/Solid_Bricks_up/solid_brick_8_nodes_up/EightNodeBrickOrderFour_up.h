...
#ifndef EightNodeBrickOrderFour_up_H
#define EightNodeBrickOrderFour_up_H

#undef BRICK_TYPE
#define BRICK_TYPE EightNodeBrickOrderFour_up

#undef BRICK_ELEMENT_NAME
#define BRICK_ELEMENT_NAME "EightNodeBrickOrderFour_up"
