...
#ifndef EightNodeBrickOrderFour_up_CPP
#define EightNodeBrickOrderFour_up_CPP

#include "EightNodeBrickOrderFour_up.h"

#undef ELE_TAG_BRICK_TYPE
#define ELE_TAG_BRICK_TYPE  ELE_TAG_EightNodeBrickOrderFour_up
