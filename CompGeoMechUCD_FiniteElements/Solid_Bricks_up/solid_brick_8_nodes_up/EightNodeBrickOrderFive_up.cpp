...
#ifndef EightNodeBrickOrderFive_up_CPP
#define EightNodeBrickOrderFive_up_CPP

#include "EightNodeBrickOrderFive_up.h"

#undef ELE_TAG_BRICK_TYPE
#define ELE_TAG_BRICK_TYPE  ELE_TAG_EightNodeBrickOrderFive_up
