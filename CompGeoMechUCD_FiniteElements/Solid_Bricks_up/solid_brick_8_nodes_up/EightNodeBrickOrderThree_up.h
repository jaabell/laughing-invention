...
#ifndef EightNodeBrickOrderThree_up_H
#define EightNodeBrickOrderThree_up_H

#undef BRICK_TYPE
#define BRICK_TYPE EightNodeBrickOrderThree_up

#undef BRICK_ELEMENT_NAME
#define BRICK_ELEMENT_NAME "EightNodeBrickOrderThree_up"

#undef NUMBER_NODES
#define NUMBER_NODES 8


#include "../MasterEightNodeBrick_up.h"
