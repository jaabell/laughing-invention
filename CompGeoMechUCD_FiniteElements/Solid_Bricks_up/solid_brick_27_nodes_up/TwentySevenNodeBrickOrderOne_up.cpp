...
#ifndef TwentySevenNodeBrickOrderOne_up_CPP
#define TwentySevenNodeBrickOrderOne_up_CPP

#include "TwentySevenNodeBrickOrderOne_up.h"

#undef ELE_TAG_BRICK_TYPE
#define ELE_TAG_BRICK_TYPE  ELE_TAG_TwentySevenNodeBrickOrderOne_up
