...
#ifndef TwentySevenNodeBrickOrderThree_up_H
#define TwentySevenNodeBrickOrderThree_up_H

#undef BRICK_TYPE
#define BRICK_TYPE TwentySevenNodeBrickOrderThree_up

#undef BRICK_ELEMENT_NAME
#define BRICK_ELEMENT_NAME "TwentySevenNodeBrickOrderThree_up"
