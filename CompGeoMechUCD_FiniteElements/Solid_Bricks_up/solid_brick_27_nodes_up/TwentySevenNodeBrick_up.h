...
#ifndef TwentySevenNodeBrick_up_H
#define TwentySevenNodeBrick_up_H

#undef BRICK_TYPE
#define BRICK_TYPE TwentySevenNodeBrick_up

#undef BRICK_ELEMENT_NAME
#define BRICK_ELEMENT_NAME "TwentySevenNodeBrick_up"
