...
#ifndef TwentySevenNodeBrickOrderFive_up_CPP
#define TwentySevenNodeBrickOrderFive_up_CPP

#include "TwentySevenNodeBrickOrderFive_up.h"

#undef ELE_TAG_BRICK_TYPE
#define ELE_TAG_BRICK_TYPE  ELE_TAG_TwentySevenNodeBrickOrderFive_up
