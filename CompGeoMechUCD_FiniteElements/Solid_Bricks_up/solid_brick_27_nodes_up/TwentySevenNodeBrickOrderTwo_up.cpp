...
#ifndef TwentySevenNodeBrickOrderTwo_up_CPP
#define TwentySevenNodeBrickOrderTwo_up_CPP

#include "TwentySevenNodeBrickOrderTwo_up.h"

#undef ELE_TAG_BRICK_TYPE
#define ELE_TAG_BRICK_TYPE  ELE_TAG_TwentySevenNodeBrickOrderTwo_up
