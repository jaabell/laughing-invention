...
#ifndef TwentySevenNodeBrickOrderFour_up_CPP
#define TwentySevenNodeBrickOrderFour_up_CPP

#include "TwentySevenNodeBrickOrderFour_up.h"

#undef ELE_TAG_BRICK_TYPE
#define ELE_TAG_BRICK_TYPE  ELE_TAG_TwentySevenNodeBrickOrderFour_up
