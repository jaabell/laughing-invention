...
#ifndef TwentySevenNodeBrickOrderSix_up_CPP
#define TwentySevenNodeBrickOrderSix_up_CPP

#include "TwentySevenNodeBrickOrderSix_up.h"

#undef ELE_TAG_BRICK_TYPE
#define ELE_TAG_BRICK_TYPE  ELE_TAG_TwentySevenNodeBrickOrderSix_up
