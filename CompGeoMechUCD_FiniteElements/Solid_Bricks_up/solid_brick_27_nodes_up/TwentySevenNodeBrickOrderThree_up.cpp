...
#ifndef TwentySevenNodeBrickOrderThree_up_CPP
#define TwentySevenNodeBrickOrderThree_up_CPP

#include "TwentySevenNodeBrickOrderThree_up.h"

#undef ELE_TAG_BRICK_TYPE
#define ELE_TAG_BRICK_TYPE  ELE_TAG_TwentySevenNodeBrickOrderThree_up
