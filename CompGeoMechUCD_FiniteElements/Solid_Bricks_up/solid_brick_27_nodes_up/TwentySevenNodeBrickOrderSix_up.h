...
#ifndef TwentySevenNodeBrickOrderSix_up_H
#define TwentySevenNodeBrickOrderSix_up_H

#undef BRICK_TYPE
#define BRICK_TYPE TwentySevenNodeBrickOrderSix_up

#undef BRICK_ELEMENT_NAME
#define BRICK_ELEMENT_NAME "TwentySevenNodeBrickOrderSix_up"
