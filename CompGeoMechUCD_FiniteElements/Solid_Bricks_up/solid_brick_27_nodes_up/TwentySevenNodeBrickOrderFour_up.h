...
#ifndef TwentySevenNodeBrickOrderFour_up_H
#define TwentySevenNodeBrickOrderFour_up_H

#undef BRICK_TYPE
#define BRICK_TYPE TwentySevenNodeBrickOrderFour_up

#undef BRICK_ELEMENT_NAME
#define BRICK_ELEMENT_NAME "TwentySevenNodeBrickOrderFour_up"
