...
#ifndef TwentySevenNodeBrickOrderTwo_up_H
#define TwentySevenNodeBrickOrderTwo_up_H

#undef BRICK_TYPE
#define BRICK_TYPE TwentySevenNodeBrickOrderTwo_up

#undef BRICK_ELEMENT_NAME
#define BRICK_ELEMENT_NAME "TwentySevenNodeBrickOrderTwo_up"
