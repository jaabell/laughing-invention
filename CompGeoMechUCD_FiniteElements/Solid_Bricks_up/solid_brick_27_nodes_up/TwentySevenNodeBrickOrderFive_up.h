...
#ifndef TwentySevenNodeBrickOrderFive_up_H
#define TwentySevenNodeBrickOrderFive_up_H

#undef BRICK_TYPE
#define BRICK_TYPE TwentySevenNodeBrickOrderFive_up

#undef BRICK_ELEMENT_NAME
#define BRICK_ELEMENT_NAME "TwentySevenNodeBrickOrderFive_up"
