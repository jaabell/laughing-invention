...
///////////////////////////////////////////////////////////////////////////////
// UPDATE HISTORY:    Based on the EightNodeBrick element with the option
//                    choosing the number of Gauss points for the element
//
///////////////////////////////////////////////////////////////////////////////


#ifndef EightNodeBrickVariableGP_H
#define EightNodeBrickVariableGP_H
...
class EightNodeBrickVariableGP: public Element
{

public:
    EightNodeBrickVariableGP(int element_number, int number_of_gauss_points_in_each_direction,
...
public:
    ...
    EightNodeBrickVariableGP &operator[](int subscript);
