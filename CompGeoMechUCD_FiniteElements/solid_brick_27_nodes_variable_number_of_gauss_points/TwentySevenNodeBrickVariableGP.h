...
#ifndef TwentySevenNodeBrickVariableGP_H
#define TwentySevenNodeBrickVariableGP_H
...
class TwentySevenNodeBrickVariableGP: public Element
{

    public:
        TwentySevenNodeBrickVariableGP(int element_number, int number_of_gauss_points_in_each_direction,
        ...
        TwentySevenNodeBrickVariableGP ();
        ~TwentySevenNodeBrickVariableGP();
    ...
    public:
        ...
        TwentySevenNodeBrickVariableGP &operator[](int subscript);
