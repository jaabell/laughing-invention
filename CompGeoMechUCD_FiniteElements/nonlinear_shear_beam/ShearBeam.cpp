...
#ifndef ShearBeam_CPP
#define ShearBeam_CPP
...
DTensor2 ShearBeam::gp_coords(1, 3, 0.0);
DTensor1 ShearBeam::gp_weight(1, 0.0);
vector<float> ShearBeam::Gauss_Output_Vector(18);

// Matrix ShearBeam::K( 6, 6);
// Matrix ShearBeam::M( 6, 6);

// Vector ShearBeam::P( 6 );

ShearBeam::ShearBeam( int element_number,
                          int node_numb_1, int node_numb_2, double area,
                          NDMaterialLT *Globalmmodel)
    : Element( element_number, ELE_TAG_ShearBeam ),
...
//====================================================================
ShearBeam::ShearBeam(): Element( 0, ELE_TAG_ShearBeam ),
...
void ShearBeam::computeGaussPoint()
{
    ...
    {
        cerr << "ShearBeam::computeGaussPoint() Warning!! ShearBeam with tag " << getTag() << " is not vertical! \n\n";
    }
...
//=============================================================================
int ShearBeam::getNumExternalNodes () const
{
    return 2;
}
...
//=============================================================================
const ID &ShearBeam::getExternalNodes ()
{
    return connectedExternalNodes;
}

Node **
ShearBeam::getNodePtrs( void )
{
    return theNodes;
}

//=============================================================================
int ShearBeam::getNumDOF ()
{
    return 6;
}

//=============================================================================
void ShearBeam::setDomain ( Domain *theDomain )
{
...
# endif
        ...
        {
            cerr << "FATAL ERROR ShearBeam (tag: " << this->getTag() << "), node not found in domain\n";
            exit( -1 );
        }
        ...
        {
            cerr << "FATAL ERROR ShearBeam (tag: " << this->getTag() << "), has differing number of DOFs at its nodes\n";
            exit( -1 );
        }
...
int ShearBeam::commitState ()
{
    ...
    {
        cerr << "ShearBeam::commitState () - failed in base class";
    }
...
//=============================================================================
int ShearBeam::revertToLastCommit ()
{
    int retVal = 0;
...
//=============================================================================
const Matrix &ShearBeam::getTangentStiff()
{
...
//=============================================================================
const Matrix &ShearBeam::getInitialStiff ()
{
    ...
    if ( Ki == 0 )
    {
        cerr << "FATAL ShearBeam::getInitialStiff() -";
...
const Matrix &ShearBeam::getMass ()
{
...
//======================================================================
const Vector &ShearBeam::getBodyForce( double loadFactor, const Vector &data )
{
...
//======================================================================
const Vector &ShearBeam::getSurfaceForce( double loadFactor, const Vector &data )
{
...
//=============================================================================
int ShearBeam::addLoad( ElementalLoad *theLoad, double loadFactor )
{
...
//=============================================================================
int ShearBeam::addInertiaLoadToUnbalance( const Vector &accel )
{
    // Check for a quick return
    if ( rho == 0.0 )
    {
    ...
    {
        cerr << "ShearBeam::addInertiaLoadToUnbalance matrix and vector sizes are incompatable\n";
        return -1;
    }
...
//=============================================================================
const Vector ShearBeam::FormEquiBodyForce( void )
{
    Vector bforce( 6 );
...
//=============================================================================
const Vector &ShearBeam::getResistingForce()
{
    //P.Zero();
...
//=============================================================================
const Vector &ShearBeam::getResistingForceIncInertia ()
{
...
int ShearBeam::sendSelf ( int commitTag, Channel &theChannel )
{
    // if ( !initialized )
    // {
    //     //populate();
    ...
    // {
    //     cerr << "WARNING ShearBeam::sendSelf() - " << this->getTag() << " failed to send ID idData\n";
    //     return -1;
    // }
    ...
    // {
    //     cerr << "WARNING ShearBeam::sendSelf() - " << this->getTag() << " failed to send Vector floatData\n";
    //     return -1;
    // }
    ...
    // {
    //     cerr << "WARNING ShearBeam::sendSelf() - " << this->getTag() << " failed to send ID connectedExternalNodes\n";
    //     return -1;
    // }
    ...
    //     {
    //         cerr << "WARNING ShearBeam::sendSelf() - " << this->getTag() << " failed to send material models\n";
    //         return -1;
    //     }
    // }
    ...
    // {
    //     cerr << "WARNING ShearBeam::sendSelf() - " << this->getTag() << " failed to send its Q\n";
    //     return -1;
    // }
    ...
    // {
    //     cerr << "WARNING ShearBeam::sendSelf() - " << this->getTag() << " failed to send its bf\n";
    //     return -1;
    // }
    ...
    // {
    //     cerr << "WARNING ShearBeam::sendSelf() - " << this->getTag() << " failed to send its Gauss point coordinates\n";
    //     return -1;
    // }
    ...
    // {
    //     cerr << "WARNING ShearBeam::sendSelf() - " << this->getTag() << " failed to send its Gauss_Output_Vector\n";
    //     return -1;
    // }
...
int ShearBeam::receiveSelf ( int commitTag, Channel &theChannel, FEM_ObjectBroker &theBroker )
{
    ...
    // {
    //     cerr << "WARNING ShearBeam::receiveSelf() - failed to receive ID\n";
    //     return -1;
    // }
    ...
    // {
    //     cerr << "WARNING ShearBeam::receiveSelf() - " << this->getTag() << " failed to recieve Vector floatData\n";
    //     return -1;
    // }
    // Volume                  = floatData(0) ;
    // e_p                     = floatData(1) ;
    ...
    // {
    //     cerr << "WARNING ShearBeam::receiveSelf() - " << this->getTag() << " failed to recieve ID connectedExternalNodes\n";
    //     return -1;
    // }
    ...
    //         if ( ndmat == 0 )
    //         {
    //             cerr << "ShearBeam::receiveSelf() - Broker could not create NDMaterialLT of class type " << matClassTag << endln;
    //             return -1;
    //         }
    ...
    //         {
    //             cerr << "ShearBeam::receiveSelf() - material " << i << "failed to recv itself\n";
    //             return -1;
    //         }
    ...
    // {
    //     cerr << "ShearBeam::receiveSelf() - failed to recv Q!\n";
    //     return -1;
    // }
    ...
    // {
    //     cerr << "ShearBeam::receiveSelf() - failed to recv bf!\n";
    //     return -1;
    // }
    ...
    // {
    //     cerr << "ShearBeam::receiveSelf() - failed to recv gauss_points!\n";
    //     return -1;
    // }
    ...
    // {
    //     cerr << "ShearBeam::receiveSelf() - failed to recv Gauss_Output_Vector!\n";
    //     return -1;
    // }
...
int ShearBeam::getObjectSize()
{
    cerr << "ShearBeam::getObjectSize() -- Not yet implemented" << endl;
...
//=============================================================================
void ShearBeam::Print( ostream &s, int flag )
{
    // Nothing to do
...
int ShearBeam::update( void )
{
    ...
    {
        cerr << "ShearBeam::update (tag: " << this->getTag() << "), Update Failed\n";
        return -1;
    }
    return 0;
}
...
int
ShearBeam::CheckMesh( ofstream &checkmesh_file )
{
...
//==================================================================================
Vector *
ShearBeam::getStress( void )
{
    cout << "ShearBeam::getStress( void ) got called!\n\n";
...
Matrix &ShearBeam::getGaussCoordinates(void)
{
    return gauss_points;
}
...
***********************************************************************************/
const vector<float> &ShearBeam::getGaussOutput()
{
    formOutput();
    return Gauss_Output_Vector;
}

int ShearBeam::startNewStage()
{
