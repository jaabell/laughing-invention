...
#ifndef TwentyNodeBrickOrderThree_H
#define TwentyNodeBrickOrderThree_H

#undef BRICK_TYPE
#define BRICK_TYPE TwentyNodeBrickOrderThree

#undef BRICK_ELEMENT_NAME
#define BRICK_ELEMENT_NAME "TwentyNodeBrickOrderThree"

#undef NUMBER_NODES
#define NUMBER_NODES 20


#include "../MasterTwentyNodeBrick.h"
