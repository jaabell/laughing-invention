...
#ifndef TwentyNodeBrickOrderOne_H
#define TwentyNodeBrickOrderOne_H

#undef BRICK_TYPE
#define BRICK_TYPE TwentyNodeBrickOrderOne

#undef BRICK_ELEMENT_NAME
#define BRICK_ELEMENT_NAME "TwentyNodeBrickOrderOne"
