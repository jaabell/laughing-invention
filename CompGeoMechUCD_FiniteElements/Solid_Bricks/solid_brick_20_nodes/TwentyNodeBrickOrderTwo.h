...
#ifndef TwentyNodeBrickOrderTwo_H
#define TwentyNodeBrickOrderTwo_H

#undef BRICK_TYPE
#define BRICK_TYPE TwentyNodeBrickOrderTwo

#undef BRICK_ELEMENT_NAME
#define BRICK_ELEMENT_NAME "TwentyNodeBrickOrderTwo"
