...
#ifndef TwentyNodeBrickOrderSix_H
#define TwentyNodeBrickOrderSix_H

#undef BRICK_TYPE
#define BRICK_TYPE TwentyNodeBrickOrderSix

#undef BRICK_ELEMENT_NAME
#define BRICK_ELEMENT_NAME "TwentyNodeBrickOrderSix"
