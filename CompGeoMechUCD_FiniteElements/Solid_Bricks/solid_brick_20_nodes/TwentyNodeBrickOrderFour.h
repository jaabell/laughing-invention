...
#ifndef TwentyNodeBrickOrderFour_H
#define TwentyNodeBrickOrderFour_H

#undef BRICK_TYPE
#define BRICK_TYPE TwentyNodeBrickOrderFour

#undef BRICK_ELEMENT_NAME
#define BRICK_ELEMENT_NAME "TwentyNodeBrickOrderFour"
