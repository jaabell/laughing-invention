...
// This is a Header file that is taken from MasterTwentyNodeBrick.h
...
#define ELE_TAG_BRICK_TYPE  ELE_TAG_TwentyNodeBrickOrderThree

#undef Order
#define Order 3


#include "../MasterTwentyNodeBrick.cpp"
