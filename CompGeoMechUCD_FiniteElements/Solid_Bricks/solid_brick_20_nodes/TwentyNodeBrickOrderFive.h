...
#ifndef TwentyNodeBrickOrderFive_H
#define TwentyNodeBrickOrderFive_H

#undef BRICK_TYPE
#define BRICK_TYPE TwentyNodeBrickOrderFive

#undef BRICK_ELEMENT_NAME
#define BRICK_ELEMENT_NAME "TwentyNodeBrickOrderFive"
