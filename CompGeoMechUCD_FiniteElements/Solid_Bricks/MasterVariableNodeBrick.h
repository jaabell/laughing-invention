...
//
// BRICK_TYPE -> define the element type like "VariableNodeBrick"
// BRICK_ELEMENT_NAME -> Name of the brick in string Eg:- "VariableNodeBrick"
...
public:
    ...
    Vector &Direction_Weight( double Xi , double Eta, Vector coord1, Vector coord2, Vector coord3, Vector coord4,  
                            Vector coord5, Vector coord6, Vector coord7, Vector coord8, Vector coord9, ID Surface_nodeExistence);
    double SurfaceShapeFunctionValues( double Xi , double Eta, int whichcomponent, ID Surface_nodeExistence);
    double SurfaceLoadValues( double Xi , double Eta, Vector Pressure, ID Surface_nodeExistence );
    ...
    const DTensor1 &interp_poli_at( double r1, double r2, double r3 ) const;
