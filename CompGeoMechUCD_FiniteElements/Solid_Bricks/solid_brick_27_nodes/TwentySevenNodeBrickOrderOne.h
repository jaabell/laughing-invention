...
#ifndef TwentySevenNodeBrickOrderOne_H
#define TwentySevenNodeBrickOrderOne_H

#undef BRICK_TYPE
#define BRICK_TYPE TwentySevenNodeBrickOrderOne

#undef BRICK_ELEMENT_NAME
#define BRICK_ELEMENT_NAME "TwentySevenNodeBrickOrderOne"
