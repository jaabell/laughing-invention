...
#ifndef TwentySevenNodeBrickOrderTwo_H
#define TwentySevenNodeBrickOrderTwo_H

#undef BRICK_TYPE
#define BRICK_TYPE TwentySevenNodeBrickOrderTwo

#undef BRICK_ELEMENT_NAME
#define BRICK_ELEMENT_NAME "TwentySevenNodeBrickOrderTwo"
