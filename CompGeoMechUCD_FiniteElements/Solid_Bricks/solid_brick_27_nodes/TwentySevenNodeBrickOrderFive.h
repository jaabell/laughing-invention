...
#ifndef TwentySevenNodeBrickOrderFive_H
#define TwentySevenNodeBrickOrderFive_H

#undef BRICK_TYPE
#define BRICK_TYPE TwentySevenNodeBrickOrderFive

#undef BRICK_ELEMENT_NAME
#define BRICK_ELEMENT_NAME "TwentySevenNodeBrickOrderFive"
