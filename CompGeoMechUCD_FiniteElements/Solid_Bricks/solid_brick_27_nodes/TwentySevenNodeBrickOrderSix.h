...
#ifndef TwentySevenNodeBrickOrderSix_H
#define TwentySevenNodeBrickOrderSix_H

#undef BRICK_TYPE
#define BRICK_TYPE TwentySevenNodeBrickOrderSix

#undef BRICK_ELEMENT_NAME
#define BRICK_ELEMENT_NAME "TwentySevenNodeBrickOrderSix"
