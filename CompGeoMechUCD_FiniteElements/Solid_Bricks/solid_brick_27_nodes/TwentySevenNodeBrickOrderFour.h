...
#ifndef TwentySevenNodeBrickOrderFour_H
#define TwentySevenNodeBrickOrderFour_H

#undef BRICK_TYPE
#define BRICK_TYPE TwentySevenNodeBrickOrderFour

#undef BRICK_ELEMENT_NAME
#define BRICK_ELEMENT_NAME "TwentySevenNodeBrickOrderFour"

#undef NUMBER_NODES
#define NUMBER_NODES 27


#include "../MasterTwentySevenNodeBrick.h"
