...
#ifndef EightNodeBrickOrderFive_H
#define EightNodeBrickOrderFive_H

#undef BRICK_TYPE
#define BRICK_TYPE EightNodeBrickOrderFive

#undef BRICK_ELEMENT_NAME
#define BRICK_ELEMENT_NAME "EightNodeBrickOrderFive"
