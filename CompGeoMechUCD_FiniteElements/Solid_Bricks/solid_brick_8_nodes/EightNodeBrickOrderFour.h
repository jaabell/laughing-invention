...
#ifndef EightNodeBrickOrderFour_H
#define EightNodeBrickOrderFour_H

#undef BRICK_TYPE
#define BRICK_TYPE EightNodeBrickOrderFour

#undef BRICK_ELEMENT_NAME
#define BRICK_ELEMENT_NAME "EightNodeBrickOrderFour"
