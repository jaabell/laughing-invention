...
#ifndef EightNodeBrickOrderSix_H
#define EightNodeBrickOrderSix_H

#undef BRICK_TYPE
#define BRICK_TYPE EightNodeBrickOrderSix

#undef BRICK_ELEMENT_NAME
#define BRICK_ELEMENT_NAME "EightNodeBrickOrderSix"
