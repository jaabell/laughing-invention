...
#ifndef EightNodeBrickOrderOne_H
#define EightNodeBrickOrderOne_H

#undef BRICK_TYPE
#define BRICK_TYPE EightNodeBrickOrderOne

#undef BRICK_ELEMENT_NAME
#define BRICK_ELEMENT_NAME "EightNodeBrickOrderOne"
