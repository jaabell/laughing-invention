...
#ifndef EightNodeBrickOrderThree_H
#define EightNodeBrickOrderThree_H

#undef BRICK_TYPE
#define BRICK_TYPE EightNodeBrickOrderThree

#undef BRICK_ELEMENT_NAME
#define BRICK_ELEMENT_NAME "EightNodeBrickOrderThree"

#undef NUMBER_NODES
#define NUMBER_NODES 8


#include "../MasterEightNodeBrick.h"
