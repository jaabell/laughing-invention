...
#ifndef VariableNodeBrickOrderOne_CPP
#define VariableNodeBrickOrderOne_CPP

#include "VariableNodeBrickOrderOne.h"

#undef  ELE_TAG_BRICK_TYPE
#define ELE_TAG_BRICK_TYPE  ELE_TAG_VariableNodeBrickOrderOne
