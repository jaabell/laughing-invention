...
#ifndef VariableNodeBrickOrderFive_H
#define VariableNodeBrickOrderFive_H

#undef BRICK_TYPE
#define BRICK_TYPE VariableNodeBrickOrderFive

#undef BRICK_ELEMENT_NAME
#define BRICK_ELEMENT_NAME "VariableNodeBrickOrderFive"
