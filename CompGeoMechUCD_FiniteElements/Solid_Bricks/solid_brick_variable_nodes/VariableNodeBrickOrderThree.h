...
#ifndef VariableNodeBrickOrderThree_H
#define VariableNodeBrickOrderThree_H

#undef BRICK_TYPE
#define BRICK_TYPE VariableNodeBrickOrderThree

#undef BRICK_ELEMENT_NAME
#define BRICK_ELEMENT_NAME "VariableNodeBrickOrderThree"

#undef NUMBER_NODES
#define NUMBER_NODES 27


#include "../MasterVariableNodeBrick.h"
