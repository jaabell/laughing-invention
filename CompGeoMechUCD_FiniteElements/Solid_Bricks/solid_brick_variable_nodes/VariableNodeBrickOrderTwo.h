...
#ifndef VariableNodeBrickOrderTwo_H
#define VariableNodeBrickOrderTwo_H

#undef BRICK_TYPE
#define BRICK_TYPE VariableNodeBrickOrderTwo

#undef BRICK_ELEMENT_NAME
#define BRICK_ELEMENT_NAME "VariableNodeBrickOrderTwo"
