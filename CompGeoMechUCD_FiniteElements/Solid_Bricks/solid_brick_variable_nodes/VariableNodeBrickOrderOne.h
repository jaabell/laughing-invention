...
#ifndef VariableNodeBrickOrderOne_H
#define VariableNodeBrickOrderOne_H

#undef BRICK_TYPE
#define BRICK_TYPE VariableNodeBrickOrderOne

#undef BRICK_ELEMENT_NAME
#define BRICK_ELEMENT_NAME "VariableNodeBrickOrderOne"
