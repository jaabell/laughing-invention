...
#ifndef VariableNodeBrickOrderFive_CPP
#define VariableNodeBrickOrderFive_CPP

#include "VariableNodeBrickOrderFive.h"

#undef  ELE_TAG_BRICK_TYPE
#define ELE_TAG_BRICK_TYPE  ELE_TAG_VariableNodeBrickOrderFive
