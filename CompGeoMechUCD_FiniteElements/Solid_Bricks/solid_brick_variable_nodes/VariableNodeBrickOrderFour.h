...
#ifndef VariableNodeBrickOrderFour_H
#define VariableNodeBrickOrderFour_H

#undef BRICK_TYPE
#define BRICK_TYPE VariableNodeBrickOrderFour

#undef BRICK_ELEMENT_NAME
#define BRICK_ELEMENT_NAME "VariableNodeBrickOrderFour"
