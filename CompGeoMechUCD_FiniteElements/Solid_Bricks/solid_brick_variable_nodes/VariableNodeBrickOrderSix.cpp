...
#ifndef VariableNodeBrickOrderSix_CPP
#define VariableNodeBrickOrderSix_CPP

#include "VariableNodeBrickOrderSix.h"

#undef  ELE_TAG_BRICK_TYPE
#define ELE_TAG_BRICK_TYPE  ELE_TAG_VariableNodeBrickOrderSix
