...
#ifndef VariableNodeBrickOrderThree_CPP
#define VariableNodeBrickOrderThree_CPP

#include "VariableNodeBrickOrderThree.h"

#undef  ELE_TAG_BRICK_TYPE
#define ELE_TAG_BRICK_TYPE  ELE_TAG_VariableNodeBrickOrderThree

#undef  Order
#define Order 3


#include "../MasterVariableNodeBrick.cpp"
