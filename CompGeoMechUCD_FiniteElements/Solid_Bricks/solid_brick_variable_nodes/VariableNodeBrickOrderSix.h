...
#ifndef VariableNodeBrickOrderSix_H
#define VariableNodeBrickOrderSix_H

#undef BRICK_TYPE
#define BRICK_TYPE VariableNodeBrickOrderSix

#undef BRICK_ELEMENT_NAME
#define BRICK_ELEMENT_NAME "VariableNodeBrickOrderSix"
