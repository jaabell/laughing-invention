...
#ifndef VariableNodeBrickOrderTwo_CPP
#define VariableNodeBrickOrderTwo_CPP

#include "VariableNodeBrickOrderTwo.h"

#undef  ELE_TAG_BRICK_TYPE
#define ELE_TAG_BRICK_TYPE  ELE_TAG_VariableNodeBrickOrderTwo
