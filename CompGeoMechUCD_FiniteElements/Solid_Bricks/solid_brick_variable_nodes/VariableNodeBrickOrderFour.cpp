...
#ifndef VariableNodeBrickOrderFour_CPP
#define VariableNodeBrickOrderFour_CPP

#include "VariableNodeBrickOrderFour.h"

#undef  ELE_TAG_BRICK_TYPE
#define ELE_TAG_BRICK_TYPE  ELE_TAG_VariableNodeBrickOrderFour
