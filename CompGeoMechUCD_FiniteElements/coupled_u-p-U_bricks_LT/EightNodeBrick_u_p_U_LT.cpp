...
#ifndef EightNodeBrick_u_p_U_LT_CPP
#define EightNodeBrick_u_p_U_LT_CPP

#include <EightNodeBrick_u_p_U_LT.h>
#include <iostream>
using namespace std;


const int EightNodeBrick_u_p_U_LT::Num_IntegrationPts = 2;
const int EightNodeBrick_u_p_U_LT::Num_TotalGaussPts = 8;
const int EightNodeBrick_u_p_U_LT::Num_Nodes = 8;
const int EightNodeBrick_u_p_U_LT::Num_Dim = 3;
const int EightNodeBrick_u_p_U_LT::Num_Dof = 7;
const int EightNodeBrick_u_p_U_LT::Num_ElemDof = 56;
const double EightNodeBrick_u_p_U_LT::pts[2] = { -0.577350269189626, +0.577350269189626};
...
EightNodeBrick_u_p_U_LT::EightNodeBrick_u_p_U_LT(int element_number,
    ...
    : Element(element_number,
              ELE_TAG_EightNodeBrick_u_p_U_LT ),
      ...
      Ki(0), gauss_points(8, 3), outputVector(EightNodeBrick_u_p_U_LT_OUTPUT_SIZE)
{
    ...
    {
        cerr << " Error, EightNodeBrick_u_p_U_LT:: permeability (kx/ky/kz) is zero! \n";
        exit(-1);
    }
    ...
    if (theMaterial == 0)
    {
        cerr << " EightNodeBrick_u_p_U_LT::EightNodeBrick_u_p_U_LT -- failed allocate material model pointer\n";
        exit(-1);
    }
...
//======================================================================
int EightNodeBrick_u_p_U_LT::getNumExternalNodes (void) const
{
    return Num_Nodes;
}

//======================================================================
const ID &EightNodeBrick_u_p_U_LT::getExternalNodes (void)
{
    return connectedExternalNodes;
}

//======================================================================
Node **EightNodeBrick_u_p_U_LT::getNodePtrs (void)
{
    return theNodes;
}

//======================================================================
int EightNodeBrick_u_p_U_LT::getNumDOF (void)
{
    return Num_ElemDof;
}

//======================================================================
void EightNodeBrick_u_p_U_LT::setDomain (Domain *theDomain)
{
    int i, Ndof;
    ...
    for (i = 0; i < Num_Nodes; i++)
    {
        ...
        if (theNodes[i] == 0)
        {
            cerr << "Error EightNodeBrick_u_p_U_LT : node not found in the domain" << "\n";
            return ;
        }
        ...
        if ( Ndof != Num_Dof)
        {
            cerr << "Error EightNodeBrick_u_p_U_LT : has wrong number of DOFs at its nodes" << "\n";
            return ;
        }
    }
...
//======================================================================
int EightNodeBrick_u_p_U_LT::commitState (void)
{
    int retVal = 0;
    int i;
...
//======================================================================
int EightNodeBrick_u_p_U_LT::revertToLastCommit (void)
{
    int retVal = 0;
    int i;
...
//======================================================================
int EightNodeBrick_u_p_U_LT::revertToStart (void)
{
    int retVal = 0;
    int i;
...
//======================================================================
const Matrix &EightNodeBrick_u_p_U_LT::getTangentStiff (void)
{
    return this->getStiff(1);
}

//======================================================================
const Matrix &EightNodeBrick_u_p_U_LT::getInitialStiff (void)
{
    return this->getStiff(0);
}

//======================================================================
const Matrix &EightNodeBrick_u_p_U_LT::getDamp (void)
{
    MCK.Zero();  // necessary
...
# ifdef _DEBUG_PRINT_
    // PRINTING
    // PRINTING      tC.print("tc","tc in const Matrix& EightNodeBrick_u_p_U_LT::getDamp (void) ");
#endif
    int i, j, m, n;
    ...
    if (a0 != 0.0)
# ifdef _DEBUG_PRINT_
        // PRINTING     fprintf(stdout,"      CRm = getMassTensorMsf(); in const Matrix& EightNodeBrick_u_p_U_LT::getDamp (void) ");
#endif
...
//======================================================================
const Matrix &EightNodeBrick_u_p_U_LT::getMass (void)
{
    MCK.Zero();  // necessary

    // PRINTING     fprintf(stdout,"        tensor tM = getMassTensorMsf();  in   const Matrix& EightNodeBrick_u_p_U_LT::getMass (void)");
...
# ifdef _DEBUG_PRINT_
    // PRINTING  // PRINTING
    fprintf(stderr, "MCK in const Matrix& EightNodeBrick_u_p_U_LT::getMass (void) \n");
...
//======================================================================
void EightNodeBrick_u_p_U_LT::zeroLoad()
{
    if ( Q != 0 )
    {
        Q->Zero();
...
//======================================================================
int EightNodeBrick_u_p_U_LT::addLoad(ElementalLoad *theLoad, double loadFactor)
{
    int type;
    ...
    {
        cerr << "EightNodeBrick_u_p_U_LT::addLoad() " << this->getTag() << ", load type unknown\n";
        return -1;
    }
...
//======================================================================
int EightNodeBrick_u_p_U_LT::addInertiaLoadToUnbalance(const Vector &accel)
{
    ...
    for (i = 0; i < Num_Nodes; i++)
    {
        ...
        if ( RA.Size() != Num_Dof )
        {
            cerr << "EightNodeBrick_u_p_U_LT::addInertiaLoadToUnbalance matrix and vector sizes are incompatable\n";
            return (-1);
        }
...
//========================================================================
const Vector &EightNodeBrick_u_p_U_LT::getResistingForce ()
{
    static Vector avu(Num_ElemDof);
...
//========================================================================
const Vector &EightNodeBrick_u_p_U_LT::getResistingForceIncInertia ()
{
    static Vector avu(Num_ElemDof);
...
//=============================================================================
int EightNodeBrick_u_p_U_LT::sendSelf (int commitTag, Channel &theChannel)
{
    // Not implemented yet
    return 0;
}
...
//=============================================================================
int EightNodeBrick_u_p_U_LT::receiveSelf (int commitTag, Channel &theChannel, FEM_ObjectBroker &theBroker)
{
    // Not implemented yet
    return 0;
}
...
//=============================================================================
int EightNodeBrick_u_p_U_LT::displaySelf (Renderer &theViewer, int displayMode, float fact)
{
    // Not implemented yet
    return 0;
}
...
//=============================================================================
void EightNodeBrick_u_p_U_LT::Print(ostream &s, int flag)
{
    s << "EightNodeBrick_u_p_U_LT, element id:  " << this->getTag() << "\n";
...
//======================================================================
int EightNodeBrick_u_p_U_LT::update()
{
    int ret = 0;
    ...
    for ( GP_c_r = 0 ; GP_c_r < Num_IntegrationPts; GP_c_r++ )
    {
        ...
        for ( GP_c_s = 0 ; GP_c_s < Num_IntegrationPts; GP_c_s++ )
        {
            ...
            for ( GP_c_t = 0 ; GP_c_t < Num_IntegrationPts; GP_c_t++ )
            {
                ...
                {
                    cerr << "EightNodeBrick_u_p_U_LT::update (tag: " << this->getTag() << "), not converged\n";
                }
            }
        }
    }
...
//======================================================================
const Vector &EightNodeBrick_u_p_U_LT::getInternalForce ()
{
...
//======================================================================
const Vector &EightNodeBrick_u_p_U_LT::getBodyForce(const Vector &data)
{
    static Vector Pforce(Num_ElemDof);
...
# ifdef _DEBUG_PRINT_
    // PRINTING       // PRINTING
    fprintf(stderr, "Pforce in const Vector& EightNodeBrick_u_p_U_LT::getAccelerationField ()\n");
...
//======================================================================
const Matrix &EightNodeBrick_u_p_U_LT::getStiff00 (void)
{
    MCK.Zero();  // necessary
    ...
    if (ks == 0.0 || kf == 0.0)
    {
        cerr << " Error, EightNodeBrick_u_p_U_LT::getStiffnessTensorP -- solid and/or fluid bulk modulus is zero\n";
        exit(-1);
    }

    double  oneOverQ = poro / kf + (alpha - poro) / ks;

    // PRINTING    fprintf(stdout,"    tensor tP = getMassTensorMsf();     in  const Matrix& EightNodeBrick_u_p_U_LT::getStiff00 (void)  ");
...
# ifdef _DEBUG_PRINT_
    // PRINTING  // PRINTING
    fprintf(stderr, "MCK in const Matrix& EightNodeBrick_u_p_U_LT::getStiff00 (void) \n");
...
//======================================================================
const Matrix &EightNodeBrick_u_p_U_LT::getStiff (int Ki_flag)
{
    if (Ki_flag != 0 && Ki_flag != 1)
    {
        cerr << "Error EightNodeBrick_u_p_U_LT::getStiff() - illegal use\n";
        exit(-1);
    }
    ...
    if (Ki == 0)
    {
        cerr << "Error EightNodeBrick_u_p_U_LT::getStiff() -";
...
//======================================================================
tensor EightNodeBrick_u_p_U_LT::getStiffnessTensorKep( )
{
...
//======================================================================
tensor EightNodeBrick_u_p_U_LT::getStiffnessTensorG12()
{
...
//======================================================================
tensor EightNodeBrick_u_p_U_LT::getDampTensorC123()
{
...
//======================================================================
tensor EightNodeBrick_u_p_U_LT::getMassTensorMsf()
{
...
# ifdef _DEBUG_PRINT_
    // PRINTING // PRINTING     // PRINTING
    Msf.print("Msf", "\n Msf tensor from tensor EightNodeBrick_u_p_U_LT::getMassTensorMsf()");
    // PRINTING     getchar();
    // PRINTING
#endif
...
//======================================================================
tensor EightNodeBrick_u_p_U_LT::Jacobian_3D(double x, double y, double z)
{
...
//======================================================================
tensor EightNodeBrick_u_p_U_LT::Jacobian_3Dinv(double x, double y, double z)
{
...
//======================================================================
tensor EightNodeBrick_u_p_U_LT::dh_Global(double x, double y, double z)
{
...
//======================================================================
tensor EightNodeBrick_u_p_U_LT::getNodesCrds(void)
{
    int i, j;
...
//======================================================================
tensor EightNodeBrick_u_p_U_LT::getNodesDisp(void)
{
    int i, j;
...
//======================================================================
double EightNodeBrick_u_p_U_LT::getPorePressure(double x1, double x2, double x3)
{
    double pp = 0.0;
...
//======================================================================
tensor EightNodeBrick_u_p_U_LT::shapeFunction(double r1, double r2, double r3)
{
    int Hfun[] = {Num_Nodes};
    tensor h(1, Hfun, 0.0);
...
//==============================================================
tensor EightNodeBrick_u_p_U_LT::shapeFunctionDerivative(double r1, double r2, double r3)
{
...
//==============================================================
tensor EightNodeBrick_u_p_U_LT::getGaussPts(void)
{
...
const Matrix &EightNodeBrick_u_p_U_LT::getTangent( int gaussNum )
{
...
//==================================================================================
Vector *
EightNodeBrick_u_p_U_LT::getStress(void)
{
...
Matrix &EightNodeBrick_u_p_U_LT::getGaussCoordinates(void)
{
    return gauss_points;
}
