...
#ifndef TwentySevenNodeBrick_upU_LT_Elastic_H
#define TwentySevenNodeBrick_upU_LT_Elastic_H
...
class TwentySevenNodeBrick_upU_LT_Elastic: public TwentySevenNodeBrick_upU_LT
{

public:
    TwentySevenNodeBrick_upU_LT_Elastic( int element_number,
    ...
    TwentySevenNodeBrick_upU_LT_Elastic ();

    const Matrix &getTangentStiff ();
    
    std::string getElementName() const
    {
        return "TwentySevenNodeBrick_upU_LT_Elastic";
    }
};
