...
/////////////////////////////////////////////////////////////////////////////////////
// Adapted by Sumeet, for TwentyNodeBrickOrderSix to use the LTensor library for
// tensorial representation. [September, 2016]
/////////////////////////////////////////////////////////////////////////////////////


#ifndef TwentyNodeBrickOrderSix_CPP
#define TwentyNodeBrickOrderSix_CPP

#include "TwentyNodeBrickOrderSix.h"
...
DTensor2 TwentyNodeBrickOrderSix::gp_coords(Num_TotalGaussPts, 3, 0.0);
DTensor2 TwentyNodeBrickOrderSix::gp_weight(Num_TotalGaussPts, 3, 0.0);
Matrix TwentyNodeBrickOrderSix::gauss_points(Num_TotalGaussPts, 3);
vector<float> TwentyNodeBrickOrderSix::Gauss_Output_Vector(Num_TotalGaussPts*18);

Matrix TwentyNodeBrickOrderSix::K(60, 60);

Vector TwentyNodeBrickOrderSix::ShapeFunctionValues_in_function(8); // Nima added for surface load (July 2012)
Vector TwentyNodeBrickOrderSix::J_vector_in_function(3);            // Nima added for surface load (July 2012)
double TwentyNodeBrickOrderSix::SurfaceLoadValues_in_function;

//====================================================================
// Constructor
//====================================================================
TwentyNodeBrickOrderSix::TwentyNodeBrickOrderSix(int element_number,
    ...
    : Element(element_number, ELE_TAG_TwentyNodeBrickOrderSix ),
      ...
      M( 60, 60), P( 60 )
{
    ...
    if (material_array == 0)
    {
        cerr << " TwentyNodeBrickOrderSix::TwentyNodeBrickOrderSix -- failed allocate material model pointer\n";
        exit(-1);
    }
...
//====================================================================
TwentyNodeBrickOrderSix::TwentyNodeBrickOrderSix (): Element(0, ELE_TAG_TwentyNodeBrickOrderSix ),
    rho(0.0), connectedExternalNodes(20),
    Ki(0), mmodel(0), Q(60),
    bf(3), M( 60, 60), P( 60 )
{
...
/////////////////////////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////////////////
TwentyNodeBrickOrderSix::~TwentyNodeBrickOrderSix ()
{
...
//#############################################################################
//***************************************************************
const DTensor2 &TwentyNodeBrickOrderSix::H_3D(double r1, double r2, double r3) const
{
...
//#############################################################################
//***************************************************************
const DTensor1 &TwentyNodeBrickOrderSix::interp_poli_at(double r1, double r2, double r3) const
{
...
const DTensor2 &TwentyNodeBrickOrderSix::dh_drst_at(double r1, double r2, double r3) const
{
...
////#############################################################################
const DTensor2 &TwentyNodeBrickOrderSix::Jacobian_3D( const DTensor2 &dh) const
{
...
//#############################################################################
const DTensor2 &TwentyNodeBrickOrderSix::Jacobian_3Dinv(const DTensor2 &dh) const
{
    const DTensor2 &N_C = Nodal_Coordinates();
...
////#############################################################################
const DTensor2 &TwentyNodeBrickOrderSix::Nodal_Coordinates(void) const
{
...
////#############################################################################
const DTensor2 &TwentyNodeBrickOrderSix::incr_disp(void) const
{
...
////#############################################################################
const DTensor2 &TwentyNodeBrickOrderSix::total_disp(void) const
{
...
////#############################################################################
int TwentyNodeBrickOrderSix::get_global_number_of_node(int local_node_number)
{
    return connectedExternalNodes(local_node_number);
}

////#############################################################################
int  TwentyNodeBrickOrderSix::get_Brick_Number(void)
{
    return this->getTag();
}
...
const DTensor2 &TwentyNodeBrickOrderSix::nodal_forces(void) const
{
    double r  = 0.0;
    double w_r = 0.0;
    double s  = 0.0;
...
void TwentyNodeBrickOrderSix::computeGaussPoint(void)
{
...
//=============================================================================
int TwentyNodeBrickOrderSix::getNumExternalNodes () const
{
...
//=============================================================================
const ID &TwentyNodeBrickOrderSix::getExternalNodes ()
{
    return connectedExternalNodes;
}

Node **
TwentyNodeBrickOrderSix::getNodePtrs(void)
{
    return theNodes;
}

//=============================================================================
int TwentyNodeBrickOrderSix::getNumDOF ()
{
    return 3 * nodes_in_brick;
}

//=============================================================================
void TwentyNodeBrickOrderSix::setDomain (Domain *theDomain)
{
...
# endif
                ...
                theNodes[16] == 0 || theNodes[17] == 0 || theNodes[18] == 0 || theNodes[19] == 0 )
        {
            ...
            cerr << "FATAL ERROR TwentyNodeBrickOrderSix (tag: " << this->getTag() << " ), node not found in domain\n";
            exit(-1);
        }
        ...
        {
            cerr << "FATAL ERROR TwentyNodeBrickOrderSix (tag: " << this->getTag() <<
...
//=============================================================================
int TwentyNodeBrickOrderSix::commitState ()
{
    int retVal = 0;
    ...
    {
        cerr << "TwentyNodeBrickOrderSix::commitState () - failed in base class";
    }
...
//=============================================================================
int TwentyNodeBrickOrderSix::revertToLastCommit ()
{
    int retVal = 0;
...
//=============================================================================
int TwentyNodeBrickOrderSix::revertToStart ()
{
    int retVal = 0;
...
//=============================================================================
const Matrix &TwentyNodeBrickOrderSix::getTangentStiff ()
{
...
//=============================================================================
const Matrix &TwentyNodeBrickOrderSix::getInitialStiff ()
{
    if ( Ki == 0 )
    {
    ...
    if ( Ki == 0 )
    {
        cerr << "FATAL TwentyNodeBrickOrderSix::getInitialStiff() -";
...
////#############################################################################
//  tensor TwentyNodeBrickOrderSix::mass_tensor(Elastic  mmodel)
const Matrix &TwentyNodeBrickOrderSix::getMass()
{
...
//=============================================================================
void TwentyNodeBrickOrderSix::zeroLoad(void)
{
    Q.Zero();
}
...
//======================================================================
const Vector &TwentyNodeBrickOrderSix::getBodyForce(double loadFactor, const Vector &data)
{
...
//======================================================================
const Vector &TwentyNodeBrickOrderSix::getSurfaceForce(double loadFactor, const Vector &data)
{
...
//=============================================================================
int TwentyNodeBrickOrderSix::addLoad(ElementalLoad *theLoad, double loadFactor)
{
    ...
    {
        cerr << "TwentyNodeBrickOrderSix::addLoad() - 20NodeBrick " << this->getTag() << ",load type " << type << "unknown\n";
        return -1;
    }
...
//=============================================================================
int TwentyNodeBrickOrderSix::addInertiaLoadToUnbalance(const Vector &accel)
{
    // Check for a quick return
    if (rho == 0.0)
    {
            ...
            3 != Raccel17.Size() || 3 != Raccel18.Size() || 3 != Raccel19.Size() || 3 != Raccel20.Size()   )
    {
        ...
        cerr << "TwentyNodeBrickOrderSix::addInertiaLoadToUnbalance " <<
...
//=============================================================================
const Vector TwentyNodeBrickOrderSix::FormEquiBodyForce(const Vector &data)
{
    Vector bforce(60);
...
//=============================================================================
const Vector &TwentyNodeBrickOrderSix::getResistingForce ()
{
...
//=============================================================================
const Vector &TwentyNodeBrickOrderSix::getResistingForceIncInertia ()
{
...
//=============================================================================
int TwentyNodeBrickOrderSix::sendSelf (int commitTag, Channel &theChannel)
{
    ID idData(3);
    ...
    {
        cerr << "WARNING TwentyNodeBrickOrderSix::sendSelf() - " << this->getTag() << " failed to send ID idData\n";
        return -1;
    }
    ...
    if(idData( 2 )==1){
        ...
        {
            cerr << "WARNING TwentyNodeBrickOrderSix::sendSelf() - " << this->getTag() << " failed to send its K\n";
            return -1;
        }
    }
    ...
    {
        cerr << "WARNING TwentyNodeBrickOrderSix::sendSelf() - " << this->getTag() << " failed to send Vector floatData\n";
        return -1;
    }
    ...
    {
        cerr << "WARNING TwentyNodeBrickOrderSix::sendSelf() - " << this->getTag() << " failed to send String stiffness_type\n";
        return -1;
    }
    ...
    {
        cerr << "WARNING TwentyNodeBrickOrderSix::sendSelf() - " << this->getTag() << " failed to send String damping_type\n";
        return -1;
    }
    ...
    {
        cerr << "WARNING TwentyNodeBrickOrderSix::sendSelf() - " << this->getTag() << " failed to send ID connectedExternalNodes\n";
        return -1;
    }
    ...
    for ( int i = 0; i < Num_TotalGaussPts; i++ )
    {
        ...
        {
            cerr << "WARNING TwentyNodeBrickOrderSix::sendSelf() - " << this->getTag() << " failed to send material models\n";
            return -1;
        }
    }
    ...
    {
        cerr << "WARNING TwentyNodeBrickOrderSix::sendSelf() - " << this->getTag() << " failed to send its Q\n";
        return -1;
    }
    ...
    {
        cerr << "WARNING TwentyNodeBrickOrderSix::sendSelf() - " << this->getTag() << " failed to send its bf\n";
        return -1;
    }
...
//=============================================================================
int TwentyNodeBrickOrderSix::receiveSelf (int commitTag, Channel &theChannel, FEM_ObjectBroker &theBroker)
{
    ID idData( 3 );

    if ( theChannel.receiveID( 0, commitTag, idData ) < 0 )
    {
        cerr << "WARNING TwentyNodeBrickOrderSix::receiveSelf() - failed to receive ID\n";
        return -1;
    }
    ...
    if(idData(2)){
        if ( theChannel.sendMatrix( 0, commitTag, K ) < 0 )
        {
            cerr << "WARNING TwentyNodeBrickOrderSix::receiveSelf() - " << this->getTag() << " failed to recieve its K\n";
            return -1;
        }
    }
    ...
    {
        cerr << "WARNING TwentyNodeBrickOrderSix::receiveSelf() - " << this->getTag() << " failed to recieve Vector floatData\n";
        return -1;
    }
    Volume                  = floatData(0) ;
    ...
    {
        cerr << "WARNING TwentyNodeBrickOrderSix::receiveSelf() - " << this->getTag() << " failed to recieve String stiffness_type\n";
        return -1;
    }
    ...
    if ( theChannel.receiveString( 0, commitTag, tmp_string ) < 0 )
    {
        cerr << "WARNING TwentyNodeBrickOrderSix::receiveSelf() - " << this->getTag() << " failed to recieve String damping_type\n";
        return -1;
    }
    ...
    {
        cerr << "WARNING TwentyNodeBrickOrderSix::receiveSelf() - " << this->getTag() << " failed to recieve ID connectedExternalNodes\n";
        return -1;
    }

    // cout << "TwentyNodeBrickOrderSix::receiveSelf() connectedExternalNodes = " << connectedExternalNodes << "\n";
    ...
    for ( int i = 0; i < Num_TotalGaussPts; i++ )
    {
        ...
        if ( ndmat == 0 )
        {
            cerr << "TwentyNodeBrickOrderSix::receiveSelf() - Broker could not create NDMaterialLT of class type " << matClassTag << "\n";
            return -1;
        }
        ...
        {
            cerr << "TwentyNodeBrickOrderSix::receiveSelf() - material " << i << "failed to recv itself\n";
            return -1;
        }
    ...
    {
        cerr << "TwentyNodeBrickOrderSix::receiveSelf() - failed to recv Q!\n";
        return -1;
    }
    ...
    {
        cerr << "TwentyNodeBrickOrderSix::receiveSelf() - failed to recv bf!\n";
        return -1;
    }
...
int TwentyNodeBrickOrderSix::getObjectSize()
{
...
//=============================================================================
void TwentyNodeBrickOrderSix::Print(ostream &s, int flag)
{
    cout << "TwentyNodeBrickOrderSix: LTensor-based 27 node brick." << endl << endl;
...
void TwentyNodeBrickOrderSix::ComputeVolume()
{
    Volume = 0.0;
...
int TwentyNodeBrickOrderSix::update() //Added by Guanzhou, May 7 2004
{
    double r  = 0.0;
    double s  = 0.0;
    double t  = 0.0;
    ...
    for ( short gp = 0; gp < Num_TotalGaussPts; gp++ )
    {
        ...
        {
            cerr << "TwentyNodeBrickOrderSix::update (tag: " << this->getTag() << "), Update Failed\n";
        }
    }
...
double  TwentyNodeBrickOrderSix::SurfaceShapeFunctionValues(double Xi , double Eta, int whichcomponent)
{
...
Vector &TwentyNodeBrickOrderSix::Direction_Weight(double Xi , double Eta,
...
double TwentyNodeBrickOrderSix::SurfaceLoadValues(double Xi , double Eta, Vector Pressure)
{
...
int
TwentyNodeBrickOrderSix::CheckMesh(ofstream &checkmesh_file)
{
    double r  = 0.0;
    double s  = 0.0;
    double t  = 0.0;
...
Vector *
TwentyNodeBrickOrderSix::getStress( void )
{
...
Matrix &TwentyNodeBrickOrderSix::getGaussCoordinates(void)
{
    computeGaussPoint();
    return gauss_points;
}
...
Matrix &TwentyNodeBrickOrderSix::get_Gauss_p_c( )
{
...
Matrix &TwentyNodeBrickOrderSix::get_Gauss_p_w()
{
...
***********************************************************************************/
const vector<float> &TwentyNodeBrickOrderSix::getGaussOutput()
{
    DTensor2 stress(3, 3);
    DTensor2 strain(3, 3);
...
void TwentyNodeBrickOrderSix::zeroStrain()
{
    for (int gp = 0; gp < Num_TotalGaussPts; gp++)
    {
