...
/////////////////////////////////////////////////////////////////////////////////////
// Adapted by Sumeet, for TwentyNodeBrickOrderOne to use the LTensor library for
// tensorial representation. [September, 2016]
/////////////////////////////////////////////////////////////////////////////////////


#ifndef TwentyNodeBrickOrderOne_CPP
#define TwentyNodeBrickOrderOne_CPP

#include "TwentyNodeBrickOrderOne.h"
...
DTensor2 TwentyNodeBrickOrderOne::gp_coords(Num_TotalGaussPts, 3, 0.0);
DTensor2 TwentyNodeBrickOrderOne::gp_weight(Num_TotalGaussPts, 3, 0.0);
Matrix TwentyNodeBrickOrderOne::gauss_points(Num_TotalGaussPts, 3);
vector<float> TwentyNodeBrickOrderOne::Gauss_Output_Vector(Num_TotalGaussPts*18);

Matrix TwentyNodeBrickOrderOne::K(60, 60);

Vector TwentyNodeBrickOrderOne::ShapeFunctionValues_in_function(8); // Nima added for surface load (July 2012)
Vector TwentyNodeBrickOrderOne::J_vector_in_function(3);            // Nima added for surface load (July 2012)
double TwentyNodeBrickOrderOne::SurfaceLoadValues_in_function;

//====================================================================
// Constructor
//====================================================================
TwentyNodeBrickOrderOne::TwentyNodeBrickOrderOne(int element_number,
    ...
    : Element(element_number, ELE_TAG_TwentyNodeBrickOrderOne ),
      ...
      M( 60, 60), P( 60 )
{
    ...
    if (material_array == 0)
    {
        cerr << " TwentyNodeBrickOrderOne::TwentyNodeBrickOrderOne -- failed allocate material model pointer\n";
        exit(-1);
    }
...
//====================================================================
TwentyNodeBrickOrderOne::TwentyNodeBrickOrderOne (): Element(0, ELE_TAG_TwentyNodeBrickOrderOne ),
    rho(0.0), connectedExternalNodes(20),
    Ki(0), mmodel(0), Q(60),
    bf(3), M( 60, 60), P( 60 )
{
...
/////////////////////////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////////////////
TwentyNodeBrickOrderOne::~TwentyNodeBrickOrderOne ()
{
...
//#############################################################################
//***************************************************************
const DTensor2 &TwentyNodeBrickOrderOne::H_3D(double r1, double r2, double r3) const
{
...
//#############################################################################
//***************************************************************
const DTensor1 &TwentyNodeBrickOrderOne::interp_poli_at(double r1, double r2, double r3) const
{
...
const DTensor2 &TwentyNodeBrickOrderOne::dh_drst_at(double r1, double r2, double r3) const
{
...
////#############################################################################
const DTensor2 &TwentyNodeBrickOrderOne::Jacobian_3D( const DTensor2 &dh) const
{
...
//#############################################################################
const DTensor2 &TwentyNodeBrickOrderOne::Jacobian_3Dinv(const DTensor2 &dh) const
{
    const DTensor2 &N_C = Nodal_Coordinates();
...
////#############################################################################
const DTensor2 &TwentyNodeBrickOrderOne::Nodal_Coordinates(void) const
{
...
////#############################################################################
const DTensor2 &TwentyNodeBrickOrderOne::incr_disp(void) const
{
...
////#############################################################################
const DTensor2 &TwentyNodeBrickOrderOne::total_disp(void) const
{
...
////#############################################################################
int TwentyNodeBrickOrderOne::get_global_number_of_node(int local_node_number)
{
    return connectedExternalNodes(local_node_number);
}

////#############################################################################
int  TwentyNodeBrickOrderOne::get_Brick_Number(void)
{
    return this->getTag();
}
...
const DTensor2 &TwentyNodeBrickOrderOne::nodal_forces(void) const
{
    double r  = 0.0;
    double w_r = 0.0;
    double s  = 0.0;
...
void TwentyNodeBrickOrderOne::computeGaussPoint(void)
{
...
//=============================================================================
int TwentyNodeBrickOrderOne::getNumExternalNodes () const
{
...
//=============================================================================
const ID &TwentyNodeBrickOrderOne::getExternalNodes ()
{
    return connectedExternalNodes;
}

Node **
TwentyNodeBrickOrderOne::getNodePtrs(void)
{
    return theNodes;
}

//=============================================================================
int TwentyNodeBrickOrderOne::getNumDOF ()
{
    return 3 * nodes_in_brick;
}

//=============================================================================
void TwentyNodeBrickOrderOne::setDomain (Domain *theDomain)
{
...
# endif
                ...
                theNodes[16] == 0 || theNodes[17] == 0 || theNodes[18] == 0 || theNodes[19] == 0 )
        {
            ...
            cerr << "FATAL ERROR TwentyNodeBrickOrderOne (tag: " << this->getTag() << " ), node not found in domain\n";
            exit(-1);
        }
        ...
        {
            cerr << "FATAL ERROR TwentyNodeBrickOrderOne (tag: " << this->getTag() <<
...
//=============================================================================
int TwentyNodeBrickOrderOne::commitState ()
{
    int retVal = 0;
    ...
    {
        cerr << "TwentyNodeBrickOrderOne::commitState () - failed in base class";
    }
...
//=============================================================================
int TwentyNodeBrickOrderOne::revertToLastCommit ()
{
    int retVal = 0;
...
//=============================================================================
int TwentyNodeBrickOrderOne::revertToStart ()
{
    int retVal = 0;
...
//=============================================================================
const Matrix &TwentyNodeBrickOrderOne::getTangentStiff ()
{
...
//=============================================================================
const Matrix &TwentyNodeBrickOrderOne::getInitialStiff ()
{
    if ( Ki == 0 )
    {
    ...
    if ( Ki == 0 )
    {
        cerr << "FATAL TwentyNodeBrickOrderOne::getInitialStiff() -";
...
////#############################################################################
//  tensor TwentyNodeBrickOrderOne::mass_tensor(Elastic  mmodel)
const Matrix &TwentyNodeBrickOrderOne::getMass()
{
...
//=============================================================================
void TwentyNodeBrickOrderOne::zeroLoad(void)
{
    Q.Zero();
}
...
//======================================================================
const Vector &TwentyNodeBrickOrderOne::getBodyForce(double loadFactor, const Vector &data)
{
...
//======================================================================
const Vector &TwentyNodeBrickOrderOne::getSurfaceForce(double loadFactor, const Vector &data)
{
...
//=============================================================================
int TwentyNodeBrickOrderOne::addLoad(ElementalLoad *theLoad, double loadFactor)
{
    ...
    {
        cerr << "TwentyNodeBrickOrderOne::addLoad() - 20NodeBrick " << this->getTag() << ",load type " << type << "unknown\n";
        return -1;
    }
...
//=============================================================================
int TwentyNodeBrickOrderOne::addInertiaLoadToUnbalance(const Vector &accel)
{
    // Check for a quick return
    if (rho == 0.0)
    {
            ...
            3 != Raccel17.Size() || 3 != Raccel18.Size() || 3 != Raccel19.Size() || 3 != Raccel20.Size()   )
    {
        ...
        cerr << "TwentyNodeBrickOrderOne::addInertiaLoadToUnbalance " <<
...
//=============================================================================
const Vector TwentyNodeBrickOrderOne::FormEquiBodyForce(const Vector &data)
{
    Vector bforce(60);
...
//=============================================================================
const Vector &TwentyNodeBrickOrderOne::getResistingForce ()
{
...
//=============================================================================
const Vector &TwentyNodeBrickOrderOne::getResistingForceIncInertia ()
{
...
//=============================================================================
int TwentyNodeBrickOrderOne::sendSelf (int commitTag, Channel &theChannel)
{
    ID idData(3);
    ...
    {
        cerr << "WARNING TwentyNodeBrickOrderOne::sendSelf() - " << this->getTag() << " failed to send ID idData\n";
        return -1;
    }
    ...
    if(idData( 2 )==1){
        ...
        {
            cerr << "WARNING TwentyNodeBrickOrderOne::sendSelf() - " << this->getTag() << " failed to send its K\n";
            return -1;
        }
    }
    ...
    {
        cerr << "WARNING TwentyNodeBrickOrderOne::sendSelf() - " << this->getTag() << " failed to send Vector floatData\n";
        return -1;
    }
    ...
    {
        cerr << "WARNING TwentyNodeBrickOrderOne::sendSelf() - " << this->getTag() << " failed to send String stiffness_type\n";
        return -1;
    }
    ...
    {
        cerr << "WARNING TwentyNodeBrickOrderOne::sendSelf() - " << this->getTag() << " failed to send String damping_type\n";
        return -1;
    }
    ...
    {
        cerr << "WARNING TwentyNodeBrickOrderOne::sendSelf() - " << this->getTag() << " failed to send ID connectedExternalNodes\n";
        return -1;
    }
    ...
    for ( int i = 0; i < Num_TotalGaussPts; i++ )
    {
        ...
        {
            cerr << "WARNING TwentyNodeBrickOrderOne::sendSelf() - " << this->getTag() << " failed to send material models\n";
            return -1;
        }
    }
    ...
    {
        cerr << "WARNING TwentyNodeBrickOrderOne::sendSelf() - " << this->getTag() << " failed to send its Q\n";
        return -1;
    }
    ...
    {
        cerr << "WARNING TwentyNodeBrickOrderOne::sendSelf() - " << this->getTag() << " failed to send its bf\n";
        return -1;
    }
...
//=============================================================================
int TwentyNodeBrickOrderOne::receiveSelf (int commitTag, Channel &theChannel, FEM_ObjectBroker &theBroker)
{
    ID idData( 3 );

    if ( theChannel.receiveID( 0, commitTag, idData ) < 0 )
    {
        cerr << "WARNING TwentyNodeBrickOrderOne::receiveSelf() - failed to receive ID\n";
        return -1;
    }
    ...
    if(idData(2)){
        if ( theChannel.sendMatrix( 0, commitTag, K ) < 0 )
        {
            cerr << "WARNING TwentyNodeBrickOrderOne::receiveSelf() - " << this->getTag() << " failed to recieve its K\n";
            return -1;
        }
    }
    ...
    {
        cerr << "WARNING TwentyNodeBrickOrderOne::receiveSelf() - " << this->getTag() << " failed to recieve Vector floatData\n";
        return -1;
    }
    Volume                  = floatData(0) ;
    ...
    {
        cerr << "WARNING TwentyNodeBrickOrderOne::receiveSelf() - " << this->getTag() << " failed to recieve String stiffness_type\n";
        return -1;
    }
    ...
    if ( theChannel.receiveString( 0, commitTag, tmp_string ) < 0 )
    {
        cerr << "WARNING TwentyNodeBrickOrderOne::receiveSelf() - " << this->getTag() << " failed to recieve String damping_type\n";
        return -1;
    }
    ...
    {
        cerr << "WARNING TwentyNodeBrickOrderOne::receiveSelf() - " << this->getTag() << " failed to recieve ID connectedExternalNodes\n";
        return -1;
    }

    // cout << "TwentyNodeBrickOrderOne::receiveSelf() connectedExternalNodes = " << connectedExternalNodes << "\n";
    ...
    for ( int i = 0; i < Num_TotalGaussPts; i++ )
    {
        ...
        if ( ndmat == 0 )
        {
            cerr << "TwentyNodeBrickOrderOne::receiveSelf() - Broker could not create NDMaterialLT of class type " << matClassTag << "\n";
            return -1;
        }
        ...
        {
            cerr << "TwentyNodeBrickOrderOne::receiveSelf() - material " << i << "failed to recv itself\n";
            return -1;
        }
    ...
    {
        cerr << "TwentyNodeBrickOrderOne::receiveSelf() - failed to recv Q!\n";
        return -1;
    }
    ...
    {
        cerr << "TwentyNodeBrickOrderOne::receiveSelf() - failed to recv bf!\n";
        return -1;
    }
...
int TwentyNodeBrickOrderOne::getObjectSize()
{
...
//=============================================================================
void TwentyNodeBrickOrderOne::Print(ostream &s, int flag)
{
    cout << "TwentyNodeBrickOrderOne: LTensor-based 27 node brick." << endl << endl;
...
void TwentyNodeBrickOrderOne::ComputeVolume()
{
    Volume = 0.0;
...
int TwentyNodeBrickOrderOne::update() //Added by Guanzhou, May 7 2004
{
    double r  = 0.0;
    double s  = 0.0;
    double t  = 0.0;
    ...
    for ( short gp = 0; gp < Num_TotalGaussPts; gp++ )
    {
        ...
        {
            cerr << "TwentyNodeBrickOrderOne::update (tag: " << this->getTag() << "), Update Failed\n";
        }
    }
...
double  TwentyNodeBrickOrderOne::SurfaceShapeFunctionValues(double Xi , double Eta, int whichcomponent)
{
...
Vector &TwentyNodeBrickOrderOne::Direction_Weight(double Xi , double Eta,
...
double TwentyNodeBrickOrderOne::SurfaceLoadValues(double Xi , double Eta, Vector Pressure)
{
...
int
TwentyNodeBrickOrderOne::CheckMesh(ofstream &checkmesh_file)
{
    double r  = 0.0;
    double s  = 0.0;
    double t  = 0.0;
...
Vector *
TwentyNodeBrickOrderOne::getStress( void )
{
...
Matrix &TwentyNodeBrickOrderOne::getGaussCoordinates(void)
{
    computeGaussPoint();
    return gauss_points;
}
...
Matrix &TwentyNodeBrickOrderOne::get_Gauss_p_c( )
{
...
Matrix &TwentyNodeBrickOrderOne::get_Gauss_p_w()
{
...
***********************************************************************************/
const vector<float> &TwentyNodeBrickOrderOne::getGaussOutput()
{
    DTensor2 stress(3, 3);
    DTensor2 strain(3, 3);
...
void TwentyNodeBrickOrderOne::zeroStrain()
{
    for (int gp = 0; gp < Num_TotalGaussPts; gp++)
    {
