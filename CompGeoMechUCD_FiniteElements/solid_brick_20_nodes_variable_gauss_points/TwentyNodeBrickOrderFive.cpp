...
/////////////////////////////////////////////////////////////////////////////////////
// Adapted by Sumeet, for TwentyNodeBrickOrderFive to use the LTensor library for
// tensorial representation. [September, 2016]
/////////////////////////////////////////////////////////////////////////////////////


#ifndef TwentyNodeBrickOrderFive_CPP
#define TwentyNodeBrickOrderFive_CPP

#include "TwentyNodeBrickOrderFive.h"
...
DTensor2 TwentyNodeBrickOrderFive::gp_coords(Num_TotalGaussPts, 3, 0.0);
DTensor2 TwentyNodeBrickOrderFive::gp_weight(Num_TotalGaussPts, 3, 0.0);
Matrix TwentyNodeBrickOrderFive::gauss_points(Num_TotalGaussPts, 3);
vector<float> TwentyNodeBrickOrderFive::Gauss_Output_Vector(Num_TotalGaussPts*18);

Matrix TwentyNodeBrickOrderFive::K(60, 60);

Vector TwentyNodeBrickOrderFive::ShapeFunctionValues_in_function(8); // Nima added for surface load (July 2012)
Vector TwentyNodeBrickOrderFive::J_vector_in_function(3);            // Nima added for surface load (July 2012)
double TwentyNodeBrickOrderFive::SurfaceLoadValues_in_function;

//====================================================================
// Constructor
//====================================================================
TwentyNodeBrickOrderFive::TwentyNodeBrickOrderFive(int element_number,
    ...
    : Element(element_number, ELE_TAG_TwentyNodeBrickOrderFive ),
      ...
      M( 60, 60), P( 60 )
{
    ...
    if (material_array == 0)
    {
        cerr << " TwentyNodeBrickOrderFive::TwentyNodeBrickOrderFive -- failed allocate material model pointer\n";
        exit(-1);
    }
...
//====================================================================
TwentyNodeBrickOrderFive::TwentyNodeBrickOrderFive (): Element(0, ELE_TAG_TwentyNodeBrickOrderFive ),
    rho(0.0), connectedExternalNodes(20),
    Ki(0), mmodel(0), Q(60),
    bf(3), M( 60, 60), P( 60 )
{
...
/////////////////////////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////////////////
TwentyNodeBrickOrderFive::~TwentyNodeBrickOrderFive ()
{
...
//#############################################################################
//***************************************************************
const DTensor2 &TwentyNodeBrickOrderFive::H_3D(double r1, double r2, double r3) const
{
...
//#############################################################################
//***************************************************************
const DTensor1 &TwentyNodeBrickOrderFive::interp_poli_at(double r1, double r2, double r3) const
{
...
const DTensor2 &TwentyNodeBrickOrderFive::dh_drst_at(double r1, double r2, double r3) const
{
...
////#############################################################################
const DTensor2 &TwentyNodeBrickOrderFive::Jacobian_3D( const DTensor2 &dh) const
{
...
//#############################################################################
const DTensor2 &TwentyNodeBrickOrderFive::Jacobian_3Dinv(const DTensor2 &dh) const
{
    const DTensor2 &N_C = Nodal_Coordinates();
...
////#############################################################################
const DTensor2 &TwentyNodeBrickOrderFive::Nodal_Coordinates(void) const
{
...
////#############################################################################
const DTensor2 &TwentyNodeBrickOrderFive::incr_disp(void) const
{
...
////#############################################################################
const DTensor2 &TwentyNodeBrickOrderFive::total_disp(void) const
{
...
////#############################################################################
int TwentyNodeBrickOrderFive::get_global_number_of_node(int local_node_number)
{
    return connectedExternalNodes(local_node_number);
}

////#############################################################################
int  TwentyNodeBrickOrderFive::get_Brick_Number(void)
{
    return this->getTag();
}
...
const DTensor2 &TwentyNodeBrickOrderFive::nodal_forces(void) const
{
    double r  = 0.0;
    double w_r = 0.0;
    double s  = 0.0;
...
void TwentyNodeBrickOrderFive::computeGaussPoint(void)
{
...
//=============================================================================
int TwentyNodeBrickOrderFive::getNumExternalNodes () const
{
...
//=============================================================================
const ID &TwentyNodeBrickOrderFive::getExternalNodes ()
{
    return connectedExternalNodes;
}

Node **
TwentyNodeBrickOrderFive::getNodePtrs(void)
{
    return theNodes;
}

//=============================================================================
int TwentyNodeBrickOrderFive::getNumDOF ()
{
    return 3 * nodes_in_brick;
}

//=============================================================================
void TwentyNodeBrickOrderFive::setDomain (Domain *theDomain)
{
...
# endif
                ...
                theNodes[16] == 0 || theNodes[17] == 0 || theNodes[18] == 0 || theNodes[19] == 0 )
        {
            ...
            cerr << "FATAL ERROR TwentyNodeBrickOrderFive (tag: " << this->getTag() << " ), node not found in domain\n";
            exit(-1);
        }
        ...
        {
            cerr << "FATAL ERROR TwentyNodeBrickOrderFive (tag: " << this->getTag() <<
...
//=============================================================================
int TwentyNodeBrickOrderFive::commitState ()
{
    int retVal = 0;
    ...
    {
        cerr << "TwentyNodeBrickOrderFive::commitState () - failed in base class";
    }
...
//=============================================================================
int TwentyNodeBrickOrderFive::revertToLastCommit ()
{
    int retVal = 0;
...
//=============================================================================
int TwentyNodeBrickOrderFive::revertToStart ()
{
    int retVal = 0;
...
//=============================================================================
const Matrix &TwentyNodeBrickOrderFive::getTangentStiff ()
{
...
//=============================================================================
const Matrix &TwentyNodeBrickOrderFive::getInitialStiff ()
{
    if ( Ki == 0 )
    {
    ...
    if ( Ki == 0 )
    {
        cerr << "FATAL TwentyNodeBrickOrderFive::getInitialStiff() -";
...
////#############################################################################
//  tensor TwentyNodeBrickOrderFive::mass_tensor(Elastic  mmodel)
const Matrix &TwentyNodeBrickOrderFive::getMass()
{
...
//=============================================================================
void TwentyNodeBrickOrderFive::zeroLoad(void)
{
    Q.Zero();
}
...
//======================================================================
const Vector &TwentyNodeBrickOrderFive::getBodyForce(double loadFactor, const Vector &data)
{
...
//======================================================================
const Vector &TwentyNodeBrickOrderFive::getSurfaceForce(double loadFactor, const Vector &data)
{
...
//=============================================================================
int TwentyNodeBrickOrderFive::addLoad(ElementalLoad *theLoad, double loadFactor)
{
    ...
    {
        cerr << "TwentyNodeBrickOrderFive::addLoad() - 20NodeBrick " << this->getTag() << ",load type " << type << "unknown\n";
        return -1;
    }
...
//=============================================================================
int TwentyNodeBrickOrderFive::addInertiaLoadToUnbalance(const Vector &accel)
{
    // Check for a quick return
    if (rho == 0.0)
    {
            ...
            3 != Raccel17.Size() || 3 != Raccel18.Size() || 3 != Raccel19.Size() || 3 != Raccel20.Size()   )
    {
        ...
        cerr << "TwentyNodeBrickOrderFive::addInertiaLoadToUnbalance " <<
...
//=============================================================================
const Vector TwentyNodeBrickOrderFive::FormEquiBodyForce(const Vector &data)
{
    Vector bforce(60);
...
//=============================================================================
const Vector &TwentyNodeBrickOrderFive::getResistingForce ()
{
...
//=============================================================================
const Vector &TwentyNodeBrickOrderFive::getResistingForceIncInertia ()
{
...
//=============================================================================
int TwentyNodeBrickOrderFive::sendSelf (int commitTag, Channel &theChannel)
{
    ID idData(3);
    ...
    {
        cerr << "WARNING TwentyNodeBrickOrderFive::sendSelf() - " << this->getTag() << " failed to send ID idData\n";
        return -1;
    }
    ...
    if(idData( 2 )==1){
        ...
        {
            cerr << "WARNING TwentyNodeBrickOrderFive::sendSelf() - " << this->getTag() << " failed to send its K\n";
            return -1;
        }
    }
    ...
    {
        cerr << "WARNING TwentyNodeBrickOrderFive::sendSelf() - " << this->getTag() << " failed to send Vector floatData\n";
        return -1;
    }
    ...
    {
        cerr << "WARNING TwentyNodeBrickOrderFive::sendSelf() - " << this->getTag() << " failed to send String stiffness_type\n";
        return -1;
    }
    ...
    {
        cerr << "WARNING TwentyNodeBrickOrderFive::sendSelf() - " << this->getTag() << " failed to send String damping_type\n";
        return -1;
    }
    ...
    {
        cerr << "WARNING TwentyNodeBrickOrderFive::sendSelf() - " << this->getTag() << " failed to send ID connectedExternalNodes\n";
        return -1;
    }
    ...
    for ( int i = 0; i < Num_TotalGaussPts; i++ )
    {
        ...
        {
            cerr << "WARNING TwentyNodeBrickOrderFive::sendSelf() - " << this->getTag() << " failed to send material models\n";
            return -1;
        }
    }
    ...
    {
        cerr << "WARNING TwentyNodeBrickOrderFive::sendSelf() - " << this->getTag() << " failed to send its Q\n";
        return -1;
    }
    ...
    {
        cerr << "WARNING TwentyNodeBrickOrderFive::sendSelf() - " << this->getTag() << " failed to send its bf\n";
        return -1;
    }
...
//=============================================================================
int TwentyNodeBrickOrderFive::receiveSelf (int commitTag, Channel &theChannel, FEM_ObjectBroker &theBroker)
{
    ID idData( 3 );

    if ( theChannel.receiveID( 0, commitTag, idData ) < 0 )
    {
        cerr << "WARNING TwentyNodeBrickOrderFive::receiveSelf() - failed to receive ID\n";
        return -1;
    }
    ...
    if(idData(2)){
        if ( theChannel.sendMatrix( 0, commitTag, K ) < 0 )
        {
            cerr << "WARNING TwentyNodeBrickOrderFive::receiveSelf() - " << this->getTag() << " failed to recieve its K\n";
            return -1;
        }
    }
    ...
    {
        cerr << "WARNING TwentyNodeBrickOrderFive::receiveSelf() - " << this->getTag() << " failed to recieve Vector floatData\n";
        return -1;
    }
    Volume                  = floatData(0) ;
    ...
    {
        cerr << "WARNING TwentyNodeBrickOrderFive::receiveSelf() - " << this->getTag() << " failed to recieve String stiffness_type\n";
        return -1;
    }
    ...
    if ( theChannel.receiveString( 0, commitTag, tmp_string ) < 0 )
    {
        cerr << "WARNING TwentyNodeBrickOrderFive::receiveSelf() - " << this->getTag() << " failed to recieve String damping_type\n";
        return -1;
    }
    ...
    {
        cerr << "WARNING TwentyNodeBrickOrderFive::receiveSelf() - " << this->getTag() << " failed to recieve ID connectedExternalNodes\n";
        return -1;
    }

    // cout << "TwentyNodeBrickOrderFive::receiveSelf() connectedExternalNodes = " << connectedExternalNodes << "\n";
    ...
    for ( int i = 0; i < Num_TotalGaussPts; i++ )
    {
        ...
        if ( ndmat == 0 )
        {
            cerr << "TwentyNodeBrickOrderFive::receiveSelf() - Broker could not create NDMaterialLT of class type " << matClassTag << "\n";
            return -1;
        }
        ...
        {
            cerr << "TwentyNodeBrickOrderFive::receiveSelf() - material " << i << "failed to recv itself\n";
            return -1;
        }
    ...
    {
        cerr << "TwentyNodeBrickOrderFive::receiveSelf() - failed to recv Q!\n";
        return -1;
    }
    ...
    {
        cerr << "TwentyNodeBrickOrderFive::receiveSelf() - failed to recv bf!\n";
        return -1;
    }
...
int TwentyNodeBrickOrderFive::getObjectSize()
{
...
//=============================================================================
void TwentyNodeBrickOrderFive::Print(ostream &s, int flag)
{
    cout << "TwentyNodeBrickOrderFive: LTensor-based 27 node brick." << endl << endl;
...
void TwentyNodeBrickOrderFive::ComputeVolume()
{
    Volume = 0.0;
...
int TwentyNodeBrickOrderFive::update() //Added by Guanzhou, May 7 2004
{
    double r  = 0.0;
    double s  = 0.0;
    double t  = 0.0;
    ...
    for ( short gp = 0; gp < Num_TotalGaussPts; gp++ )
    {
        ...
        {
            cerr << "TwentyNodeBrickOrderFive::update (tag: " << this->getTag() << "), Update Failed\n";
        }
    }
...
double  TwentyNodeBrickOrderFive::SurfaceShapeFunctionValues(double Xi , double Eta, int whichcomponent)
{
...
Vector &TwentyNodeBrickOrderFive::Direction_Weight(double Xi , double Eta,
...
double TwentyNodeBrickOrderFive::SurfaceLoadValues(double Xi , double Eta, Vector Pressure)
{
...
int
TwentyNodeBrickOrderFive::CheckMesh(ofstream &checkmesh_file)
{
    double r  = 0.0;
    double s  = 0.0;
    double t  = 0.0;
...
Vector *
TwentyNodeBrickOrderFive::getStress( void )
{
...
Matrix &TwentyNodeBrickOrderFive::getGaussCoordinates(void)
{
    computeGaussPoint();
    return gauss_points;
}
...
Matrix &TwentyNodeBrickOrderFive::get_Gauss_p_c( )
{
...
Matrix &TwentyNodeBrickOrderFive::get_Gauss_p_w()
{
...
***********************************************************************************/
const vector<float> &TwentyNodeBrickOrderFive::getGaussOutput()
{
    DTensor2 stress(3, 3);
    DTensor2 strain(3, 3);
...
void TwentyNodeBrickOrderFive::zeroStrain()
{
    for (int gp = 0; gp < Num_TotalGaussPts; gp++)
    {
