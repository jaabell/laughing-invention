...
/////////////////////////////////////////////////////////////////////////////////////
// Adapted by Sumeet, for TwentyNodeBrickOrderThree to use the LTensor library for
// tensorial representation. [September, 2016]
/////////////////////////////////////////////////////////////////////////////////////


#ifndef TwentyNodeBrickOrderThree_CPP
#define TwentyNodeBrickOrderThree_CPP

#include "TwentyNodeBrickOrderThree.h"
...
DTensor2 TwentyNodeBrickOrderThree::gp_coords(Num_TotalGaussPts, 3, 0.0);
DTensor2 TwentyNodeBrickOrderThree::gp_weight(Num_TotalGaussPts, 3, 0.0);
Matrix TwentyNodeBrickOrderThree::gauss_points(Num_TotalGaussPts, 3);
vector<float> TwentyNodeBrickOrderThree::Gauss_Output_Vector(Num_TotalGaussPts*18);

Matrix TwentyNodeBrickOrderThree::K(60, 60);

Vector TwentyNodeBrickOrderThree::ShapeFunctionValues_in_function(8); // Nima added for surface load (July 2012)
Vector TwentyNodeBrickOrderThree::J_vector_in_function(3);            // Nima added for surface load (July 2012)
double TwentyNodeBrickOrderThree::SurfaceLoadValues_in_function;

//====================================================================
// Constructor
//====================================================================
TwentyNodeBrickOrderThree::TwentyNodeBrickOrderThree(int element_number,
    ...
    : Element(element_number, ELE_TAG_TwentyNodeBrickOrderThree ),
      ...
      M( 60, 60), P( 60 )
{
    ...
    if (material_array == 0)
    {
        cerr << " TwentyNodeBrickOrderThree::TwentyNodeBrickOrderThree -- failed allocate material model pointer\n";
        exit(-1);
    }
...
//====================================================================
TwentyNodeBrickOrderThree::TwentyNodeBrickOrderThree (): Element(0, ELE_TAG_TwentyNodeBrickOrderThree ),
    rho(0.0), connectedExternalNodes(20),
    Ki(0), mmodel(0), Q(60),
    bf(3), M( 60, 60), P( 60 )
{
...
/////////////////////////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////////////////
TwentyNodeBrickOrderThree::~TwentyNodeBrickOrderThree ()
{
...
//#############################################################################
//***************************************************************
const DTensor2 &TwentyNodeBrickOrderThree::H_3D(double r1, double r2, double r3) const
{
...
//#############################################################################
//***************************************************************
const DTensor1 &TwentyNodeBrickOrderThree::interp_poli_at(double r1, double r2, double r3) const
{
...
const DTensor2 &TwentyNodeBrickOrderThree::dh_drst_at(double r1, double r2, double r3) const
{
...
////#############################################################################
const DTensor2 &TwentyNodeBrickOrderThree::Jacobian_3D( const DTensor2 &dh) const
{
...
//#############################################################################
const DTensor2 &TwentyNodeBrickOrderThree::Jacobian_3Dinv(const DTensor2 &dh) const
{
    const DTensor2 &N_C = Nodal_Coordinates();
...
////#############################################################################
const DTensor2 &TwentyNodeBrickOrderThree::Nodal_Coordinates(void) const
{
...
////#############################################################################
const DTensor2 &TwentyNodeBrickOrderThree::incr_disp(void) const
{
...
////#############################################################################
const DTensor2 &TwentyNodeBrickOrderThree::total_disp(void) const
{
...
////#############################################################################
int TwentyNodeBrickOrderThree::get_global_number_of_node(int local_node_number)
{
    return connectedExternalNodes(local_node_number);
}

////#############################################################################
int  TwentyNodeBrickOrderThree::get_Brick_Number(void)
{
    return this->getTag();
}
...
const DTensor2 &TwentyNodeBrickOrderThree::nodal_forces(void) const
{
    double r  = 0.0;
    double w_r = 0.0;
    double s  = 0.0;
...
void TwentyNodeBrickOrderThree::computeGaussPoint(void)
{
...
//=============================================================================
int TwentyNodeBrickOrderThree::getNumExternalNodes () const
{
...
//=============================================================================
const ID &TwentyNodeBrickOrderThree::getExternalNodes ()
{
    return connectedExternalNodes;
}

Node **
TwentyNodeBrickOrderThree::getNodePtrs(void)
{
    return theNodes;
}

//=============================================================================
int TwentyNodeBrickOrderThree::getNumDOF ()
{
    return 3 * nodes_in_brick;
}

//=============================================================================
void TwentyNodeBrickOrderThree::setDomain (Domain *theDomain)
{
...
# endif
                ...
                theNodes[16] == 0 || theNodes[17] == 0 || theNodes[18] == 0 || theNodes[19] == 0 )
        {
            ...
            cerr << "FATAL ERROR TwentyNodeBrickOrderThree (tag: " << this->getTag() << " ), node not found in domain\n";
            exit(-1);
        }
        ...
        {
            cerr << "FATAL ERROR TwentyNodeBrickOrderThree (tag: " << this->getTag() <<
...
//=============================================================================
int TwentyNodeBrickOrderThree::commitState ()
{
    int retVal = 0;
    ...
    {
        cerr << "TwentyNodeBrickOrderThree::commitState () - failed in base class";
    }
...
//=============================================================================
int TwentyNodeBrickOrderThree::revertToLastCommit ()
{
    int retVal = 0;
...
//=============================================================================
int TwentyNodeBrickOrderThree::revertToStart ()
{
    int retVal = 0;
...
//=============================================================================
const Matrix &TwentyNodeBrickOrderThree::getTangentStiff ()
{
...
//=============================================================================
const Matrix &TwentyNodeBrickOrderThree::getInitialStiff ()
{
    if ( Ki == 0 )
    {
    ...
    if ( Ki == 0 )
    {
        cerr << "FATAL TwentyNodeBrickOrderThree::getInitialStiff() -";
...
////#############################################################################
//  tensor TwentyNodeBrickOrderThree::mass_tensor(Elastic  mmodel)
const Matrix &TwentyNodeBrickOrderThree::getMass()
{
...
//=============================================================================
void TwentyNodeBrickOrderThree::zeroLoad(void)
{
    Q.Zero();
}
...
//======================================================================
const Vector &TwentyNodeBrickOrderThree::getBodyForce(double loadFactor, const Vector &data)
{
...
//======================================================================
const Vector &TwentyNodeBrickOrderThree::getSurfaceForce(double loadFactor, const Vector &data)
{
...
//=============================================================================
int TwentyNodeBrickOrderThree::addLoad(ElementalLoad *theLoad, double loadFactor)
{
    ...
    {
        cerr << "TwentyNodeBrickOrderThree::addLoad() - 20NodeBrick " << this->getTag() << ",load type " << type << "unknown\n";
        return -1;
    }
...
//=============================================================================
int TwentyNodeBrickOrderThree::addInertiaLoadToUnbalance(const Vector &accel)
{
    // Check for a quick return
    if (rho == 0.0)
    {
            ...
            3 != Raccel17.Size() || 3 != Raccel18.Size() || 3 != Raccel19.Size() || 3 != Raccel20.Size()   )
    {
        ...
        cerr << "TwentyNodeBrickOrderThree::addInertiaLoadToUnbalance " <<
...
//=============================================================================
const Vector TwentyNodeBrickOrderThree::FormEquiBodyForce(const Vector &data)
{
    Vector bforce(60);
...
//=============================================================================
const Vector &TwentyNodeBrickOrderThree::getResistingForce ()
{
...
//=============================================================================
const Vector &TwentyNodeBrickOrderThree::getResistingForceIncInertia ()
{
...
//=============================================================================
int TwentyNodeBrickOrderThree::sendSelf (int commitTag, Channel &theChannel)
{
    ID idData(3);
    ...
    {
        cerr << "WARNING TwentyNodeBrickOrderThree::sendSelf() - " << this->getTag() << " failed to send ID idData\n";
        return -1;
    }
    ...
    if(idData( 2 )==1){
        ...
        {
            cerr << "WARNING TwentyNodeBrickOrderThree::sendSelf() - " << this->getTag() << " failed to send its K\n";
            return -1;
        }
    }
    ...
    {
        cerr << "WARNING TwentyNodeBrickOrderThree::sendSelf() - " << this->getTag() << " failed to send Vector floatData\n";
        return -1;
    }
    ...
    {
        cerr << "WARNING TwentyNodeBrickOrderThree::sendSelf() - " << this->getTag() << " failed to send String stiffness_type\n";
        return -1;
    }
    ...
    {
        cerr << "WARNING TwentyNodeBrickOrderThree::sendSelf() - " << this->getTag() << " failed to send String damping_type\n";
        return -1;
    }
    ...
    {
        cerr << "WARNING TwentyNodeBrickOrderThree::sendSelf() - " << this->getTag() << " failed to send ID connectedExternalNodes\n";
        return -1;
    }
    ...
    for ( int i = 0; i < Num_TotalGaussPts; i++ )
    {
        ...
        {
            cerr << "WARNING TwentyNodeBrickOrderThree::sendSelf() - " << this->getTag() << " failed to send material models\n";
            return -1;
        }
    }
    ...
    {
        cerr << "WARNING TwentyNodeBrickOrderThree::sendSelf() - " << this->getTag() << " failed to send its Q\n";
        return -1;
    }
    ...
    {
        cerr << "WARNING TwentyNodeBrickOrderThree::sendSelf() - " << this->getTag() << " failed to send its bf\n";
        return -1;
    }
...
//=============================================================================
int TwentyNodeBrickOrderThree::receiveSelf (int commitTag, Channel &theChannel, FEM_ObjectBroker &theBroker)
{
    ID idData( 3 );

    if ( theChannel.receiveID( 0, commitTag, idData ) < 0 )
    {
        cerr << "WARNING TwentyNodeBrickOrderThree::receiveSelf() - failed to receive ID\n";
        return -1;
    }
    ...
    if(idData(2)){
        if ( theChannel.sendMatrix( 0, commitTag, K ) < 0 )
        {
            cerr << "WARNING TwentyNodeBrickOrderThree::receiveSelf() - " << this->getTag() << " failed to recieve its K\n";
            return -1;
        }
    }
    ...
    {
        cerr << "WARNING TwentyNodeBrickOrderThree::receiveSelf() - " << this->getTag() << " failed to recieve Vector floatData\n";
        return -1;
    }
    Volume                  = floatData(0) ;
    ...
    {
        cerr << "WARNING TwentyNodeBrickOrderThree::receiveSelf() - " << this->getTag() << " failed to recieve String stiffness_type\n";
        return -1;
    }
    ...
    if ( theChannel.receiveString( 0, commitTag, tmp_string ) < 0 )
    {
        cerr << "WARNING TwentyNodeBrickOrderThree::receiveSelf() - " << this->getTag() << " failed to recieve String damping_type\n";
        return -1;
    }
    ...
    {
        cerr << "WARNING TwentyNodeBrickOrderThree::receiveSelf() - " << this->getTag() << " failed to recieve ID connectedExternalNodes\n";
        return -1;
    }

    // cout << "TwentyNodeBrickOrderThree::receiveSelf() connectedExternalNodes = " << connectedExternalNodes << "\n";
    ...
    for ( int i = 0; i < Num_TotalGaussPts; i++ )
    {
        ...
        if ( ndmat == 0 )
        {
            cerr << "TwentyNodeBrickOrderThree::receiveSelf() - Broker could not create NDMaterialLT of class type " << matClassTag << "\n";
            return -1;
        }
        ...
        {
            cerr << "TwentyNodeBrickOrderThree::receiveSelf() - material " << i << "failed to recv itself\n";
            return -1;
        }
    ...
    {
        cerr << "TwentyNodeBrickOrderThree::receiveSelf() - failed to recv Q!\n";
        return -1;
    }
    ...
    {
        cerr << "TwentyNodeBrickOrderThree::receiveSelf() - failed to recv bf!\n";
        return -1;
    }
...
int TwentyNodeBrickOrderThree::getObjectSize()
{
...
//=============================================================================
void TwentyNodeBrickOrderThree::Print(ostream &s, int flag)
{
    cout << "TwentyNodeBrickOrderThree: LTensor-based 27 node brick." << endl << endl;
...
void TwentyNodeBrickOrderThree::ComputeVolume()
{
    Volume = 0.0;
...
int TwentyNodeBrickOrderThree::update() //Added by Guanzhou, May 7 2004
{
    double r  = 0.0;
    double s  = 0.0;
    double t  = 0.0;
    ...
    for ( short gp = 0; gp < Num_TotalGaussPts; gp++ )
    {
        ...
        {
            cerr << "TwentyNodeBrickOrderThree::update (tag: " << this->getTag() << "), Update Failed\n";
        }
    }
...
double  TwentyNodeBrickOrderThree::SurfaceShapeFunctionValues(double Xi , double Eta, int whichcomponent)
{
...
Vector &TwentyNodeBrickOrderThree::Direction_Weight(double Xi , double Eta,
...
double TwentyNodeBrickOrderThree::SurfaceLoadValues(double Xi , double Eta, Vector Pressure)
{
...
int
TwentyNodeBrickOrderThree::CheckMesh(ofstream &checkmesh_file)
{
    double r  = 0.0;
    double s  = 0.0;
    double t  = 0.0;
...
Vector *
TwentyNodeBrickOrderThree::getStress( void )
{
...
Matrix &TwentyNodeBrickOrderThree::getGaussCoordinates(void)
{
    computeGaussPoint();
    return gauss_points;
}
...
Matrix &TwentyNodeBrickOrderThree::get_Gauss_p_c( )
{
...
Matrix &TwentyNodeBrickOrderThree::get_Gauss_p_w()
{
...
***********************************************************************************/
const vector<float> &TwentyNodeBrickOrderThree::getGaussOutput()
{
    DTensor2 stress(3, 3);
    DTensor2 strain(3, 3);
...
void TwentyNodeBrickOrderThree::zeroStrain()
{
    for (int gp = 0; gp < Num_TotalGaussPts; gp++)
    {
