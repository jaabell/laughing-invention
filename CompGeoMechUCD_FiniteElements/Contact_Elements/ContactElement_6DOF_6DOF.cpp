...
#include "ContactElement_6DOF_6DOF.h"
...
Matrix  ContactElement_6DOF_6DOF::stiff(6 * numberNodes, 6 * numberNodes);
Vector  ContactElement_6DOF_6DOF::resid(6 * numberNodes);
Matrix  ContactElement_6DOF_6DOF::zeroMatrix(6 * numberNodes, 6 * numberNodes);
Vector ContactElement_6DOF_6DOF::y_local(3);
Vector ContactElement_6DOF_6DOF::z_local(3);
Vector ContactElement_6DOF_6DOF::x_local_normalized(3);
Vector ContactElement_6DOF_6DOF::y_local_normalized(3);
Vector ContactElement_6DOF_6DOF::z_local_normalized(3);
double ContactElement_6DOF_6DOF::normalforce;
Vector ContactElement_6DOF_6DOF::shearforce(2);
Matrix ContactElement_6DOF_6DOF::transformation(3, 3);
Vector ContactElement_6DOF_6DOF::global_gap(3);
Vector ContactElement_6DOF_6DOF::local_gap(3);
Vector ContactElement_6DOF_6DOF::shear_relative_displacement(2);

//*********************************************************************
//  Constructor for defining the contact element

ContactElement_6DOF_6DOF::ContactElement_6DOF_6DOF(int tag,
        int Nd1, int Nd2,
        double Knormal,
        double Ktangent,
    ...
    : Element(tag, ELE_TAG_ContactElement_6DOF_6DOF),
...
//null constructor
ContactElement_6DOF_6DOF::ContactElement_6DOF_6DOF(void)
    : Element(0, ELE_TAG_ContactElement_6DOF_6DOF),
      connectedExternalNodes(numberNodes),
      N(3 * numberNodes), T1(3 * numberNodes), T2(3 * numberNodes)
{
    ...
    if (connectedExternalNodes.Size() != 2)
    {
        cerr << "FATAL ContactElement_6DOF_6DOF::ContactElement_6DOF_6DOF - failed to create an ID of correct size\n";
    }
...
//  Destructor
ContactElement_6DOF_6DOF::~ContactElement_6DOF_6DOF()
{
...
int
ContactElement_6DOF_6DOF::getNumExternalNodes(void) const
{
    return 2;
}
...
int
ContactElement_6DOF_6DOF::getNumDOF(void)
{
    return numDOF;
}
...
ContactElement_6DOF_6DOF::setDomain(Domain *theDomain)
{
    ...
    if ( nodePointers[0] == 0 || nodePointers[1] == 0 )
    {
        if (nodePointers[0] == 0)
        {
            cerr << "WARNING ContactElement_6DOF_6DOF::setDomain() - Nd1: " << Nd1 << " does not exist in ";
        }
        else
        {
            cerr << "WARNING ContactElement_6DOF_6DOF::setDomain() - Nd2: " << Nd2 << " does not exist in ";
        }
...
int
ContactElement_6DOF_6DOF::commitState()
{
    return 0;
}
...
int
ContactElement_6DOF_6DOF::revertToLastCommit()
{
    return 0;
}
...
int
ContactElement_6DOF_6DOF::revertToStart()
{
    return 0;
}
...
void
ContactElement_6DOF_6DOF::zeroLoad(void)
{
    // does nothing
}
...
ContactElement_6DOF_6DOF::Print(ostream &s, int flag)
{
    if (flag == 0)   // print everything
    {
        ...
        s << " type: ContactElement_6DOF_6DOF  iNode: " << connectedExternalNodes(0);
...
int ContactElement_6DOF_6DOF::if_nodes_are_in_contact_or_not(void)
{
    ...
    Vector slaveNode_TrialDisp_original(6);
    ...
    slaveNode_location = nodePointers[0]->getCrds() + slaveNode_TrialDisp_reduced;
...
int ContactElement_6DOF_6DOF::stick_or_slide(void)
{
...
int
ContactElement_6DOF_6DOF::receiveSelf(int commitTag, Channel &theChannel, FEM_ObjectBroker &theBroker)
{
    return 0;
}
