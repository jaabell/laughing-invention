...
int FrictionalPenaltyContact::receiveSelf(int commitTag, Channel &theChannel, FEM_ObjectBroker &theBroker)
{
    ...
    {
        cerr << "WARNING FrictionalPenaltyContact::receiveSelf() - " << this->getTag() << " failed to recieve ID idData\n";
        return -1;
    }
    ...
    {
        cerr << "WARNING FrictionalPenaltyContact::receiveSelf() - " << this->getTag() << " failed to recieve Vector floatData\n";
        return -1;
    }
...
#define FrictionalPenaltyContact_NOUTPUT 9
