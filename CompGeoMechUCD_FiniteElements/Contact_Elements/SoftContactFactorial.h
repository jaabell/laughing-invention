...
#ifndef SoftContactFactorial_h
#define SoftContactFactorial_h
...
class SoftContactFactorial: public Element
{

public:

    // Constructor
    SoftContactFactorial(int tag, double a, double b, int node1, int node2, double kn,  double kt,  double cn_,  double ct_, double mu, double e1_x_, double e1_y_, double e1_z_);

    // Empty constructor
    SoftContactFactorial();
...
private:
    ...
    double fact(double x); // Finds the factorial of a number 

    double a,b;    // Soft Contact Function Variables F = b*(log(a*u)!)
