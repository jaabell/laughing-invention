...
#ifndef ContactElement_3DOF_6DOF_h
#define ContactElement_3DOF_6DOF_h
...
class ContactElement_3DOF_6DOF: public Element

{
    ...
    public:
        ...
        // Constructor
        ContactElement_3DOF_6DOF(int tag,
                                 int Nd1, int Nd2,
