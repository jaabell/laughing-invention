...
#ifndef SoftContactInverse_h
#define SoftContactInverse_h
...
class SoftContactInverse: public Element
{

public:

    // Constructor
    SoftContactInverse(int tag, double a, double b, int node1, int node2, double kn,  double kt,  double cn_,  double ct_, double mu, double e1_x_, double e1_y_, double e1_z_);
...
private:
    ...
    double a,b;    // Soft Contact Function Variables F = b/(a-u)*u
