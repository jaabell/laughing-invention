...
/////////////////////////////////////////////////////////////////////////////////////
// Adapted by Sumeet, for TwentySevenNodeBrick to use the LTensor library for
...
DTensor2 TwentySevenNodeBrick::gp_coords(Num_TotalGaussPts, 3, 0.0);
DTensor2 TwentySevenNodeBrick::gp_weight(Num_TotalGaussPts, 3, 0.0);
Matrix TwentySevenNodeBrick::gauss_points(Num_TotalGaussPts, 3);
vector<float> TwentySevenNodeBrick::Gauss_Output_Vector(Num_TotalGaussPts*18);
      ...
      M(81,81), P( 81 )
{
    ...
    if (material_array == 0)
    {
        cerr << " TwentySevenNodeBrick::TwentySevenNodeBrick -- failed allocate material model pointer\n";
        exit(-1);
    }
...
//#############################################################################
//***************************************************************
const DTensor2 &TwentySevenNodeBrick::H_3D( double r1, double r2, double r3 ) const
{
...
//#############################################################################
//***************************************************************
const DTensor1 &TwentySevenNodeBrick::interp_poli_at( double r1, double r2, double r3 ) const
{
...
const DTensor2 &TwentySevenNodeBrick::dh_drst_at( double r1, double r2, double r3 ) const
{
...
////#############################################################################
const DTensor2 &TwentySevenNodeBrick::Jacobian_3D( const DTensor2 &dh ) const
{
...
//#############################################################################
const DTensor2  &TwentySevenNodeBrick::Jacobian_3Dinv( const DTensor2 &dh ) const
{
    const DTensor2 &N_C = Nodal_Coordinates();
...
////#############################################################################
const DTensor2 &TwentySevenNodeBrick::Nodal_Coordinates( void ) const
{
...
////#############################################################################
const DTensor2 &TwentySevenNodeBrick::incr_disp( void ) const
{
...
////#############################################################################
const DTensor2 &TwentySevenNodeBrick::total_disp( void ) const
{
...
const DTensor2 &TwentySevenNodeBrick::nodal_forces( void ) const
{
    double r  = 0.0;
    double w_r = 0.0;
    double s  = 0.0;
...
void TwentySevenNodeBrick::computeGaussPoint()
{
    double r  = 0.0;
    double s  = 0.0;
    double t  = 0.0;
...
# endif
        ...
        {
            cerr << "FATAL ERROR TwentySevenNodeBrick (tag: " << this->getTag() << "), has differing number of DOFs at its nodes\n";
            exit( -1 );
        }
...
const Matrix &TwentySevenNodeBrick::getInitialStiff ()
{
    ...
    if ( Ki == 0 )
    {
        cerr << "FATAL TwentySevenNodeBrick::getInitialStiff() -";
...
//=============================================================================
int TwentySevenNodeBrick::addLoad( ElementalLoad *theLoad, double loadFactor )
{
    ...
    {
        cerr << "TwentySevenNodeBrick::addLoad() - 8NodeBrick " << this->getTag() << ",load type " << type << "unknown\n";
        return -1;
    }
...
int TwentySevenNodeBrick::addInertiaLoadToUnbalance( const Vector &accel )
{
    ...
    {
        cerr << "TwentySevenNodeBrick::addInertiaLoadToUnbalance matrix and vector sizes are incompatable\n";
        return -1;
    }
...
int TwentySevenNodeBrick::sendSelf ( int commitTag, Channel &theChannel )
{
    ...
    {
        cerr << "WARNING TwentySevenNodeBrick::sendSelf() - " << this->getTag() << " failed to send ID idData\n";
        return -1;
    }
    ...
    if(idData( 2 )==1){
        ...
        {
            cerr << "WARNING TwentySevenNodeBrick::sendSelf() - " << this->getTag() << " failed to send its K\n";
            return -1;
        }
    }
    ...
    {
        cerr << "WARNING TwentySevenNodeBrick::sendSelf() - " << this->getTag() << " failed to send Vector floatData\n";
        return -1;
    }
    ...
    {
        cerr << "WARNING TwentySevenNodeBrick::sendSelf() - " << this->getTag() << " failed to send String stiffness_type\n";
        return -1;
    }
    ...
    {
        cerr << "WARNING TwentySevenNodeBrick::sendSelf() - " << this->getTag() << " failed to send String damping_type\n";
        return -1;
    }
    ...
    {
        cerr << "WARNING TwentySevenNodeBrick::sendSelf() - " << this->getTag() << " failed to send ID connectedExternalNodes\n";
        return -1;
    }
    ...
    for ( int i = 0; i < Num_TotalGaussPts; i++ )
    {
        ...
        {
            cerr << "WARNING TwentySevenNodeBrick::sendSelf() - " << this->getTag() << " failed to send material models\n";
            return -1;
        }
    }
    ...
    {
        cerr << "WARNING TwentySevenNodeBrick::sendSelf() - " << this->getTag() << " failed to send its Q\n";
        return -1;
    }
    ...
    {
        cerr << "WARNING TwentySevenNodeBrick::sendSelf() - " << this->getTag() << " failed to send its bf\n";
        return -1;
    }
...
int TwentySevenNodeBrick::receiveSelf ( int commitTag, Channel &theChannel, FEM_ObjectBroker &theBroker )
{
    ...
    {
        cerr << "WARNING TwentySevenNodeBrick::receiveSelf() - " << this->getTag() << " failed to recieve Vector floatData\n";
        return -1;
    }
    Volume                  = floatData(0) ;
    ...
    {
        cerr << "WARNING TwentySevenNodeBrick::receiveSelf() - " << this->getTag() << " failed to recieve String stiffness_type\n";
        return -1;
    }
    ...
    if ( theChannel.receiveString( 0, commitTag, tmp_string ) < 0 )
    {
        cerr << "WARNING TwentySevenNodeBrick::receiveSelf() - " << this->getTag() << " failed to recieve String damping_type\n";
        return -1;
    }
    ...
    {
        cerr << "WARNING TwentySevenNodeBrick::receiveSelf() - " << this->getTag() << " failed to recieve ID connectedExternalNodes\n";
        return -1;
    }

    // cout << "TwentySevenNodeBrick::receiveSelf() connectedExternalNodes = " << connectedExternalNodes << "\n";
    ...
    for ( int i = 0; i < Num_TotalGaussPts; i++ )
    {
        ...
        if ( ndmat == 0 )
        {
            cerr << "TwentySevenNodeBrick::receiveSelf() - Broker could not create NDMaterialLT of class type " << matClassTag << "\n";
            return -1;
        }
        ...
        {
            cerr << "TwentySevenNodeBrick::receiveSelf() - material " << i << "failed to recv itself\n";
            return -1;
        }
    ...
    {
        cerr << "TwentySevenNodeBrick::receiveSelf() - failed to recv Q!\n";
        return -1;
    }
    ...
    {
        cerr << "TwentySevenNodeBrick::receiveSelf() - failed to recv bf!\n";
        return -1;
    }
...
{
    cout << "TwentySevenNodeBrick: LTensor-based 27 node brick." << endl << endl;
...
void TwentySevenNodeBrick::ComputeVolume()
{
    Volume = 0.0;
...
int TwentySevenNodeBrick::update( void )
{
    double r  = 0.0;
    double s  = 0.0;
    double t  = 0.0;
...
double TwentySevenNodeBrick::SurfaceShapeFunctionValues( double Xi , double Eta, int whichcomponent )
{
...
Vector &TwentySevenNodeBrick::Direction_Weight( double Xi , double Eta, Vector coord1, Vector coord2,
...
Matrix &TwentySevenNodeBrick::get_Gauss_p_c( )
{
...
Matrix &TwentySevenNodeBrick::get_Gauss_p_w()
{
...
***********************************************************************************/
const vector<float> &TwentySevenNodeBrick::getGaussOutput()
{
    DTensor2 stress(3, 3);
    DTensor2 strain(3, 3);
...
void TwentySevenNodeBrick::zeroStrain()
{
    for (int gp = 0; gp < Num_TotalGaussPts; gp++)
    {
