...

{
    ...
    {
        cerr << "TotalLagrangianFD8NodeBrick::commitState () - failed in base class";
    }
...

{
    ...
    cerr << "TotalLagrangianFD8NodeBrick::addLoad - load type unknown for ele with tag: " << this->getTag();
...

{
    ...
    for (i = 0; i < NumNodes; i++)
    {
        ...
        if ( RA.Size() != NumDof )
        {
            ...
            cerr << "TotalLagrangianFD8NodeBrick::addInertiaLoadToUnbalance(): matrix and vector sizes are incompatable \n";
...

    {
        ...
        for (i = 0; i < NumNodes; i++)
        {
            ...
            if ( acc.Size() != NumDof )
            {
                ...
                cerr << "TotalLagrangianFD8NodeBrick::getResistingForceIncInertia matrix and vector sizes are incompatable \n";
