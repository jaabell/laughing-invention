...
#ifndef VariableNodeBrick_upU_CPP
#define VariableNodeBrick_upU_CPP

#include "VariableNodeBrick_upU.h"

#undef  ELE_TAG_BRICK_TYPE
#define ELE_TAG_BRICK_TYPE  ELE_TAG_VariableNodeBrick_upU
