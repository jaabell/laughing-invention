...
#ifndef VariableNodeBrickOrderFive_upU_CPP
#define VariableNodeBrickOrderFive_upU_CPP

#include "VariableNodeBrickOrderFive_upU.h"

#undef  ELE_TAG_BRICK_TYPE
#define ELE_TAG_BRICK_TYPE  ELE_TAG_VariableNodeBrickOrderFive_upU
