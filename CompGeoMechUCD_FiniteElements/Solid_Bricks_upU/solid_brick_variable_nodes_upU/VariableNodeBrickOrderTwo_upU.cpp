...
#ifndef VariableNodeBrickOrderTwo_upU_CPP
#define VariableNodeBrickOrderTwo_upU_CPP

#include "VariableNodeBrickOrderTwo_upU.h"

#undef  ELE_TAG_BRICK_TYPE
#define ELE_TAG_BRICK_TYPE  ELE_TAG_VariableNodeBrickOrderTwo_upU
