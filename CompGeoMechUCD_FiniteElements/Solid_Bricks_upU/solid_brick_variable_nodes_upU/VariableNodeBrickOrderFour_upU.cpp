...
#ifndef VariableNodeBrickOrderFour_upU_CPP
#define VariableNodeBrickOrderFour_upU_CPP

#include "VariableNodeBrickOrderFour_upU.h"

#undef  ELE_TAG_BRICK_TYPE
#define ELE_TAG_BRICK_TYPE  ELE_TAG_VariableNodeBrickOrderFour_upU
