...
#ifndef VariableNodeBrickOrderOne_upU_CPP
#define VariableNodeBrickOrderOne_upU_CPP

#include "VariableNodeBrickOrderOne_upU.h"

#undef  ELE_TAG_BRICK_TYPE
#define ELE_TAG_BRICK_TYPE  ELE_TAG_VariableNodeBrickOrderOne_upU
