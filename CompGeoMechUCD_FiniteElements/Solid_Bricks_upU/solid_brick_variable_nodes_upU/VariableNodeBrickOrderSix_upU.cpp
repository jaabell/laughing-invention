...
#ifndef VariableNodeBrickOrderSix_upU_CPP
#define VariableNodeBrickOrderSix_upU_CPP

#include "VariableNodeBrickOrderSix_upU.h"

#undef  ELE_TAG_BRICK_TYPE
#define ELE_TAG_BRICK_TYPE  ELE_TAG_VariableNodeBrickOrderSix_upU
