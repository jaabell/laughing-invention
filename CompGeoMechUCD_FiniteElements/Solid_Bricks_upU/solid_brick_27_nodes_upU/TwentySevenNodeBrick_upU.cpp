...
#ifndef TwentySevenNodeBrick_upU_CPP
#define TwentySevenNodeBrick_upU_CPP

#include "TwentySevenNodeBrick_upU.h"

#undef  ELE_TAG_BRICK_TYPE
#define ELE_TAG_BRICK_TYPE  ELE_TAG_TwentySevenNodeBrick_upU
