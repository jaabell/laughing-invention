...
#ifndef TwentySevenNodeBrick_upU_H
#define TwentySevenNodeBrick_upU_H

#undef BRICK_TYPE
#define BRICK_TYPE TwentySevenNodeBrick_upU

#undef BRICK_ELEMENT_NAME
#define BRICK_ELEMENT_NAME "TwentySevenNodeBrick_upU"
