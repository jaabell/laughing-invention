...
#ifndef EightNodeBrickOrderThree_upU_H
#define EightNodeBrickOrderThree_upU_H

#undef BRICK_TYPE
#define BRICK_TYPE EightNodeBrickOrderThree_upU

#undef BRICK_ELEMENT_NAME
#define BRICK_ELEMENT_NAME "EightNodeBrickOrderThree_upU"
