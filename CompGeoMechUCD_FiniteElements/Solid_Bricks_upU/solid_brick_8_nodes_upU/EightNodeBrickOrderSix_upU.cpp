...
#ifndef EightNodeBrickOrderSix_upU_CPP
#define EightNodeBrickOrderSix_upU_CPP

#include "EightNodeBrickOrderSix_upU.h"

#undef ELE_TAG_BRICK_TYPE
#define ELE_TAG_BRICK_TYPE  ELE_TAG_EightNodeBrickOrderSix_upU
