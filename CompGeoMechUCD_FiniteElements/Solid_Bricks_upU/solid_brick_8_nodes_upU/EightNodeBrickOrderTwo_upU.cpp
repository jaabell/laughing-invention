...
#ifndef EightNodeBrickOrderTwo_upU_CPP
#define EightNodeBrickOrderTwo_upU_CPP

#include "EightNodeBrickOrderTwo_upU.h"

#undef ELE_TAG_BRICK_TYPE
#define ELE_TAG_BRICK_TYPE  ELE_TAG_EightNodeBrickOrderTwo_upU
