...
#ifndef EightNodeBrickOrderOne_upU_H
#define EightNodeBrickOrderOne_upU_H

#undef BRICK_TYPE
#define BRICK_TYPE EightNodeBrickOrderOne_upU

#undef BRICK_ELEMENT_NAME
#define BRICK_ELEMENT_NAME "EightNodeBrickOrderOne_upU"
