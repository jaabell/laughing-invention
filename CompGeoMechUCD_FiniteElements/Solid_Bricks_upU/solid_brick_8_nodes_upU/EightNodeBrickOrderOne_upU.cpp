...
#ifndef EightNodeBrickOrderOne_upU_CPP
#define EightNodeBrickOrderOne_upU_CPP

#include "EightNodeBrickOrderOne_upU.h"

#undef ELE_TAG_BRICK_TYPE
#define ELE_TAG_BRICK_TYPE  ELE_TAG_EightNodeBrickOrderOne_upU
