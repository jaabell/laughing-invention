...
#ifndef EightNodeBrickOrderThree_upU_CPP
#define EightNodeBrickOrderThree_upU_CPP

#include "EightNodeBrickOrderThree_upU.h"

#undef ELE_TAG_BRICK_TYPE
#define ELE_TAG_BRICK_TYPE  ELE_TAG_EightNodeBrickOrderThree_upU

#undef Order
#define Order 3


#include "../MasterEightNodeBrick_upU.cpp"
