...
#ifndef EightNodeBrickOrderTwo_upU_H
#define EightNodeBrickOrderTwo_upU_H

#undef BRICK_TYPE
#define BRICK_TYPE EightNodeBrickOrderTwo_upU

#undef BRICK_ELEMENT_NAME
#define BRICK_ELEMENT_NAME "EightNodeBrickOrderTwo_upU"
