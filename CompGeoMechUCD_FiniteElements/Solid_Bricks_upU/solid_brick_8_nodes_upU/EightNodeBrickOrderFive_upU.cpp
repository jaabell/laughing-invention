...
#ifndef EightNodeBrickOrderFive_upU_CPP
#define EightNodeBrickOrderFive_upU_CPP

#include "EightNodeBrickOrderFive_upU.h"

#undef ELE_TAG_BRICK_TYPE
#define ELE_TAG_BRICK_TYPE  ELE_TAG_EightNodeBrickOrderFive_upU
