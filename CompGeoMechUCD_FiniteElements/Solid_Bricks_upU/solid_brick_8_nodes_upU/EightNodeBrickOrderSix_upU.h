...
#ifndef EightNodeBrickOrderSix_upU_H
#define EightNodeBrickOrderSix_upU_H

#undef BRICK_TYPE
#define BRICK_TYPE EightNodeBrickOrderSix_upU

#undef BRICK_ELEMENT_NAME
#define BRICK_ELEMENT_NAME "EightNodeBrickOrderSix_upU"
