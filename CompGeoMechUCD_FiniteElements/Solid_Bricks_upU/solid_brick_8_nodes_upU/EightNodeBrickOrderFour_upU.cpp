...
#ifndef EightNodeBrickOrderFour_upU_CPP
#define EightNodeBrickOrderFour_upU_CPP

#include "EightNodeBrickOrderFour_upU.h"

#undef ELE_TAG_BRICK_TYPE
#define ELE_TAG_BRICK_TYPE  ELE_TAG_EightNodeBrickOrderFour_upU
