...
#ifndef EightNodeBrickOrderFive_upU_H
#define EightNodeBrickOrderFive_upU_H

#undef BRICK_TYPE
#define BRICK_TYPE EightNodeBrickOrderFive_upU

#undef BRICK_ELEMENT_NAME
#define BRICK_ELEMENT_NAME "EightNodeBrickOrderFive_upU"
