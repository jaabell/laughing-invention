...
#ifndef TwentyNodeBrickOrderTwo_upU_H
#define TwentyNodeBrickOrderTwo_upU_H

#undef BRICK_TYPE
#define BRICK_TYPE TwentyNodeBrickOrderTwo_upU

#undef BRICK_ELEMENT_NAME
#define BRICK_ELEMENT_NAME "TwentyNodeBrickOrderTwo_upU"
