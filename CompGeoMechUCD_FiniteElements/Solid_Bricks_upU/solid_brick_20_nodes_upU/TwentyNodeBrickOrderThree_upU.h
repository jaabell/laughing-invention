...
#ifndef TwentyNodeBrickOrderThree_upU_H
#define TwentyNodeBrickOrderThree_upU_H

#undef BRICK_TYPE
#define BRICK_TYPE TwentyNodeBrickOrderThree_upU

#undef BRICK_ELEMENT_NAME
#define BRICK_ELEMENT_NAME "TwentyNodeBrickOrderThree_upU"

#undef NUMBER_NODES
#define NUMBER_NODES 20


#include "../MasterTwentyNodeBrick_upU.h"
