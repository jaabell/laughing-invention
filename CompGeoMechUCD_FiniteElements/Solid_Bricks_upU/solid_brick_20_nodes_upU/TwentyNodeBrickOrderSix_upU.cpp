...
#ifndef TwentyNodeBrickOrderSix_upU_CPP
#define TwentyNodeBrickOrderSix_upU_CPP

#include "TwentyNodeBrickOrderSix_upU.h"

#undef ELE_TAG_BRICK_TYPE
#define ELE_TAG_BRICK_TYPE  ELE_TAG_TwentyNodeBrickOrderSix_upU
