...
#ifndef TwentyNodeBrickOrderTwo_upU_CPP
#define TwentyNodeBrickOrderTwo_upU_CPP

#include "TwentyNodeBrickOrderTwo_upU.h"

#undef ELE_TAG_BRICK_TYPE
#define ELE_TAG_BRICK_TYPE  ELE_TAG_TwentyNodeBrickOrderTwo_upU
