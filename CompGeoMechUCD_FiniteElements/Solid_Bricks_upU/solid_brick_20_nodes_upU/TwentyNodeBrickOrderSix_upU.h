...
#ifndef TwentyNodeBrickOrderSix_upU_H
#define TwentyNodeBrickOrderSix_upU_H

#undef BRICK_TYPE
#define BRICK_TYPE TwentyNodeBrickOrderSix_upU

#undef BRICK_ELEMENT_NAME
#define BRICK_ELEMENT_NAME "TwentyNodeBrickOrderSix_upU"
