...
#ifndef TwentyNodeBrickOrderFour_upU_CPP
#define TwentyNodeBrickOrderFour_upU_CPP

#include "TwentyNodeBrickOrderFour_upU.h"

#undef ELE_TAG_BRICK_TYPE
#define ELE_TAG_BRICK_TYPE  ELE_TAG_TwentyNodeBrickOrderFour_upU
