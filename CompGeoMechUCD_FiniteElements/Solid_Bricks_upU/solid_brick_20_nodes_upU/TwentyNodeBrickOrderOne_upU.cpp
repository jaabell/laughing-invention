...
#ifndef TwentyNodeBrickOrderOne_upU_CPP
#define TwentyNodeBrickOrderOne_upU_CPP

#include "TwentyNodeBrickOrderOne_upU.h"

#undef ELE_TAG_BRICK_TYPE
#define ELE_TAG_BRICK_TYPE  ELE_TAG_TwentyNodeBrickOrderOne_upU
