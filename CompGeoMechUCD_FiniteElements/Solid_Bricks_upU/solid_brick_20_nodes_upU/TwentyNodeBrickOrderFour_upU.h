...
#ifndef TwentyNodeBrickOrderFour_upU_H
#define TwentyNodeBrickOrderFour_upU_H

#undef BRICK_TYPE
#define BRICK_TYPE TwentyNodeBrickOrderFour_upU

#undef BRICK_ELEMENT_NAME
#define BRICK_ELEMENT_NAME "TwentyNodeBrickOrderFour_upU"
