...
#ifndef TwentyNodeBrickOrderFive_upU_H
#define TwentyNodeBrickOrderFive_upU_H

#undef BRICK_TYPE
#define BRICK_TYPE TwentyNodeBrickOrderFive_upU

#undef BRICK_ELEMENT_NAME
#define BRICK_ELEMENT_NAME "TwentyNodeBrickOrderFive_upU"
