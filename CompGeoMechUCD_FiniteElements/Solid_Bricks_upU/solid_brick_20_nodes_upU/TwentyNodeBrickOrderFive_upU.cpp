...
#ifndef TwentyNodeBrickOrderFive_upU_CPP
#define TwentyNodeBrickOrderFive_upU_CPP

#include "TwentyNodeBrickOrderFive_upU.h"

#undef ELE_TAG_BRICK_TYPE
#define ELE_TAG_BRICK_TYPE  ELE_TAG_TwentyNodeBrickOrderFive_upU
