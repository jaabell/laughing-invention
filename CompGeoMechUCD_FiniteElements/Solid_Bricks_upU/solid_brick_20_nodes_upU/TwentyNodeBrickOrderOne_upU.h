...
#ifndef TwentyNodeBrickOrderOne_upU_H
#define TwentyNodeBrickOrderOne_upU_H

#undef BRICK_TYPE
#define BRICK_TYPE TwentyNodeBrickOrderOne_upU

#undef BRICK_ELEMENT_NAME
#define BRICK_ELEMENT_NAME "TwentyNodeBrickOrderOne_upU"
