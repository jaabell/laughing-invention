...
#ifndef TwentyNodeBrickVariableGP_H
#define TwentyNodeBrickVariableGP_H
...
class TwentyNodeBrickVariableGP: public Element
{

    public:
        TwentyNodeBrickVariableGP(int element_number, int number_of_gauss_points_in_each_direction,
    ...
    public:
        ...
        TwentyNodeBrickVariableGP &operator[](int subscript);
