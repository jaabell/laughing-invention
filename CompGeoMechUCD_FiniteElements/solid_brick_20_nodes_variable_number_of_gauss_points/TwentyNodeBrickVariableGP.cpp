...
// FILE:              TwentyNodeBrickVariableGP.cpp
// CLASS:             TwentyNodeBrickVariableGP
// MEMBER FUNCTIONS:
//
// MEMBER VARIABLES
//
...
// DATE:              May 2013
// UPDATE HISTORY:    Based on the TwentyNodeBrick element with the option of
//                    choosing the number of Gauss points
//
///////////////////////////////////////////////////////////////////////////////


#ifndef TwentyNodeBrickVariableGP_CPP
#define TwentyNodeBrickVariableGP_CPP


#include "TwentyNodeBrickVariableGP.h"


Matrix TwentyNodeBrickVariableGP::K(60, 60);
Matrix TwentyNodeBrickVariableGP::M(60, 60);
Vector TwentyNodeBrickVariableGP::P(60);
Vector TwentyNodeBrickVariableGP::ShapeFunctionValues_in_function(8);
Vector TwentyNodeBrickVariableGP::J_vector_in_function(3);
double TwentyNodeBrickVariableGP::SurfaceLoadValues_in_function;
...
TwentyNodeBrickVariableGP::TwentyNodeBrickVariableGP(int element_number, int number_of_gauss_points_in_each_direction,
      ...
      connectedExternalNodes(20), Ki(0), Q(60), rho(0.0)
{
    ...
    integration_order = number_of_gauss_points_in_each_direction;
...
//====================================================================
TwentyNodeBrickVariableGP::TwentyNodeBrickVariableGP (): Element(0, ELE_TAG_TwentyNodeBrickVariableGP ),
    connectedExternalNodes(20), Ki(0), Q(60), rho(0.0), mmodel(0)
{
    matpoint = 0;
...
/////////////////////////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////////////////
TwentyNodeBrickVariableGP::~TwentyNodeBrickVariableGP ()
{
...
/////////////////////////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////////////////
void TwentyNodeBrickVariableGP::incremental_Update()
{
    double r  = 0.0;
    // double rw = 0.0;
    double s  = 0.0;
    ...
    for ( short GP_c_r = 1 ; GP_c_r <= integration_order ; GP_c_r++ )
    {
        ...
        for ( short GP_c_s = 1 ; GP_c_s <= integration_order ; GP_c_s++ )
        {
            ...
            for ( short GP_c_t = 1 ; GP_c_t <= integration_order ; GP_c_t++ )
            {
                ...
                {
                    cerr << "TwentyNodeBrickVariableGP::incremental_Update (tag: " << this->getTag() << "), not converged\n";
                }
            }
        }
    }
...
//#############################################################################
//***************************************************************
tensor TwentyNodeBrickVariableGP::H_3D(double r1, double r2, double r3)
{
...
//#############################################################################
//***************************************************************
tensor TwentyNodeBrickVariableGP::interp_poli_at(double r1, double r2, double r3)
{
...
tensor TwentyNodeBrickVariableGP::dh_drst_at(double r1, double r2, double r3)
{
    ...
    dh.val(11, 2) = - (1.0 - r1 * r1) * (1.0 + r3) * 0.25; ///4.0;
...
////#############################################################################
tensor TwentyNodeBrickVariableGP::getStiffnessTensor(void)
{
    int K_dim[] = {20, 3, 3, 20};
...
////#############################################################################
//  tensor TwentyNodeBrickVariableGP::mass_tensor(Elastic  mmodel)
tensor TwentyNodeBrickVariableGP::getMassTensor(void)
{
    //int M_dim[] = {8,3,3,8};
    int M_dim[] = {60, 60};
...
////#############################################################################
tensor TwentyNodeBrickVariableGP::Jacobian_3D(tensor dh)
{
...
//#############################################################################
tensor TwentyNodeBrickVariableGP::Jacobian_3Dinv(tensor dh)
{
    tensor N_C = Nodal_Coordinates();
...
////#############################################################################
tensor TwentyNodeBrickVariableGP::Nodal_Coordinates(void)
{
...
////#############################################################################
tensor TwentyNodeBrickVariableGP::incr_disp(void)
{
    const int dimensions[] = {20, 3};
...
////#############################################################################
tensor TwentyNodeBrickVariableGP::total_disp(void)
{
    const int dimensions[] = {20, 3};
...
////#############################################################################
int TwentyNodeBrickVariableGP::get_global_number_of_node(int local_node_number)
{
...
////#############################################################################
int  TwentyNodeBrickVariableGP::get_Brick_Number(void)
{
    //return elem_numb;
    return this->getTag();
}
...
tensor TwentyNodeBrickVariableGP::nodal_forces(void)
{
...
tensor TwentyNodeBrickVariableGP::iterative_nodal_forces(void)
{
    int force_dim[] = {20, 3}; // Xiaoyan changed from {20,3 to {8,3} for 8 nodes
...
tensor TwentyNodeBrickVariableGP::linearized_nodal_forces(void)
{
    int force_dim[] = {20, 3}; // Xiaoyan changed from {20,3 to {8,3} for 8 nodes
    ...
    for ( short GP_c_r = 1 ; GP_c_r <= integration_order ; GP_c_r++ )
    {
        ...
        for ( short GP_c_s = 1 ; GP_c_s <= integration_order ; GP_c_s++ )
        {
            ...
            for ( short GP_c_t = 1 ; GP_c_t <= integration_order ; GP_c_t++ )
            {
                ...
                if ( ! (matpoint[where]->matmodel)->setTrialStrainIncr( incremental_strain)  )
                {
                    cerr << "TwentyNodeBrickVariableGP::linearized_nodal_forces (tag: " << this->getTag() << "), not converged\n";
                }
...
void TwentyNodeBrickVariableGP::report(char *msg)
{
    ...
    ::printf("\n Element Number = %d\n", this->getTag() );
    ::printf("\n Number of nodes in a TwentyNodeBrickVariableGP = %d\n",
             nodes_in_brick);
...
//#############################################################################
void TwentyNodeBrickVariableGP::reportpqtheta(int GP_numb)
{
...
//=============================================================================
int TwentyNodeBrickVariableGP::getNumExternalNodes () const
{
...
//=============================================================================
int TwentyNodeBrickVariableGP::getNumDOF ()
{
...
void TwentyNodeBrickVariableGP::setDomain (Domain *theDomain)
{
    ...
    else
    {
                ...
                theNodes[16] == 0 || theNodes[17] == 0 || theNodes[18] == 0 || theNodes[19] == 0 )
        {
            ...
            cerr << "FATAL ERROR TwentyNodeBrickVariableGP (tag: " << this->getTag() << " ), node not found in domain\n";
            exit(-1);
        }
        ...
        {
            cerr << "FATAL ERROR TwentyNodeBrickVariableGP (tag: " << this->getTag() <<
...
//=============================================================================
int TwentyNodeBrickVariableGP::commitState ()
{
    int retVal = 0;
    ...
    {
        cerr << "TwentyNodeBrickVariableGP::commitState () - failed in base class";
    }
...
//=============================================================================
int TwentyNodeBrickVariableGP::revertToLastCommit ()
{
    int i;
    int retVal = 0;
...
//=============================================================================
int TwentyNodeBrickVariableGP::revertToStart ()
{
    int i;
    int retVal = 0;
...
//=============================================================================
void TwentyNodeBrickVariableGP::zeroLoad(void)
{
    Q.Zero();
}
...
TwentyNodeBrickVariableGP::addLoad(ElementalLoad *theLoad, double loadFactor)
{
    ...
    {
        cerr << "TwentyNodeBrickVariableGP::addLoad() - 20NodeBrick " << this->getTag() << ",load type " << type << "unknown\n";
        return -1;
    }
...
int TwentyNodeBrickVariableGP::addInertiaLoadToUnbalance(const Vector &accel)
{
            ...
            3 != Raccel17.Size() || 3 != Raccel18.Size() || 3 != Raccel19.Size() || 3 != Raccel20.Size()   )
    {
        ...
        cerr << "TwentyNodeBrickVariableGP::addInertiaLoadToUnbalance " <<
...
//=============================================================================
int TwentyNodeBrickVariableGP::receiveSelf (int commitTag, Channel &theChannel, FEM_ObjectBroker &theBroker)
{
    // Not implemtented yet
    return 0;
}
...
////#############################################################################
Vector TwentyNodeBrickVariableGP::getWeightofGP(void)
{
...
double TwentyNodeBrickVariableGP::get_Gauss_p_c(short order, short point_numb)
{
...
double TwentyNodeBrickVariableGP::get_Gauss_p_w(short order, short point_numb)
{
...
int TwentyNodeBrickVariableGP::update() //Added by Guanzhou, May 7 2004
{
    double r  = 0.0;
    double s  = 0.0;
    double t  = 0.0;
    ...
    for ( short GP_c_r = 1 ; GP_c_r <= integration_order ; GP_c_r++ )
    {
        ...
        for ( short GP_c_s = 1 ; GP_c_s <= integration_order ; GP_c_s++ )
        {
            ...
            for ( short GP_c_t = 1 ; GP_c_t <= integration_order ; GP_c_t++ )
            {
                ...
                if ( ( (matpoint[where]->matmodel)->setTrialStrainIncr( incremental_strain)) )
                {
                    cerr << "TwentyNodeBrickVariableGP::update (tag: " << this->getTag() << "), update() failed\n";
                }
            }
        }
    }
...
double  TwentyNodeBrickVariableGP::SurfaceShapeFunctionValues(double Xi , double Eta, int whichcomponent)
{
...
double TwentyNodeBrickVariableGP::SurfaceLoadValues(double Xi , double Eta, Vector Pressure)
{
