...
/////////////////////////////////////////////////////////////////////////////////////
// Adapted by Sumeet, for EightNodeBrickOrderOne to use the LTensor library for
// tensorial representation. [September, 2016]
/////////////////////////////////////////////////////////////////////////////////////


#ifndef EightNodeBrickOrderOne_CPP
#define EightNodeBrickOrderOne_CPP

#include "EightNodeBrickOrderOne.h"
...
DTensor2 EightNodeBrickOrderOne::gp_coords(Num_TotalGaussPts, 3, 0.0);
DTensor2 EightNodeBrickOrderOne::gp_weight(Num_TotalGaussPts, 3, 0.0);
Matrix EightNodeBrickOrderOne::gauss_points(Num_TotalGaussPts, 3);
vector<float> EightNodeBrickOrderOne::Gauss_Output_Vector(Num_TotalGaussPts*18);

Matrix EightNodeBrickOrderOne::K( 24, 24);

Vector EightNodeBrickOrderOne::ShapeFunctionValues_in_function( 4 );  // Nima added for surface load (July 2012)
Vector EightNodeBrickOrderOne::J_vector_in_function( 3 );             // Nima added for surface load (July 2012)
double EightNodeBrickOrderOne::SurfaceLoadValues_in_function;

//====================================================================
// Constructor
//====================================================================
EightNodeBrickOrderOne::EightNodeBrickOrderOne( int element_number,
                                    int node_numb_1, int node_numb_2, int node_numb_3, int node_numb_4,
                                    int node_numb_5, int node_numb_6, int node_numb_7, int node_numb_8,
                                    NDMaterialLT *Globalmmodel)

    : Element( element_number,ELE_TAG_EightNodeBrickOrderOne ),
      ...
      M( 24, 24), P( 24 )
{
    ...
    if (material_array == 0)
    {
        cerr << " EightNodeBrickOrderOne::EightNodeBrickOrderOne -- failed allocate material model pointer\n";
        exit(-1);
    }
...
//====================================================================
EightNodeBrickOrderOne::EightNodeBrickOrderOne(): Element( 0, ELE_TAG_EightNodeBrickOrderOne ),
    rho( 0.0 ), connectedExternalNodes( 8 ) ,
...
//####DESTROYER!###############################################################
EightNodeBrickOrderOne::~EightNodeBrickOrderOne ()
{
...
//#############################################################################
//***************************************************************
const DTensor2 &EightNodeBrickOrderOne::H_3D( double r1, double r2, double r3 ) const
{
...
//#############################################################################
//***************************************************************
const DTensor1 &EightNodeBrickOrderOne::interp_poli_at( double r1, double r2, double r3 ) const
{
...
const DTensor2 &EightNodeBrickOrderOne::dh_drst_at( double r1, double r2, double r3 ) const
{
...
////#############################################################################
const DTensor2 &EightNodeBrickOrderOne::Jacobian_3D( const DTensor2 &dh ) const
{
...
//#############################################################################
const DTensor2  &EightNodeBrickOrderOne::Jacobian_3Dinv( const DTensor2 &dh ) const
{
    const DTensor2 &N_C = Nodal_Coordinates();
...
////#############################################################################
const DTensor2 &EightNodeBrickOrderOne::Nodal_Coordinates( void ) const
{
...
////#############################################################################
const DTensor2 &EightNodeBrickOrderOne::incr_disp( void ) const
{
...
////#############################################################################
const DTensor2 &EightNodeBrickOrderOne::total_disp( void ) const
{
...
////#############################################################################
int EightNodeBrickOrderOne::get_global_number_of_node( int local_node_number )
{
    return connectedExternalNodes( local_node_number );
}

////#############################################################################
int  EightNodeBrickOrderOne::get_Brick_Number( void )
{
    return this->getTag();
}
...
const DTensor2 &EightNodeBrickOrderOne::nodal_forces( void ) const
{
    double r  = 0.0;
    double w_r = 0.0;
    double s  = 0.0;
...
void EightNodeBrickOrderOne::computeGaussPoint()
{
    double r  = 0.0;
    double s  = 0.0;
    double t  = 0.0;
...
//=============================================================================
int EightNodeBrickOrderOne::getNumExternalNodes () const
{
    return 8;
}
...
//=============================================================================
const ID &EightNodeBrickOrderOne::getExternalNodes ()
{
    return connectedExternalNodes;
}

Node **
EightNodeBrickOrderOne::getNodePtrs( void )
{
    return theNodes;
}

//=============================================================================
int EightNodeBrickOrderOne::getNumDOF ()
{
    return 24;
}

//=============================================================================
void EightNodeBrickOrderOne::setDomain ( Domain *theDomain )
{
...
# endif
        ...
        {
            cerr << "FATAL ERROR EightNodeBrickOrderOne (tag: " << this->getTag() << "), node not found in domain\n";
            exit( -1 );
        }
        ...
        {
            cerr << "FATAL ERROR EightNodeBrickOrderOne (tag: " << this->getTag() << "), has differing number of DOFs at its nodes\n";
            exit( -1 );
        }
...
//=============================================================================
int EightNodeBrickOrderOne::commitState ()
{
    ...
    {
        cerr << "EightNodeBrickOrderOne::commitState () - failed in base class";
    }
...
//=============================================================================
int EightNodeBrickOrderOne::revertToLastCommit ()
{
    int retVal = 0;
...
//=============================================================================
int EightNodeBrickOrderOne::revertToStart ()
{
    int retVal = 0;
...
//=============================================================================
const Matrix &EightNodeBrickOrderOne::getTangentStiff()
{
...
//=============================================================================
const Matrix &EightNodeBrickOrderOne::getInitialStiff ()
{
    ...
    if ( Ki == 0 )
    {
        cerr << "FATAL EightNodeBrickOrderOne::getInitialStiff() -";
...
const Matrix &EightNodeBrickOrderOne::getMass ()
{
...
//=============================================================================
void EightNodeBrickOrderOne::zeroLoad( void )
{
    Q.Zero();
}
...
//======================================================================
const Vector &EightNodeBrickOrderOne::getBodyForce( double loadFactor, const Vector &data )
{
...
//======================================================================
const Vector &EightNodeBrickOrderOne::getSurfaceForce( double loadFactor, const Vector &data )
{
...
//=============================================================================
int EightNodeBrickOrderOne::addLoad( ElementalLoad *theLoad, double loadFactor )
{
    ...
    {
        cerr << "EightNodeBrickOrderOne::addLoad() - 8NodeBrickLT " << this->getTag() << ",load type " << type << "unknown\n";
        return -1;
    }
...
//=============================================================================
int EightNodeBrickOrderOne::addInertiaLoadToUnbalance( const Vector &accel )
{
    // Check for a quick return
    if ( rho == 0.0 )
    {
    ...
    {
        cerr << "EightNodeBrickOrderOne::addInertiaLoadToUnbalance matrix and vector sizes are incompatable\n";
        return -1;
    }
...
//=============================================================================
const Vector EightNodeBrickOrderOne::FormEquiBodyForce( void )
{
    Vector bforce( 24 );
...
//=============================================================================
const Vector &EightNodeBrickOrderOne::getResistingForce()
{
...
//=============================================================================
const Vector &EightNodeBrickOrderOne::getResistingForceIncInertia ()
{
...
int EightNodeBrickOrderOne::sendSelf ( int commitTag, Channel &theChannel )
{
    ...
    {
        cerr << "WARNING EightNodeBrickOrderOne::sendSelf() - " << this->getTag() << " failed to send ID idData\n";
        return -1;
    }
    ...
    if(idData( 2 )==1){
        ...
        {
            cerr << "WARNING EightNodeBrickOrderOne::sendSelf() - " << this->getTag() << " failed to send its K\n";
            return -1;
        }
    }
    ...
    {
        cerr << "WARNING EightNodeBrickOrderOne::sendSelf() - " << this->getTag() << " failed to send Vector floatData\n";
        return -1;
    }
    ...
    {
        cerr << "WARNING EightNodeBrickOrderOne::sendSelf() - " << this->getTag() << " failed to send String stiffness_type\n";
        return -1;
    }
    ...
    {
        cerr << "WARNING EightNodeBrickOrderOne::sendSelf() - " << this->getTag() << " failed to send String damping_type\n";
        return -1;
    }

    // Send the nodes

    cout << this->getTag() << " -> EightNodeBrickOrderOne::sendSelf() connectedExternalNodes = " << connectedExternalNodes << "\n";


    if ( theChannel.sendID( 0, commitTag, connectedExternalNodes ) < 0 )
    {
        cerr << "WARNING EightNodeBrickOrderOne::sendSelf() - " << this->getTag() << " failed to send ID connectedExternalNodes\n";
        return -1;
    }
    ...
    for ( int i = 0; i < Num_TotalGaussPts; i++ )
    {
        ...
        {
            cerr << "WARNING EightNodeBrickOrderOne::sendSelf() - " << this->getTag() << " failed to send material models\n";
            return -1;
        }
    }
    ...
    {
        cerr << "WARNING EightNodeBrickOrderOne::sendSelf() - " << this->getTag() << " failed to send its Q\n";
        return -1;
    }
    ...
    {
        cerr << "WARNING EightNodeBrickOrderOne::sendSelf() - " << this->getTag() << " failed to send its bf\n";
        return -1;
    }
...
int EightNodeBrickOrderOne::receiveSelf ( int commitTag, Channel &theChannel, FEM_ObjectBroker &theBroker )
{
    ...
    {
        cerr << "WARNING EightNodeBrickOrderOne::receiveSelf() - failed to receive ID\n";
        return -1;
    }
    ...
    if(idData(2)){
        if ( theChannel.sendMatrix( 0, commitTag, K ) < 0 )
        {
            cerr << "WARNING EightNodeBrickOrderOne::receiveSelf() - " << this->getTag() << " failed to recieve its K\n";
            return -1;
        }
    }
    ...
    {
        cerr << "WARNING EightNodeBrickOrderOne::receiveSelf() - " << this->getTag() << " failed to recieve Vector floatData\n";
        return -1;
    }
    Volume                  = floatData(0) ;
    ...
    {
        cerr << "WARNING EightNodeBrickOrderOne::receiveSelf() - " << this->getTag() << " failed to recieve String stiffness_type\n";
        return -1;
    }
    ...
    if ( theChannel.receiveString( 0, commitTag, tmp_string ) < 0 )
    {
        cerr << "WARNING EightNodeBrickOrderOne::receiveSelf() - " << this->getTag() << " failed to recieve String damping_type\n";
        return -1;
    }
    ...
    {
        cerr << "WARNING EightNodeBrickOrderOne::receiveSelf() - " << this->getTag() << " failed to recieve ID connectedExternalNodes\n";
        return -1;
    }

    cout << this->getTag() << " -> EightNodeBrickOrderOne::receiveSelf() connectedExternalNodes = " << connectedExternalNodes << "\n";
    ...
    for ( int i = 0; i < Num_TotalGaussPts; i++ )
    {
        ...
        if ( ndmat == 0 )
        {
            cerr << "EightNodeBrickOrderOne::receiveSelf() - Broker could not create NDMaterialLT of class type " << matClassTag << "\n";
            return -1;
        }
        ...
        {
            cerr << "EightNodeBrickOrderOne::receiveSelf() - material " << i << "failed to recv itself\n";
            return -1;
        }
    ...
    {
        cerr << "EightNodeBrickOrderOne::receiveSelf() - failed to recv Q!\n";
        return -1;
    }
    ...
    {
        cerr << "EightNodeBrickOrderOne::receiveSelf() - failed to recv bf!\n";
        return -1;
    }
...
int EightNodeBrickOrderOne::getObjectSize()
{
...
//=============================================================================
void EightNodeBrickOrderOne::Print( ostream &s, int flag )
{
    cout << "EightNodeBrickOrderOne: LTensor-based 8 node brick." << endl << endl;
...
void EightNodeBrickOrderOne::ComputeVolume()
{
    Volume = 0.0;
...
int EightNodeBrickOrderOne::update( void )
{
    ...
    //Debug
    // cout << endl << endl << "EightNodeBrickOrderOne::update()" << endl;
    ...
    for ( short gp = 0; gp < Num_TotalGaussPts; gp++ )
    {
        ...
        if ( ( material_array[gp]->setTrialStrainIncr( trial_strain ) ) )
        {
            ...
            cerr << "EightNodeBrickOrderOne::update (tag: " << this->getTag()
...
double EightNodeBrickOrderOne::SurfaceShapeFunctionValues( double Xi , double Eta, int whichcomponent )
{
...
Vector &EightNodeBrickOrderOne::Direction_Weight( double Xi , double Eta, Vector coord1, Vector coord2, Vector coord3, Vector coord4 )
{
    Vector J1( 3 );
    Vector J2( 3 );
...
double EightNodeBrickOrderOne::SurfaceLoadValues( double Xi , double Eta, Vector Pressure )
{
...
int
EightNodeBrickOrderOne::CheckMesh( ofstream &checkmesh_file )
{
...
//==================================================================================
Vector *
EightNodeBrickOrderOne::getStress( void )
{
...
Matrix &EightNodeBrickOrderOne::getGaussCoordinates(void)
{
    computeGaussPoint();
    return gauss_points;
}

Matrix &EightNodeBrickOrderOne::get_Gauss_p_c( )
{
...
Matrix &EightNodeBrickOrderOne::get_Gauss_p_w()
{
...
***********************************************************************************/
const vector<float> &EightNodeBrickOrderOne::getGaussOutput()
{
    DTensor2 stress(3, 3);
    DTensor2 strain(3, 3);
...
void EightNodeBrickOrderOne::zeroStrain()
{
    for (int gp = 0; gp < Num_TotalGaussPts; gp++)
    {
