...
/////////////////////////////////////////////////////////////////////////////////////
// Adapted by Sumeet, for EightNodeBrickOrderTwo to use the LTensor library for
// tensorial representation. [September, 2016]
/////////////////////////////////////////////////////////////////////////////////////


#ifndef EightNodeBrickOrderTwo_CPP
#define EightNodeBrickOrderTwo_CPP

#include "EightNodeBrickOrderTwo.h"
...
DTensor2 EightNodeBrickOrderTwo::gp_coords(Num_TotalGaussPts, 3, 0.0);
DTensor2 EightNodeBrickOrderTwo::gp_weight(Num_TotalGaussPts, 3, 0.0);
Matrix EightNodeBrickOrderTwo::gauss_points(Num_TotalGaussPts, 3);
vector<float> EightNodeBrickOrderTwo::Gauss_Output_Vector(Num_TotalGaussPts*18);

Matrix EightNodeBrickOrderTwo::K( 24, 24);

Vector EightNodeBrickOrderTwo::ShapeFunctionValues_in_function( 4 );  // Nima added for surface load (July 2012)
Vector EightNodeBrickOrderTwo::J_vector_in_function( 3 );             // Nima added for surface load (July 2012)
double EightNodeBrickOrderTwo::SurfaceLoadValues_in_function;

//====================================================================
// Constructor
//====================================================================
EightNodeBrickOrderTwo::EightNodeBrickOrderTwo( int element_number,
                                    int node_numb_1, int node_numb_2, int node_numb_3, int node_numb_4,
                                    int node_numb_5, int node_numb_6, int node_numb_7, int node_numb_8,
                                    NDMaterialLT *Globalmmodel)

    : Element( element_number,ELE_TAG_EightNodeBrickOrderTwo ),
      ...
      M( 24, 24), P( 24 )
{
    ...
    if (material_array == 0)
    {
        cerr << " EightNodeBrickOrderTwo::EightNodeBrickOrderTwo -- failed allocate material model pointer\n";
        exit(-1);
    }
...
//====================================================================
EightNodeBrickOrderTwo::EightNodeBrickOrderTwo(): Element( 0, ELE_TAG_EightNodeBrickOrderTwo ),
    rho( 0.0 ), connectedExternalNodes( 8 ) ,
...
//####DESTROYER!###############################################################
EightNodeBrickOrderTwo::~EightNodeBrickOrderTwo ()
{
...
//#############################################################################
//***************************************************************
const DTensor2 &EightNodeBrickOrderTwo::H_3D( double r1, double r2, double r3 ) const
{
...
//#############################################################################
//***************************************************************
const DTensor1 &EightNodeBrickOrderTwo::interp_poli_at( double r1, double r2, double r3 ) const
{
...
const DTensor2 &EightNodeBrickOrderTwo::dh_drst_at( double r1, double r2, double r3 ) const
{
...
////#############################################################################
const DTensor2 &EightNodeBrickOrderTwo::Jacobian_3D( const DTensor2 &dh ) const
{
...
//#############################################################################
const DTensor2  &EightNodeBrickOrderTwo::Jacobian_3Dinv( const DTensor2 &dh ) const
{
    const DTensor2 &N_C = Nodal_Coordinates();
...
////#############################################################################
const DTensor2 &EightNodeBrickOrderTwo::Nodal_Coordinates( void ) const
{
...
////#############################################################################
const DTensor2 &EightNodeBrickOrderTwo::incr_disp( void ) const
{
...
////#############################################################################
const DTensor2 &EightNodeBrickOrderTwo::total_disp( void ) const
{
...
////#############################################################################
int EightNodeBrickOrderTwo::get_global_number_of_node( int local_node_number )
{
    return connectedExternalNodes( local_node_number );
}

////#############################################################################
int  EightNodeBrickOrderTwo::get_Brick_Number( void )
{
    return this->getTag();
}
...
const DTensor2 &EightNodeBrickOrderTwo::nodal_forces( void ) const
{
    double r  = 0.0;
    double w_r = 0.0;
    double s  = 0.0;
...
void EightNodeBrickOrderTwo::computeGaussPoint()
{
    double r  = 0.0;
    double s  = 0.0;
    double t  = 0.0;
...
//=============================================================================
int EightNodeBrickOrderTwo::getNumExternalNodes () const
{
    return 8;
}
...
//=============================================================================
const ID &EightNodeBrickOrderTwo::getExternalNodes ()
{
    return connectedExternalNodes;
}

Node **
EightNodeBrickOrderTwo::getNodePtrs( void )
{
    return theNodes;
}

//=============================================================================
int EightNodeBrickOrderTwo::getNumDOF ()
{
    return 24;
}

//=============================================================================
void EightNodeBrickOrderTwo::setDomain ( Domain *theDomain )
{
...
# endif
        ...
        {
            cerr << "FATAL ERROR EightNodeBrickOrderTwo (tag: " << this->getTag() << "), node not found in domain\n";
            exit( -1 );
        }
        ...
        {
            cerr << "FATAL ERROR EightNodeBrickOrderTwo (tag: " << this->getTag() << "), has differing number of DOFs at its nodes\n";
            exit( -1 );
        }
...
//=============================================================================
int EightNodeBrickOrderTwo::commitState ()
{
    ...
    {
        cerr << "EightNodeBrickOrderTwo::commitState () - failed in base class";
    }
...
//=============================================================================
int EightNodeBrickOrderTwo::revertToLastCommit ()
{
    int retVal = 0;
...
//=============================================================================
int EightNodeBrickOrderTwo::revertToStart ()
{
    int retVal = 0;
...
//=============================================================================
const Matrix &EightNodeBrickOrderTwo::getTangentStiff()
{
...
//=============================================================================
const Matrix &EightNodeBrickOrderTwo::getInitialStiff ()
{
    ...
    if ( Ki == 0 )
    {
        cerr << "FATAL EightNodeBrickOrderTwo::getInitialStiff() -";
...
const Matrix &EightNodeBrickOrderTwo::getMass ()
{
...
//=============================================================================
void EightNodeBrickOrderTwo::zeroLoad( void )
{
    Q.Zero();
}
...
//======================================================================
const Vector &EightNodeBrickOrderTwo::getBodyForce( double loadFactor, const Vector &data )
{
...
//======================================================================
const Vector &EightNodeBrickOrderTwo::getSurfaceForce( double loadFactor, const Vector &data )
{
...
//=============================================================================
int EightNodeBrickOrderTwo::addLoad( ElementalLoad *theLoad, double loadFactor )
{
    ...
    {
        cerr << "EightNodeBrickOrderTwo::addLoad() - 8NodeBrickLT " << this->getTag() << ",load type " << type << "unknown\n";
        return -1;
    }
...
//=============================================================================
int EightNodeBrickOrderTwo::addInertiaLoadToUnbalance( const Vector &accel )
{
    // Check for a quick return
    if ( rho == 0.0 )
    {
    ...
    {
        cerr << "EightNodeBrickOrderTwo::addInertiaLoadToUnbalance matrix and vector sizes are incompatable\n";
        return -1;
    }
...
//=============================================================================
const Vector EightNodeBrickOrderTwo::FormEquiBodyForce( void )
{
    Vector bforce( 24 );
...
//=============================================================================
const Vector &EightNodeBrickOrderTwo::getResistingForce()
{
...
//=============================================================================
const Vector &EightNodeBrickOrderTwo::getResistingForceIncInertia ()
{
...
int EightNodeBrickOrderTwo::sendSelf ( int commitTag, Channel &theChannel )
{
    ...
    {
        cerr << "WARNING EightNodeBrickOrderTwo::sendSelf() - " << this->getTag() << " failed to send ID idData\n";
        return -1;
    }
    ...
    if(idData( 2 )==1){
        ...
        {
            cerr << "WARNING EightNodeBrickOrderTwo::sendSelf() - " << this->getTag() << " failed to send its K\n";
            return -1;
        }
    }
    ...
    {
        cerr << "WARNING EightNodeBrickOrderTwo::sendSelf() - " << this->getTag() << " failed to send Vector floatData\n";
        return -1;
    }
    ...
    {
        cerr << "WARNING EightNodeBrickOrderTwo::sendSelf() - " << this->getTag() << " failed to send String stiffness_type\n";
        return -1;
    }
    ...
    {
        cerr << "WARNING EightNodeBrickOrderTwo::sendSelf() - " << this->getTag() << " failed to send String damping_type\n";
        return -1;
    }

    // Send the nodes

    cout << this->getTag() << " -> EightNodeBrickOrderTwo::sendSelf() connectedExternalNodes = " << connectedExternalNodes << "\n";


    if ( theChannel.sendID( 0, commitTag, connectedExternalNodes ) < 0 )
    {
        cerr << "WARNING EightNodeBrickOrderTwo::sendSelf() - " << this->getTag() << " failed to send ID connectedExternalNodes\n";
        return -1;
    }
    ...
    for ( int i = 0; i < Num_TotalGaussPts; i++ )
    {
        ...
        {
            cerr << "WARNING EightNodeBrickOrderTwo::sendSelf() - " << this->getTag() << " failed to send material models\n";
            return -1;
        }
    }
    ...
    {
        cerr << "WARNING EightNodeBrickOrderTwo::sendSelf() - " << this->getTag() << " failed to send its Q\n";
        return -1;
    }
    ...
    {
        cerr << "WARNING EightNodeBrickOrderTwo::sendSelf() - " << this->getTag() << " failed to send its bf\n";
        return -1;
    }
...
int EightNodeBrickOrderTwo::receiveSelf ( int commitTag, Channel &theChannel, FEM_ObjectBroker &theBroker )
{
    ...
    {
        cerr << "WARNING EightNodeBrickOrderTwo::receiveSelf() - failed to receive ID\n";
        return -1;
    }
    ...
    if(idData(2)){
        if ( theChannel.sendMatrix( 0, commitTag, K ) < 0 )
        {
            cerr << "WARNING EightNodeBrickOrderTwo::receiveSelf() - " << this->getTag() << " failed to recieve its K\n";
            return -1;
        }
    }
    ...
    {
        cerr << "WARNING EightNodeBrickOrderTwo::receiveSelf() - " << this->getTag() << " failed to recieve Vector floatData\n";
        return -1;
    }
    Volume                  = floatData(0) ;
    ...
    {
        cerr << "WARNING EightNodeBrickOrderTwo::receiveSelf() - " << this->getTag() << " failed to recieve String stiffness_type\n";
        return -1;
    }
    ...
    if ( theChannel.receiveString( 0, commitTag, tmp_string ) < 0 )
    {
        cerr << "WARNING EightNodeBrickOrderTwo::receiveSelf() - " << this->getTag() << " failed to recieve String damping_type\n";
        return -1;
    }
    ...
    {
        cerr << "WARNING EightNodeBrickOrderTwo::receiveSelf() - " << this->getTag() << " failed to recieve ID connectedExternalNodes\n";
        return -1;
    }

    cout << this->getTag() << " -> EightNodeBrickOrderTwo::receiveSelf() connectedExternalNodes = " << connectedExternalNodes << "\n";
    ...
    for ( int i = 0; i < Num_TotalGaussPts; i++ )
    {
        ...
        if ( ndmat == 0 )
        {
            cerr << "EightNodeBrickOrderTwo::receiveSelf() - Broker could not create NDMaterialLT of class type " << matClassTag << "\n";
            return -1;
        }
        ...
        {
            cerr << "EightNodeBrickOrderTwo::receiveSelf() - material " << i << "failed to recv itself\n";
            return -1;
        }
    ...
    {
        cerr << "EightNodeBrickOrderTwo::receiveSelf() - failed to recv Q!\n";
        return -1;
    }
    ...
    {
        cerr << "EightNodeBrickOrderTwo::receiveSelf() - failed to recv bf!\n";
        return -1;
    }
...
int EightNodeBrickOrderTwo::getObjectSize()
{
...
//=============================================================================
void EightNodeBrickOrderTwo::Print( ostream &s, int flag )
{
    cout << "EightNodeBrickOrderTwo: LTensor-based 8 node brick." << endl << endl;
...
void EightNodeBrickOrderTwo::ComputeVolume()
{
    Volume = 0.0;
...
int EightNodeBrickOrderTwo::update( void )
{
    ...
    //Debug
    // cout << endl << endl << "EightNodeBrickOrderTwo::update()" << endl;
    ...
    for ( short gp = 0; gp < Num_TotalGaussPts; gp++ )
    {
        ...
        if ( ( material_array[gp]->setTrialStrainIncr( trial_strain ) ) )
        {
            ...
            cerr << "EightNodeBrickOrderTwo::update (tag: " << this->getTag()
...
double EightNodeBrickOrderTwo::SurfaceShapeFunctionValues( double Xi , double Eta, int whichcomponent )
{
...
Vector &EightNodeBrickOrderTwo::Direction_Weight( double Xi , double Eta, Vector coord1, Vector coord2, Vector coord3, Vector coord4 )
{
    Vector J1( 3 );
    Vector J2( 3 );
...
double EightNodeBrickOrderTwo::SurfaceLoadValues( double Xi , double Eta, Vector Pressure )
{
...
int
EightNodeBrickOrderTwo::CheckMesh( ofstream &checkmesh_file )
{
...
//==================================================================================
Vector *
EightNodeBrickOrderTwo::getStress( void )
{
...
Matrix &EightNodeBrickOrderTwo::getGaussCoordinates(void)
{
    computeGaussPoint();
    return gauss_points;
}

Matrix &EightNodeBrickOrderTwo::get_Gauss_p_c( )
{
...
Matrix &EightNodeBrickOrderTwo::get_Gauss_p_w()
{
...
***********************************************************************************/
const vector<float> &EightNodeBrickOrderTwo::getGaussOutput()
{
    DTensor2 stress(3, 3);
    DTensor2 strain(3, 3);
...
void EightNodeBrickOrderTwo::zeroStrain()
{
    for (int gp = 0; gp < Num_TotalGaussPts; gp++)
    {
