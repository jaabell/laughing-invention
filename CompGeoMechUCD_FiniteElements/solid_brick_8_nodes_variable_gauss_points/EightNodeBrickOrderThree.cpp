...
/////////////////////////////////////////////////////////////////////////////////////
// Adapted by Sumeet, for EightNodeBrickOrderThree to use the LTensor library for
// tensorial representation. [September, 2016]
/////////////////////////////////////////////////////////////////////////////////////


#ifndef EightNodeBrickOrderThree_CPP
#define EightNodeBrickOrderThree_CPP

#include "EightNodeBrickOrderThree.h"
...
DTensor2 EightNodeBrickOrderThree::gp_coords(Num_TotalGaussPts, 3, 0.0);
DTensor2 EightNodeBrickOrderThree::gp_weight(Num_TotalGaussPts, 3, 0.0);
Matrix EightNodeBrickOrderThree::gauss_points(Num_TotalGaussPts, 3);
vector<float> EightNodeBrickOrderThree::Gauss_Output_Vector(Num_TotalGaussPts*18);

Matrix EightNodeBrickOrderThree::K( 24, 24);

Vector EightNodeBrickOrderThree::ShapeFunctionValues_in_function( 4 );  // Nima added for surface load (July 2012)
Vector EightNodeBrickOrderThree::J_vector_in_function( 3 );             // Nima added for surface load (July 2012)
double EightNodeBrickOrderThree::SurfaceLoadValues_in_function;

//====================================================================
// Constructor
//====================================================================
EightNodeBrickOrderThree::EightNodeBrickOrderThree( int element_number,
                                    int node_numb_1, int node_numb_2, int node_numb_3, int node_numb_4,
                                    int node_numb_5, int node_numb_6, int node_numb_7, int node_numb_8,
                                    NDMaterialLT *Globalmmodel)

    : Element( element_number,ELE_TAG_EightNodeBrickOrderThree ),
      ...
      M( 24, 24), P( 24 )
{
    ...
    if (material_array == 0)
    {
        cerr << " EightNodeBrickOrderThree::EightNodeBrickOrderThree -- failed allocate material model pointer\n";
        exit(-1);
    }
...
//====================================================================
EightNodeBrickOrderThree::EightNodeBrickOrderThree(): Element( 0, ELE_TAG_EightNodeBrickOrderThree ),
    rho( 0.0 ), connectedExternalNodes( 8 ) ,
...
//####DESTROYER!###############################################################
EightNodeBrickOrderThree::~EightNodeBrickOrderThree ()
{
...
//#############################################################################
//***************************************************************
const DTensor2 &EightNodeBrickOrderThree::H_3D( double r1, double r2, double r3 ) const
{
...
//#############################################################################
//***************************************************************
const DTensor1 &EightNodeBrickOrderThree::interp_poli_at( double r1, double r2, double r3 ) const
{
...
const DTensor2 &EightNodeBrickOrderThree::dh_drst_at( double r1, double r2, double r3 ) const
{
...
////#############################################################################
const DTensor2 &EightNodeBrickOrderThree::Jacobian_3D( const DTensor2 &dh ) const
{
...
//#############################################################################
const DTensor2  &EightNodeBrickOrderThree::Jacobian_3Dinv( const DTensor2 &dh ) const
{
    const DTensor2 &N_C = Nodal_Coordinates();
...
////#############################################################################
const DTensor2 &EightNodeBrickOrderThree::Nodal_Coordinates( void ) const
{
...
////#############################################################################
const DTensor2 &EightNodeBrickOrderThree::incr_disp( void ) const
{
...
////#############################################################################
const DTensor2 &EightNodeBrickOrderThree::total_disp( void ) const
{
...
////#############################################################################
int EightNodeBrickOrderThree::get_global_number_of_node( int local_node_number )
{
    return connectedExternalNodes( local_node_number );
}

////#############################################################################
int  EightNodeBrickOrderThree::get_Brick_Number( void )
{
    return this->getTag();
}
...
const DTensor2 &EightNodeBrickOrderThree::nodal_forces( void ) const
{
    double r  = 0.0;
    double w_r = 0.0;
    double s  = 0.0;
...
void EightNodeBrickOrderThree::computeGaussPoint()
{
    double r  = 0.0;
    double s  = 0.0;
    double t  = 0.0;
...
//=============================================================================
int EightNodeBrickOrderThree::getNumExternalNodes () const
{
    return 8;
}
...
//=============================================================================
const ID &EightNodeBrickOrderThree::getExternalNodes ()
{
    return connectedExternalNodes;
}

Node **
EightNodeBrickOrderThree::getNodePtrs( void )
{
    return theNodes;
}

//=============================================================================
int EightNodeBrickOrderThree::getNumDOF ()
{
    return 24;
}

//=============================================================================
void EightNodeBrickOrderThree::setDomain ( Domain *theDomain )
{
...
# endif
        ...
        {
            cerr << "FATAL ERROR EightNodeBrickOrderThree (tag: " << this->getTag() << "), node not found in domain\n";
            exit( -1 );
        }
        ...
        {
            cerr << "FATAL ERROR EightNodeBrickOrderThree (tag: " << this->getTag() << "), has differing number of DOFs at its nodes\n";
            exit( -1 );
        }
...
//=============================================================================
int EightNodeBrickOrderThree::commitState ()
{
    ...
    {
        cerr << "EightNodeBrickOrderThree::commitState () - failed in base class";
    }
...
//=============================================================================
int EightNodeBrickOrderThree::revertToLastCommit ()
{
    int retVal = 0;
...
//=============================================================================
int EightNodeBrickOrderThree::revertToStart ()
{
    int retVal = 0;
...
//=============================================================================
const Matrix &EightNodeBrickOrderThree::getTangentStiff()
{
...
//=============================================================================
const Matrix &EightNodeBrickOrderThree::getInitialStiff ()
{
    ...
    if ( Ki == 0 )
    {
        cerr << "FATAL EightNodeBrickOrderThree::getInitialStiff() -";
...
const Matrix &EightNodeBrickOrderThree::getMass ()
{
...
//=============================================================================
void EightNodeBrickOrderThree::zeroLoad( void )
{
    Q.Zero();
}
...
//======================================================================
const Vector &EightNodeBrickOrderThree::getBodyForce( double loadFactor, const Vector &data )
{
...
//======================================================================
const Vector &EightNodeBrickOrderThree::getSurfaceForce( double loadFactor, const Vector &data )
{
...
//=============================================================================
int EightNodeBrickOrderThree::addLoad( ElementalLoad *theLoad, double loadFactor )
{
    ...
    {
        cerr << "EightNodeBrickOrderThree::addLoad() - 8NodeBrickLT " << this->getTag() << ",load type " << type << "unknown\n";
        return -1;
    }
...
//=============================================================================
int EightNodeBrickOrderThree::addInertiaLoadToUnbalance( const Vector &accel )
{
    // Check for a quick return
    if ( rho == 0.0 )
    {
    ...
    {
        cerr << "EightNodeBrickOrderThree::addInertiaLoadToUnbalance matrix and vector sizes are incompatable\n";
        return -1;
    }
...
//=============================================================================
const Vector EightNodeBrickOrderThree::FormEquiBodyForce( void )
{
    Vector bforce( 24 );
...
//=============================================================================
const Vector &EightNodeBrickOrderThree::getResistingForce()
{
...
//=============================================================================
const Vector &EightNodeBrickOrderThree::getResistingForceIncInertia ()
{
...
int EightNodeBrickOrderThree::sendSelf ( int commitTag, Channel &theChannel )
{
    ...
    {
        cerr << "WARNING EightNodeBrickOrderThree::sendSelf() - " << this->getTag() << " failed to send ID idData\n";
        return -1;
    }
    ...
    if(idData( 2 )==1){
        ...
        {
            cerr << "WARNING EightNodeBrickOrderThree::sendSelf() - " << this->getTag() << " failed to send its K\n";
            return -1;
        }
    }
    ...
    {
        cerr << "WARNING EightNodeBrickOrderThree::sendSelf() - " << this->getTag() << " failed to send Vector floatData\n";
        return -1;
    }
    ...
    {
        cerr << "WARNING EightNodeBrickOrderThree::sendSelf() - " << this->getTag() << " failed to send String stiffness_type\n";
        return -1;
    }
    ...
    {
        cerr << "WARNING EightNodeBrickOrderThree::sendSelf() - " << this->getTag() << " failed to send String damping_type\n";
        return -1;
    }

    // Send the nodes

    cout << this->getTag() << " -> EightNodeBrickOrderThree::sendSelf() connectedExternalNodes = " << connectedExternalNodes << "\n";


    if ( theChannel.sendID( 0, commitTag, connectedExternalNodes ) < 0 )
    {
        cerr << "WARNING EightNodeBrickOrderThree::sendSelf() - " << this->getTag() << " failed to send ID connectedExternalNodes\n";
        return -1;
    }
    ...
    for ( int i = 0; i < Num_TotalGaussPts; i++ )
    {
        ...
        {
            cerr << "WARNING EightNodeBrickOrderThree::sendSelf() - " << this->getTag() << " failed to send material models\n";
            return -1;
        }
    }
    ...
    {
        cerr << "WARNING EightNodeBrickOrderThree::sendSelf() - " << this->getTag() << " failed to send its Q\n";
        return -1;
    }
    ...
    {
        cerr << "WARNING EightNodeBrickOrderThree::sendSelf() - " << this->getTag() << " failed to send its bf\n";
        return -1;
    }
...
int EightNodeBrickOrderThree::receiveSelf ( int commitTag, Channel &theChannel, FEM_ObjectBroker &theBroker )
{
    ...
    {
        cerr << "WARNING EightNodeBrickOrderThree::receiveSelf() - failed to receive ID\n";
        return -1;
    }
    ...
    if(idData(2)){
        if ( theChannel.sendMatrix( 0, commitTag, K ) < 0 )
        {
            cerr << "WARNING EightNodeBrickOrderThree::receiveSelf() - " << this->getTag() << " failed to recieve its K\n";
            return -1;
        }
    }
    ...
    {
        cerr << "WARNING EightNodeBrickOrderThree::receiveSelf() - " << this->getTag() << " failed to recieve Vector floatData\n";
        return -1;
    }
    Volume                  = floatData(0) ;
    ...
    {
        cerr << "WARNING EightNodeBrickOrderThree::receiveSelf() - " << this->getTag() << " failed to recieve String stiffness_type\n";
        return -1;
    }
    ...
    if ( theChannel.receiveString( 0, commitTag, tmp_string ) < 0 )
    {
        cerr << "WARNING EightNodeBrickOrderThree::receiveSelf() - " << this->getTag() << " failed to recieve String damping_type\n";
        return -1;
    }
    ...
    {
        cerr << "WARNING EightNodeBrickOrderThree::receiveSelf() - " << this->getTag() << " failed to recieve ID connectedExternalNodes\n";
        return -1;
    }

    cout << this->getTag() << " -> EightNodeBrickOrderThree::receiveSelf() connectedExternalNodes = " << connectedExternalNodes << "\n";
    ...
    for ( int i = 0; i < Num_TotalGaussPts; i++ )
    {
        ...
        if ( ndmat == 0 )
        {
            cerr << "EightNodeBrickOrderThree::receiveSelf() - Broker could not create NDMaterialLT of class type " << matClassTag << "\n";
            return -1;
        }
        ...
        {
            cerr << "EightNodeBrickOrderThree::receiveSelf() - material " << i << "failed to recv itself\n";
            return -1;
        }
    ...
    {
        cerr << "EightNodeBrickOrderThree::receiveSelf() - failed to recv Q!\n";
        return -1;
    }
    ...
    {
        cerr << "EightNodeBrickOrderThree::receiveSelf() - failed to recv bf!\n";
        return -1;
    }
...
int EightNodeBrickOrderThree::getObjectSize()
{
...
//=============================================================================
void EightNodeBrickOrderThree::Print( ostream &s, int flag )
{
    cout << "EightNodeBrickOrderThree: LTensor-based 8 node brick." << endl << endl;
...
void EightNodeBrickOrderThree::ComputeVolume()
{
    Volume = 0.0;
...
int EightNodeBrickOrderThree::update( void )
{
    ...
    //Debug
    // cout << endl << endl << "EightNodeBrickOrderThree::update()" << endl;
    ...
    for ( short gp = 0; gp < Num_TotalGaussPts; gp++ )
    {
        ...
        if ( ( material_array[gp]->setTrialStrainIncr( trial_strain ) ) )
        {
            ...
            cerr << "EightNodeBrickOrderThree::update (tag: " << this->getTag()
...
double EightNodeBrickOrderThree::SurfaceShapeFunctionValues( double Xi , double Eta, int whichcomponent )
{
...
Vector &EightNodeBrickOrderThree::Direction_Weight( double Xi , double Eta, Vector coord1, Vector coord2, Vector coord3, Vector coord4 )
{
    Vector J1( 3 );
    Vector J2( 3 );
...
double EightNodeBrickOrderThree::SurfaceLoadValues( double Xi , double Eta, Vector Pressure )
{
...
int
EightNodeBrickOrderThree::CheckMesh( ofstream &checkmesh_file )
{
...
//==================================================================================
Vector *
EightNodeBrickOrderThree::getStress( void )
{
...
Matrix &EightNodeBrickOrderThree::getGaussCoordinates(void)
{
    computeGaussPoint();
    return gauss_points;
}

Matrix &EightNodeBrickOrderThree::get_Gauss_p_c( )
{
...
Matrix &EightNodeBrickOrderThree::get_Gauss_p_w()
{
...
***********************************************************************************/
const vector<float> &EightNodeBrickOrderThree::getGaussOutput()
{
    DTensor2 stress(3, 3);
    DTensor2 strain(3, 3);
...
void EightNodeBrickOrderThree::zeroStrain()
{
    for (int gp = 0; gp < Num_TotalGaussPts; gp++)
    {
