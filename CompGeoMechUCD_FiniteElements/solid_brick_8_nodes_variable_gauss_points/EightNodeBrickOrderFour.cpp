...
/////////////////////////////////////////////////////////////////////////////////////
// Adapted by Sumeet, for EightNodeBrickOrderFour to use the LTensor library for
// tensorial representation. [September, 2016]
/////////////////////////////////////////////////////////////////////////////////////


#ifndef EightNodeBrickOrderFour_CPP
#define EightNodeBrickOrderFour_CPP

#include "EightNodeBrickOrderFour.h"
...
DTensor2 EightNodeBrickOrderFour::gp_coords(Num_TotalGaussPts, 3, 0.0);
DTensor2 EightNodeBrickOrderFour::gp_weight(Num_TotalGaussPts, 3, 0.0);
Matrix EightNodeBrickOrderFour::gauss_points(Num_TotalGaussPts, 3);
vector<float> EightNodeBrickOrderFour::Gauss_Output_Vector(Num_TotalGaussPts*18);

Matrix EightNodeBrickOrderFour::K( 24, 24);

Vector EightNodeBrickOrderFour::ShapeFunctionValues_in_function( 4 );  // Nima added for surface load (July 2012)
Vector EightNodeBrickOrderFour::J_vector_in_function( 3 );             // Nima added for surface load (July 2012)
double EightNodeBrickOrderFour::SurfaceLoadValues_in_function;

//====================================================================
// Constructor
//====================================================================
EightNodeBrickOrderFour::EightNodeBrickOrderFour( int element_number,
                                    int node_numb_1, int node_numb_2, int node_numb_3, int node_numb_4,
                                    int node_numb_5, int node_numb_6, int node_numb_7, int node_numb_8,
                                    NDMaterialLT *Globalmmodel)

    : Element( element_number,ELE_TAG_EightNodeBrickOrderFour ),
      ...
      M( 24, 24), P( 24 )
{
    ...
    if (material_array == 0)
    {
        cerr << " EightNodeBrickOrderFour::EightNodeBrickOrderFour -- failed allocate material model pointer\n";
        exit(-1);
    }
...
//====================================================================
EightNodeBrickOrderFour::EightNodeBrickOrderFour(): Element( 0, ELE_TAG_EightNodeBrickOrderFour ),
    rho( 0.0 ), connectedExternalNodes( 8 ) ,
...
//####DESTROYER!###############################################################
EightNodeBrickOrderFour::~EightNodeBrickOrderFour ()
{
...
//#############################################################################
//***************************************************************
const DTensor2 &EightNodeBrickOrderFour::H_3D( double r1, double r2, double r3 ) const
{
...
//#############################################################################
//***************************************************************
const DTensor1 &EightNodeBrickOrderFour::interp_poli_at( double r1, double r2, double r3 ) const
{
...
const DTensor2 &EightNodeBrickOrderFour::dh_drst_at( double r1, double r2, double r3 ) const
{
...
////#############################################################################
const DTensor2 &EightNodeBrickOrderFour::Jacobian_3D( const DTensor2 &dh ) const
{
...
//#############################################################################
const DTensor2  &EightNodeBrickOrderFour::Jacobian_3Dinv( const DTensor2 &dh ) const
{
    const DTensor2 &N_C = Nodal_Coordinates();
...
////#############################################################################
const DTensor2 &EightNodeBrickOrderFour::Nodal_Coordinates( void ) const
{
...
////#############################################################################
const DTensor2 &EightNodeBrickOrderFour::incr_disp( void ) const
{
...
////#############################################################################
const DTensor2 &EightNodeBrickOrderFour::total_disp( void ) const
{
...
////#############################################################################
int EightNodeBrickOrderFour::get_global_number_of_node( int local_node_number )
{
    return connectedExternalNodes( local_node_number );
}

////#############################################################################
int  EightNodeBrickOrderFour::get_Brick_Number( void )
{
    return this->getTag();
}
...
const DTensor2 &EightNodeBrickOrderFour::nodal_forces( void ) const
{
    double r  = 0.0;
    double w_r = 0.0;
    double s  = 0.0;
...
void EightNodeBrickOrderFour::computeGaussPoint()
{
    double r  = 0.0;
    double s  = 0.0;
    double t  = 0.0;
...
//=============================================================================
int EightNodeBrickOrderFour::getNumExternalNodes () const
{
    return 8;
}
...
//=============================================================================
const ID &EightNodeBrickOrderFour::getExternalNodes ()
{
    return connectedExternalNodes;
}

Node **
EightNodeBrickOrderFour::getNodePtrs( void )
{
    return theNodes;
}

//=============================================================================
int EightNodeBrickOrderFour::getNumDOF ()
{
    return 24;
}

//=============================================================================
void EightNodeBrickOrderFour::setDomain ( Domain *theDomain )
{
...
# endif
        ...
        {
            cerr << "FATAL ERROR EightNodeBrickOrderFour (tag: " << this->getTag() << "), node not found in domain\n";
            exit( -1 );
        }
        ...
        {
            cerr << "FATAL ERROR EightNodeBrickOrderFour (tag: " << this->getTag() << "), has differing number of DOFs at its nodes\n";
            exit( -1 );
        }
...
//=============================================================================
int EightNodeBrickOrderFour::commitState ()
{
    ...
    {
        cerr << "EightNodeBrickOrderFour::commitState () - failed in base class";
    }
...
//=============================================================================
int EightNodeBrickOrderFour::revertToLastCommit ()
{
    int retVal = 0;
...
//=============================================================================
int EightNodeBrickOrderFour::revertToStart ()
{
    int retVal = 0;
...
//=============================================================================
const Matrix &EightNodeBrickOrderFour::getTangentStiff()
{
...
//=============================================================================
const Matrix &EightNodeBrickOrderFour::getInitialStiff ()
{
    ...
    if ( Ki == 0 )
    {
        cerr << "FATAL EightNodeBrickOrderFour::getInitialStiff() -";
...
const Matrix &EightNodeBrickOrderFour::getMass ()
{
...
//=============================================================================
void EightNodeBrickOrderFour::zeroLoad( void )
{
    Q.Zero();
}
...
//======================================================================
const Vector &EightNodeBrickOrderFour::getBodyForce( double loadFactor, const Vector &data )
{
...
//======================================================================
const Vector &EightNodeBrickOrderFour::getSurfaceForce( double loadFactor, const Vector &data )
{
...
//=============================================================================
int EightNodeBrickOrderFour::addLoad( ElementalLoad *theLoad, double loadFactor )
{
    ...
    {
        cerr << "EightNodeBrickOrderFour::addLoad() - 8NodeBrickLT " << this->getTag() << ",load type " << type << "unknown\n";
        return -1;
    }
...
//=============================================================================
int EightNodeBrickOrderFour::addInertiaLoadToUnbalance( const Vector &accel )
{
    // Check for a quick return
    if ( rho == 0.0 )
    {
    ...
    {
        cerr << "EightNodeBrickOrderFour::addInertiaLoadToUnbalance matrix and vector sizes are incompatable\n";
        return -1;
    }
...
//=============================================================================
const Vector EightNodeBrickOrderFour::FormEquiBodyForce( void )
{
    Vector bforce( 24 );
...
//=============================================================================
const Vector &EightNodeBrickOrderFour::getResistingForce()
{
...
//=============================================================================
const Vector &EightNodeBrickOrderFour::getResistingForceIncInertia ()
{
...
int EightNodeBrickOrderFour::sendSelf ( int commitTag, Channel &theChannel )
{
    ...
    {
        cerr << "WARNING EightNodeBrickOrderFour::sendSelf() - " << this->getTag() << " failed to send ID idData\n";
        return -1;
    }
    ...
    if(idData( 2 )==1){
        ...
        {
            cerr << "WARNING EightNodeBrickOrderFour::sendSelf() - " << this->getTag() << " failed to send its K\n";
            return -1;
        }
    }
    ...
    {
        cerr << "WARNING EightNodeBrickOrderFour::sendSelf() - " << this->getTag() << " failed to send Vector floatData\n";
        return -1;
    }
    ...
    {
        cerr << "WARNING EightNodeBrickOrderFour::sendSelf() - " << this->getTag() << " failed to send String stiffness_type\n";
        return -1;
    }
    ...
    {
        cerr << "WARNING EightNodeBrickOrderFour::sendSelf() - " << this->getTag() << " failed to send String damping_type\n";
        return -1;
    }

    // Send the nodes

    cout << this->getTag() << " -> EightNodeBrickOrderFour::sendSelf() connectedExternalNodes = " << connectedExternalNodes << "\n";


    if ( theChannel.sendID( 0, commitTag, connectedExternalNodes ) < 0 )
    {
        cerr << "WARNING EightNodeBrickOrderFour::sendSelf() - " << this->getTag() << " failed to send ID connectedExternalNodes\n";
        return -1;
    }
    ...
    for ( int i = 0; i < Num_TotalGaussPts; i++ )
    {
        ...
        {
            cerr << "WARNING EightNodeBrickOrderFour::sendSelf() - " << this->getTag() << " failed to send material models\n";
            return -1;
        }
    }
    ...
    {
        cerr << "WARNING EightNodeBrickOrderFour::sendSelf() - " << this->getTag() << " failed to send its Q\n";
        return -1;
    }
    ...
    {
        cerr << "WARNING EightNodeBrickOrderFour::sendSelf() - " << this->getTag() << " failed to send its bf\n";
        return -1;
    }
...
int EightNodeBrickOrderFour::receiveSelf ( int commitTag, Channel &theChannel, FEM_ObjectBroker &theBroker )
{
    ...
    {
        cerr << "WARNING EightNodeBrickOrderFour::receiveSelf() - failed to receive ID\n";
        return -1;
    }
    ...
    if(idData(2)){
        if ( theChannel.sendMatrix( 0, commitTag, K ) < 0 )
        {
            cerr << "WARNING EightNodeBrickOrderFour::receiveSelf() - " << this->getTag() << " failed to recieve its K\n";
            return -1;
        }
    }
    ...
    {
        cerr << "WARNING EightNodeBrickOrderFour::receiveSelf() - " << this->getTag() << " failed to recieve Vector floatData\n";
        return -1;
    }
    Volume                  = floatData(0) ;
    ...
    {
        cerr << "WARNING EightNodeBrickOrderFour::receiveSelf() - " << this->getTag() << " failed to recieve String stiffness_type\n";
        return -1;
    }
    ...
    if ( theChannel.receiveString( 0, commitTag, tmp_string ) < 0 )
    {
        cerr << "WARNING EightNodeBrickOrderFour::receiveSelf() - " << this->getTag() << " failed to recieve String damping_type\n";
        return -1;
    }
    ...
    {
        cerr << "WARNING EightNodeBrickOrderFour::receiveSelf() - " << this->getTag() << " failed to recieve ID connectedExternalNodes\n";
        return -1;
    }

    cout << this->getTag() << " -> EightNodeBrickOrderFour::receiveSelf() connectedExternalNodes = " << connectedExternalNodes << "\n";
    ...
    for ( int i = 0; i < Num_TotalGaussPts; i++ )
    {
        ...
        if ( ndmat == 0 )
        {
            cerr << "EightNodeBrickOrderFour::receiveSelf() - Broker could not create NDMaterialLT of class type " << matClassTag << "\n";
            return -1;
        }
        ...
        {
            cerr << "EightNodeBrickOrderFour::receiveSelf() - material " << i << "failed to recv itself\n";
            return -1;
        }
    ...
    {
        cerr << "EightNodeBrickOrderFour::receiveSelf() - failed to recv Q!\n";
        return -1;
    }
    ...
    {
        cerr << "EightNodeBrickOrderFour::receiveSelf() - failed to recv bf!\n";
        return -1;
    }
...
int EightNodeBrickOrderFour::getObjectSize()
{
...
//=============================================================================
void EightNodeBrickOrderFour::Print( ostream &s, int flag )
{
    cout << "EightNodeBrickOrderFour: LTensor-based 8 node brick." << endl << endl;
...
void EightNodeBrickOrderFour::ComputeVolume()
{
    Volume = 0.0;
...
int EightNodeBrickOrderFour::update( void )
{
    ...
    //Debug
    // cout << endl << endl << "EightNodeBrickOrderFour::update()" << endl;
    ...
    for ( short gp = 0; gp < Num_TotalGaussPts; gp++ )
    {
        ...
        if ( ( material_array[gp]->setTrialStrainIncr( trial_strain ) ) )
        {
            ...
            cerr << "EightNodeBrickOrderFour::update (tag: " << this->getTag()
...
double EightNodeBrickOrderFour::SurfaceShapeFunctionValues( double Xi , double Eta, int whichcomponent )
{
...
Vector &EightNodeBrickOrderFour::Direction_Weight( double Xi , double Eta, Vector coord1, Vector coord2, Vector coord3, Vector coord4 )
{
    Vector J1( 3 );
    Vector J2( 3 );
...
double EightNodeBrickOrderFour::SurfaceLoadValues( double Xi , double Eta, Vector Pressure )
{
...
int
EightNodeBrickOrderFour::CheckMesh( ofstream &checkmesh_file )
{
...
//==================================================================================
Vector *
EightNodeBrickOrderFour::getStress( void )
{
...
Matrix &EightNodeBrickOrderFour::getGaussCoordinates(void)
{
    computeGaussPoint();
    return gauss_points;
}

Matrix &EightNodeBrickOrderFour::get_Gauss_p_c( )
{
...
Matrix &EightNodeBrickOrderFour::get_Gauss_p_w()
{
...
***********************************************************************************/
const vector<float> &EightNodeBrickOrderFour::getGaussOutput()
{
    DTensor2 stress(3, 3);
    DTensor2 strain(3, 3);
...
void EightNodeBrickOrderFour::zeroStrain()
{
    for (int gp = 0; gp < Num_TotalGaussPts; gp++)
    {
