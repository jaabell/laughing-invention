...
/////////////////////////////////////////////////////////////////////////////////////
// Adapted by Sumeet, for TwentySevenNodeBrickOrderTwo to use the LTensor library for
// tensorial representation. [September, 2016]
/////////////////////////////////////////////////////////////////////////////////////



#ifndef TwentySevenNodeBrickOrderTwo_CPP
#define TwentySevenNodeBrickOrderTwo_CPP

#include "TwentySevenNodeBrickOrderTwo.h"
...
DTensor2 TwentySevenNodeBrickOrderTwo::gp_coords(Num_TotalGaussPts, 3, 0.0);
DTensor2 TwentySevenNodeBrickOrderTwo::gp_weight(Num_TotalGaussPts, 3, 0.0);
Matrix TwentySevenNodeBrickOrderTwo::gauss_points(Num_TotalGaussPts, 3);
vector<float> TwentySevenNodeBrickOrderTwo::Gauss_Output_Vector(Num_TotalGaussPts*18);

Matrix TwentySevenNodeBrickOrderTwo::K(81, 81);

Vector TwentySevenNodeBrickOrderTwo::ShapeFunctionValues_in_function( 9 );  // Nima added for surface load (July 2012)
Vector TwentySevenNodeBrickOrderTwo::J_vector_in_function( 3 );             // Nima added for surface load (July 2012)
double TwentySevenNodeBrickOrderTwo::SurfaceLoadValues_in_function;

//====================================================================
// Constructor
//====================================================================

TwentySevenNodeBrickOrderTwo::TwentySevenNodeBrickOrderTwo( int element_number,
    ...
    : Element( element_number, ELE_TAG_TwentySevenNodeBrickOrderTwo ),
      ...
      M(81,81), P( 81 )
{
    ...
    if (material_array == 0)
    {
        cerr << " TwentySevenNodeBrickOrderTwo::TwentySevenNodeBrickOrderTwo -- failed allocate material model pointer\n";
        exit(-1);
    }
...
//====================================================================
TwentySevenNodeBrickOrderTwo::TwentySevenNodeBrickOrderTwo(): Element( 0, ELE_TAG_TwentySevenNodeBrickOrderTwo ),
    rho( 0.0 ), connectedExternalNodes( 27 ) , 
...
//####DESTROYER!###############################################################
TwentySevenNodeBrickOrderTwo::~TwentySevenNodeBrickOrderTwo ()
{
...
//#############################################################################
//***************************************************************
const DTensor2 &TwentySevenNodeBrickOrderTwo::H_3D( double r1, double r2, double r3 ) const
{
...
//#############################################################################
//***************************************************************
const DTensor1 &TwentySevenNodeBrickOrderTwo::interp_poli_at( double r1, double r2, double r3 ) const
{
...
const DTensor2 &TwentySevenNodeBrickOrderTwo::dh_drst_at( double r1, double r2, double r3 ) const
{
...
////#############################################################################
const DTensor2 &TwentySevenNodeBrickOrderTwo::Jacobian_3D( const DTensor2 &dh ) const
{
...
//#############################################################################
const DTensor2  &TwentySevenNodeBrickOrderTwo::Jacobian_3Dinv( const DTensor2 &dh ) const
{
    const DTensor2 &N_C = Nodal_Coordinates();
...
////#############################################################################
const DTensor2 &TwentySevenNodeBrickOrderTwo::Nodal_Coordinates( void ) const
{
...
////#############################################################################
const DTensor2 &TwentySevenNodeBrickOrderTwo::incr_disp( void ) const
{
...
////#############################################################################
const DTensor2 &TwentySevenNodeBrickOrderTwo::total_disp( void ) const
{
...
////#############################################################################
int TwentySevenNodeBrickOrderTwo::get_global_number_of_node( int local_node_number )
{
    return connectedExternalNodes( local_node_number );
}

////#############################################################################
int  TwentySevenNodeBrickOrderTwo::get_Brick_Number( void )
{
    return this->getTag();
}
...
const DTensor2 &TwentySevenNodeBrickOrderTwo::nodal_forces( void ) const
{
    double r  = 0.0;
    double w_r = 0.0;
    double s  = 0.0;
...
void TwentySevenNodeBrickOrderTwo::computeGaussPoint()
{
    double r  = 0.0;
    double s  = 0.0;
    double t  = 0.0;
...
//=============================================================================
int TwentySevenNodeBrickOrderTwo::getNumExternalNodes () const
{
    return 27;
}
...
//=============================================================================
const ID &TwentySevenNodeBrickOrderTwo::getExternalNodes ()
{
    return connectedExternalNodes;
}

Node **
TwentySevenNodeBrickOrderTwo::getNodePtrs( void )
{
    return theNodes;
}

//=============================================================================
int TwentySevenNodeBrickOrderTwo::getNumDOF ()
{
    return 81;
}

//=============================================================================
void TwentySevenNodeBrickOrderTwo::setDomain ( Domain *theDomain )
{
...
# endif
        ...
        {
            cerr << "FATAL ERROR TwentySevenNodeBrickOrderTwo (tag: " << this->getTag() << "), node not found in domain\n";
            exit( -1 );
        }
        ...
        {
            cerr << "FATAL ERROR TwentySevenNodeBrickOrderTwo (tag: " << this->getTag() << "), has differing number of DOFs at its nodes\n";
            exit( -1 );
        }
...
//=============================================================================
int TwentySevenNodeBrickOrderTwo::commitState ()
{
    ...
    {
        cerr << "TwentySevenNodeBrickOrderTwo::commitState () - failed in base class";
    }
...
//=============================================================================
int TwentySevenNodeBrickOrderTwo::revertToLastCommit ()
{
    int retVal = 0;
...
//=============================================================================
int TwentySevenNodeBrickOrderTwo::revertToStart ()
{
    int retVal = 0;
...
//=============================================================================
const Matrix &TwentySevenNodeBrickOrderTwo::getTangentStiff()
{
...
//=============================================================================
const Matrix &TwentySevenNodeBrickOrderTwo::getInitialStiff ()
{
    ...
    if ( Ki == 0 )
    {
        cerr << "FATAL TwentySevenNodeBrickOrderTwo::getInitialStiff() -";
...
const Matrix &TwentySevenNodeBrickOrderTwo::getMass ()
{
...
//=============================================================================
void TwentySevenNodeBrickOrderTwo::zeroLoad( void )
{
    Q.Zero();
}
...
//======================================================================
const Vector &TwentySevenNodeBrickOrderTwo::getBodyForce( double loadFactor, const Vector &data )
{
...
//======================================================================
const Vector &TwentySevenNodeBrickOrderTwo::getSurfaceForce( double loadFactor, const Vector &data )
{
...
//=============================================================================
int TwentySevenNodeBrickOrderTwo::addLoad( ElementalLoad *theLoad, double loadFactor )
{
    ...
    {
        cerr << "TwentySevenNodeBrickOrderTwo::addLoad() - 8NodeBrick " << this->getTag() << ",load type " << type << "unknown\n";
        return -1;
    }
...
//=============================================================================
int TwentySevenNodeBrickOrderTwo::addInertiaLoadToUnbalance( const Vector &accel )
{
    // Check for a quick return
    if ( rho == 0.0 )
    {
    ...
    {
        cerr << "TwentySevenNodeBrickOrderTwo::addInertiaLoadToUnbalance matrix and vector sizes are incompatable\n";
        return -1;
    }
...
//=============================================================================
const Vector TwentySevenNodeBrickOrderTwo::FormEquiBodyForce(const Vector &data)
{
    static Vector bforce( 81 );
    bforce.Zero();
...
//=============================================================================
const Vector &TwentySevenNodeBrickOrderTwo::getResistingForce()
{
...
//=============================================================================
const Vector &TwentySevenNodeBrickOrderTwo::getResistingForceIncInertia ()
{
...
int TwentySevenNodeBrickOrderTwo::sendSelf ( int commitTag, Channel &theChannel )
{
    ...
    {
        cerr << "WARNING TwentySevenNodeBrickOrderTwo::sendSelf() - " << this->getTag() << " failed to send ID idData\n";
        return -1;
    }
    ...
    if(idData( 2 )==1){
        ...
        {
            cerr << "WARNING TwentySevenNodeBrickOrderTwo::sendSelf() - " << this->getTag() << " failed to send its K\n";
            return -1;
        }
    }
    ...
    {
        cerr << "WARNING TwentySevenNodeBrickOrderTwo::sendSelf() - " << this->getTag() << " failed to send Vector floatData\n";
        return -1;
    }
    ...
    {
        cerr << "WARNING TwentySevenNodeBrickOrderTwo::sendSelf() - " << this->getTag() << " failed to send String stiffness_type\n";
        return -1;
    }
    ...
    {
        cerr << "WARNING TwentySevenNodeBrickOrderTwo::sendSelf() - " << this->getTag() << " failed to send String damping_type\n";
        return -1;
    }
    ...
    {
        cerr << "WARNING TwentySevenNodeBrickOrderTwo::sendSelf() - " << this->getTag() << " failed to send ID connectedExternalNodes\n";
        return -1;
    }
    ...
    for ( int i = 0; i < Num_TotalGaussPts; i++ )
    {
        ...
        {
            cerr << "WARNING TwentySevenNodeBrickOrderTwo::sendSelf() - " << this->getTag() << " failed to send material models\n";
            return -1;
        }
    }
    ...
    {
        cerr << "WARNING TwentySevenNodeBrickOrderTwo::sendSelf() - " << this->getTag() << " failed to send its Q\n";
        return -1;
    }
    ...
    {
        cerr << "WARNING TwentySevenNodeBrickOrderTwo::sendSelf() - " << this->getTag() << " failed to send its bf\n";
        return -1;
    }
...
int TwentySevenNodeBrickOrderTwo::receiveSelf ( int commitTag, Channel &theChannel, FEM_ObjectBroker &theBroker )
{
    ID idData( 3 );
    ...
    {
        cerr << "WARNING TwentySevenNodeBrickOrderTwo::receiveSelf() - " << this->getTag() << " failed to recieve Vector floatData\n";
        return -1;
    }
    Volume                  = floatData(0) ;
    ...
    {
        cerr << "WARNING TwentySevenNodeBrickOrderTwo::receiveSelf() - " << this->getTag() << " failed to recieve String stiffness_type\n";
        return -1;
    }
    ...
    if ( theChannel.receiveString( 0, commitTag, tmp_string ) < 0 )
    {
        cerr << "WARNING TwentySevenNodeBrickOrderTwo::receiveSelf() - " << this->getTag() << " failed to recieve String damping_type\n";
        return -1;
    }
    ...
    {
        cerr << "WARNING TwentySevenNodeBrickOrderTwo::receiveSelf() - " << this->getTag() << " failed to recieve ID connectedExternalNodes\n";
        return -1;
    }

    // cout << "TwentySevenNodeBrickOrderTwo::receiveSelf() connectedExternalNodes = " << connectedExternalNodes << "\n";
    ...
    for ( int i = 0; i < Num_TotalGaussPts; i++ )
    {
        ...
        if ( ndmat == 0 )
        {
            cerr << "TwentySevenNodeBrickOrderTwo::receiveSelf() - Broker could not create NDMaterialLT of class type " << matClassTag << "\n";
            return -1;
        }
        ...
        {
            cerr << "TwentySevenNodeBrickOrderTwo::receiveSelf() - material " << i << "failed to recv itself\n";
            return -1;
        }
    ...
    {
        cerr << "TwentySevenNodeBrickOrderTwo::receiveSelf() - failed to recv Q!\n";
        return -1;
    }
    ...
    {
        cerr << "TwentySevenNodeBrickOrderTwo::receiveSelf() - failed to recv bf!\n";
        return -1;
    }
...
int TwentySevenNodeBrickOrderTwo::getObjectSize()
{
    int size = 0;
...
//=============================================================================
void TwentySevenNodeBrickOrderTwo::Print( ostream &s, int flag )
{
    cout << "TwentySevenNodeBrickOrderTwo: LTensor-based 27 node brick." << endl << endl;
...
void TwentySevenNodeBrickOrderTwo::ComputeVolume()
{
    Volume = 0.0;
...
int TwentySevenNodeBrickOrderTwo::update( void )
{
    double r  = 0.0;
    double s  = 0.0;
    double t  = 0.0;
    ...
    for ( short gp = 0; gp < Num_TotalGaussPts; gp++ )
    {
        ...
        {
            cerr << "TwentySevenNodeBrickOrderTwo::update (tag: " << this->getTag() << "), Update Failed\n";
            return -1;
        }
    }
...
double TwentySevenNodeBrickOrderTwo::SurfaceShapeFunctionValues( double Xi , double Eta, int whichcomponent )
{
...
Vector &TwentySevenNodeBrickOrderTwo::Direction_Weight( double Xi , double Eta, Vector coord1, Vector coord2,
...
double TwentySevenNodeBrickOrderTwo::SurfaceLoadValues( double Xi , double Eta, Vector Pressure )
{
...
int
TwentySevenNodeBrickOrderTwo::CheckMesh( ofstream &checkmesh_file )
{
    double r  = 0.0;
    double s  = 0.0;
    double t  = 0.0;
...
//==================================================================================
Vector *
TwentySevenNodeBrickOrderTwo::getStress( void )
{
...
Matrix &TwentySevenNodeBrickOrderTwo::getGaussCoordinates(void)
{
    computeGaussPoint();
    return gauss_points;
}

Matrix &TwentySevenNodeBrickOrderTwo::get_Gauss_p_c( )
{
...
Matrix &TwentySevenNodeBrickOrderTwo::get_Gauss_p_w()
{
...
***********************************************************************************/
const vector<float> &TwentySevenNodeBrickOrderTwo::getGaussOutput()
{
    DTensor2 stress(3, 3);
    DTensor2 strain(3, 3);
...
void TwentySevenNodeBrickOrderTwo::zeroStrain()
{
    for (int gp = 0; gp < Num_TotalGaussPts; gp++)
    {
