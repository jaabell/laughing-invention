...
/////////////////////////////////////////////////////////////////////////////////////
// Adapted by Sumeet, for TwentySevenNodeBrickOrderSix to use the LTensor library for
// tensorial representation. [September, 2016]
/////////////////////////////////////////////////////////////////////////////////////



#ifndef TwentySevenNodeBrickOrderSix_CPP
#define TwentySevenNodeBrickOrderSix_CPP

#include "TwentySevenNodeBrickOrderSix.h"
...
DTensor2 TwentySevenNodeBrickOrderSix::gp_coords(Num_TotalGaussPts, 3, 0.0);
DTensor2 TwentySevenNodeBrickOrderSix::gp_weight(Num_TotalGaussPts, 3, 0.0);
Matrix TwentySevenNodeBrickOrderSix::gauss_points(Num_TotalGaussPts, 3);
vector<float> TwentySevenNodeBrickOrderSix::Gauss_Output_Vector(Num_TotalGaussPts*18);

Matrix TwentySevenNodeBrickOrderSix::K(81, 81);

Vector TwentySevenNodeBrickOrderSix::ShapeFunctionValues_in_function( 9 );  // Nima added for surface load (July 2012)
Vector TwentySevenNodeBrickOrderSix::J_vector_in_function( 3 );             // Nima added for surface load (July 2012)
double TwentySevenNodeBrickOrderSix::SurfaceLoadValues_in_function;

//====================================================================
// Constructor
//====================================================================

TwentySevenNodeBrickOrderSix::TwentySevenNodeBrickOrderSix( int element_number,
    ...
    : Element( element_number, ELE_TAG_TwentySevenNodeBrickOrderSix ),
      ...
      M(81,81), P( 81 )
{
    ...
    if (material_array == 0)
    {
        cerr << " TwentySevenNodeBrickOrderSix::TwentySevenNodeBrickOrderSix -- failed allocate material model pointer\n";
        exit(-1);
    }
...
//====================================================================
TwentySevenNodeBrickOrderSix::TwentySevenNodeBrickOrderSix(): Element( 0, ELE_TAG_TwentySevenNodeBrickOrderSix ),
    rho( 0.0 ), connectedExternalNodes( 27 ) , 
...
//####DESTROYER!###############################################################
TwentySevenNodeBrickOrderSix::~TwentySevenNodeBrickOrderSix ()
{
...
//#############################################################################
//***************************************************************
const DTensor2 &TwentySevenNodeBrickOrderSix::H_3D( double r1, double r2, double r3 ) const
{
...
//#############################################################################
//***************************************************************
const DTensor1 &TwentySevenNodeBrickOrderSix::interp_poli_at( double r1, double r2, double r3 ) const
{
...
const DTensor2 &TwentySevenNodeBrickOrderSix::dh_drst_at( double r1, double r2, double r3 ) const
{
...
////#############################################################################
const DTensor2 &TwentySevenNodeBrickOrderSix::Jacobian_3D( const DTensor2 &dh ) const
{
...
//#############################################################################
const DTensor2  &TwentySevenNodeBrickOrderSix::Jacobian_3Dinv( const DTensor2 &dh ) const
{
    const DTensor2 &N_C = Nodal_Coordinates();
...
////#############################################################################
const DTensor2 &TwentySevenNodeBrickOrderSix::Nodal_Coordinates( void ) const
{
...
////#############################################################################
const DTensor2 &TwentySevenNodeBrickOrderSix::incr_disp( void ) const
{
...
////#############################################################################
const DTensor2 &TwentySevenNodeBrickOrderSix::total_disp( void ) const
{
...
////#############################################################################
int TwentySevenNodeBrickOrderSix::get_global_number_of_node( int local_node_number )
{
    return connectedExternalNodes( local_node_number );
}

////#############################################################################
int  TwentySevenNodeBrickOrderSix::get_Brick_Number( void )
{
    return this->getTag();
}
...
const DTensor2 &TwentySevenNodeBrickOrderSix::nodal_forces( void ) const
{
    double r  = 0.0;
    double w_r = 0.0;
    double s  = 0.0;
...
void TwentySevenNodeBrickOrderSix::computeGaussPoint()
{
    double r  = 0.0;
    double s  = 0.0;
    double t  = 0.0;
...
//=============================================================================
int TwentySevenNodeBrickOrderSix::getNumExternalNodes () const
{
    return 27;
}
...
//=============================================================================
const ID &TwentySevenNodeBrickOrderSix::getExternalNodes ()
{
    return connectedExternalNodes;
}

Node **
TwentySevenNodeBrickOrderSix::getNodePtrs( void )
{
    return theNodes;
}

//=============================================================================
int TwentySevenNodeBrickOrderSix::getNumDOF ()
{
    return 81;
}

//=============================================================================
void TwentySevenNodeBrickOrderSix::setDomain ( Domain *theDomain )
{
...
# endif
        ...
        {
            cerr << "FATAL ERROR TwentySevenNodeBrickOrderSix (tag: " << this->getTag() << "), node not found in domain\n";
            exit( -1 );
        }
        ...
        {
            cerr << "FATAL ERROR TwentySevenNodeBrickOrderSix (tag: " << this->getTag() << "), has differing number of DOFs at its nodes\n";
            exit( -1 );
        }
...
//=============================================================================
int TwentySevenNodeBrickOrderSix::commitState ()
{
    ...
    {
        cerr << "TwentySevenNodeBrickOrderSix::commitState () - failed in base class";
    }
...
//=============================================================================
int TwentySevenNodeBrickOrderSix::revertToLastCommit ()
{
    int retVal = 0;
...
//=============================================================================
int TwentySevenNodeBrickOrderSix::revertToStart ()
{
    int retVal = 0;
...
//=============================================================================
const Matrix &TwentySevenNodeBrickOrderSix::getTangentStiff()
{
...
//=============================================================================
const Matrix &TwentySevenNodeBrickOrderSix::getInitialStiff ()
{
    ...
    if ( Ki == 0 )
    {
        cerr << "FATAL TwentySevenNodeBrickOrderSix::getInitialStiff() -";
...
const Matrix &TwentySevenNodeBrickOrderSix::getMass ()
{
...
//=============================================================================
void TwentySevenNodeBrickOrderSix::zeroLoad( void )
{
    Q.Zero();
}
...
//======================================================================
const Vector &TwentySevenNodeBrickOrderSix::getBodyForce( double loadFactor, const Vector &data )
{
...
//======================================================================
const Vector &TwentySevenNodeBrickOrderSix::getSurfaceForce( double loadFactor, const Vector &data )
{
...
//=============================================================================
int TwentySevenNodeBrickOrderSix::addLoad( ElementalLoad *theLoad, double loadFactor )
{
    ...
    {
        cerr << "TwentySevenNodeBrickOrderSix::addLoad() - 8NodeBrick " << this->getTag() << ",load type " << type << "unknown\n";
        return -1;
    }
...
//=============================================================================
int TwentySevenNodeBrickOrderSix::addInertiaLoadToUnbalance( const Vector &accel )
{
    // Check for a quick return
    if ( rho == 0.0 )
    {
    ...
    {
        cerr << "TwentySevenNodeBrickOrderSix::addInertiaLoadToUnbalance matrix and vector sizes are incompatable\n";
        return -1;
    }
...
//=============================================================================
const Vector TwentySevenNodeBrickOrderSix::FormEquiBodyForce(const Vector &data)
{
    static Vector bforce( 81 );
    bforce.Zero();
...
//=============================================================================
const Vector &TwentySevenNodeBrickOrderSix::getResistingForce()
{
...
//=============================================================================
const Vector &TwentySevenNodeBrickOrderSix::getResistingForceIncInertia ()
{
...
int TwentySevenNodeBrickOrderSix::sendSelf ( int commitTag, Channel &theChannel )
{
    ...
    {
        cerr << "WARNING TwentySevenNodeBrickOrderSix::sendSelf() - " << this->getTag() << " failed to send ID idData\n";
        return -1;
    }
    ...
    if(idData( 2 )==1){
        ...
        {
            cerr << "WARNING TwentySevenNodeBrickOrderSix::sendSelf() - " << this->getTag() << " failed to send its K\n";
            return -1;
        }
    }
    ...
    {
        cerr << "WARNING TwentySevenNodeBrickOrderSix::sendSelf() - " << this->getTag() << " failed to send Vector floatData\n";
        return -1;
    }
    ...
    {
        cerr << "WARNING TwentySevenNodeBrickOrderSix::sendSelf() - " << this->getTag() << " failed to send String stiffness_type\n";
        return -1;
    }
    ...
    {
        cerr << "WARNING TwentySevenNodeBrickOrderSix::sendSelf() - " << this->getTag() << " failed to send String damping_type\n";
        return -1;
    }
    ...
    {
        cerr << "WARNING TwentySevenNodeBrickOrderSix::sendSelf() - " << this->getTag() << " failed to send ID connectedExternalNodes\n";
        return -1;
    }
    ...
    for ( int i = 0; i < Num_TotalGaussPts; i++ )
    {
        ...
        {
            cerr << "WARNING TwentySevenNodeBrickOrderSix::sendSelf() - " << this->getTag() << " failed to send material models\n";
            return -1;
        }
    }
    ...
    {
        cerr << "WARNING TwentySevenNodeBrickOrderSix::sendSelf() - " << this->getTag() << " failed to send its Q\n";
        return -1;
    }
    ...
    {
        cerr << "WARNING TwentySevenNodeBrickOrderSix::sendSelf() - " << this->getTag() << " failed to send its bf\n";
        return -1;
    }
...
int TwentySevenNodeBrickOrderSix::receiveSelf ( int commitTag, Channel &theChannel, FEM_ObjectBroker &theBroker )
{
    ID idData( 3 );
    ...
    {
        cerr << "WARNING TwentySevenNodeBrickOrderSix::receiveSelf() - " << this->getTag() << " failed to recieve Vector floatData\n";
        return -1;
    }
    Volume                  = floatData(0) ;
    ...
    {
        cerr << "WARNING TwentySevenNodeBrickOrderSix::receiveSelf() - " << this->getTag() << " failed to recieve String stiffness_type\n";
        return -1;
    }
    ...
    if ( theChannel.receiveString( 0, commitTag, tmp_string ) < 0 )
    {
        cerr << "WARNING TwentySevenNodeBrickOrderSix::receiveSelf() - " << this->getTag() << " failed to recieve String damping_type\n";
        return -1;
    }
    ...
    {
        cerr << "WARNING TwentySevenNodeBrickOrderSix::receiveSelf() - " << this->getTag() << " failed to recieve ID connectedExternalNodes\n";
        return -1;
    }

    // cout << "TwentySevenNodeBrickOrderSix::receiveSelf() connectedExternalNodes = " << connectedExternalNodes << "\n";
    ...
    for ( int i = 0; i < Num_TotalGaussPts; i++ )
    {
        ...
        if ( ndmat == 0 )
        {
            cerr << "TwentySevenNodeBrickOrderSix::receiveSelf() - Broker could not create NDMaterialLT of class type " << matClassTag << "\n";
            return -1;
        }
        ...
        {
            cerr << "TwentySevenNodeBrickOrderSix::receiveSelf() - material " << i << "failed to recv itself\n";
            return -1;
        }
    ...
    {
        cerr << "TwentySevenNodeBrickOrderSix::receiveSelf() - failed to recv Q!\n";
        return -1;
    }
    ...
    {
        cerr << "TwentySevenNodeBrickOrderSix::receiveSelf() - failed to recv bf!\n";
        return -1;
    }
...
int TwentySevenNodeBrickOrderSix::getObjectSize()
{
    int size = 0;
...
//=============================================================================
void TwentySevenNodeBrickOrderSix::Print( ostream &s, int flag )
{
    cout << "TwentySevenNodeBrickOrderSix: LTensor-based 27 node brick." << endl << endl;
...
void TwentySevenNodeBrickOrderSix::ComputeVolume()
{
    Volume = 0.0;
...
int TwentySevenNodeBrickOrderSix::update( void )
{
    double r  = 0.0;
    double s  = 0.0;
    double t  = 0.0;
    ...
    for ( short gp = 0; gp < Num_TotalGaussPts; gp++ )
    {
        ...
        {
            cerr << "TwentySevenNodeBrickOrderSix::update (tag: " << this->getTag() << "), Update Failed\n";
            return -1;
        }
    }
...
double TwentySevenNodeBrickOrderSix::SurfaceShapeFunctionValues( double Xi , double Eta, int whichcomponent )
{
...
Vector &TwentySevenNodeBrickOrderSix::Direction_Weight( double Xi , double Eta, Vector coord1, Vector coord2,
...
double TwentySevenNodeBrickOrderSix::SurfaceLoadValues( double Xi , double Eta, Vector Pressure )
{
...
int
TwentySevenNodeBrickOrderSix::CheckMesh( ofstream &checkmesh_file )
{
    double r  = 0.0;
    double s  = 0.0;
    double t  = 0.0;
...
//==================================================================================
Vector *
TwentySevenNodeBrickOrderSix::getStress( void )
{
...
Matrix &TwentySevenNodeBrickOrderSix::getGaussCoordinates(void)
{
    computeGaussPoint();
    return gauss_points;
}

Matrix &TwentySevenNodeBrickOrderSix::get_Gauss_p_c( )
{
...
Matrix &TwentySevenNodeBrickOrderSix::get_Gauss_p_w()
{
...
***********************************************************************************/
const vector<float> &TwentySevenNodeBrickOrderSix::getGaussOutput()
{
    DTensor2 stress(3, 3);
    DTensor2 strain(3, 3);
...
void TwentySevenNodeBrickOrderSix::zeroStrain()
{
    for (int gp = 0; gp < Num_TotalGaussPts; gp++)
    {
