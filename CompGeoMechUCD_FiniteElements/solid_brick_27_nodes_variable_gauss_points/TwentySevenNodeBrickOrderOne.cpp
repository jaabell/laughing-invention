...
/////////////////////////////////////////////////////////////////////////////////////
// Adapted by Sumeet, for TwentySevenNodeBrickOrderOne to use the LTensor library for
// tensorial representation. [September, 2016]
/////////////////////////////////////////////////////////////////////////////////////



#ifndef TwentySevenNodeBrickOrderOne_CPP
#define TwentySevenNodeBrickOrderOne_CPP

#include "TwentySevenNodeBrickOrderOne.h"
...
DTensor2 TwentySevenNodeBrickOrderOne::gp_coords(Num_TotalGaussPts, 3, 0.0);
DTensor2 TwentySevenNodeBrickOrderOne::gp_weight(Num_TotalGaussPts, 3, 0.0);
Matrix TwentySevenNodeBrickOrderOne::gauss_points(Num_TotalGaussPts, 3);
vector<float> TwentySevenNodeBrickOrderOne::Gauss_Output_Vector(Num_TotalGaussPts*18);

Matrix TwentySevenNodeBrickOrderOne::K(81, 81);

Vector TwentySevenNodeBrickOrderOne::ShapeFunctionValues_in_function( 9 );  // Nima added for surface load (July 2012)
Vector TwentySevenNodeBrickOrderOne::J_vector_in_function( 3 );             // Nima added for surface load (July 2012)
double TwentySevenNodeBrickOrderOne::SurfaceLoadValues_in_function;

//====================================================================
// Constructor
//====================================================================

TwentySevenNodeBrickOrderOne::TwentySevenNodeBrickOrderOne( int element_number,
    ...
    : Element( element_number, ELE_TAG_TwentySevenNodeBrickOrderOne ),
      ...
      M(81,81), P( 81 )
{
    ...
    if (material_array == 0)
    {
        cerr << " TwentySevenNodeBrickOrderOne::TwentySevenNodeBrickOrderOne -- failed allocate material model pointer\n";
        exit(-1);
    }
...
//====================================================================
TwentySevenNodeBrickOrderOne::TwentySevenNodeBrickOrderOne(): Element( 0, ELE_TAG_TwentySevenNodeBrickOrderOne ),
    rho( 0.0 ), connectedExternalNodes( 27 ) , 
...
//####DESTROYER!###############################################################
TwentySevenNodeBrickOrderOne::~TwentySevenNodeBrickOrderOne ()
{
...
//#############################################################################
//***************************************************************
const DTensor2 &TwentySevenNodeBrickOrderOne::H_3D( double r1, double r2, double r3 ) const
{
...
//#############################################################################
//***************************************************************
const DTensor1 &TwentySevenNodeBrickOrderOne::interp_poli_at( double r1, double r2, double r3 ) const
{
...
const DTensor2 &TwentySevenNodeBrickOrderOne::dh_drst_at( double r1, double r2, double r3 ) const
{
...
////#############################################################################
const DTensor2 &TwentySevenNodeBrickOrderOne::Jacobian_3D( const DTensor2 &dh ) const
{
...
//#############################################################################
const DTensor2  &TwentySevenNodeBrickOrderOne::Jacobian_3Dinv( const DTensor2 &dh ) const
{
    const DTensor2 &N_C = Nodal_Coordinates();
...
////#############################################################################
const DTensor2 &TwentySevenNodeBrickOrderOne::Nodal_Coordinates( void ) const
{
...
////#############################################################################
const DTensor2 &TwentySevenNodeBrickOrderOne::incr_disp( void ) const
{
...
////#############################################################################
const DTensor2 &TwentySevenNodeBrickOrderOne::total_disp( void ) const
{
...
////#############################################################################
int TwentySevenNodeBrickOrderOne::get_global_number_of_node( int local_node_number )
{
    return connectedExternalNodes( local_node_number );
}

////#############################################################################
int  TwentySevenNodeBrickOrderOne::get_Brick_Number( void )
{
    return this->getTag();
}
...
const DTensor2 &TwentySevenNodeBrickOrderOne::nodal_forces( void ) const
{
    double r  = 0.0;
    double w_r = 0.0;
    double s  = 0.0;
...
void TwentySevenNodeBrickOrderOne::computeGaussPoint()
{
    double r  = 0.0;
    double s  = 0.0;
    double t  = 0.0;
...
//=============================================================================
int TwentySevenNodeBrickOrderOne::getNumExternalNodes () const
{
    return 27;
}
...
//=============================================================================
const ID &TwentySevenNodeBrickOrderOne::getExternalNodes ()
{
    return connectedExternalNodes;
}

Node **
TwentySevenNodeBrickOrderOne::getNodePtrs( void )
{
    return theNodes;
}

//=============================================================================
int TwentySevenNodeBrickOrderOne::getNumDOF ()
{
    return 81;
}

//=============================================================================
void TwentySevenNodeBrickOrderOne::setDomain ( Domain *theDomain )
{
...
# endif
        ...
        {
            cerr << "FATAL ERROR TwentySevenNodeBrickOrderOne (tag: " << this->getTag() << "), node not found in domain\n";
            exit( -1 );
        }
        ...
        {
            cerr << "FATAL ERROR TwentySevenNodeBrickOrderOne (tag: " << this->getTag() << "), has differing number of DOFs at its nodes\n";
            exit( -1 );
        }
...
//=============================================================================
int TwentySevenNodeBrickOrderOne::commitState ()
{
    ...
    {
        cerr << "TwentySevenNodeBrickOrderOne::commitState () - failed in base class";
    }
...
//=============================================================================
int TwentySevenNodeBrickOrderOne::revertToLastCommit ()
{
    int retVal = 0;
...
//=============================================================================
int TwentySevenNodeBrickOrderOne::revertToStart ()
{
    int retVal = 0;
...
//=============================================================================
const Matrix &TwentySevenNodeBrickOrderOne::getTangentStiff()
{
...
//=============================================================================
const Matrix &TwentySevenNodeBrickOrderOne::getInitialStiff ()
{
    ...
    if ( Ki == 0 )
    {
        cerr << "FATAL TwentySevenNodeBrickOrderOne::getInitialStiff() -";
...
const Matrix &TwentySevenNodeBrickOrderOne::getMass ()
{
...
//=============================================================================
void TwentySevenNodeBrickOrderOne::zeroLoad( void )
{
    Q.Zero();
}
...
//======================================================================
const Vector &TwentySevenNodeBrickOrderOne::getBodyForce( double loadFactor, const Vector &data )
{
...
//======================================================================
const Vector &TwentySevenNodeBrickOrderOne::getSurfaceForce( double loadFactor, const Vector &data )
{
...
//=============================================================================
int TwentySevenNodeBrickOrderOne::addLoad( ElementalLoad *theLoad, double loadFactor )
{
    ...
    {
        cerr << "TwentySevenNodeBrickOrderOne::addLoad() - 8NodeBrick " << this->getTag() << ",load type " << type << "unknown\n";
        return -1;
    }
...
//=============================================================================
int TwentySevenNodeBrickOrderOne::addInertiaLoadToUnbalance( const Vector &accel )
{
    // Check for a quick return
    if ( rho == 0.0 )
    {
    ...
    {
        cerr << "TwentySevenNodeBrickOrderOne::addInertiaLoadToUnbalance matrix and vector sizes are incompatable\n";
        return -1;
    }
...
//=============================================================================
const Vector TwentySevenNodeBrickOrderOne::FormEquiBodyForce(const Vector &data)
{
    static Vector bforce( 81 );
    bforce.Zero();
...
//=============================================================================
const Vector &TwentySevenNodeBrickOrderOne::getResistingForce()
{
...
//=============================================================================
const Vector &TwentySevenNodeBrickOrderOne::getResistingForceIncInertia ()
{
...
int TwentySevenNodeBrickOrderOne::sendSelf ( int commitTag, Channel &theChannel )
{
    ...
    {
        cerr << "WARNING TwentySevenNodeBrickOrderOne::sendSelf() - " << this->getTag() << " failed to send ID idData\n";
        return -1;
    }
    ...
    if(idData( 2 )==1){
        ...
        {
            cerr << "WARNING TwentySevenNodeBrickOrderOne::sendSelf() - " << this->getTag() << " failed to send its K\n";
            return -1;
        }
    }
    ...
    {
        cerr << "WARNING TwentySevenNodeBrickOrderOne::sendSelf() - " << this->getTag() << " failed to send Vector floatData\n";
        return -1;
    }
    ...
    {
        cerr << "WARNING TwentySevenNodeBrickOrderOne::sendSelf() - " << this->getTag() << " failed to send String stiffness_type\n";
        return -1;
    }
    ...
    {
        cerr << "WARNING TwentySevenNodeBrickOrderOne::sendSelf() - " << this->getTag() << " failed to send String damping_type\n";
        return -1;
    }
    ...
    {
        cerr << "WARNING TwentySevenNodeBrickOrderOne::sendSelf() - " << this->getTag() << " failed to send ID connectedExternalNodes\n";
        return -1;
    }
    ...
    for ( int i = 0; i < Num_TotalGaussPts; i++ )
    {
        ...
        {
            cerr << "WARNING TwentySevenNodeBrickOrderOne::sendSelf() - " << this->getTag() << " failed to send material models\n";
            return -1;
        }
    }
    ...
    {
        cerr << "WARNING TwentySevenNodeBrickOrderOne::sendSelf() - " << this->getTag() << " failed to send its Q\n";
        return -1;
    }
    ...
    {
        cerr << "WARNING TwentySevenNodeBrickOrderOne::sendSelf() - " << this->getTag() << " failed to send its bf\n";
        return -1;
    }
...
int TwentySevenNodeBrickOrderOne::receiveSelf ( int commitTag, Channel &theChannel, FEM_ObjectBroker &theBroker )
{
    ID idData( 3 );
    ...
    {
        cerr << "WARNING TwentySevenNodeBrickOrderOne::receiveSelf() - " << this->getTag() << " failed to recieve Vector floatData\n";
        return -1;
    }
    Volume                  = floatData(0) ;
    ...
    {
        cerr << "WARNING TwentySevenNodeBrickOrderOne::receiveSelf() - " << this->getTag() << " failed to recieve String stiffness_type\n";
        return -1;
    }
    ...
    if ( theChannel.receiveString( 0, commitTag, tmp_string ) < 0 )
    {
        cerr << "WARNING TwentySevenNodeBrickOrderOne::receiveSelf() - " << this->getTag() << " failed to recieve String damping_type\n";
        return -1;
    }
    ...
    {
        cerr << "WARNING TwentySevenNodeBrickOrderOne::receiveSelf() - " << this->getTag() << " failed to recieve ID connectedExternalNodes\n";
        return -1;
    }

    // cout << "TwentySevenNodeBrickOrderOne::receiveSelf() connectedExternalNodes = " << connectedExternalNodes << "\n";
    ...
    for ( int i = 0; i < Num_TotalGaussPts; i++ )
    {
        ...
        if ( ndmat == 0 )
        {
            cerr << "TwentySevenNodeBrickOrderOne::receiveSelf() - Broker could not create NDMaterialLT of class type " << matClassTag << "\n";
            return -1;
        }
        ...
        {
            cerr << "TwentySevenNodeBrickOrderOne::receiveSelf() - material " << i << "failed to recv itself\n";
            return -1;
        }
    ...
    {
        cerr << "TwentySevenNodeBrickOrderOne::receiveSelf() - failed to recv Q!\n";
        return -1;
    }
    ...
    {
        cerr << "TwentySevenNodeBrickOrderOne::receiveSelf() - failed to recv bf!\n";
        return -1;
    }
...
int TwentySevenNodeBrickOrderOne::getObjectSize()
{
    int size = 0;
...
//=============================================================================
void TwentySevenNodeBrickOrderOne::Print( ostream &s, int flag )
{
    cout << "TwentySevenNodeBrickOrderOne: LTensor-based 27 node brick." << endl << endl;
...
void TwentySevenNodeBrickOrderOne::ComputeVolume()
{
    Volume = 0.0;
...
int TwentySevenNodeBrickOrderOne::update( void )
{
    double r  = 0.0;
    double s  = 0.0;
    double t  = 0.0;
    ...
    for ( short gp = 0; gp < Num_TotalGaussPts; gp++ )
    {
        ...
        {
            cerr << "TwentySevenNodeBrickOrderOne::update (tag: " << this->getTag() << "), Update Failed\n";
            return -1;
        }
    }
...
double TwentySevenNodeBrickOrderOne::SurfaceShapeFunctionValues( double Xi , double Eta, int whichcomponent )
{
...
Vector &TwentySevenNodeBrickOrderOne::Direction_Weight( double Xi , double Eta, Vector coord1, Vector coord2,
...
double TwentySevenNodeBrickOrderOne::SurfaceLoadValues( double Xi , double Eta, Vector Pressure )
{
...
int
TwentySevenNodeBrickOrderOne::CheckMesh( ofstream &checkmesh_file )
{
    double r  = 0.0;
    double s  = 0.0;
    double t  = 0.0;
...
//==================================================================================
Vector *
TwentySevenNodeBrickOrderOne::getStress( void )
{
...
Matrix &TwentySevenNodeBrickOrderOne::getGaussCoordinates(void)
{
    computeGaussPoint();
    return gauss_points;
}

Matrix &TwentySevenNodeBrickOrderOne::get_Gauss_p_c( )
{
...
Matrix &TwentySevenNodeBrickOrderOne::get_Gauss_p_w()
{
...
***********************************************************************************/
const vector<float> &TwentySevenNodeBrickOrderOne::getGaussOutput()
{
    DTensor2 stress(3, 3);
    DTensor2 strain(3, 3);
...
void TwentySevenNodeBrickOrderOne::zeroStrain()
{
    for (int gp = 0; gp < Num_TotalGaussPts; gp++)
    {
