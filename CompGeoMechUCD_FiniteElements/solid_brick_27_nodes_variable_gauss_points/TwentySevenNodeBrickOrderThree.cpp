...
/////////////////////////////////////////////////////////////////////////////////////
// Adapted by Sumeet, for TwentySevenNodeBrickOrderThree to use the LTensor library for
// tensorial representation. [September, 2016]
/////////////////////////////////////////////////////////////////////////////////////



#ifndef TwentySevenNodeBrickOrderThree_CPP
#define TwentySevenNodeBrickOrderThree_CPP

#include "TwentySevenNodeBrickOrderThree.h"
...
DTensor2 TwentySevenNodeBrickOrderThree::gp_coords(Num_TotalGaussPts, 3, 0.0);
DTensor2 TwentySevenNodeBrickOrderThree::gp_weight(Num_TotalGaussPts, 3, 0.0);
Matrix TwentySevenNodeBrickOrderThree::gauss_points(Num_TotalGaussPts, 3);
vector<float> TwentySevenNodeBrickOrderThree::Gauss_Output_Vector(Num_TotalGaussPts*18);

Matrix TwentySevenNodeBrickOrderThree::K(81, 81);

Vector TwentySevenNodeBrickOrderThree::ShapeFunctionValues_in_function( 9 );  // Nima added for surface load (July 2012)
Vector TwentySevenNodeBrickOrderThree::J_vector_in_function( 3 );             // Nima added for surface load (July 2012)
double TwentySevenNodeBrickOrderThree::SurfaceLoadValues_in_function;

//====================================================================
// Constructor
//====================================================================

TwentySevenNodeBrickOrderThree::TwentySevenNodeBrickOrderThree( int element_number,
    ...
    : Element( element_number, ELE_TAG_TwentySevenNodeBrickOrderThree ),
      ...
      M(81,81), P( 81 )
{
    ...
    if (material_array == 0)
    {
        cerr << " TwentySevenNodeBrickOrderThree::TwentySevenNodeBrickOrderThree -- failed allocate material model pointer\n";
        exit(-1);
    }
...
//====================================================================
TwentySevenNodeBrickOrderThree::TwentySevenNodeBrickOrderThree(): Element( 0, ELE_TAG_TwentySevenNodeBrickOrderThree ),
    rho( 0.0 ), connectedExternalNodes( 27 ) , 
...
//####DESTROYER!###############################################################
TwentySevenNodeBrickOrderThree::~TwentySevenNodeBrickOrderThree ()
{
...
//#############################################################################
//***************************************************************
const DTensor2 &TwentySevenNodeBrickOrderThree::H_3D( double r1, double r2, double r3 ) const
{
...
//#############################################################################
//***************************************************************
const DTensor1 &TwentySevenNodeBrickOrderThree::interp_poli_at( double r1, double r2, double r3 ) const
{
...
const DTensor2 &TwentySevenNodeBrickOrderThree::dh_drst_at( double r1, double r2, double r3 ) const
{
...
////#############################################################################
const DTensor2 &TwentySevenNodeBrickOrderThree::Jacobian_3D( const DTensor2 &dh ) const
{
...
//#############################################################################
const DTensor2  &TwentySevenNodeBrickOrderThree::Jacobian_3Dinv( const DTensor2 &dh ) const
{
    const DTensor2 &N_C = Nodal_Coordinates();
...
////#############################################################################
const DTensor2 &TwentySevenNodeBrickOrderThree::Nodal_Coordinates( void ) const
{
...
////#############################################################################
const DTensor2 &TwentySevenNodeBrickOrderThree::incr_disp( void ) const
{
...
////#############################################################################
const DTensor2 &TwentySevenNodeBrickOrderThree::total_disp( void ) const
{
...
////#############################################################################
int TwentySevenNodeBrickOrderThree::get_global_number_of_node( int local_node_number )
{
    return connectedExternalNodes( local_node_number );
}

////#############################################################################
int  TwentySevenNodeBrickOrderThree::get_Brick_Number( void )
{
    return this->getTag();
}
...
const DTensor2 &TwentySevenNodeBrickOrderThree::nodal_forces( void ) const
{
    double r  = 0.0;
    double w_r = 0.0;
    double s  = 0.0;
...
void TwentySevenNodeBrickOrderThree::computeGaussPoint()
{
    double r  = 0.0;
    double s  = 0.0;
    double t  = 0.0;
...
//=============================================================================
int TwentySevenNodeBrickOrderThree::getNumExternalNodes () const
{
    return 27;
}
...
//=============================================================================
const ID &TwentySevenNodeBrickOrderThree::getExternalNodes ()
{
    return connectedExternalNodes;
}

Node **
TwentySevenNodeBrickOrderThree::getNodePtrs( void )
{
    return theNodes;
}

//=============================================================================
int TwentySevenNodeBrickOrderThree::getNumDOF ()
{
    return 81;
}

//=============================================================================
void TwentySevenNodeBrickOrderThree::setDomain ( Domain *theDomain )
{
...
# endif
        ...
        {
            cerr << "FATAL ERROR TwentySevenNodeBrickOrderThree (tag: " << this->getTag() << "), node not found in domain\n";
            exit( -1 );
        }
        ...
        {
            cerr << "FATAL ERROR TwentySevenNodeBrickOrderThree (tag: " << this->getTag() << "), has differing number of DOFs at its nodes\n";
            exit( -1 );
        }
...
//=============================================================================
int TwentySevenNodeBrickOrderThree::commitState ()
{
    ...
    {
        cerr << "TwentySevenNodeBrickOrderThree::commitState () - failed in base class";
    }
...
//=============================================================================
int TwentySevenNodeBrickOrderThree::revertToLastCommit ()
{
    int retVal = 0;
...
//=============================================================================
int TwentySevenNodeBrickOrderThree::revertToStart ()
{
    int retVal = 0;
...
//=============================================================================
const Matrix &TwentySevenNodeBrickOrderThree::getTangentStiff()
{
...
//=============================================================================
const Matrix &TwentySevenNodeBrickOrderThree::getInitialStiff ()
{
    ...
    if ( Ki == 0 )
    {
        cerr << "FATAL TwentySevenNodeBrickOrderThree::getInitialStiff() -";
...
const Matrix &TwentySevenNodeBrickOrderThree::getMass ()
{
...
//=============================================================================
void TwentySevenNodeBrickOrderThree::zeroLoad( void )
{
    Q.Zero();
}
...
//======================================================================
const Vector &TwentySevenNodeBrickOrderThree::getBodyForce( double loadFactor, const Vector &data )
{
...
//======================================================================
const Vector &TwentySevenNodeBrickOrderThree::getSurfaceForce( double loadFactor, const Vector &data )
{
...
//=============================================================================
int TwentySevenNodeBrickOrderThree::addLoad( ElementalLoad *theLoad, double loadFactor )
{
    ...
    {
        cerr << "TwentySevenNodeBrickOrderThree::addLoad() - 8NodeBrick " << this->getTag() << ",load type " << type << "unknown\n";
        return -1;
    }
...
//=============================================================================
int TwentySevenNodeBrickOrderThree::addInertiaLoadToUnbalance( const Vector &accel )
{
    // Check for a quick return
    if ( rho == 0.0 )
    {
    ...
    {
        cerr << "TwentySevenNodeBrickOrderThree::addInertiaLoadToUnbalance matrix and vector sizes are incompatable\n";
        return -1;
    }
...
//=============================================================================
const Vector TwentySevenNodeBrickOrderThree::FormEquiBodyForce(const Vector &data)
{
    static Vector bforce( 81 );
    bforce.Zero();
...
//=============================================================================
const Vector &TwentySevenNodeBrickOrderThree::getResistingForce()
{
...
//=============================================================================
const Vector &TwentySevenNodeBrickOrderThree::getResistingForceIncInertia ()
{
...
int TwentySevenNodeBrickOrderThree::sendSelf ( int commitTag, Channel &theChannel )
{
    ...
    {
        cerr << "WARNING TwentySevenNodeBrickOrderThree::sendSelf() - " << this->getTag() << " failed to send ID idData\n";
        return -1;
    }
    ...
    if(idData( 2 )==1){
        ...
        {
            cerr << "WARNING TwentySevenNodeBrickOrderThree::sendSelf() - " << this->getTag() << " failed to send its K\n";
            return -1;
        }
    }
    ...
    {
        cerr << "WARNING TwentySevenNodeBrickOrderThree::sendSelf() - " << this->getTag() << " failed to send Vector floatData\n";
        return -1;
    }
    ...
    {
        cerr << "WARNING TwentySevenNodeBrickOrderThree::sendSelf() - " << this->getTag() << " failed to send String stiffness_type\n";
        return -1;
    }
    ...
    {
        cerr << "WARNING TwentySevenNodeBrickOrderThree::sendSelf() - " << this->getTag() << " failed to send String damping_type\n";
        return -1;
    }
    ...
    {
        cerr << "WARNING TwentySevenNodeBrickOrderThree::sendSelf() - " << this->getTag() << " failed to send ID connectedExternalNodes\n";
        return -1;
    }
    ...
    for ( int i = 0; i < Num_TotalGaussPts; i++ )
    {
        ...
        {
            cerr << "WARNING TwentySevenNodeBrickOrderThree::sendSelf() - " << this->getTag() << " failed to send material models\n";
            return -1;
        }
    }
    ...
    {
        cerr << "WARNING TwentySevenNodeBrickOrderThree::sendSelf() - " << this->getTag() << " failed to send its Q\n";
        return -1;
    }
    ...
    {
        cerr << "WARNING TwentySevenNodeBrickOrderThree::sendSelf() - " << this->getTag() << " failed to send its bf\n";
        return -1;
    }
...
int TwentySevenNodeBrickOrderThree::receiveSelf ( int commitTag, Channel &theChannel, FEM_ObjectBroker &theBroker )
{
    ID idData( 3 );
    ...
    {
        cerr << "WARNING TwentySevenNodeBrickOrderThree::receiveSelf() - " << this->getTag() << " failed to recieve Vector floatData\n";
        return -1;
    }
    Volume                  = floatData(0) ;
    ...
    {
        cerr << "WARNING TwentySevenNodeBrickOrderThree::receiveSelf() - " << this->getTag() << " failed to recieve String stiffness_type\n";
        return -1;
    }
    ...
    if ( theChannel.receiveString( 0, commitTag, tmp_string ) < 0 )
    {
        cerr << "WARNING TwentySevenNodeBrickOrderThree::receiveSelf() - " << this->getTag() << " failed to recieve String damping_type\n";
        return -1;
    }
    ...
    {
        cerr << "WARNING TwentySevenNodeBrickOrderThree::receiveSelf() - " << this->getTag() << " failed to recieve ID connectedExternalNodes\n";
        return -1;
    }

    // cout << "TwentySevenNodeBrickOrderThree::receiveSelf() connectedExternalNodes = " << connectedExternalNodes << "\n";
    ...
    for ( int i = 0; i < Num_TotalGaussPts; i++ )
    {
        ...
        if ( ndmat == 0 )
        {
            cerr << "TwentySevenNodeBrickOrderThree::receiveSelf() - Broker could not create NDMaterialLT of class type " << matClassTag << "\n";
            return -1;
        }
        ...
        {
            cerr << "TwentySevenNodeBrickOrderThree::receiveSelf() - material " << i << "failed to recv itself\n";
            return -1;
        }
    ...
    {
        cerr << "TwentySevenNodeBrickOrderThree::receiveSelf() - failed to recv Q!\n";
        return -1;
    }
    ...
    {
        cerr << "TwentySevenNodeBrickOrderThree::receiveSelf() - failed to recv bf!\n";
        return -1;
    }
...
int TwentySevenNodeBrickOrderThree::getObjectSize()
{
    int size = 0;
...
//=============================================================================
void TwentySevenNodeBrickOrderThree::Print( ostream &s, int flag )
{
    cout << "TwentySevenNodeBrickOrderThree: LTensor-based 27 node brick." << endl << endl;
...
void TwentySevenNodeBrickOrderThree::ComputeVolume()
{
    Volume = 0.0;
...
int TwentySevenNodeBrickOrderThree::update( void )
{
    double r  = 0.0;
    double s  = 0.0;
    double t  = 0.0;
    ...
    for ( short gp = 0; gp < Num_TotalGaussPts; gp++ )
    {
        ...
        {
            cerr << "TwentySevenNodeBrickOrderThree::update (tag: " << this->getTag() << "), Update Failed\n";
            return -1;
        }
    }
...
double TwentySevenNodeBrickOrderThree::SurfaceShapeFunctionValues( double Xi , double Eta, int whichcomponent )
{
...
Vector &TwentySevenNodeBrickOrderThree::Direction_Weight( double Xi , double Eta, Vector coord1, Vector coord2,
...
double TwentySevenNodeBrickOrderThree::SurfaceLoadValues( double Xi , double Eta, Vector Pressure )
{
...
int
TwentySevenNodeBrickOrderThree::CheckMesh( ofstream &checkmesh_file )
{
    double r  = 0.0;
    double s  = 0.0;
    double t  = 0.0;
...
//==================================================================================
Vector *
TwentySevenNodeBrickOrderThree::getStress( void )
{
...
Matrix &TwentySevenNodeBrickOrderThree::getGaussCoordinates(void)
{
    computeGaussPoint();
    return gauss_points;
}

Matrix &TwentySevenNodeBrickOrderThree::get_Gauss_p_c( )
{
...
Matrix &TwentySevenNodeBrickOrderThree::get_Gauss_p_w()
{
...
***********************************************************************************/
const vector<float> &TwentySevenNodeBrickOrderThree::getGaussOutput()
{
    DTensor2 stress(3, 3);
    DTensor2 strain(3, 3);
...
void TwentySevenNodeBrickOrderThree::zeroStrain()
{
    for (int gp = 0; gp < Num_TotalGaussPts; gp++)
    {
