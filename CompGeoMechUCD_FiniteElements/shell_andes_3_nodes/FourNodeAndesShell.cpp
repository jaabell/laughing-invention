...
// DATE:              July 2012
// UPDATE HISTORY:    Modified by Babak Kamrani on 20/12/12 to work with parallel
//
///////////////////////////////////////////////////////////////////////////////
...
FourNodeAndesShell::FourNodeAndesShell()
    ...
    K(24, 24), M(24, 24),
    P(24), Q(24), bf(3),  x0(3), T_lg(3, 3),
    is_stiffness_calculated(false),
    is_mass_calculated(false), thickness(0.0)
{
    // zero node pointers
    for (int i = 0; i < 4; i++)
    {
...
FourNodeAndesShell::FourNodeAndesShell(int element_number,
    ...
    P(24), Q(24), bf(3),  x0(3), T_lg(3, 3),
    is_stiffness_calculated(false),
    is_mass_calculated(false), thickness(t)
{
    ...
    *theMaterial = Globalmmodel->getCopy();
    ...
    triangle1 = new ThreeNodeAndesShell(element_number, node_numb_1, node_numb_2,  node_numb_3, t, theMaterial, bodyforce);
    triangle2 = new ThreeNodeAndesShell(element_number, node_numb_1, node_numb_3,  node_numb_4, t, theMaterial, bodyforce);
    triangle3 = new ThreeNodeAndesShell(element_number, node_numb_1, node_numb_2,  node_numb_4, t, theMaterial, bodyforce);
    triangle4 = new ThreeNodeAndesShell(element_number, node_numb_2, node_numb_3,  node_numb_4, t, theMaterial, bodyforce);
...
int FourNodeAndesShell::addLoad(ElementalLoad* theLoad, double loadFactor)
{
    ...
    if (type == LOAD_TAG_AndesShellSelfWeight)
    {
...
//Implemented by Babak Kamrani on 12/27/12:
{
    ...
    *theMaterial = theBroker.getNewNDMaterial(matClassTag);
    ...
    BodyForce* bodyforce = new BodyForce(BodyForce_Tag, bf(0), bf(1), bf(2));

    triangle1 = new ThreeNodeAndesShell(element_number, connectedExternalNodes(0), connectedExternalNodes(1), connectedExternalNodes(2), t, theMaterial, bodyforce);
    triangle2 = new ThreeNodeAndesShell(element_number, connectedExternalNodes(0), connectedExternalNodes(2), connectedExternalNodes(3), t, theMaterial, bodyforce);
    triangle3 = new ThreeNodeAndesShell(element_number, connectedExternalNodes(0), connectedExternalNodes(1), connectedExternalNodes(3), t, theMaterial, bodyforce);
    triangle4 = new ThreeNodeAndesShell(element_number, connectedExternalNodes(1), connectedExternalNodes(2), connectedExternalNodes(3), t, theMaterial, bodyforce);
...
const Vector& FourNodeAndesShell::getBodyForce(double loadFactor)
{
