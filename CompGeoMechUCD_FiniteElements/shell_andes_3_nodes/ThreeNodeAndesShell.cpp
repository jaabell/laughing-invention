    ...
    is_mass_calculated(false)
{
    ...
    *theMaterial = Globalmmodel->getCopy();
    ...
    membrane_element = new ThreeNodeAndesMembrane(element_number, node_numb_1, node_numb_2,  node_numb_3, t, theMaterial, bodyforce);
    bending_element = new ThreeNodeAndesBending(element_number, node_numb_1, node_numb_2,  node_numb_3, t, theMaterial, bodyforce);
}
...
const Vector& ThreeNodeAndesShell::getBodyForce(double loadFactor)
{
