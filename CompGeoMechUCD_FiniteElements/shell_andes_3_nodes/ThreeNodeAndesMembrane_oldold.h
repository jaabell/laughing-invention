...
class ThreeNodeAndesMembrane: public Element
{
    ...
    public:
        ...
        ThreeNodeAndesMembrane(int element_number,
                               int node_numb_1, int node_numb_2, int node_numb_3, double t,
                               NDMaterial** material, BodyForce* bodyforce);   // Need this to be called when this element is part of complete shell element :P
        void init(
    ...
    private:
        ...
        double Ar;                    // yes... its the area of the triangle :)
        ...
        double ab;   // Scale factor relating boundary normal displacements to corner rotations. See paper (1) by Felippa.
        double ah;    // beta_membrane parameter values
