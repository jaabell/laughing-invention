...
class TwentySevenNodeBrickElastic: public Element
{

    public:
        TwentySevenNodeBrickElastic(int element_number,
        ...
        {
            return "TwentySevenNodeBrickElastic";
        }
    ...
    public:
        ...
        TwentySevenNodeBrickElastic &operator[](int subscript);
