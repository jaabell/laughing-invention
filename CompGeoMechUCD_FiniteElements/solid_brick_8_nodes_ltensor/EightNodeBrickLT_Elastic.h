...
#ifndef EightNodeBrickLT_ElasticLT_H
#define EightNodeBrickLT_ElasticLT_H
...
class EightNodeBrickLT_Elastic: public EightNodeBrickLT
{

public:
    EightNodeBrickLT_Elastic( int element_number,
                      int node_numb_1, int node_numb_2, int node_numb_3, int node_numb_4,
                      int node_numb_5, int node_numb_6, int node_numb_7, int node_numb_8,
                      NDMaterialLT *Globalmmodel);

    EightNodeBrickLT_Elastic ();

    const Matrix &getTangentStiff ();
    
    std::string getElementName() const
    {
        return "EightNodeBrickLT_Elastic";
    }
};
