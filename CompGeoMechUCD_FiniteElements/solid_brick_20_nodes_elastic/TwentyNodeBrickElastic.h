...
#ifndef TWENTYNODEBRICKELASTIC_H
#define TWENTYNODEBRICKELASTIC_H
...
class TwentyNodeBrickElastic: public Element
{

    public:
        TwentyNodeBrickElastic(int element_number,
    ...
    public:
        ...
        TwentyNodeBrickElastic& operator[](int subscript);
