...
#line 135 "feiparser.tab.hh" // lalr1.cc:372
    ...
    struct token
    {
      enum yytokentype
      {
        ...
        TH_LINEAR = 373,
        TH_PATH_SERIES = 374,
        TH_PATH_TIME_SERIES = 375,
        TH_CONSTANT = 376,
        TH_FROM_REACTIONS = 377,
        self_weight = 378,
        surface = 379,
        load_value = 380,
        scale_factor = 381,
        displacement_scale_unit = 382,
        velocity_scale_unit = 383,
        acceleration_scale_unit = 384,
        number_of_steps = 385,
        number_of_drm_nodes = 386,
        number_of_drm_elements = 387,
        x_max = 388,
        x_min = 389,
        y_max = 390,
        y_min = 391,
  ...
  private:
    ...
    {
      yyeof_ = 0,
      yylast_ = 10503,     ///< Last index in yytable_.
      yynnts_ = 15,  ///< Number of nonterminal symbols.
      yyempty_ = -2,
      yyfinal_ = 107, ///< Termination state number.
      yyterror_ = 1,
      yyerrcode_ = 256,
      yyntokens_ = 407  ///< Number of tokens.
    };
...
#line 844 "feiparser.tab.hh" // lalr1.cc:372
