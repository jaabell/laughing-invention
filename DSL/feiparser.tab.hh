...
#line 135 "feiparser.tab.hh" // lalr1.cc:372
    ...
    struct token
    {
      enum yytokentype
      {
        ...
        linear_elastic_isotropic_3d_LT = 490,
        sanisand2008 = 491,
        camclay = 492,
        camclay_accelerated = 493,
        sanisand2004 = 494,
        linear_elastic_crossanisotropic = 495,
        uniaxial_concrete02 = 496,
        uniaxial_elastic_1d = 497,
        uniaxial_steel01 = 498,
        uniaxial_steel02 = 499,
        pisano = 500,
        PisanoLT = 501,
        VonMisesLT = 502,
        DruckerPragerLT = 503,
        mass_density = 504,
        elastic_modulus = 505,
        viscoelastic_modulus = 506,
        poisson_ratio = 507,
        von_mises_radius = 508,
        druckerprager_angle = 509,
        druckerprager_k = 510,
  ...
  private:
    ...
    {
      yyeof_ = 0,
      yylast_ = 8398,     ///< Last index in yytable_.
