...
#line 135 "feiparser.tab.hh" // lalr1.cc:372
    ...
    struct token
    {
      enum yytokentype
      {
        ...
        frequency3 = 671,
        frequency4 = 672,
        stiffness_to_use_opt = 673,
        DAMPING_RAYLEIGH = 674,
        DAMPING_CAUGHEY3 = 675,
        DAMPING_CAUGHEY4 = 676,
        a0 = 677,
        a1 = 678,
        stiffness_to_use = 679,
        a2 = 680,
        a3 = 681,
        a4 = 682,
        R0 = 683,
  ...
  private:
    ...
    {
      yyeof_ = 0,
      yylast_ = 9516,     ///< Last index in yytable_.
      yynnts_ = 16,  ///< Number of nonterminal symbols.
      yyempty_ = -2,
      yyfinal_ = 120, ///< Termination state number.
      yyterror_ = 1,
      yyerrcode_ = 256,
      yyntokens_ = 468  ///< Number of tokens.
    };
...
#line 905 "feiparser.tab.hh" // lalr1.cc:372
