...
#line 135 "feiparser.tab.hh" // lalr1.cc:372
    ...
    struct token
    {
      enum yytokentype
      {
        ...
        mass_density = 508,
        elastic_modulus = 509,
        viscoelastic_modulus = 510,
        poisson_ratio = 511,
        von_mises_radius = 512,
        druckerprager_angle = 513,
        druckerprager_k = 514,
        ...
        tolerance = 597,
        yield_function_relative_tolerance = 598,
        stress_relative_tolerance = 599,
        beta = 600,
        gamma = 601,
        kappa = 602,
        lambda = 603,
        ...
        frequency3 = 615,
        frequency4 = 616,
        stiffness_to_use_opt = 617,
        DAMPING_RAYLEIGH = 618,
        DAMPING_CAUGHEY3 = 619,
        DAMPING_CAUGHEY4 = 620,
        a0 = 621,
        a1 = 622,
        stiffness_to_use = 623,
        a2 = 624,
        a3 = 625,
        a4 = 626,
        R0 = 627,
  ...
  private:
    ...
    {
      yyeof_ = 0,
      yylast_ = 8018,     ///< Last index in yytable_.
      yynnts_ = 16,  ///< Number of nonterminal symbols.
      yyempty_ = -2,
      yyfinal_ = 116, ///< Termination state number.
      yyterror_ = 1,
      yyerrcode_ = 256,
      yyntokens_ = 410  ///< Number of tokens.
    };
...
#line 847 "feiparser.tab.hh" // lalr1.cc:372
