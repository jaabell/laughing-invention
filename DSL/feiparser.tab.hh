...
#line 91 "feiparser.tab.hh"
   ...
   enum yytokentype {
     ...
     frequency3 = 604,
     frequency4 = 605,
     stiffness_to_use_opt = 606,
     DAMPING_RAYLEIGH = 607,
     DAMPING_CAUGHEY3 = 608,
     DAMPING_CAUGHEY4 = 609,
     a0 = 610,
     a1 = 611,
     stiffness_to_use = 612,
     a2 = 613,
     a3 = 614,
     a4 = 615,
     R0 = 616,
