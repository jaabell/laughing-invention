...
#line 135 "feiparser.tab.hh" // lalr1.cc:372
    ...
    struct token
    {
      enum yytokentype
      {
        ...
        frequency3 = 626,
        frequency4 = 627,
        stiffness_to_use_opt = 628,
        DAMPING_RAYLEIGH = 629,
        DAMPING_CAUGHEY3 = 630,
        DAMPING_CAUGHEY4 = 631,
        a0 = 632,
        a1 = 633,
        stiffness_to_use = 634,
        a2 = 635,
        a3 = 636,
        a4 = 637,
        R0 = 638,
  ...
  private:
    ...
    {
      yyeof_ = 0,
      yylast_ = 10540,     ///< Last index in yytable_.
      yynnts_ = 15,  ///< Number of nonterminal symbols.
      yyempty_ = -2,
      yyfinal_ = 115, ///< Termination state number.
      yyterror_ = 1,
      yyerrcode_ = 256,
      yyntokens_ = 421  ///< Number of tokens.
    };
...
#line 858 "feiparser.tab.hh" // lalr1.cc:372
