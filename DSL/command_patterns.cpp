...
patterns->push_back("add element # <.> type contact with nodes (<.>, <.>) normal_stiffness = <F/L^2> tangential_stiffness = <F/L^2> friction_ratio = <.> maximum_gap = <L> contact_plane_vector = (<.>, <.>, <.> );");
...
patterns->push_back("define output to binary;");
